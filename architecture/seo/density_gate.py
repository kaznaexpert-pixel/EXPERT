...
Служебные блоки (навигация, футер, «Что почитать ещё», формы, глоссарий) исключаются.
...
SKIP_HEADS = ('что почитать', 'коротко о главном', 'источники и нормативная база', 'глоссарий', 'календарь дедлайнов', 'разделы', 'связаться',

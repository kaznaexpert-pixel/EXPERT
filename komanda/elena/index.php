...
<meta name="description" content="Елена — эксперт КазнаЭксперт по ведению долгосрочных контрактов с помесячными платежами в ИТ и строительстве. 6 лет в казначействе, в команде с 2020 года.">
...
{"@context": "https://schema.org", "@type": "ProfilePage", "mainEntity": {"@type": "Person", "name": "Елена", "jobTitle": "Эксперт по ведению · ИТ и строительство", "description": "Елена — эксперт КазнаЭксперт по ведению долгосрочных контрактов с помесячными платежами в ИТ и строительстве. 6 лет в казначействе, в команде с 2020 года.", "url": "https://kaznaexpert.ru/komanda/elena/", "image": "https://kaznaexpert.ru/img/team/elena-640.jpg", "worksFor": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "telephone": "+7-981-833-10-10"}, "knowsAbout": ["Долгосрочные контракты с помесячными платежами", "Контроль сроков на всём горизонте", "Корректность оснований каждого платежа", "Профиль ИТ и строительство", "Сводный реестр и отчётность", "Взаимодействие с УФК по длинным контрактам"], "colleague": {"@type": "Person", "name": "Ярослав Михайлов", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/"}}}
</script>
<script type="application/ld+json">
...
<meta property="og:description" content="Елена — эксперт КазнаЭксперт по ведению долгосрочных контрактов с помесячными платежами в ИТ и строительстве. 6 лет в казначействе, в команде с 2020 года.">
...
<meta name="twitter:description" content="Елена — эксперт КазнаЭксперт по ведению долгосрочных контрактов с помесячными платежами в ИТ и строительстве. 6 лет в казначействе, в команде с 2020 года.">
  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      <div class="v2-hero-main">
        <nav class="team-crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/komanda/">Команда</a> › <span>Елена</span></nav>
        ...
        <div class="author-hero">
          <div class="author-hero__photo"><picture><source type="image/webp" srcset="/img/team/elena-640.webp?b=2"><img src="/img/team/elena-640.jpg?b=2" width="640" height="800" decoding="async" alt="Елена — Эксперт по ведению · ИТ и строительство, КазнаЭксперт"></picture></div>
          <div>
            <h1>Елена</h1>
...
<section class="v2-section v2-screen" id="bio">
  <div class="v2-container">
    ...
    <div class="bio-prose"><p>Работала в органах казначейства, знакома с командой по совместной службе. Знает специфику длинных контрактов, где платежи идут месяц за месяцем и любая ошибка в основании накапливается.</p><p>В КазнаЭксперт с 2020 года. Ведёт долгосрочные контракты с помесячными платежами в ИТ и строительстве, следит за сроками и корректностью оснований платежа на всём горизонте исполнения.</p></div>
  </div>
</section>

<section class="v2-section v2-screen" id="zona">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Чем занимается</div><h2 class="v2-section-title">Зона <em>ответственности</em></h2><p class="v2-section-lede">Ведёт долгосрочные контракты с помесячными платежами. Особое внимание — срокам и корректности оснований платежа.</p></div>
    <ul class="expert-focus"><li>Долгосрочные контракты с помесячными платежами</li><li>Контроль сроков на всём горизонте</li><li>Корректность оснований каждого платежа</li><li>Профиль ИТ и строительство</li><li>Сводный реестр и отчётность</li><li>Взаимодействие с УФК по длинным контрактам</li></ul>
    <div class="crossfunc"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 1l4 4-4 4"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><path d="M7 23l-4-4 4-4"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg><p>Елена ведёт контракты в группе с Натальей и Юлией. Они взаимозаменяемы: при отпуске или болезни вашего эксперта длинный контракт без паузы подхватит коллега из группы — с полной историей и единым стандартом.</p></div>
  </div>
</section>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    ...
    <div style="max-width:520px;margin:0 auto"><form class="railform" id="leadFormBottom" novalidate data-endpoint="/php/lead.php" data-source="expert-elena-cta">
          <input class="fld" name="name" placeholder="Имя" required minlength="2" maxlength="80" autocomplete="name">
          <input class="fld" name="phone" type="tel" placeholder="+7 (___) ___-__-__" required autocomplete="tel" inputmode="tel">
          <input class="hp" name="company_extra" tabindex="-1" autocomplete="off" aria-hidden="true">
          <label class="policy"><input type="checkbox" name="consent" required><span>Согласен с <a href="/privacy/" target="_blank" rel="noopener">политикой обработки данных</a>. Не передаём третьим лицам.</span></label>

...
<title>Наталья — эксперт по ведению контрактов с авансом и ГОЗ | КазнаЭксперт</title>
<meta name="description" content="Наталья — эксперт КазнаЭксперт по ведению контрактов с авансом, ГОЗ и нацпроектов. 12 лет в Федеральном казначействе, в команде с 2018 года.">
<meta name="author" content="Ярослав Михайлов">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
<meta name="theme-color" content="#F4F1EB" media="(prefers-color-scheme: light)">
<meta name="theme-color" content="#141310" media="(prefers-color-scheme: dark)">
<!-- PROD: canonical и og:url ОБЯЗАТЕЛЬНО менять под URL каждой статьи -->
<link rel="canonical" href="https://kaznaexpert.ru/komanda/natalya/">
...
{"@context": "https://schema.org", "@type": "ProfilePage", "mainEntity": {"@type": "Person", "name": "Наталья", "jobTitle": "Эксперт по ведению · аванс и ГОЗ", "description": "Наталья — эксперт КазнаЭксперт по ведению контрактов с авансом, ГОЗ и нацпроектов. 12 лет в Федеральном казначействе, в команде с 2018 года.", "url": "https://kaznaexpert.ru/komanda/natalya/", "image": "https://kaznaexpert.ru/img/team/natalya-640.jpg", "worksFor": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "telephone": "+7-981-833-10-10"}, "knowsAbout": ["Контракты с авансом и контроль целевого использования", "Гособоронзаказ и национальные проекты", "Цепочка кооперации с соисполнителями", "Переписка и споры с УФК", "Разморозка аванса и снятие блокировок", "Контроль всех этапов платежей до зачисления"], "colleague": {"@type": "Person", "name": "Ярослав Михайлов", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/"}}}
</script>
<script type="application/ld+json">
...
<meta property="og:description" content="Наталья — эксперт КазнаЭксперт по ведению контрактов с авансом, ГОЗ и нацпроектов. 12 лет в Федеральном казначействе, в команде с 2018 года.">
...
<meta name="twitter:description" content="Наталья — эксперт КазнаЭксперт по ведению контрактов с авансом, ГОЗ и нацпроектов. 12 лет в Федеральном казначействе, в команде с 2018 года.">
  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      <div class="v2-hero-main">
        <nav class="team-crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/komanda/">Команда</a> › <span>Наталья</span></nav>
        ...
        <div class="author-hero">
          <div class="author-hero__photo"><picture><source type="image/webp" srcset="/img/team/natalya-640.webp?b=2"><img src="/img/team/natalya-640.jpg?b=2" width="640" height="800" decoding="async" alt="Наталья — Эксперт по ведению · аванс и ГОЗ, КазнаЭксперт"></picture></div>
          <div>
            <h1>Наталья</h1>
            <div class="author-hero__sub">Эксперт по ведению · аванс и ГОЗ</div>
            <p class="v2-hero-lede" style="margin-top:14px">Ведёт контракты с авансом, гособоронзаказ и нацпроекты. Контролирует все этапы платежей и переписку с казначейством.</p>
            <div class="author-hero__meta"><span>В команде КазнаЭксперт с 2018 года</span></div>
          </div>
        </div>
        <div class="v2-hero-trust" style="margin-top:28px"><div class="v2-trust-item"><div class="v2-trust-num">12<span class="v2-trust-suffix">&nbsp;лет</span></div><div class="v2-trust-label">в Казначействе</div></div><div class="v2-trust-item"><div class="v2-trust-num">с 2018<span class="v2-trust-suffix"></span></div><div class="v2-trust-label">в команде</div></div></div>
      </div>
      <aside class="v2-hero-action">
        ...
        <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="expert-natalya">
...
<section class="v2-section v2-screen" id="bio">
  <div class="v2-container">
    ...
    <div class="bio-prose"><p>12 лет в системе Федерального казначейства — глубокий опыт по самым требовательным к срокам и документам направлениям. Пересекалась с Ярославом Михайловым в годы совместной работы в Казначействе, отсюда единый подход к работе с УФК.</p><p>В команде с 2018 года. Специализируется на контрактах с авансом, ГОЗ и национальных проектах: ведёт переписку с УФК, контролирует целевое использование средств и все этапы платежей — от санкционирования до зачисления. К ней эскалируют ситуации с возвратами и блокировками.</p></div>
  </div>
</section>

<section class="v2-section v2-screen" id="zona">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Чем занимается</div><h2 class="v2-section-title">Зона <em>ответственности</em></h2><p class="v2-section-lede">Ведёт контракты с авансом, гособоронзаказ и нацпроекты. Контролирует все этапы платежей и переписку с казначейством.</p></div>
    <ul class="expert-focus"><li>Контракты с авансом и контроль целевого использования</li><li>Гособоронзаказ и национальные проекты</li><li>Цепочка кооперации с соисполнителями</li><li>Переписка и споры с УФК</li><li>Разморозка аванса и снятие блокировок</li><li>Контроль всех этапов платежей до зачисления</li></ul>
    <div class="crossfunc"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 1l4 4-4 4"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><path d="M7 23l-4-4 4-4"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg><p>Группа ведения — Наталья, Юлия и Елена — подстраховывает друг друга. При отпуске или болезни вашего эксперта контракт без паузы подхватит коллега из той же группы: все ведут единый стандарт работы с УФК и видят полную историю.</p></div>
  </div>
</section>

<section class="v2-section v2-screen" id="uslugi">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Услуги</div><h2 class="v2-section-title">С чем <em>помогает</em></h2><p class="v2-section-lede">Направления, которые ведёт Наталья. Условия и цены — на страницах услуг.</p></div>
    <div class="author-services"><a class="author-service" href="/uslugi/soprovozhdenie-avans/"><span class="author-service__stage">Ведение</span><h3 class="author-service__title">Сопровождение с авансом</h3><p class="author-service__desc">Контроль целевого использования, санкционирование, цепочка кооперации — безлимит операций.</p><span class="author-service__link">Подробнее об услуге <span aria-hidden="true">→</span></span></a><a class="author-service" href="/uslugi/soprovozhdenie-postoplata/"><span class="author-service__stage">Ведение</span><h3 class="author-service__title">Сопровождение постоплаты</h3><p class="author-service__desc">Проведение платежей по актам и УПД без возвратов — до зачисления средств.</p><span class="author-service__link">Подробнее об услуге <span aria-hidden="true">→</span></span></a></div>
  </div>
</section>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    ...
    <div style="max-width:520px;margin:0 auto"><form class="railform" id="leadFormBottom" novalidate data-endpoint="/php/lead.php" data-source="expert-natalya-cta">
          <input class="fld" name="name" placeholder="Имя" required minlength="2" maxlength="80" autocomplete="name">
          <input class="fld" name="phone" type="tel" placeholder="+7 (___) ___-__-__" required autocomplete="tel" inputmode="tel">
          <input class="hp" name="company_extra" tabindex="-1" autocomplete="off" aria-hidden="true">
          <label class="policy"><input type="checkbox" name="consent" required><span>Согласен с <a href="/privacy/" target="_blank" rel="noopener">политикой обработки данных</a>. Не передаём третьим лицам.</span></label>

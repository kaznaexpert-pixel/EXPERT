...
<meta name="description" content="Наталья — эксперт КазнаЭксперт по ведению контрактов с авансом, ГОЗ и нацпроектов: санкционирование, переписка с УФК. 12 лет в Казначействе, в команде с 2018.">
...
<section class="v2-section v2-screen" id="chem">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Чем занимается</div><h2 class="v2-section-title">Зона <em>ответственности</em></h2><p class="v2-section-lede">Специализируется на контрактах с авансом, ГОЗ и национальных проектах. Ведёт переписку с УФК и контролирует все этапы платежей — от санкционирования до зачисления. К ней приходят самые требовательные к срокам контракты.</p></div>
    <ul class="expert-focus"><li>Контракты с авансом</li><li>Гособоронзаказ и нацпроекты</li><li>Переписка с УФК</li><li>Контроль всех этапов платежей</li></ul>
  </div>
</section>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    ...
    <div style="max-width:520px;margin:0 auto">
      <form class="railform" id="leadFormBottom" novalidate data-endpoint="/php/lead.php" data-source="expert-natalya-cta">
        <input class="fld" name="name" placeholder="Имя" required minlength="2" maxlength="80" autocomplete="name">
        <input class="fld" name="phone" type="tel" placeholder="+7 (___) ___-__-__" required autocomplete="tel" inputmode="tel">
        <input class="hp" name="company_extra" tabindex="-1" autocomplete="off" aria-hidden="true">
        <label class="policy"><input type="checkbox" name="consent" required><span>Согласен с <a href="/privacy/" target="_blank" rel="noopener">политикой обработки данных</a>. Не передаём третьим лицам.</span></label>

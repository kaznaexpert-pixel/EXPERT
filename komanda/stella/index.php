...
<title>Стелла — эксперт по резервированию казначейских счетов | КазнаЭксперт</title>
<meta name="description" content="Стелла — эксперт КазнаЭксперт по резервированию казначейских счетов к дате тендера, проверке документов до подачи. Опыт в казначействе, в команде с 2020 года.">
<meta name="author" content="Ярослав Михайлов">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
<meta name="theme-color" content="#F4F1EB" media="(prefers-color-scheme: light)">
<meta name="theme-color" content="#141310" media="(prefers-color-scheme: dark)">
<!-- PROD: canonical и og:url ОБЯЗАТЕЛЬНО менять под URL каждой статьи -->
<link rel="canonical" href="https://kaznaexpert.ru/komanda/stella/">
...
{"@context": "https://schema.org", "@type": "ProfilePage", "mainEntity": {"@type": "Person", "name": "Стелла", "jobTitle": "Эксперт по резервированию счетов", "description": "Стелла — эксперт КазнаЭксперт по резервированию казначейских счетов к дате тендера, проверке документов до подачи. Опыт в казначействе, в команде с 2020 года.", "url": "https://kaznaexpert.ru/komanda/stella/", "image": "https://kaznaexpert.ru/img/team/stella-480.jpg", "worksFor": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "telephone": "+7-981-833-10-10"}, "knowsAbout": ["Резервирование счёта к дате тендера", "Подтверждение готовности для заказчика", "Проверка документов до подачи", "Сопровождение до получения реквизитов", "Зачёт стоимости резерва в открытие", "Бэкап по открытию счёта"], "colleague": {"@type": "Person", "name": "Ярослав Михайлов", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/"}}}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Главная", "item": "https://kaznaexpert.ru/"}, {"@type": "ListItem", "position": 2, "name": "Команда", "item": "https://kaznaexpert.ru/komanda/"}, {"@type": "ListItem", "position": 3, "name": "Стелла"}]}
</script>
...
<meta property="og:title" content="Стелла — Эксперт по резервированию счетов">
<meta property="og:description" content="Стелла — эксперт КазнаЭксперт по резервированию казначейских счетов к дате тендера, проверке документов до подачи. Опыт в казначействе, в команде с 2020 года.">
<meta property="og:url" content="https://kaznaexpert.ru/komanda/stella/">
<meta property="og:image" content="https://kaznaexpert.ru/img/team/stella-480.jpg">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:image:alt" content="Стелла — Эксперт по резервированию счетов">
...
<meta name="twitter:title" content="Стелла — Эксперт по резервированию счетов">
<meta name="twitter:description" content="Стелла — эксперт КазнаЭксперт по резервированию казначейских счетов к дате тендера, проверке документов до подачи. Опыт в казначействе, в команде с 2020 года.">
<meta name="twitter:image" content="https://kaznaexpert.ru/img/team/stella-480.jpg">
  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      <div class="v2-hero-main">
        <nav class="team-crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/komanda/">Команда</a> › <span>Стелла</span></nav>
        ...
        <div class="author-hero">
          <div class="author-hero__photo"><picture><source type="image/webp" srcset="/img/team/stella-480.webp?b=2"><img src="/img/team/stella-480.jpg?b=2" width="480" height="600" decoding="async" alt="Стелла — Эксперт по резервированию счетов, КазнаЭксперт"></picture></div>
          <div>
            <h1>Стелла</h1>
            <div class="author-hero__sub">Эксперт по резервированию счетов</div>
            <p class="v2-hero-lede" style="margin-top:14px">Отвечает за этап тендера: резервирование счёта, проверку документов до подачи и сопровождение до получения реквизитов.</p>
            <div class="author-hero__meta"><span>В команде КазнаЭксперт с 2020 года</span></div>
          </div>
        </div>
        <div class="v2-hero-trust" style="margin-top:28px"><div class="v2-trust-item"><div class="v2-trust-num">5<span class="v2-trust-suffix">&nbsp;лет</span></div><div class="v2-trust-label">в Казначействе</div></div><div class="v2-trust-item"><div class="v2-trust-num">с 2020<span class="v2-trust-suffix"></span></div><div class="v2-trust-label">в команде</div></div></div>
      </div>
      <aside class="v2-hero-action">
        ...
        <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="expert-stella">
...
<section class="v2-section v2-screen" id="bio">
  <div class="v2-container">
    ...
    <div class="bio-prose"><p>Опыт работы в органах казначейства и знакомство с командой ещё до прихода в КазнаЭксперт. Хорошо знает требования к документам на этапе тендера — там, где важна точность ещё до подачи.</p><p>В команде с 2020 года. Резервирует счёт к дате тендера, проверяет пакет документов до подачи и ведёт клиента до получения реквизитов. Полностью взаимозаменяема с Антоном: при его загрузке или отпуске без паузы ведёт и открытие счёта.</p></div>
  </div>
</section>

<section class="v2-section v2-screen" id="zona">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Чем занимается</div><h2 class="v2-section-title">Зона <em>ответственности</em></h2><p class="v2-section-lede">Отвечает за этап тендера: резервирование счёта, проверку документов до подачи и сопровождение до получения реквизитов.</p></div>
    <ul class="expert-focus"><li>Резервирование счёта к дате тендера</li><li>Подтверждение готовности для заказчика</li><li>Проверка документов до подачи</li><li>Сопровождение до получения реквизитов</li><li>Зачёт стоимости резерва в открытие</li><li>Бэкап по открытию счёта</li></ul>
    <div class="crossfunc"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 1l4 4-4 4"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><path d="M7 23l-4-4 4-4"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg><p>Стелла и Антон — взаимозаменяемая пара по открытию и резерву. При отпуске или болезни одного второй подхватывает работу без потери контекста: единый стандарт и общая история по каждому контракту.</p></div>
  </div>
</section>

<section class="v2-section v2-screen" id="uslugi">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Услуги</div><h2 class="v2-section-title">С чем <em>помогает</em></h2><p class="v2-section-lede">Направления, которые ведёт Стелла. Условия и цены — на страницах услуг.</p></div>
    <div class="author-services"><a class="author-service" href="/uslugi/rezervirovanie-scheta/"><span class="author-service__stage">До тендера</span><h3 class="author-service__title">Резервирование счёта</h3><p class="author-service__desc">Резерв счёта к дате тендера: подтверждение для заказчика, зачёт в открытие.</p><span class="author-service__link">Подробнее об услуге <span aria-hidden="true">→</span></span></a><a class="author-service" href="/uslugi/otkrytie-scheta/"><span class="author-service__stage">Старт</span><h3 class="author-service__title">Открытие казначейского счёта</h3><p class="author-service__desc">Полный пакет документов и открытие счёта в УФК с первой подачи за два рабочих дня.</p><span class="author-service__link">Подробнее об услуге <span aria-hidden="true">→</span></span></a></div>
  </div>
</section>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    ...
    <div style="max-width:520px;margin:0 auto"><form class="railform" id="leadFormBottom" novalidate data-endpoint="/php/lead.php" data-source="expert-stella-cta">
          <input class="fld" name="name" placeholder="Имя" required minlength="2" maxlength="80" autocomplete="name">
          <input class="fld" name="phone" type="tel" placeholder="+7 (___) ___-__-__" required autocomplete="tel" inputmode="tel">
          <input class="hp" name="company_extra" tabindex="-1" autocomplete="off" aria-hidden="true">
          <label class="policy"><input type="checkbox" name="consent" required><span>Согласен с <a href="/privacy/" target="_blank" rel="noopener">политикой обработки данных</a>. Не передаём третьим лицам.</span></label>

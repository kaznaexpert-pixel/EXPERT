...
<div class="v2">
<style>
.v2 .v2-hero{min-height:0 !important;padding:44px 0 6px !important}.v2 .v2-section.v2-screen{min-height:0 !important;padding-top:64px !important;padding-bottom:56px !important;display:block !important}.v2 .v2-section{min-height:0 !important;padding-top:28px !important}.v2 .team-hero{max-width:none}.v2 .team-hero .v2-hero-lede{max-width:none}
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Заявка</div><h2 class="v2-section-title">Закрепим за вами <em>эксперта</em></h2><p class="v2-section-lede">Оставьте контакты — перезвоним за 15 минут, разберём контракт и закрепим профильного специалиста.</p></div>
    <div style="max-width:520px;margin:0 auto">
      <form class="railform" id="leadFormBottom" novalidate data-endpoint="/php/lead.php" data-source="komanda-cta">
...
<section class="kb-faq" aria-labelledby="faqH"><style>.kb-faq{max-width:1240px;margin:48px auto;padding:0 24px;font-family:'Inter',system-ui,sans-serif}.kb-faq>h2{font-family:'Playfair Display',Georgia,serif;font-weight:500;font-size:clamp(1.5rem,2vw+1rem,2rem);letter-spacing:-.01em;margin:0 0 18px;color:var(--ink,#1A1A1A)}</style>
  ...
  <div class="faq">
      <details><summary>Кто входит в команду КазнаЭксперт?</summary><p>Небольшая команда, которая занимается только казначейским сопровождением государственных контрактов. Основатель и главный эксперт — <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>.</p></details>
      <details><summary>Какой опыт у специалистов?</summary><p>Более 15 лет в сфере казначейского сопровождения; команда сопроводила свыше 7000 контрактов на 90 млрд рублей по 44-ФЗ, 223-ФЗ и гособоронзаказу.</p></details>
      <details><summary>С какого года вы работаете?</summary><p>Компания работает с 2009 года и сопровождает клиентов по всей России.</p></details>
      <details><summary>По каким вопросам можно к вам обратиться?</summary><p>Казначейское сопровождение по 44-ФЗ, 223-ФЗ и гособоронзаказу, раздельный учёт, открытие лицевых счетов, санкционирование платежей и спасение контрактов.</p></details>
      <details><summary>Соблюдаете ли вы конфиденциальность?</summary><p>Да. Соглашение о неразглашении (NDA) предоставляем по запросу — до анализа документов.</p></details>
  </div>
</section>
<script type="application/ld+json">

            ...
            while($row = mysqli_fetch_assoc($query)){
                ...
                if($row['outgoing_msg_id'] === $outgoing_id){ //msg sender
                    $output .= '<div class="chat outgoing">
                                ...
                                $output .= '<a href="cms/uploads/'. $row['file'] .'" download><img src="cms/uploads/'. $row['file'] .'" alt=""></a>';
                                }elseif(in_array($row['extension'], $doc_ext) === true){
                                $output .= '<p><a href="cms/uploads/'. $row['file'] .'" download class="doclink">'. $row['file'] .'</a></p>';
                                }else{
                                    $output .= '<p>'. $row['msg'] .'</p>';
                                }
                                $output .='</div>

...
{"@type": "HowToStep", "position": 2, "name": "Сверить со случаями КС", "text": "Проверить контракт по ст. 5 закона о федеральном бюджете на 2026 год и главе 24.4 БК РФ."},
  ...
  <article class="content" id="main">
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        <div class="kf"><div class="kf__n">гл. 24.4</div><div class="kf__t"><b>КС</b> — БК РФ + правила ПП № 2024</div></div>
        <div class="kf"><div class="kf__n">ст. 35</div><div class="kf__t"><b>Банковское</b> — 44-ФЗ + ПП № 963</div></div>
        <div class="kf"><div class="kf__n">ТОФК</div><div class="kf__t"><b>Кто контролирует при КС</b> — орган казначейства</div></div>
    ...
    <table>
      ...
      <tr><td>Раздельный учёт</td><td>Обязателен у участников КС</td><td>По условиям контракта и НПА</td></tr>
    ...
    <p>Механика режима подробно разобрана в нашем <a href="/baza-znaniy/chto-takoe-kaznacheyskoe-soprovozhdenie/">базовом разборе КС</a>: открытие лицевого счёта, режим целевых средств, санкционирование каждого платежа, отчётность.</p>
    ...
    <h3>Шаг 2. Сверьте параметры сделки со случаями КС</h3>
    <p>Проверьте контракт по ст. 5 закона о федеральном бюджете на 2026 год и главе 24.4 БК РФ: сумма, источник средств, способ закупки. Если сделка попадает под перечень — условие о КС обязано быть в контракте.</p>
    ...
    <div class="takeaways">
      ...
      <ol>
        <li>КС — предварительный контроль казначейства с санкционированием на лицевых счетах; БС — мониторинг расчётов банком на отдельном счёте.</li>
    ...
    <dl class="gloss">
      ...
      <div><dt>Лицевой счёт участника КС</dt><dd>Счёт с кодом 71 в ТОФК для операций с целевыми средствами.</dd></div>

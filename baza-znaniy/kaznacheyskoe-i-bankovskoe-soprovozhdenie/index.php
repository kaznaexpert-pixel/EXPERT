...
<meta name="description" content="Казначейское и банковское сопровождение контрактов: кто контролирует, какие счета, стоимость, случаи применения и сочетание режимов. Разбор эксперта.">
...
{"@type": "HowToStep", "position": 5, "name": "Выстроить документооборот", "text": "Под каждый контур подготовить свой комплект документов; при сочетании режимов вести их параллельно."}
]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "DefinedTermSet", "name": "Глоссарий: режимы сопровождения контрактов", "inLanguage": "ru-RU", "hasDefinedTerm": [
{"@type": "DefinedTerm", "name": "Казначейское сопровождение", "description": "Контроль целевых средств органами ФК: лицевые счета, санкционирование операций, отчётность (гл. 24.4 БК РФ)."},
{"@type": "DefinedTerm", "name": "Банковское сопровождение", "description": "Мониторинг расчётов по контракту банком на основании договора с отчётами заказчику (ст. 35 44-ФЗ)."},
{"@type": "DefinedTerm", "name": "Отдельный счёт", "description": "Счёт в уполномоченном банке для расчётов по сопровождаемому контракту."},
{"@type": "DefinedTerm", "name": "Расширенное банковское сопровождение", "description": "Банковское сопровождение с дополнительным контролем исполнения контракта и комиссией в установленных пределах."}
]}
</script>
<script type="application/ld+json">
...
<meta property="og:description" content="Сравнение режимов по 10 параметрам: контролёр, счета, стоимость, скорость платежей, случаи применения и сочетание. Разбор эксперта.">
...
<meta name="twitter:description" content="Сравнение режимов по 10 параметрам: контролёр, счета, стоимость, скорость платежей, случаи применения и сочетание. Разбор эксперта.">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#vmeste">Когда режимы сочетаются</a></li>
  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        <li><a href="#sut">Суть двух режимов</a></li><li><a href="#pravovaya">Правовая база</a></li><li><a href="#sravnenie">Сравнение по 10 параметрам</a></li><li><a href="#kogda-ks">Когда применяется казначейское</a></li><li><a href="#kogda-bank">Когда применяется банковское</a></li><li><a href="#vmeste">Когда режимы сочетаются</a></li><li><a href="#goz">Особый случай: ГОЗ</a></li><li><a href="#dlya-podryadchika">Что это значит для подрядчика</a></li><li><a href="#algoritm">Как определить режим: алгоритм</a></li><li><a href="#oshibki">Частые заблуждения</a></li><li><a href="#keys">Пример из практики</a></li><li><a href="#glossary">Глоссарий</a></li><li><a href="#faq">Частые вопросы</a></li>
      </ol>
    </details>
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">вместе</div><div class="kf__t"><b>Сочетание</b> режимов возможно в установленных случаях</div></div>
      </div>
    </section>
    ...
    <p>Показательно, что даже терминология не пересекается: в казначейском контуре работают понятия «лицевой счёт», «санкционирование», «целевые средства», в банковском — «отдельный счёт», «мониторинг расчётов», «отчёт банка». Если в вашем контракте встречаются термины из обоих наборов — вы попали в зону сочетания режимов, о ней ниже.</p>
    ...
    <table>
      ...
      <tr><td>Скорость платежа</td><td>До нескольких рабочих дней на санкционирование</td><td>Как правило, банковские сроки проведения операций</td></tr>
    ...
    <h2 id="vmeste">Когда режимы сочетаются</h2>
    <p>Казначейское и банковское сопровождение — не взаимоисключающие режимы. Законодательство прямо предусматривает их стык: Правительство утверждает правила банковского сопровождения при казначейском сопровождении средств, а механизм казначейского обеспечения обязательств работает в обоих контурах — при банковском сопровождении выданное КОО казначейство направляет в сопровождающий банк (ст. 242.22 БК РФ, ПП № 481). Как устроен этот механизм, мы разобрали в статье про <a href="/baza-znaniy/kaznacheyskoe-obespechenie-obyazatelstv/">казначейское обеспечение обязательств</a>.<a class="fn" href="#ref-4" aria-label="Источник 4">[4]</a></p>
    <p>На практике сочетание выглядит так: крупный контракт сопровождает банк (мониторинг расчётов по всей цепочке), а целевые средства при этом идут через лицевые счета в казначействе с санкционированием. Документооборот удваивается — и именно на таких контрактах чаще всего возникают задержки оплат из-за рассинхрона требований банка и ТОФК.</p>
    ...
    <p>Если контракт под банковским сопровождением — расчёты идут через отдельный счёт в банке, контроль мягче (мониторинг), но за расширенное сопровождение платится комиссия, а отчёт банка перед заказчиком становится фактором приёмки. При сочетании режимов закладывайте в график исполнения двойной документооборот.</p>
    ...
    <p>Лицевой счёт в ТОФК — при казначейском контуре, отдельный счёт в сопровождающем банке — при банковском. При сочетании режимов потребуются оба.</p>
    ...
    <table>
      ...
      <tr><td>«При банковском сопровождении казначейство не участвует»</td><td>Режимы сочетаются: банковское сопровождение может идти при казначейском сопровождении средств, а КОО передаётся в банк</td></tr>
    ...
    <div class="takeaways">
      ...
      <ol>
        ...
        <li>Режимы могут сочетаться — тогда документооборот ведётся параллельно под требования банка и ТОФК.</li>
    ...
    <div class="faq">
      ...
      <details><summary>Может ли контракт быть одновременно под обоими режимами?</summary><p>Да, законодательство предусматривает банковское сопровождение при казначейском сопровождении средств. В этом случае документооборот ведётся параллельно под требования банка и ТОФК.</p></details>
      ...
      <details><summary>Влияют ли режимы на сроки оплаты?</summary><p>Да. Санкционирование в казначействе занимает до нескольких рабочих дней и требует документов-оснований; банковский мониторинг обычно работает в банковские сроки, но расширенное сопровождение добавляет проверки.</p></details>

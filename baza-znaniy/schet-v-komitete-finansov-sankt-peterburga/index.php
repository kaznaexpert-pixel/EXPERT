...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__schet-v-komitete-finansov-sankt-peterburga-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__schet-v-komitete-finansov-sankt-peterburga-16x9.jpg">
...
<p class="lead-p">Порядок открытия и ведения лицевых счетов участников казначейского сопровождения и санкционирования операций утверждён распоряжением Комитета финансов от 10 февраля 2022 года № 10-р, а само право города сопровождать средства своего бюджета основано на статье 242.23 Бюджетного кодекса. Поэтому исполнителю важно правильно определить источник средств: от этого зависит, где открывать счёт, по каким формам подавать документы и кто будет санкционировать платежи.</p>
    ...
    <div class="answer reveal">
      <p class="lead-p">Лицевой счёт в Комитете финансов Санкт-Петербурга открывают исполнителям, чьи контракты, субсидии или инвестиции финансируются из бюджета города и подпадают под казначейское сопровождение. Порядок утверждён распоряжением Комитета финансов от 10 февраля 2022 года № 10-р на основании статьи 242.23 Бюджетного кодекса; средства федерального бюджета сопровождает УФК по г. Санкт-Петербургу (счёт с кодом 71).</p>
    </div>
    ...
    <h3 id="kakie-sredstva">Какие средства города попадают под сопровождение</h3>
    ...
    <h3 id="rekvizity-platezha">Реквизиты, связывающие платёж с контрактом</h3>
    ...
    <h3 id="podtverzhdenie-rashodov">Подтверждение расходов документами-основаниями</h3>
...
<div class="refs">
      ...
      <p class="refs__note">Нормы приведены по состоянию на 31 августа 2026 года. Редакция распоряжения № 10-р, формы документов и порядок подачи периодически обновляются — перед открытием счёта сверяйтесь с актуальной версией порядка Комитета финансов Санкт-Петербурга и его методическими материалами. Материал носит справочный характер и не заменяет консультацию.</p>
    </div>

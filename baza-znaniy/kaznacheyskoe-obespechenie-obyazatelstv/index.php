...
<title>Казначейское обеспечение обязательств (КОО) в 2026 | КазнаЭксперт</title>
...
{"@type": "Question", "name": "Что такое казначейское обеспечение обязательств простыми словами?", "acceptedAnswer": {"@type": "Answer", "text": "Это документ Федерального казначейства, подтверждающий, что оно оплатит обязательства по контракту в пределах указанной суммы. Деньги не перечисляются авансом, а резервируются в бюджетной системе до момента фактической оплаты."}},
{"@type": "Question", "name": "КОО — это ценная бумага?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Статья 242.22 БК РФ прямо указывает, что казначейское обеспечение обязательств — документ, не являющийся ценной бумагой."}},
{"@type": "Question", "name": "Чем КОО отличается от казначейского аккредитива?", "acceptedAnswer": {"@type": "Answer", "text": "«Казначейский аккредитив» — обиходное название того же механизма. В законодательстве используется один термин: казначейское обеспечение обязательств."}},
{"@type": "Question", "name": "Чем КОО отличается от аванса?", "acceptedAnswer": {"@type": "Answer", "text": "При авансе исполнитель получает деньги до исполнения. При КОО денег нет — есть гарантия оплаты, средства остаются на едином казначейском счёте до оплаты подтверждённых обязательств."}},
{"@type": "Question", "name": "Когда применяется КОО?", "acceptedAnswer": {"@type": "Answer", "text": "В случаях, определённых федеральным законом о федеральном бюджете (на 2026 год — ст. 5 закона № 426-ФЗ) и решениями Правительства, при обязательном условии о КОО в контракте."}},
{"@type": "Question", "name": "Применяется ли КОО по гособоронзаказу?", "acceptedAnswer": {"@type": "Answer", "text": "Для государственных контрактов по ГОЗ из подпункта 5 статьи 242.27 БК РФ механизм КОО не применяется — для них действует режим казначейского сопровождения ГОЗ по 275-ФЗ."}},
{"@type": "Question", "name": "Как соисполнителю получить оплату по КОО?", "acceptedAnswer": {"@type": "Answer", "text": "Принять перевод части обеспечения, исполнить обязательства и подать документы-основания на санкционирование — оплата пройдёт за счёт средств, зарезервированных под обеспечение."}},
{"@type": "Question", "name": "Можно ли отозвать КОО досрочно?", "acceptedAnswer": {"@type": "Answer", "text": "Да, по письменному заявлению получателя бюджетных средств в орган казначейства. По истечении срока действия КОО отзывается автоматически."}},
{"@type": "Question", "name": "Кто проводит операции с КОО при банковском сопровождении?", "acceptedAnswer": {"@type": "Answer", "text": "Сопровождающий банк по правилам постановления Правительства № 481: казначейство направляет ему выданное обеспечение, банк ведёт перевод и операции при исполнении."}},
{"@type": "Question", "name": "Что изменится в КОО с 2028 года?", "acceptedAnswer": {"@type": "Answer", "text": "С 01.01.2028 вступают в силу поправки в пункты 1 и 6 ст. 242.22 БК РФ (ФЗ от 28.11.2025 № 432-ФЗ) — уточняются случаи применения и полномочия по установлению порядка."}}
]}
</script>
<script type="application/ld+json">

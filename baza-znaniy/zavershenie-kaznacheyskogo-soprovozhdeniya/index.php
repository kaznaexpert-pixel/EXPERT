...
<title>Завершение КС: возврат остатков и закрытие счёта | КазнаЭксперт</title>
...
{"@type": "Question", "name": "Что значит завершить казначейское сопровождение?", "acceptedAnswer": {"@type": "Answer", "text": "Вернуть неиспользованный остаток целевых средств источнику и закрыть лицевой счёт 71 после исполнения контракта. Пока эти шаги не сделаны, контракт в казначейском контуре считается незакрытым."}},
{"@type": "Question", "name": "Куда возвращается неиспользованный остаток?", "acceptedAnswer": {"@type": "Answer", "text": "Источнику предоставления — заказчику или в доход соответствующего бюджета. Реквизиты и порядок указаны в контракте; их согласуют с заказчиком и сверяют с правилами текущего года."}},
{"@type": "Question", "name": "Заберёт ли казначейство прибыль по контракту?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Возврату подлежит только неизрасходованный целевой остаток. Прибыль и экономия исполнителя выводятся на расчётный счёт после подтверждения факта поставки или выполнения работ."}},
{"@type": "Question", "name": "Как определить сумму остатка к возврату?", "acceptedAnswer": {"@type": "Answer", "text": "По исходящему остатку последней выписки из лицевого счёта после всех расчётов."}},
{"@type": "Question", "name": "Как закрыть лицевой счёт 71?", "acceptedAnswer": {"@type": "Answer", "text": "Подать заявление на закрытие в «Электронном бюджете» при нулевом остатке и отсутствии неисполненных распоряжений. ТОФК проверяет условия и закрывает счёт по приказу № 21н."}},
{"@type": "Question", "name": "Почему ТОФК отказывает в закрытии счёта?", "acceptedAnswer": {"@type": "Answer", "text": "Чаще всего из-за ненулевого остатка или зависшего распоряжения. Сначала завершите расчёты, верните остаток и дождитесь нулевого баланса, затем подавайте заявление."}},
{"@type": "Question", "name": "Есть ли дедлайн по остаткам в конце года?", "acceptedAnswer": {"@type": "Answer", "text": "Да. Для целевых средств действуют годовые правила: неиспользованные остатки отдельных видов средств возвращаются в установленные сроки декабря. Точные даты задаются правилами года и доводятся ТОФК."}},
{"@type": "Question", "name": "Нужно ли заново включаться в сводный реестр под новый контракт?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Реестровая запись сохраняется после закрытия счёта и лишь актуализируется при изменениях. Под новый контракт открывается новый лицевой счёт."}},
{"@type": "Question", "name": "Действует ли электронная подпись после закрытия счёта?", "acceptedAnswer": {"@type": "Answer", "text": "Да, до окончания срока сертификата. Перевыпускать подпись под каждый контракт не нужно; при необходимости её продлевают или отзывают по отдельной процедуре."}},
{"@type": "Question", "name": "Что делать с документами после закрытия?", "acceptedAnswer": {"@type": "Answer", "text": "Сохранить выписки за весь срок, заявление на закрытие и подтверждение возврата остатка в сроки хранения первичных документов."}}
]}
</script>
<script type="application/ld+json">

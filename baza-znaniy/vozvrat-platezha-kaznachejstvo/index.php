...
{"@context": "https://schema.org", "@type": "Article", "headline": "Возврат платежа через казначейство: ошибочный платёж, невыясненные поступления и возврат с лицевого счёта", "description": "Как вернуть платёж через казначейство: возврат ошибочных и невыясненных поступлений по заявлению (137н, 172н) при казначейском сопровождении.", "inLanguage": "ru-RU", "datePublished": "2026-06-29", "dateModified": "2026-08-27", "author": {"@type": "Person", "name": "Анна Богданова", "jobTitle": "Ведущий эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/bogdanova-anna/", "@id": "https://kaznaexpert.ru/komanda/bogdanova-anna/#person", "image": "https://kaznaexpert.ru/img/team/bogdanova-photo.jpg"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}, "@id": "https://kaznaexpert.ru/#organization"}, "image": ["https://kaznaexpert.ru/img/og/baza-znaniy__vozvrat-platezha-kaznachejstvo-16x9.jpg", "https://kaznaexpert.ru/img/og/baza-znaniy__vozvrat-platezha-kaznachejstvo-4x3.webp", "https://kaznaexpert.ru/img/og/baza-znaniy__vozvrat-platezha-kaznachejstvo-1x1.webp"], "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/vozvrat-platezha-kaznachejstvo/"}, "citation": ["Приказ Минфина России от 27.09.2021 № 137н (Общие требования к возврату излишне уплаченных (взысканных) платежей).", "Порядок учёта Федеральным казначейством поступлений в бюджетную систему Российской Федерации и их распределения между бюджетами (приказ Минфина России от 15.11.2024 № 172н (ред. от 06.08.2025)).", "Бюджетный кодекс РФ, статья 242.23 (казначейское сопровождение; возврат средств с лицевого счёта). КонсультантПлюс — https://www.consultant.ru/document/cons_doc_LAW_19702/", "Постановление Правительства РФ от 24.11.2021 № 2024 (Правила казначейского сопровождения). КонсультантПлюс — https://www.consultant.ru/document/cons_doc_LAW_401366/", "Информация территориальных органов Федерального казначейства о порядке возврата излишне или ошибочно уплаченных средств (рекомендуемые образцы заявлений)."]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Главная", "item": "https://kaznaexpert.ru/", "url": "https://kaznaexpert.ru/"}, {"@type": "ListItem", "position": 2, "name": "База знаний", "item": "https://kaznaexpert.ru/baza-znaniy/", "url": "https://kaznaexpert.ru/baza-znaniy/"}, {"@type": "ListItem", "position": 3, "name": "Возврат платежа через казначейство", "item": "https://kaznaexpert.ru/baza-znaniy/vozvrat-platezha-kaznachejstvo/", "url": "https://kaznaexpert.ru/baza-znaniy/vozvrat-platezha-kaznachejstvo/"}]}
</script>
<script type="application/ld+json">
...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__vozvrat-platezha-kaznachejstvo-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__vozvrat-platezha-kaznachejstvo-16x9.jpg">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <p class="lead-p">Возврат платежа через казначейство идёт двумя разными путями. Ошибочно или излишне перечисленные в бюджет деньги орган казначейства возвращает по заявлению плательщика. Средства, которые уже лежат на лицевом счёте под сопровождением, возвращают не заявлением, а распоряжением о совершении казначейского платежа.</p>
    </div>
    ...
    <p class="note">Возврат будет повторяться, пока не устранена его причина; мы находим её по формулировке казначейства и доводим платёж до списания — <a href="/uslugi/spasenie-kontrakta/">спасение контракта &rarr;</a></p>
    <h3 id="dve-mehaniki">Две разные механики: бюджет и лицевой счёт</h3>
    ...
    <h3 id="kto-iniciiruet">Кто инициирует возврат и каким документом</h3>
    ...
    <h3 id="srok-137n">Срок возврата: 30 календарных дней по приказу № 137н</h3>
    ...
    <h3 id="vnutrennie-sroki">Внутренние сроки: 10 рабочих дней на проверку, 5 — на поручение</h3>
    <p>Тридцать календарных дней — внешняя граница. Внутри неё Общие требования задают собственные сроки, и по ним видно, на каком этапе застрял возврат.</p>
    <table>
      <thead><tr><th>Этап</th><th>Срок</th><th>Норма</th></tr></thead>
      <tbody>
        <tr><td>Проверка заявления и документов, решение о возврате либо об отказе</td><td>10 рабочих дней со дня регистрации заявления</td><td>пункт 9</td></tr>
        <tr><td>Поручение в орган Федерального казначейства на возврат денег</td><td>5 рабочих дней со дня решения</td><td>подпункт 1 пункта 11</td></tr>
        <tr><td>Уведомление об отказе в возврате</td><td>5 рабочих дней со дня решения</td><td>пункт 12</td></tr>
        <tr><td>Возврат платежа целиком</td><td>30 календарных дней, следующих за днём регистрации заявления</td><td>пункт 3</td></tr>
      </tbody>
    </table>
    <p>Если в заявлении не хватает сведений или документов, администратор в тот же десятидневный срок направляет уведомление о невозможности рассмотрения с мотивированным объяснением причин (пункт 10). Это не отказ: недочёты устраняются, заявление подаётся заново, и срок считается от новой регистрации.</p>

    <h3 id="tolko-po-zayavleniyu">Автоматически деньги не вернут — нужно заявление</h3>
    ...
    <h3 id="prichiny-oshibki">Почему платежи уходят не туда</h3>
    ...
    <h3 id="ot-chego-srok">От чего зависит фактический срок</h3>
    ...
    <h3 id="fiksaciya-podachi">Что зафиксировать при подаче заявления</h3>
    ...
    <h3 id="avans-i-ostatki">Неотработанный аванс и остатки целевых средств</h3>
    ...
    <h3 id="prosyat-vernut">Что делать, если просят вернуть платёж с лицевого счёта</h3>
    ...
    <h3 id="smeshannyy-sluchay">Смешанный случай: контрагент возвращает лишнее</h3>
    ...
    <p class="note">Если платежи возвращают не первый раз и срок контракта под угрозой, быстрее подключить разбор эксперта, чем переписываться с УФК вслепую: <a href="/uslugi/spasenie-kontrakta/">спасение контракта &rarr;</a></p>
    <ul>
    ...
    <h3 id="tipovaya-situaciya">Типовая ситуация: платёж завис как невыясненный</h3>
...
<div class="refs">
      ...
      <ol>
        <li id="ref-1">Приказ Минфина России от 27.09.2021 № 137н (ред. от 23.08.2024) «Об утверждении Общих требований к возврату излишне уплаченных (взысканных) платежей», Минюст 27.10.2021 № 65582 — пункты 3, 9, 11, 12.</li>
      ...
      <p class="refs__note">Нормы приведены по состоянию на 27 августа 2026 года. Конкретный порядок и форма заявления уточняются на сайте территориального управления казначейства; реквизиты приказов о порядке учёта поступлений могут обновляться. Материал носит справочный характер и не заменяет консультацию.</p>
    </div>

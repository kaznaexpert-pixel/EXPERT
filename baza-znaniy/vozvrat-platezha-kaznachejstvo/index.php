  ...
  <article class="content" id="main">
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">137н и 66н</div><div class="kf__t"><b>Нормы</b> — возврат регулируют приказ Минфина № 137н и Порядок учёта казначейством поступлений в бюджетную систему (приказ № 66н)</div></div>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-2">Порядок учёта Федеральным казначейством поступлений в бюджетную систему Российской Федерации и их распределения между бюджетами (приказ Минфина России № 66н от 29.12.2022).</li>
        <li id="ref-3">Бюджетный кодекс РФ, статья 242.23 (казначейское сопровождение; возврат средств с лицевого счёта).</li>
        <li id="ref-4">Постановление Правительства РФ от 24.11.2021 № 2024 (Правила казначейского сопровождения).</li>
      ...
      <p class="refs__note">Нормы приведены по состоянию на 29 июня 2026 года. Конкретный порядок и форма заявления уточняются на сайте территориального управления казначейства; реквизиты приказов о порядке учёта поступлений могут обновляться. Материал носит справочный характер и не заменяет консультацию.</p>
    </div>
  </article>

...
<meta name="description" content="Когда субподрядчику нужен казначейский счёт при КС: как целевые средства идут по цепочке, кто открывает лицевой счёт, временный режим 2025–2027 и как открыть счёт.">
  ...
  <article class="content" id="main">
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">Подпункт 3</div><div class="kf__t"><b>Цепочка</b> — контракты на средства госконтракта тоже под КС</div></div>
        <div class="kf"><div class="kf__n">Свой счёт</div><div class="kf__t"><b>Правило</b> — участник КС открывает лицевой счёт в казначействе</div></div>
        ...
        <div class="kf"><div class="kf__n">Пункт 4.1</div><div class="kf__t"><b>Условие</b> — условие о КС в договор включает исполнитель</div></div>
    ...
    <table>
      ...
      <tr><th>Подпункт</th><th>Что под КС</th><th>Кто получатель</th></tr>
    ...
    <p>Для субподрядчика это значит: условие о казначейском сопровождении в его договор вписывает не заказчик, а тот, кто его нанял. Поэтому первый сигнал «я под КС» — пункт о казначейском сопровождении и требование указывать идентификатор государственного контракта в самом договоре субподряда.</p>

    <h2 id="kogda-nuzhen">Когда субподрядчику нужен свой лицевой счёт</h2>
    <p>Общее правило задаёт подпункт 1 пункта 2 статьи 242.23: договоры под КС должны содержать условие об открытии участником лицевого счёта в Федеральном казначействе для операций с целевыми средствами.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a> То есть «по умолчанию» субподрядчик-участник КС открывает свой лицевой счёт.</p>
    ...
    <table>
      ...
      <tr><td>Общая норма (БК)</td><td>Участник КС открывает лицевой счёт в казначействе</td></tr>
    ...
    <table>
      <caption>Субподрядчик в КС по БК и соисполнитель в ГОЗ</caption>
      <tr><th>Параметр</th><th>КС по 44-ФЗ / БК</th><th>ГОЗ (275-ФЗ)</th></tr>
    ...
    <p>Если средства целевые, головной исполнитель обязан включить в договор субподряда те же условия КС, что и в госконтракте (пункт 4.1 статьи 242.23). Минимальный набор:<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></p>
    <ul class="check">
    ...
    <p>Получив статус участника КС, субподрядчик принимает на себя те же обязанности, что и головной исполнитель: вести раздельный учёт по контракту и проводить расходы через санкционирование.</p>
    ...
    <ol>
      ...
      <li><b>Прочитайте условия КС в договоре.</b> Найдите пункт о сопровождении, требование об ИГК, об открытии счёта и раздельном учёте.</li>
    ...
    <ul class="check">
      <li><b>Считать, что КС касается только головного исполнителя.</b> Подпункт 3 пункта 1 статьи 242.23 прямо распространяет режим на субподрядные договоры за счёт целевых средств.</li>
      ...
      <li><b>Путать режим ГОЗ и КС по БК.</b> В ГОЗ нужен отдельный счёт в уполномоченном банке, а не лицевой счёт в казначействе.</li>
    ...
    <dl class="gloss">
      ...
      <div><dt>Лицевой счёт (счёт 71)</dt><dd>Счёт в Федеральном казначействе для учёта операций участника КС с целевыми средствами.</dd></div>
    ...
    <div class="faq">
      ...
      <details><summary>Кто включает условие о КС в договор субподряда?</summary><p>Не заказчик, а тот, кто нанимает субподрядчика: исполнитель по госконтракту или вышестоящий исполнитель (пункт 4.1 статьи 242.23, введён ФЗ от 24.06.2025 № 158-ФЗ).</p></details>

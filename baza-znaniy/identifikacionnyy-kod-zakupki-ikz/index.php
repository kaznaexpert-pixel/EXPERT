...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p>Первые два блока (год и код заказчика) задают «кто и когда», средние блоки (номера в плане-графике) — «какая именно закупка», а последние (ОКПД2 и КВР) — «что закупается и за счёт чего». Такая логика делает код самодостаточным: по нему многое понятно даже без обращения к документам.</p>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 23 «Идентификационный код закупки, каталог товаров, работ, услуг» (ред. на 26.06.2026).</li>
        ...
        <li id="ref-3">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 103 «Реестр контрактов» (ИКЗ как реквизит реестровой записи).</li>
        <li id="ref-4">Общероссийский классификатор продукции по видам экономической деятельности (ОКПД2) — для разрядов 30–33 кода.</li>
        <li id="ref-5">Бюджетный кодекс РФ и приказ Минфина о порядке применения кодов видов расходов (КВР) — для разрядов 34–36 кода.</li>
      </ol>

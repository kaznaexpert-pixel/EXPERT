...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__identifikacionnyy-kod-zakupki-ikz-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__identifikacionnyy-kod-zakupki-ikz-16x9.jpg">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>13 мин чтения</span><span class="dot">·</span><span>Обновлено 19 сентября 2026</span></div>
    </div>
    ...
    <div class="answer reveal">
      <p class="lead-p">Идентификационный код закупки — это 36 цифр, которые заказчик присваивает закупке ещё в плане-графике и переносит в извещение, документацию, контракт и реестровую запись. Код сшивает документы в одну цепочку и позволяет найти закупку по одному реквизиту. Правила формирования — статья 23 Закона № 44-ФЗ и приказ Минфина № 55н.</p>
    </div>
    ...
    <h3 id="zachem-nuzhen-ikz">Зачем нужен код: связь плана, извещения и контракта</h3>
    ...
    <h3 id="ikz-dlya-postavshchika">Что идентификационный код значит для поставщика</h3>
    ...
    <h3 id="prikaz-55n">Приказ Минфина № 55н: состав и порядок формирования</h3>
    ...
    <h3 id="razryady-ikz">Что кодирует каждый разряд</h3>
    <table>
    ...
    <h3 id="logika-blokov">Логика блоков: кто, когда, что и за счёт чего</h3>
    ...
    <h3 id="okpd2-i-kvr">Последние разряды: ОКПД2 и код вида расходов</h3>
    ...
    <h3 id="chto-daet-rasshifrovka">Что даёт расшифровка на практике</h3>
    ...
    <h3 id="postavshchik-ne-formiruet">Что делает с кодом поставщик</h3>
    ...
    <h3 id="eis-i-otvetstvennost">ЕИС формирует код автоматически, отвечает заказчик</h3>
    ...
    <h3 id="ikz-v-dogovore">ИКЗ в договоре: что это и где он стоит</h3>
    <p>ИКЗ в договоре — это тот же 36-значный идентификационный код закупки, который заказчик сформировал в плане-графике и который часть 1 статьи 23 Закона № 44-ФЗ требует указывать в контракте. В тексте он обычно стоит в шапке рядом с номером и датой либо в реквизитах, а в ЕИС попадает в реестровую запись контракта. Поставщик код не формирует: его задача — сверить, что цифры в договоре совпадают с извещением, а не путать ИКЗ с идентификатором государственного контракта, о котором сказано в разделе <a href="#ikz-igk">«ИКЗ и ИГК»</a>.</p>
    <h3 id="rashozhdenie-kodov">Чем грозит расхождение кодов в документах</h3>
    ...
    <h3 id="chto-takoe-ktru">Что такое каталог товаров, работ, услуг</h3>
    ...
    <h3 id="sverka-ktru-i-koda">Зачем сверять позицию каталога с кодом объекта закупки</h3>
    ...
    <h3 id="pozicii-obyazatelny">Позиции каталога обязательны с момента размещения</h3>
    ...
    <h3 id="sravnenie-ikz-igk">ИКЗ и ИГК: сравнение по признакам</h3>
    <table>
    ...
    <h3 id="kak-ne-pereputat">Как не перепутать два кода</h3>
    ...
    <h3 id="dva-koda-v-soprovozhdenii">Два кода в сопровождаемом контракте</h3>
    ...
    <h3 id="chto-derzhat-pod-rukoy">Что держать под рукой при оплате</h3>
    ...
    <h3 id="roli-vedomstv">Роли Минфина и казначейства: какой код чей</h3>
    ...
    <h3 id="brat-kod-iz-kontrakta">Правило поставщика: код берут из контракта</h3>
    ...
    <h3 id="tipovaya-ikz-vmesto-igk">Типовая ситуация: код закупки вместо идентификатора контракта</h3>
...
<p data-ctx="auto-ctx:p75">Если в разрядах 34–36 стоят нули, заказчик не ошибся: пункт 6 Порядка формирования кода допускает это для закупок унитарных предприятий и когда расходы отражаются сразу по нескольким видам расходов. Разбор с примерами — в материале о том, <a href="/baza-znaniy/kvr-kosgu-celevye-sredstva/#ikz-nuli">что читается из разрядов 34–36 идентификационного кода закупки</a>.</p>
    ...
    <div class="faq">
      ...
      <details><summary>ИКЗ в договоре — что это?</summary><p>Тот же 36-значный код закупки из плана-графика и извещения, который по части 1 статьи 23 Закона № 44-ФЗ обязательно указывается в контракте — обычно в шапке или реквизитах. Поставщик его не формирует, а сверяет с извещением; это не ИГК, который нужен для казначейского сопровождения.</p></details>
    </div>
...
<div class="refs">
      ...
      <p class="refs__note">Нормы и классификаторы приведены в редакции, действующей на 19 сентября 2026 года. Материал носит справочный характер.</p>
    </div>

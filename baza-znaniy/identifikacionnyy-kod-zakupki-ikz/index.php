...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p>Идентификационный код закупки (ИКЗ) — это уникальный цифровой код, который присваивается каждой закупке по 44-ФЗ и проходит с ней через все стадии: от плана-графика до контракта и его исполнения. По сути это «паспортный номер» закупки, по которому её можно однозначно найти и проследить.</p>

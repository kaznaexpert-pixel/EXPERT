...
<title>Код 0820/8820/9820 — Иные выплаты</title>
<meta name="description" content="Код направления расходования 0820 «Иные выплаты» в казначейском сопровождении: подкоды, варианты 6/8/9, ошибки санкционирования, документы.">
<meta name="author" content="Ярослав Михайлов">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
<meta name="theme-color" content="#F4F1EB" media="(prefers-color-scheme: light)">
<meta name="theme-color" content="#141310" media="(prefers-color-scheme: dark)">
<!-- PROD: canonical и og:url ОБЯЗАТЕЛЬНО менять под URL каждой статьи -->
<link rel="canonical" href="https://kaznaexpert.ru/baza-znaniy/kody/0820/">
...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/baza-znaniy/">База знаний</a> › <a href="/baza-znaniy/kody/">Коды</a> › 0820</nav>
  ...
  <article class="content" id="main">
    ...
    <div class="hero">
      ...
      <h1>Код 0820 — Иные выплаты <span class="codealt">(варианты: 8820 / 9820)</span></h1>
    ...
    <div class="tldr">Код <b>0820</b> «Иные выплаты» — направление расходования целевых средств по Приложению 3 к Приказу Минфина № 214н. Выплаты, не связанные с авансами: гранты, командировочные, возмещение вреда, судебные платежи и прочее.</div>
    <!-- svc-cta:top -->
    ...
    <h2 id="chto">Что означает код 0820</h2>
    <div class="answer reveal"><p class="lead-p">Выплаты, не связанные с авансами: гранты, командировочные, возмещение вреда, судебные платежи и прочее.</p><p>Применяется для разнородных выплат, не отнесённых к другим кодам 0100–0820.</p><p class="kosgu"><b>Связь с бюджетной классификацией.</b> Ориентир КОСГУ: командировочные 212/226, выплаты по судам 296/297, гранты 280/296 — по характеру выплаты. Соответствие справочное (Приказ 209н), не нормативное 1:1 — уточняйте у бухгалтера.</p></div>

    <h2 id="podkody">Детализированные подкоды 0820</h2>
    <div class="answer reveal"><p>В Сведениях об операциях и распоряжениях о казначейском платеже указывается детализированный код (семизначный) из группы 0820:</p><table class="ctab"><thead><tr><th>Подкод</th><th>Назначение выплаты</th></tr></thead><tbody><tr><td class="cd">0820 001</td><td>выплаты грантов</td></tr><tr><td class="cd">0820 002</td><td>возмещение таможенному представителю пошлины и НДС</td></tr><tr><td class="cd">0820 003</td><td>командировочные расходы</td></tr><tr><td class="cd">0820 004–005, 007</td><td>возмещение морального вреда, выплаты по решениям судов (включая штрафы и пени), судебные издержки</td></tr><tr><td class="cd">0820 006</td><td>компенсационные выплаты за невыполнение условий квотирования</td></tr><tr><td class="cd">0820 008</td><td>иные выплаты, не отнесённые к кодам 0100–0820</td></tr></tbody></table></div>

    <h2 id="varianty">Варианты кода: первая цифра 6 / 8 / 9</h2><div class="answer reveal"><p>Первая цифра кода направления показывает режим выплаты. Для кода <b>0820</b> на практике применяются варианты:</p><table class="ctab"><thead><tr><th>Код</th><th>Когда указывается</th></tr></thead><tbody><tr><td class="cd">8820</td><td>прямая оплата за фактически поставленное без привлечения иных участников казначейского сопровождения</td></tr><tr><td class="cd">9820</td><td>возмещение ранее понесённых собственных расходов со счёта в банке</td></tr></tbody></table><p>Базовый код <b>0820</b> используется при оплате с лицевого счёта по утверждённым Сведениям; вариант с «9» — когда вы возмещаете уже понесённые за счёт собственных средств расходы.</p></div>

    <h2 id="naznachenie">Назначение платежа по коду 0820</h2><div class="answer reveal"><p>В распоряжении о совершении казначейского платежа назначение формулируют с привязкой к контракту и ИГК. Образец для кода 0820:</p><blockquote class="purpose">«<Командировочные / грант / выплата по решению суда> по контракту № __, ИГК __, основание: __».</blockquote><p class="refs__note">Образец справочный — точную формулировку сверяйте с условиями контракта и требованиями вашего ТОФК.</p></div>

    <h2 id="proverka">Что проверяет казначейство по коду 0820</h2><div class="answer reveal"><p>При санкционировании ТОФК проверяет по этому коду прежде всего:</p><ul class="ul"><li>характер выплаты соответствует конкретному подкоду 0820 001–008</li><li>выплата связана с исполнением контракта</li><li>подкод 0820 008 («иные») обоснован, а не использован как «корзина»</li><li>первичные документы/решения судов прилагаются</li></ul></div>

    <h2 id="primery">Примеры из практики</h2>
    <div class="answer reveal"><ul class="ul"><li>Оплата командировки специалиста на объект заказчика — код 0820 003.</li><li>Выплата по решению суда, связанная с исполнением контракта, — код 0820 005.</li></ul><p class="refs__note">Примеры обезличены и носят справочный характер; они не гарантируют конкретного результата по вашему контракту.</p></div>

    <h2 id="nyuans">Экспертные нюансы кода 0820</h2><div class="answer reveal"><ul class="ul"><li>Командировочные работников — 0820 003 (не 0100).</li><li>Выплаты по решениям судов, штрафы по контракту — 0820 004–005, 007; компенсации за невыполнение условий квотирования — 0820 006.</li><li>Гранты — 0820 001.</li></ul></div>

    <h2 id="oshibki">Типичные ошибки санкционирования по коду 0820</h2>
    <div class="answer reveal"><ul class="ul"><li>Проводят зарплату/компенсации работникам по 0820 вместо 0100.</li><li>Используют 0820 008 как «корзину» без обоснования характера выплаты.</li><li>Оплачивают штрафы и пени, не связанные с контрактом.</li></ul></div>

    <h2 id="dokumenty">Документы-основания</h2>
    <div class="answer reveal"><ul class="ul"><li>авансовые отчёты</li><li>решения судов</li><li>подтверждающие первичные документы</li></ul></div>

    <div class="note">Связанные коды: <div class="codechips"><a class="codechip" href="/baza-znaniy/kody/0100/">0100 · Выплаты персоналу</a><a class="codechip" href="/baza-znaniy/kody/0888/">0888 · Накладные расходы</a></div></div>

    <h2 id="faq">Частые вопросы по коду 0820</h2>
    <div class="faq"><details><summary>Что означает код 0820 в казначейском сопровождении?</summary><p>Выплаты, не связанные с авансами: гранты, командировочные, возмещение вреда, судебные платежи и прочее.</p></details><details><summary>Когда применяется код 0820?</summary><p>Применяется для разнородных выплат, не отнесённых к другим кодам 0100–0820.</p></details><details><summary>Чем отличаются коды 8820 и 9820?</summary><p>Это тот же код направления 0820 с другой первой цифрой: «8» — прямая оплата за фактически поставленное без привлечения иных участников казначейского сопровождения, «9» — возмещение ранее понесённых вами расходов со счёта в банке.</p></details><details><summary>Какие документы нужны для платежа по коду 0820?</summary><p>Как правило: авансовые отчёты, решения судов, подтверждающие первичные документы. Точный комплект зависит от условий контракта и требований ТОФК.</p></details><details><summary>Как указать назначение платежа по коду 0820?</summary><p>Назначение формулируют с привязкой к контракту и ИГК. Образец: «<Командировочные / грант / выплата по решению суда> по контракту № __, ИГК __, основание: __».</p></details></div>
  ...
  <div class="related-inline"><b>Рядом в справочнике:</b> <a href="/baza-znaniy/kody/0813/">код 0813</a> · <a href="/baza-znaniy/kody/0888/">код 0888</a> · <a href="/baza-znaniy/kody/">все коды направлений расходования</a> · <a href="/baza-znaniy/kody-postupleniy/">коды поступлений</a></div>
...
<div class="author">
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="code-0820">

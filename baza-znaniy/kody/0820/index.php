...
<title>Код 0820/8820/9820 — Иные выплаты | КазнаЭксперт</title>
<meta name="description" content="Код направления расходования 0820 «Иные выплаты» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки санкционирования, документы. Актуально на 2">
...
<meta property="og:description" content="Код направления расходования 0820 «Иные выплаты» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки санкционирования, документы. Актуально на 2">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <h2 id="nyuans">Экспертные нюансы кода 0820</h2><div class="answer reveal"><ul class="ul"><li>Командировочные работников — 0820 003 (не 0100).</li><li>Выплаты по решениям судов, штрафы по контракту — 0820 004–007.</li><li>Гранты — 0820 001.</li></ul></div>

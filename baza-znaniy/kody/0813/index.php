...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>Уплата страховых взносов, относящихся к оплате труда персонала, занятого в исполнении контракта.</p><p>Применяется вместе с выплатами персоналу (0100). С ред. 97н единый код взносов вместо прежних 0813–0815.</p></div>

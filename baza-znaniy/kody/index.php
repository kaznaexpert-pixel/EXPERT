...
<section class="kb-faq" aria-labelledby="faqH"><style>.kb-faq{max-width:1240px;margin:48px auto;padding:0 24px;font-family:'Inter',system-ui,sans-serif}.kb-faq>h2{font-family:'Playfair Display',Georgia,serif;font-weight:500;font-size:clamp(1.5rem,2vw+1rem,2rem);letter-spacing:-.01em;margin:0 0 18px;color:var(--ink,#1A1A1A)}</style>
  ...
  <div class="faq">
      ...
      <details><summary>Чем код казначейского счёта отличается от кодов казначейского сопровождения?</summary><p>Это разные вещи. Код казначейского счёта — это номер счёта: казначейский счёт начинается с 03, а единый казначейский счёт Федерального казначейства — с 40102. Коды казначейского сопровождения — это аналитические коды направлений расходования целевых средств (например, 0410), которыми классифицируют каждый платёж по контракту.</p></details>
    </div>
</section>
<script type="application/ld+json">

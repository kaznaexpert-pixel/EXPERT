...
<title>Коды направлений расходования целевых средств 2026</title>
...
{"@context": "https://schema.org", "@type": "CollectionPage", "datePublished": "2026-06-25", "dateModified": "2026-09-03", "name": "Коды направлений расходования целевых средств 2026", "url": "https://kaznaexpert.ru/baza-znaniy/kody/", "description": "Полный справочник кодов направлений расходования целевых средств (214н, Прил.3) на 2026: укрупнённые коды 0100–2000, подкоды, правило первой цифры 6/8/9, примеры и ошибки санк", "mainEntity": {"@type": "ItemList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Код 0100 — Выплаты персоналу", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0100/"}, {"@type": "ListItem", "position": 2, "name": "Код 0200 — Закупка работ и услуг", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0200/"}, {"@type": "ListItem", "position": 3, "name": "Код 8200 — Прямая оплата работ и услуг без субучастников", "item": "https://kaznaexpert.ru/baza-znaniy/kody/8200/"}, {"@type": "ListItem", "position": 4, "name": "Код 0300 — Закупка активов, материальных запасов и основных средств", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0300/"}, {"@type": "ListItem", "position": 5, "name": "Код 0400 — Договоры финансовой аренды (лизинга)", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0400/"}, {"@type": "ListItem", "position": 6, "name": "Код 0410 — Капитальные вложения", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0410/"}, {"@type": "ListItem", "position": 7, "name": "Код 0420 — Взнос в уставный капитал, вклад в имущество", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0420/"}, {"@type": "ListItem", "position": 8, "name": "Код 0610 — Авансовые платежи по контрактам", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0610/"}, {"@type": "ListItem", "position": 9, "name": "Код 0620 — Средства обособленным (структурным) подразделениям", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0620/"}, {"@type": "ListItem", "position": 10, "name": "Код 0630 — Размещение на депозиты и иные финансовые инструменты", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0630/"}, {"@type": "ListItem", "position": 11, "name": "Код 0631 — Выплаты за счёт процентов", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0631/"}, {"@type": "ListItem", "position": 12, "name": "Код 0632 — Финансирование под уступку денежного требования (факторинг)", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0632/"}, {"@type": "ListItem", "position": 13, "name": "Код 0633 — Доходы по договорам факторинга", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0633/"}, {"@type": "ListItem", "position": 14, "name": "Код 0810 — Налоги, сборы и иные платежи в бюджет", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0810/"}, {"@type": "ListItem", "position": 15, "name": "Код 0811 — Налог на добавленную стоимость (НДС)", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0811/"}, {"@type": "ListItem", "position": 16, "name": "Код 0813 — Страховые взносы на обязательное социальное страхование", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0813/"}, {"@type": "ListItem", "position": 17, "name": "Код 0820 — Иные выплаты", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0820/"}, {"@type": "ListItem", "position": 18, "name": "Код 0888 — Накладные расходы", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0888/"}, {"@type": "ListItem", "position": 19, "name": "Код 0991 — Выплаты по окончательным расчётам", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0991/"}, {"@type": "ListItem", "position": 20, "name": "Код 0999 — Выплата прибыли", "item": "https://kaznaexpert.ru/baza-znaniy/kody/0999/"}, {"@type": "ListItem", "position": 21, "name": "Код 1000 — Возврат остатков целевых средств в доход бюджета", "item": "https://kaznaexpert.ru/baza-znaniy/kody/1000/"}, {"@type": "ListItem", "position": 22, "name": "Код 2000 — Возврат дебиторской задолженности в доход бюджета", "item": "https://kaznaexpert.ru/baza-znaniy/kody/2000/"}]}, "image": ["https://kaznaexpert.ru/img/og/kody-16x9.jpg", "https://kaznaexpert.ru/img/og/kody-4x3.jpg", "https://kaznaexpert.ru/img/og/kody-1x1.jpg"], "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/", "image": "https://kaznaexpert.ru/img/team/mihailov-photo.jpg", "@id": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/#person"}}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Главная", "item": "https://kaznaexpert.ru/", "url": "https://kaznaexpert.ru/"}, {"@type": "ListItem", "position": 2, "name": "База знаний", "item": "https://kaznaexpert.ru/baza-znaniy/", "url": "https://kaznaexpert.ru/baza-znaniy/"}, {"@type": "ListItem", "position": 3, "name": "Коды", "url": "https://kaznaexpert.ru/baza-znaniy/kody/"}]}
</script>
...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/kody-16x9.jpg">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="675">
<meta property="og:image:alt" content="Коды направлений расходования целевых средств 2026">
...
<meta name="twitter:title" content="Коды направлений расходования целевых средств 2026">
<meta name="twitter:description" content="Полный справочник кодов направлений расходования целевых средств (214н, Прил.3) на 2026: укрупнённые коды 0100–2000, подкоды, правило первой цифры 6/8/9, примеры и.">
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/kody-16x9.jpg">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание"><div class="toc__label">На странице</div><ul class="toc__list" id="tocList">
    ...
    <li><a href="#tablica">Таблица всех кодов</a></li><li><a href="#podbor">Как подобрать код направления расходования</a></li>
      <li><a href="#stranicy">Страницы по кодам</a></li>
  </ul></aside>
  ...
  <article class="content" id="main">
    ...
    <div class="tldr"><strong>Коды направлений расходования целевых средств — это аналитические коды из Приложения 3 к Приказу Минфина № 214н, которыми в сведениях об операциях обозначают, на что тратятся целевые средства по контракту.</strong> Полный справочник кодов направлений расходования целевых средств по <b>Приложению 3 к Приказу Минфина № 214н</b> (ред. 97н, действует в 2026). Укрупнённые коды 0100–2000, детализированные подкоды и правило первой цифры (6/8/9). По каждому коду — отдельная страница с примерами и ошибками санкционирования.</div>

    <h2 id="chto">Что это за коды</h2>
    <div class="answer reveal"><p class="lead-p">Код направления расходования целевых средств указывается в Сведениях об операциях с целевыми средствами и в распоряжениях о совершении казначейского платежа. По нему казначейство понимает, на что именно идут средства, и санкционирует операцию. Неверный код — частая причина возврата платежа.</p></div>
    <p>Те же коды затем переносятся в <a href="/baza-znaniy/otchet-o-rashodah-celevyh-sredstv/">отчёт о расходах целевых средств</a>, поэтому расхождение между Сведениями и отчётом сразу видно проверяющему. Не путайте эти коды с бюджетной классификацией заказчика — разница разобрана в статье <a href="/baza-znaniy/kvr-kosgu-celevye-sredstva/">КВР и КОСГУ для целевых средств</a>.</p>
...
<!-- kb-faq -->
    ...
    <p class="note">Если платёж уже вернули из-за кода, разберём формулировку отказа и проведём платёж повторно — <a href="/uslugi/kaznacheyskoe-soprovozhdenie/">казначейское сопровождение контракта &rarr;</a></p>
...
<section class="kb-faq" aria-labelledby="faqH"><style>.kb-faq{max-width:1240px;margin:48px auto;padding:0 24px;font-family:'Inter',system-ui,sans-serif}.kb-faq>h2{font-family:'Playfair Display',Georgia,serif;font-weight:500;font-size:clamp(1.5rem,2vw+1rem,2rem);letter-spacing:-.01em;margin:0 0 18px;color:var(--ink,#1A1A1A)}</style>
  ...
  <div class="faq">
      ...
      <details><summary>Где посмотреть полный перечень кодов расходования целевых средств?</summary><p>Полный перечень кодов направления расходования целевых средств установлен Приложением 3 к приказу Минфина № 214н. Укрупнённые группы (0410, 0810, 0820, 0888, 0999 и другие) с расшифровками разобраны на страницах разделов; основание — <a href="/baza-znaniy/normativnaya-baza/prikaz-214n/">приказ Минфина № 214н</a>.</p></details>
  
      <details><summary>Чем код казначейского счёта отличается от кодов казначейского сопровождения?</summary><p>Это разные вещи. Код казначейского счёта — это номер счёта: казначейский счёт начинается с 03, а <a href="/baza-znaniy/edinyy-kaznacheyskiy-schet/">единый казначейский счёт (ЕКС)</a> Федерального казначейства — с 40102. Коды казначейского сопровождения — это аналитические коды направлений расходования целевых средств (например, 0410), которыми классифицируют каждый платёж по контракту.</p></details>
    </div>
</section>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Что такое коды направления расходования целевых средств?", "acceptedAnswer": {"@type": "Answer", "text": "Это аналитические коды по приказу Минфина № 214н (Приложение 3), которые показывают, на что расходуются целевые средства при казначейском сопровождении."}}, {"@type": "Question", "name": "Где указываются эти коды?", "acceptedAnswer": {"@type": "Answer", "text": "В Сведениях об операциях с целевыми средствами и в распоряжениях на платёж. Как заполнить Сведения — в материале сведения об операциях с целевыми средствами."}}, {"@type": "Question", "name": "Что означает код 0410?", "acceptedAnswer": {"@type": "Answer", "text": "Это базовое направление — оплата поставленных товаров, выполненных работ, оказанных услуг. Разбор — на странице кода 0410."}}, {"@type": "Question", "name": "Чем код направления расходования отличается от кода источника поступления?", "acceptedAnswer": {"@type": "Answer", "text": "Направление (Приложение 3 к приказу № 214н) показывает, на что тратятся средства; источник (Приложение 2) — откуда они поступили. Об источниках — коды поступлений."}}, {"@type": "Question", "name": "Как выбрать правильный код для платежа?", "acceptedAnswer": {"@type": "Answer", "text": "По содержанию расхода и подтверждающим документам. Ошибка в коде — частая причина, по которой казначейство приостанавливает платёж; см. причины отказа казначейства в санкционировании."}}, {"@type": "Question", "name": "Где посмотреть полный перечень кодов расходования целевых средств?", "acceptedAnswer": {"@type": "Answer", "text": "Полный перечень кодов направления расходования целевых средств установлен Приложением 3 к приказу Минфина № 214н. Укрупнённые группы (0410, 0810, 0820, 0888, 0999 и другие) с расшифровками разобраны на страницах разделов; основание — приказ Минфина № 214н."}}, {"@type": "Question", "name": "Чем код казначейского счёта отличается от кодов казначейского сопровождения?", "acceptedAnswer": {"@type": "Answer", "text": "Это разные вещи. Код казначейского счёта — это номер счёта: казначейский счёт начинается с 03, а единый казначейский счёт Федерального казначейства — с 40102. Коды казначейского сопровождения — это аналитические коды направлений расходования целевых средств (например, 0410), которыми классифицируют каждый платёж по контракту."}}]}
</script>

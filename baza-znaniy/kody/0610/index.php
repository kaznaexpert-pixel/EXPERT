...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="hero">
      ...
      <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>Обновлено 11 августа 2026</span></div>
    </div>
    ...
    <ul>
      ...
      <li><b>Аванс на материалы (подкод 0610 003):</b> «Авансовый платёж 50% по договору поставки № 7 от 01.08.2026 на приобретение сырья и материалов для исполнения контракта № __, ИГК __. В т.ч. НДС 20% — __ руб.».</li>
...
<h2 id="nyuans">Экспертные нюансы кода 0610</h2><div class="answer reveal"><ul class="ul"><li>Аванс делает контрагента участником казначейского сопровождения — целевые средства «прослеживаются» на его лицевом счёте.</li><li>Оплата по факту выполнения — это 0200/0300/0410, а не 0610.</li><li>Незакрытый авансом объём при завершении возвращается (1000/2000).</li></ul></div>
    ...
    <p><b>Как 0610 связан с другими кодами.</b> Жизненный цикл расчётов с соисполнителем обычно проходит через связку кодов: аванс уходит по 0610, текущие платежи за принятые этапы — по профильным направлениям (0200 за работы и услуги, 0300 за материалы и активы, 0410 по капитальным вложениям), а окончательный расчёт после полного исполнения — по 0991. Зачёт ранее выданного аванса отражается именно на этапе оплаты исполненного, поэтому сумма по 0610 и суммы по «исполнительским» кодам должны в итоге сойтись с ценой договора. Не путайте 0610 и с кодом 0620 — тот применяется для перечислений собственным обособленным подразделениям, а не сторонним соисполнителям. Если сомневаетесь в выборе между кодами, отталкивайтесь от вопроса «за что платим»: до исполнения — 0610, за исполненное — профильный код, финальный расчёт — 0991.</p>

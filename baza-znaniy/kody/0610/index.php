...
<meta name="description" content="Код направления расходования 0610 «Авансовые платежи по контрактам» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки санкционирования, докуме">
...
<meta property="og:description" content="Код направления расходования 0610 «Авансовые платежи по контрактам» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки санкционирования, докуме">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <h2 id="nyuans">Экспертные нюансы кода 0610</h2><div class="answer reveal"><ul class="ul"><li>Аванс делает контрагента участником КС — целевые средства «прослеживаются» на его лицевом счёте.</li><li>Оплата по факту выполнения — это 0200/0300/0410, а не 0610.</li><li>Незакрытый авансом объём при завершении возвращается (1000/2000).</li></ul></div>

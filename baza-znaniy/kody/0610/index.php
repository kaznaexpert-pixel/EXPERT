...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__kody__0610-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__kody__0610-16x9.jpg">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="hero">
      ...
      <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>Обновлено 4 сентября 2026</span></div>
    </div>
    ...
    <div class="answer reveal"><p class="lead-p">Перечисление авансов субподрядчикам и поставщикам по контрактам (договорам).</p>
    <p class="note">Код 0610 отражается по операциям на лицевом счёте с кодом 71 — о том, как такой счёт открыть, читайте в <a href="/baza-znaniy/licevoy-schet-71-kak-otkryt/">пошаговом разборе &rarr;</a>, а открыть его без возвратов документов поможем мы: <a href="/uslugi/otkrytie-scheta/">открытие счёта под ключ &rarr;</a>.</p><p>Применяется при авансировании привлечённых исполнителей. Аванс получает статус целевых средств, контрагент становится участником казначейского сопровождения.</p><p class="kosgu"><b>Связь с бюджетной классификацией.</b> Ориентир КОСГУ: по той же подстатье, что и предмет аванса (221–226/310/340), с признаком авансового платежа. Соответствие справочное (Приказ 209н), не нормативное 1:1 — уточняйте у бухгалтера.</p></div>
...
<h2 id="proverka">Что проверяет казначейство по коду 0610</h2><div class="answer reveal"><p>При санкционировании ТОФК проверяет по этому коду прежде всего:</p><ul class="ul"><li>размер аванса не превышает предельный по контракту/НПА</li><li>получатель аванса открыл лицевой счёт в ТОФК</li><li>аванс не маскирует оплату уже выполненных работ</li><li>связь авансируемого договора с контрактом</li></ul></div>
    ...
    <p><b>Сколько идёт аванс по коду 0610.</b> При корректных документах цепочка выглядит так: распоряжение подано — санкционирование в срок не позднее рабочего дня, следующего за днём представления — зачисление на лицевой счёт соисполнителя в тот же операционный день. С переходом на Единую бюджетную платформу зачисление отражается в режиме реального времени, и соисполнитель видит аванс сразу после проведения операции. Закладывайте в график кооперации два-три рабочих дня на весь цикл и подавайте аванс не в день дедлайна: любой возврат на доработку добавляет к сроку новый цикл санкционирования. Срок действует с 1 сентября 2026 года — пункт 33 Порядка № 214н в редакции приказа Минфина от 16.06.2026 № 75н; до этой даты он составлял два рабочих дня.</p>
...
<h2 id="oshibki">Типичные ошибки санкционирования по коду 0610</h2>
    ...
    <p>Если все семь пунктов пройдены, аванс проходит санкционирование в нормативный срок — не позднее рабочего дня, следующего за днём представления. Если казначейство всё же вернуло документ, начните с протокола: причина возврата всегда указана, и в девяти случаях из десяти она совпадает с одним из пунктов этого списка.</p>
    ...
    <div class="faq"><details><summary>Существуют ли коды 6610, 8610 и 9610?</summary><p>Нет. Правило первой цифры (6, 8, 9) применяется к направлениям-выплатам на банковские счета — например 8410 и 9410 от базового 0410. Код 0610 — внутриказначейское перечисление аванса на лицевой счёт соисполнителя, вариантов с заменённой первой цифрой у него нет.</p></details>
      <details><summary>Изменятся ли коды направлений расходования с 1 сентября 2026 года?</summary><p>Нет. С 1 сентября 2026 года приказ Минфина № 214н действует в редакции приказа от 16.06.2026 № 75н, но Приложение 3 с направлениями расходования этим приказом не переписано — код 0610 и правило первого разряда применяются без изменений (правило сохранено и в новой редакции пункта 12(1), применяемой с 01.01.2027). Ожидавшаяся замена 214н новым порядком не состоялась. Изменилось приложение 2 (источники поступлений) и с 2027 года — форма Сведений 0501213.</p></details>

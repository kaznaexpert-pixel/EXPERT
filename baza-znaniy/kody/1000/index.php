...
<title>Код 1000 — Возврат остатков целевых средств в доход бюджета | КазнаЭкс</title>
<meta name="description" content="Код направления расходования 1000 «Возврат остатков целевых средств в доход бюджета» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки санкцио">
...
<meta property="og:title" content="Код 1000 — Возврат остатков целевых средств в доход бюджета | КазнаЭкс">
<meta property="og:description" content="Код направления расходования 1000 «Возврат остатков целевых средств в доход бюджета» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки санкцио">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>Перечисление в доход бюджета неиспользованных остатков целевых средств, потребность в которых не подтверждена.</p><p>Применяется по неиспользованным на 1 января остаткам, не подтверждённым к дальнейшему использованию.</p><p class="kosgu"><b>Связь с бюджетной классификацией.</b> Ориентир КОСГУ: 610 (выбытие средств) / зачисление в доход соответствующего бюджета. Соответствие справочное (Приказ 209н), не нормативное 1:1 — уточняйте у бухгалтера.</p></div>

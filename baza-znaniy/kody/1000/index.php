...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>Перечисление в доход бюджета неиспользованных остатков целевых средств, потребность в которых не подтверждена.</p><p>Применяется по неиспользованным на 1 января остаткам, не подтверждённым к дальнейшему использованию.</p></div>

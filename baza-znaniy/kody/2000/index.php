...
<title>Код 2000 — Возврат дебиторской задолженности в доход бюджета | КазнаЭк</title>
<meta name="description" content="Код направления расходования 2000 «Возврат дебиторской задолженности в доход бюджета» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки санкци">
...
<meta property="og:title" content="Код 2000 — Возврат дебиторской задолженности в доход бюджета | КазнаЭк">
<meta property="og:description" content="Код направления расходования 2000 «Возврат дебиторской задолженности в доход бюджета» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки санкци">

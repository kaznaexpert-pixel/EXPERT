...
<title>Код 0630 — размещение на депозиты и инструменты</title>
<meta name="description" content="Код 0630 «Размещение на депозиты и иные финансовые инструменты» при казначейском сопровождении: подкоды, варианты 6/8/9, ошибки санкционирования, документы.">
<meta name="author" content="Ярослав Михайлов">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
<meta name="theme-color" content="#F4F1EB" media="(prefers-color-scheme: light)">
<meta name="theme-color" content="#141310" media="(prefers-color-scheme: dark)">
<!-- PROD: canonical и og:url ОБЯЗАТЕЛЬНО менять под URL каждой статьи -->
<link rel="canonical" href="https://kaznaexpert.ru/baza-znaniy/kody/0630/">
...
{"@context": "https://schema.org", "@type": "Article", "headline": "Код 0630 — Размещение на депозиты и иные финансовые инструменты в казначейском сопровождении", "description": "Код направления расходования целевых средств 0630 «Размещение на депозиты и иные финансовые инструменты»: значение, детализированные подкоды, варианты 6/8/9, примеры из практики, ошибки санкционирования, документы.", "datePublished": "2026-06-05T10:00:00+03:00", "dateModified": "2026-09-03T10:00:00+03:00", "inLanguage": "ru-RU", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/", "@id": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/#person", "image": "https://kaznaexpert.ru/img/team/mihailov-photo.jpg"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}, "@id": "https://kaznaexpert.ru/#organization"}, "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/kody/0630/"}, "image": ["https://kaznaexpert.ru/img/og/baza-znaniy__kody__0630-16x9.jpg", "https://kaznaexpert.ru/img/og/baza-znaniy__kody__0630-4x3.webp", "https://kaznaexpert.ru/img/og/baza-znaniy__kody__0630-1x1.webp"], "citation": ["Приказ Минфина России от 17.12.2021 № 214н (ред. от 16.06.2026), Приложение 3 «Направления расходования целевых средств». КонсультантПлюс — https://www.consultant.ru/document/cons_doc_LAW_405138/de4649fe56038006ee16bce420115b7ba6a80da5/", "Правило первого разряда кода (6/8/9) — Приказ Минфина России от 21.06.2023 № 97н. КонсультантПлюс — https://www.consultant.ru/document/cons_doc_LAW_405138/"]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Главная", "item": "https://kaznaexpert.ru/", "url": "https://kaznaexpert.ru/"}, {"@type": "ListItem", "position": 2, "name": "База знаний", "item": "https://kaznaexpert.ru/baza-znaniy/", "url": "https://kaznaexpert.ru/baza-znaniy/"}, {"@type": "ListItem", "position": 3, "name": "Коды", "item": "https://kaznaexpert.ru/baza-znaniy/kody/", "url": "https://kaznaexpert.ru/baza-znaniy/kody/"}, {"@type": "ListItem", "position": 4, "name": "Код 0630", "url": "https://kaznaexpert.ru/baza-znaniy/kody/0630/"}]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Что означает код 0630 в казначейском сопровождении?", "acceptedAnswer": {"@type": "Answer", "text": "Перечисление целевых средств для размещения на депозиты или в иные финансовые инструменты (по договорам займа)."}}, {"@type": "Question", "name": "Когда применяется код 0630?", "acceptedAnswer": {"@type": "Answer", "text": "Применяется в установленных случаях, когда допускается временное размещение целевых средств."}}, {"@type": "Question", "name": "Какие документы нужны для платежа по коду 0630?", "acceptedAnswer": {"@type": "Answer", "text": "Как правило: договор депозита/займа, разрешающие условия сопровождения. Точный комплект зависит от условий контракта и требований ТОФК."}}, {"@type": "Question", "name": "Как указать назначение платежа по коду 0630?", "acceptedAnswer": {"@type": "Answer", "text": "Назначение формулируют с привязкой к контракту и ИГК. Образец: «Размещение временно свободных целевых средств на депозит по договору № __ от __ (контракт № __, ИГК __)»."}}]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "DefinedTerm", "name": "Код 0630", "description": "Размещение на депозиты и иные финансовые инструменты — направление расходования целевых средств (Приказ Минфина 214н, Прил.3).", "inDefinedTermSet": "https://kaznaexpert.ru/baza-znaniy/kody/"}
</script>
...
<meta property="og:title" content="Код 0630 — Размещение на депозиты и иные финансовые инструменты">
<meta property="og:description" content="Код 0630 «Размещение на депозиты и иные финансовые инструменты» при казначейском сопровождении: подкоды, варианты 6/8/9, ошибки санкционирования, документы.">
<meta property="og:url" content="https://kaznaexpert.ru/baza-znaniy/kody/0630/">
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__kody__0630-16x9.jpg">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="675">
<meta property="og:image:alt" content="Код 0630 — размещение на депозиты и инструменты">
<meta property="article:published_time" content="2026-06-05T09:00:00+03:00">
<meta property="article:modified_time" content="2026-09-03T09:00:00+03:00">
<meta property="article:author" content="https://kaznaexpert.ru/komanda/mihailov-yaroslav/">
<meta property="article:section" content="База знаний">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Код 0630 — размещение на депозиты и инструменты">
<meta name="twitter:description" content="Код 0630 «Размещение на депозиты и иные финансовые инструменты» при казначейском сопровождении: подкоды, варианты 6/8/9, ошибки санкционирования, документы.">
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__kody__0630-16x9.jpg">
...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/baza-znaniy/">База знаний</a> › <a href="/baza-znaniy/kody/">Коды</a> › 0630</nav>
  ...
  <article class="content" id="main">
    ...
    <div class="hero">
      ...
      <h1>Код 0630 — Размещение на депозиты и иные финансовые инструменты</h1>
    ...
    <div class="tldr">Код <b>0630</b> «Размещение на депозиты и иные финансовые инструменты» — направление расходования целевых средств по Приложению 3 к Приказу Минфина № 214н. Перечисление целевых средств для размещения на депозиты или в иные финансовые инструменты (по договорам займа).</div>
    <!-- svc-cta:top -->
    ...
    <h2 id="chto">Что означает код 0630</h2>
    <div class="answer reveal"><p class="lead-p">Перечисление целевых средств для размещения на депозиты или в иные финансовые инструменты (по договорам займа).</p><p>Применяется в установленных случаях, когда допускается временное размещение целевых средств.</p><p class="kosgu"><b>Связь с бюджетной классификацией.</b> Ориентир КОСГУ: операции с финансовыми активами (размещение средств); признаётся как финансовое вложение. Соответствие справочное (Приказ 209н), не нормативное 1:1 — уточняйте у бухгалтера.</p></div>

    <h2 id="podkody">Детализированные подкоды 0630</h2>
    <div class="answer reveal"><p>В Сведениях об операциях и распоряжениях о казначейском платеже указывается детализированный код (семизначный) из группы 0630:</p><table class="ctab"><thead><tr><th>Подкод</th><th>Назначение выплаты</th></tr></thead><tbody><tr><td class="cd">0630 001</td><td>перечисление средств для размещения на депозиты, в иные финансовые инструменты (по договорам займа)</td></tr></tbody></table></div>

    

    <h2 id="naznachenie">Назначение платежа по коду 0630</h2><div class="answer reveal"><p>В распоряжении о совершении казначейского платежа назначение формулируют с привязкой к контракту и ИГК. Образец для кода 0630:</p><blockquote class="purpose">«Размещение временно свободных целевых средств на депозит по договору № __ от __ (контракт № __, ИГК __)».</blockquote><p class="refs__note">Образец справочный — точную формулировку сверяйте с условиями контракта и требованиями вашего ТОФК.</p></div>

    <h2 id="proverka">Что проверяет казначейство по коду 0630</h2><div class="answer reveal"><p>При санкционировании ТОФК проверяет по этому коду прежде всего:</p><ul class="ul"><li>право на размещение по условиям контракта и НПА</li><li>уполномоченный банк/инструмент</li><li>срок и условия возврата средств и процентов на лицевой счёт</li><li>договор депозита/займа</li></ul></div>

    <h2 id="primery">Примеры из практики</h2>
    <div class="answer reveal"><ul class="ul"><li>Допустимое временное размещение свободных целевых средств на депозит в уполномоченном банке.</li><li>Размещение средств в иные финансовые инструменты в рамках, разрешённых условиями сопровождения.</li></ul><p class="refs__note">Примеры обезличены и носят справочный характер; они не гарантируют конкретного результата по вашему контракту.</p></div>

    <h2 id="nyuans">Экспертные нюансы кода 0630</h2><div class="answer reveal"><ul class="ul"><li>Размещение возможно только если прямо разрешено — по умолчанию целевые средства не размещают.</li><li>Проценты от размещения расходуются по отдельному коду 0631.</li></ul></div>

    <h2 id="oshibki">Типичные ошибки санкционирования по коду 0630</h2>
    <div class="answer reveal"><ul class="ul"><li>Размещают средства без права на это по условиям контракта/НПА.</li><li>Не возвращают средства и проценты на лицевой счёт в установленный срок.</li><li>Путают код размещения (0630) и код выплат за счёт процентов (0631).</li></ul></div>

    <h2 id="dokumenty">Документы-основания</h2>
    <div class="answer reveal"><ul class="ul"><li>договор депозита/займа</li><li>разрешающие условия сопровождения</li></ul></div>

    <div class="note">Связанные коды: <div class="codechips"><a class="codechip" href="/baza-znaniy/kody/0631/">0631 · Выплаты за счёт процентов</a></div></div>

    <h2 id="faq">Частые вопросы по коду 0630</h2>
    <div class="faq"><details><summary>Что означает код 0630 в казначейском сопровождении?</summary><p>Перечисление целевых средств для размещения на депозиты или в иные финансовые инструменты (по договорам займа).</p></details><details><summary>Когда применяется код 0630?</summary><p>Применяется в установленных случаях, когда допускается временное размещение целевых средств.</p></details><details><summary>Какие документы нужны для платежа по коду 0630?</summary><p>Как правило: договор депозита/займа, разрешающие условия сопровождения. Точный комплект зависит от условий контракта и требований ТОФК.</p></details><details><summary>Как указать назначение платежа по коду 0630?</summary><p>Назначение формулируют с привязкой к контракту и ИГК. Образец: «Размещение временно свободных целевых средств на депозит по договору № __ от __ (контракт № __, ИГК __)».</p></details></div>
  ...
  <div class="related-inline"><b>Рядом в справочнике:</b> <a href="/baza-znaniy/kody/0620/">код 0620</a> · <a href="/baza-znaniy/kody/0631/">код 0631</a> · <a href="/baza-znaniy/kody/">все коды направлений расходования</a> · <a href="/baza-znaniy/kody-postupleniy/">коды поступлений</a></div>
...
<div class="author">
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="code-0630">

...
<title>Код 0630 — Размещение на депозиты и иные финансовые инструменты | Казн</title>
<meta name="description" content="Код направления расходования 0630 «Размещение на депозиты и иные финансовые инструменты» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки сан">
...
<meta property="og:title" content="Код 0630 — Размещение на депозиты и иные финансовые инструменты | Казн">
<meta property="og:description" content="Код направления расходования 0630 «Размещение на депозиты и иные финансовые инструменты» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки сан">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>Перечисление целевых средств для размещения на депозиты или в иные финансовые инструменты (по договорам займа).</p><p>Применяется в установленных случаях, когда допускается временное размещение целевых средств.</p><p class="kosgu"><b>Связь с бюджетной классификацией.</b> Ориентир КОСГУ: операции с финансовыми активами (размещение средств); признаётся как финансовое вложение. Соответствие справочное (Приказ 209н), не нормативное 1:1 — уточняйте у бухгалтера.</p></div>

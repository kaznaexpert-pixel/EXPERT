...
<title>Код 0631 — Выплаты за счёт процентов | КазнаЭксперт</title>
<meta name="description" content="Код направления расходования 0631 «Выплаты за счёт процентов» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки санкционирования, документы. А">
...
<meta property="og:description" content="Код направления расходования 0631 «Выплаты за счёт процентов» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки санкционирования, документы. А">

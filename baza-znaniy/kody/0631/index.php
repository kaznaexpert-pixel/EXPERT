...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>Выплаты, осуществляемые за счёт процентов от размещения средств на депозиты и доходов по иным инструментам.</p><p>Применяется при расходовании доходов, полученных от размещения целевых средств.</p></div>

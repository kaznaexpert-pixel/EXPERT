...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>Общепроизводственные, общехозяйственные и административно-управленческие затраты, связанные с исполнением контракта.</p><p>Один из самых спорных кодов при санкционировании: казначейство тщательно проверяет обоснованность и долю накладных.</p></div>

...
<title>Код 0888/8888/9888 — Накладные расходы | КазнаЭксперт</title>
<meta name="description" content="Код направления расходования 0888 «Накладные расходы» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки санкционирования, документы. Актуально">
...
<meta property="og:description" content="Код направления расходования 0888 «Накладные расходы» в казначейском сопровождении: подкоды, варианты 6/8/9, примеры из практики, ошибки санкционирования, документы. Актуально">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>Общепроизводственные, общехозяйственные и административно-управленческие затраты, связанные с исполнением контракта.</p><p>Один из самых спорных кодов при санкционировании: казначейство тщательно проверяет обоснованность и долю накладных.</p><p class="kosgu"><b>Связь с бюджетной классификацией.</b> Ориентир КОСГУ: смешанный — 211/213/221–226/310/340 пропорционально базе распределения. Соответствие справочное (Приказ 209н), не нормативное 1:1 — уточняйте у бухгалтера.</p></div>

...
<title>Код 0888/8888/9888 — Накладные расходы</title>
<meta name="description" content="Код направления расходования 0888 «Накладные расходы» в казначейском сопровождении: подкоды, варианты 6/8/9, ошибки санкционирования, документы.">
<meta name="author" content="Ярослав Михайлов">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
<meta name="theme-color" content="#F4F1EB" media="(prefers-color-scheme: light)">
<meta name="theme-color" content="#141310" media="(prefers-color-scheme: dark)">
<!-- PROD: canonical и og:url ОБЯЗАТЕЛЬНО менять под URL каждой статьи -->
<link rel="canonical" href="https://kaznaexpert.ru/baza-znaniy/kody/0888/">
...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Что означает код 0888 в казначейском сопровождении?", "acceptedAnswer": {"@type": "Answer", "text": "Общепроизводственные, общехозяйственные и административно-управленческие затраты, связанные с исполнением контракта."}}, {"@type": "Question", "name": "Когда применяется код 0888?", "acceptedAnswer": {"@type": "Answer", "text": "Один из самых спорных кодов при санкционировании: казначейство тщательно проверяет обоснованность и долю накладных."}}, {"@type": "Question", "name": "Чем отличаются коды 8888 и 9888?", "acceptedAnswer": {"@type": "Answer", "text": "Это тот же код направления 0888 с другой первой цифрой: «8» — прямая оплата за фактически поставленное без привлечения иных участников казначейского сопровождения, «9» — возмещение ранее понесённых вами расходов со счёта в банке."}}, {"@type": "Question", "name": "Какие документы нужны для платежа по коду 0888?", "acceptedAnswer": {"@type": "Answer", "text": "Как правило: учётная политика с методикой распределения, расчёт доли накладных, первичные документы по затратам. Точный комплект зависит от условий контракта и требований ТОФК."}}, {"@type": "Question", "name": "Как указать назначение платежа по коду 0888?", "acceptedAnswer": {"@type": "Answer", "text": "Назначение формулируют с привязкой к контракту и ИГК. Образец: «Накладные расходы (доля __%) по контракту № __, ИГК __: <аренда/связь/АУП> за <период>»."}}]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "DefinedTerm", "name": "Код 0888", "description": "Накладные расходы — направление расходования целевых средств (Приказ Минфина 214н, Прил.3).", "inDefinedTermSet": "https://kaznaexpert.ru/baza-znaniy/kody/"}
</script>
...
<meta property="og:title" content="Код 0888/8888/9888 — Накладные расходы | КазнаЭксперт">
<meta property="og:description" content="Код направления расходования 0888 «Накладные расходы» в казначейском сопровождении: подкоды, варианты 6/8/9, ошибки санкционирования, документы.">
<meta property="og:url" content="https://kaznaexpert.ru/baza-znaniy/kody/0888/">
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__kody__0888-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__kody__0888-16x9.jpg">
...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/baza-znaniy/">База знаний</a> › <a href="/baza-znaniy/kody/">Коды</a> › 0888</nav>
  ...
  <article class="content" id="main">
    ...
    <div class="hero">
      ...
      <h1>Код 0888 — Накладные расходы <span class="codealt">(варианты: 8888 / 9888)</span></h1>
    ...
    <div class="tldr">Код <b>0888</b> «Накладные расходы» — направление расходования целевых средств по Приложению 3 к Приказу Минфина № 214н. Общепроизводственные, общехозяйственные и административно-управленческие затраты, связанные с исполнением контракта.</div>
    <!-- svc-cta:top -->
    ...
    <h2 id="chto">Что означает код 0888</h2>
    <div class="answer reveal"><p class="lead-p">Общепроизводственные, общехозяйственные и административно-управленческие затраты, связанные с исполнением контракта.</p><p>Один из самых спорных кодов при санкционировании: казначейство тщательно проверяет обоснованность и долю накладных.</p><p class="kosgu"><b>Связь с бюджетной классификацией.</b> Ориентир КОСГУ: смешанный — 211/213/221–226/310/340 пропорционально базе распределения. Соответствие справочное (Приказ 209н), не нормативное 1:1 — уточняйте у бухгалтера.</p></div>

    <h2 id="podkody">Детализированные подкоды 0888</h2>
    <div class="answer reveal"><p>В Сведениях об операциях и распоряжениях о казначейском платеже указывается детализированный код (семизначный) из группы 0888:</p><table class="ctab"><thead><tr><th>Подкод</th><th>Назначение выплаты</th></tr></thead><tbody><tr><td class="cd">0888 001–003, 017, 018</td><td>общепроизводственные затраты (оплата труда персонала, связанного с управлением и обслуживанием производства, работы и услуги сторонних лиц, НДФЛ, страховые взносы, прочие затраты)</td></tr><tr><td class="cd">0888 005–011, 019–021</td><td>общехозяйственные затраты (консультации, содержание и ремонт имущества, аренда, транспорт, связь, коммуналка, работы и услуги сторонних лиц, НДФЛ, страховые взносы, прочие)</td></tr><tr><td class="cd">0888 012–016, 022</td><td>административно-управленческие расходы (оплата труда АУП, работы и услуги сторонних лиц, НДФЛ, страховые взносы, обучение АУП, прочие непроизводственные расходы)</td></tr></tbody></table></div>

    <h2 id="varianty">Варианты кода: первая цифра 6 / 8 / 9</h2><div class="answer reveal"><p>Первая цифра кода направления показывает режим выплаты. Для кода <b>0888</b> на практике применяются варианты:</p><table class="ctab"><thead><tr><th>Код</th><th>Когда указывается</th></tr></thead><tbody><tr><td class="cd">8888</td><td>прямая оплата за фактически поставленное без привлечения иных участников казначейского сопровождения</td></tr><tr><td class="cd">9888</td><td>возмещение ранее понесённых собственных расходов со счёта в банке</td></tr></tbody></table><p>Базовый код <b>0888</b> используется при оплате с лицевого счёта по утверждённым Сведениям; вариант с «9» — когда вы возмещаете уже понесённые за счёт собственных средств расходы.</p></div>

    <h2 id="naznachenie">Назначение платежа по коду 0888</h2><div class="answer reveal"><p>В распоряжении о совершении казначейского платежа назначение формулируют с привязкой к контракту и ИГК. Образец для кода 0888:</p><blockquote class="purpose">«Накладные расходы (доля __%) по контракту № __, ИГК __: <аренда/связь/АУП> за <период>».</blockquote><p class="refs__note">Образец справочный — точную формулировку сверяйте с условиями контракта и требованиями вашего ТОФК.</p></div>

    <h2 id="proverka">Что проверяет казначейство по коду 0888</h2><div class="answer reveal"><p>При санкционировании ТОФК проверяет по этому коду прежде всего:</p><ul class="ul"><li>наличие методики распределения накладных в учётной политике</li><li>обоснованность доли, отнесённой на контракт</li><li>прямые затраты не «спрятаны» в накладных (их место — 0100/0200/0300)</li><li>расчёт распределения по запросу ТОФК</li></ul></div>

    <h2 id="primery">Примеры из практики</h2>
    <div class="answer reveal"><ul class="ul"><li>Распределение части аренды офиса и услуг связи на контракт пропорционально загрузке — код 0888 по соответствующим подкодам.</li><li>Оплата труда административно-управленческого персонала в доле, приходящейся на контракт, — код 0888 013.</li></ul><p class="refs__note">Примеры обезличены и носят справочный характер; они не гарантируют конкретного результата по вашему контракту.</p></div>

    <h2 id="nyuans">Экспертные нюансы кода 0888</h2><div class="answer reveal"><ul class="ul"><li>Самый спорный код при санкционировании — казначейство проверяет обоснованность доли особенно тщательно.</li><li>Структура 0888: общепроизводственные (001–004), общехозяйственные (005–011), АУП (012–016), услуги сторонних лиц + НДФЛ/взносы (017–022).</li><li>Без закреплённой методики распределения накладные не пройдут санкционирование.</li></ul></div>

    <h2 id="oshibki">Типичные ошибки санкционирования по коду 0888</h2>
    <div class="answer reveal"><ul class="ul"><li>Завышают долю накладных, не подтверждая методику распределения.</li><li>Относят к 0888 прямые затраты, которые должны идти по 0100/0200/0300.</li><li>Не закрепляют порядок распределения накладных в учётной политике.</li></ul></div>

    <h2 id="dokumenty">Документы-основания</h2>
    <div class="answer reveal"><ul class="ul"><li>учётная политика с методикой распределения</li><li>расчёт доли накладных</li><li>первичные документы по затратам</li></ul></div>

    <div class="note">Связанные коды: <div class="codechips"><a class="codechip" href="/baza-znaniy/kody/0100/">0100 · Выплаты персоналу</a><a class="codechip" href="/baza-znaniy/kody/0200/">0200 · Закупка работ и услуг</a><a class="codechip" href="/baza-znaniy/kody/0813/">0813 · Страховые взносы на обязательное социальное страхование</a></div></div>

    <h2 id="faq">Частые вопросы по коду 0888</h2>
    <div class="faq"><details><summary>Что означает код 0888 в казначейском сопровождении?</summary><p>Общепроизводственные, общехозяйственные и административно-управленческие затраты, связанные с исполнением контракта.</p></details><details><summary>Когда применяется код 0888?</summary><p>Один из самых спорных кодов при санкционировании: казначейство тщательно проверяет обоснованность и долю накладных.</p></details><details><summary>Чем отличаются коды 8888 и 9888?</summary><p>Это тот же код направления 0888 с другой первой цифрой: «8» — прямая оплата за фактически поставленное без привлечения иных участников казначейского сопровождения, «9» — возмещение ранее понесённых вами расходов со счёта в банке.</p></details><details><summary>Какие документы нужны для платежа по коду 0888?</summary><p>Как правило: учётная политика с методикой распределения, расчёт доли накладных, первичные документы по затратам. Точный комплект зависит от условий контракта и требований ТОФК.</p></details><details><summary>Как указать назначение платежа по коду 0888?</summary><p>Назначение формулируют с привязкой к контракту и ИГК. Образец: «Накладные расходы (доля __%) по контракту № __, ИГК __: <аренда/связь/АУП> за <период>».</p></details></div>
  ...
  <div class="related-inline"><b>Рядом в справочнике:</b> <a href="/baza-znaniy/kody/0820/">код 0820</a> · <a href="/baza-znaniy/kody/0991/">код 0991</a> · <a href="/baza-znaniy/kody/">все коды направлений расходования</a> · <a href="/baza-znaniy/kody-postupleniy/">коды поступлений</a></div>
...
<div class="author">
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="code-0888">

...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>В Сведениях об операциях и распоряжениях о казначейском платеже указывается детализированный код (семизначный) из группы 0888:</p><table class="ctab"><thead><tr><th>Подкод</th><th>Назначение выплаты</th></tr></thead><tbody><tr><td class="cd">0888 001–004</td><td>общепроизводственные затраты (оплата труда обслуживающего персонала, взносы, амортизация и пр.)</td></tr><tr><td class="cd">0888 005–011</td><td>общехозяйственные затраты (консультации, аренда, связь, коммуналка, обслуживание транспорта)</td></tr><tr><td class="cd">0888 012–016</td><td>административно-управленческие расходы (оплата труда АУП, обучение, прочие)</td></tr><tr><td class="cd">0888 017–022</td><td>оплата работ/услуг сторонних лиц, НДФЛ и взносы по соответствующим группам</td></tr></tbody></table></div>

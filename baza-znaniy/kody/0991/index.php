...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>Окончательные расчёты (экономия) после полного исполнения обязательств по контракту.</p><p>Применяется при выплате экономии, кроме стоимости фактически поставленного и прибыли.</p></div>

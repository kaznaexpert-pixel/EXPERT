...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>Выплата прибыли участнику КС после исполнения обязательств по контракту, если это предусмотрено условиями.</p><p>Применяется при выводе прибыли с лицевого счёта по завершении (этапа) контракта.</p></div>

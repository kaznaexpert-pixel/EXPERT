...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>Уплата НДС, относящегося к операциям по контракту под казначейским сопровождением.</p><p>Отдельный код для НДС. Один из самых частых при санкционировании.</p></div>

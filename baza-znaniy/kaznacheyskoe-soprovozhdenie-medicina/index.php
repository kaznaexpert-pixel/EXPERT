...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>12 мин чтения</span><span class="dot">·</span><span>Обновлено 4 августа 2026</span></div>
    </div>
    ...
    <ul>
      <li>контракты в рамках национального проекта «Здравоохранение» и целевых программ — под сопровождением независимо от цены;</li>
    ...
    <p>Для федеральных бюджетных и автономных учреждений в 2026 году порог сопровождения снижен: авансовые платежи по контрактам от 10 млн рублей, заключаемым за счёт субсидий на задание, на иные цели и на капитальные вложения, подпадают под режим. Это прямо затрагивает крупные закупки медучреждений — томографы, ангиографы, дорогостоящее оборудование и партии медизделий.</p>
    ...
    <p>Содержательно медицинские контракты сопровождаются так же, как остальные целевые: исполнитель открывает лицевой счёт, ведёт <a href="/baza-znaniy/razdelnyy-uchet-po-goskontraktu/">раздельный учёт</a> целевых средств и проходит <a href="/baza-znaniy/poryadok-sankcionirovaniya-rashodov/">санкционирование</a> каждого платежа. Отраслевая специфика проявляется в деталях: подтверждающие документы под поставку медизделий (регистрационные удостоверения, товарные документы), привязка платежа к конкретной позиции спецификации, а при работе с оборудованием — этапность поставки, монтажа и ввода в эксплуатацию.</p>
    ...
    <ul>
      ...
      <li>Готовить под каждый платёж полный пакет документов, подтверждающих поставку медизделий или работ.</li>
    ...
    <div class="takeaways">
      ...
      <ul>
        ...
        <li>Контракты нацпроекта «Здравоохранение» сопровождаются независимо от суммы.</li>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Основания и пороги сопровождения на 2026 год установлены статьёй 5 Закона № 426-ФЗ и главой 24.4 Бюджетного кодекса; по конкретному контракту режим определяется его условиями и источником финансирования. Материал носит справочный характер. Проверено экспертом КазнаЭксперт. Дата актуализации — 4 августа 2026.</p>
    </div>
  </article>

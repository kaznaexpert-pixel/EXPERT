...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p data-ctx="giis-root">Где ПОИБ находится в общей архитектуре — среди подсистем и точек входа ГИИС — показано в обзоре <a href="/baza-znaniy/giis-elektronnyy-byudzhet/">ГИИС «Электронный бюджет»: устройство, подсистемы, адреса</a>.</p>

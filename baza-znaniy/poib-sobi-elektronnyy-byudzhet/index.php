...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>«ПОИБ СОБИ», «СОБИ ФК», «ПОИБ СОБИ ФК», а также адреса sobi.cert.roskazna.ru и poib.sobi.cert.roskazna.ru — это разные обозначения одной подсистемы безопасности Федерального казначейства для управления полномочиями в ГИИС «Электронный бюджет». Вход выполняется по сертификату электронной подписи через защищённое соединение.</p></div>

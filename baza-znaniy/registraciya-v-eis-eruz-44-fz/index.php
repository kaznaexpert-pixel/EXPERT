...
<meta name="description" content="Как поставщику зарегистрироваться в ЕИС и попасть в единый реестр участников закупок (ЕРУЗ) по 44-ФЗ: порядок через Госуслуги, срок 3 года, аккредитация на ЭТП.">
...
<meta property="og:description" content="Пошаговая регистрация поставщика в ЕИС, единый реестр участников закупок (ЕРУЗ), срок три года, документы и автоматическая аккредитация на электронных площадках.">
...
<meta name="twitter:description" content="Пошаговая регистрация поставщика в ЕИС, единый реестр участников закупок (ЕРУЗ), срок три года, документы и автоматическая аккредитация на электронных площадках.">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#srok">Срок регистрации и продление</a></li>
  ...
  <article class="content" id="main">
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">3 года</div><div class="kf__t"><b>Срок</b> — регистрация действует три года; в последние три месяца срока новая регистрация недоступна</div></div>
    ...
    <p>Регистрация полностью электронная и бесплатная. Никакой платы за внесение в ЕРУЗ закон не предусматривает, а попытки взять деньги за «регистрацию» — признак посредников, а не самой системы.</p>
    ...
    <h2 id="srok">Срок регистрации и продление</h2>
    <p>Регистрация в ЕИС действует три года. Ближе к концу срока её нужно проходить заново, и здесь важно не упустить момент: в течение последних трёх месяцев срока действия регистрации подать заявку на новую регистрацию нельзя. Это правило существует, чтобы участник не оказался без действующей регистрации в разгар процедуры, и одновременно вынуждает не откладывать перерегистрацию на последний день.</p>
    <table>
      <thead><tr><th>Параметр</th><th>Значение</th></tr></thead>
      <tbody>
        <tr><td>Срок действия регистрации</td><td>3 года</td></tr>
        <tr><td>Когда нельзя подать новую заявку</td><td>В последние 3 месяца срока действия</td></tr>
        <tr><td>Стоимость</td><td>Бесплатно</td></tr>
        <tr><td>Где обновлять сведения</td><td>В личном кабинете участника в ЕИС</td></tr>
      </tbody>
    </table>
    <p>Практический ориентир: планируйте перерегистрацию заранее, за несколько месяцев до окончания срока, чтобы между старой и новой регистрацией не возникло «окна», в которое нельзя участвовать в закупках.</p>
    ...
    <ul>
      ...
      <li>Учтён трёхлетний срок: перерегистрация запланирована заранее.</li>
    </ul>
    ...
    <div class="faq">
      ...
      <details><summary>Сколько стоит регистрация в ЕРУЗ?</summary><p>Регистрация бесплатна. Платы за внесение сведений в единый реестр участников закупок закон не предусматривает; плату могут брать только посредники за свои услуги, а не сама система.</p></details>
      ...
      <details><summary>Как долго действует регистрация?</summary><p>Регистрация действует три года. В последние три месяца срока подать заявку на новую регистрацию нельзя, поэтому перерегистрацию нужно планировать заранее.</p></details>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 24.2 «Регистрация участников закупок в единой информационной системе и их аккредитация на электронной площадке» (ред. на 26.06.2026).</li>
        ...
        <li id="ref-3">Федеральный закон от 06.04.2011 № 63-ФЗ «Об электронной подписи» (квалифицированная электронная подпись для регистрации).</li>
        <li id="ref-4">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 103 «Реестр контрактов» (следующий этап после заключения контракта).</li>
      </ol>

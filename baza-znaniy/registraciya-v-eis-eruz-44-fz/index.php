...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="faq">
      ...
      <details><summary>Каким законом установлена регистрация в ЕИС?</summary><p>Статьёй 24.2 Закона № 44-ФЗ, а порядок — постановлением Правительства РФ от 27.01.2022 № 60. Прежнее постановление № 1752 от 30.12.2018 утратило силу, и ориентироваться нужно на действующую редакцию.</p></details>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-3">Постановление Правительства РФ от 30.12.2018 № 1752 — утратило силу (приведено для разграничения с действующим порядком).</li>
        <li id="ref-4">Федеральный закон от 06.04.2011 № 63-ФЗ «Об электронной подписи» (квалифицированная электронная подпись для регистрации).</li>
        <li id="ref-5">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 103 «Реестр контрактов» (следующий этап после заключения контракта).</li>
      </ol>

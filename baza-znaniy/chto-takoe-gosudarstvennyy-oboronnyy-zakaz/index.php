...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>17 мин чтения</span><span class="dot">·</span><span>Обновлено 16 июня 2026</span></div>
    </div>
    ...
    <div class="answer reveal">
      <p class="lead-p">Гособоронзаказ (сокращённо ГОЗ, полностью — государственный оборонный заказ) — это задания государства на поставку товаров, выполнение работ и оказание услуг, которые нужны для обороны и безопасности страны, а также для поставок по военно-техническому сотрудничеству с другими странами. Простыми словами: государство заказывает у предприятий технику, вооружение, комплектующие, ремонт, НИОКР и сопутствующие услуги, оплачивает их из федерального бюджета и жёстко контролирует, чтобы деньги дошли по назначению и цена была обоснованной. Базовое определение закреплено в статье 3 Федерального закона от 29.12.2012 № 275-ФЗ «О государственном оборонном заказе».<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></p>
...
<section class="related" aria-labelledby="relTitle">
  ...
  <div class="related__grid">
    <a class="card reveal" href="/baza-znaniy/kaznacheyskoe-soprovozhdenie-goz-275-fz/"><div class="card__cover"><span>КС ГОЗ</span></div><div class="card__body"><span class="card__cat">База знаний</span><h3 class="card__title">Казначейское сопровождение ГОЗ по 275-ФЗ</h3><div class="card__meta">Сопровождение · 20 мин</div></div></a>

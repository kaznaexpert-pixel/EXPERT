...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Главная", "item": "https://kaznaexpert.ru/"}, {"@type": "ListItem", "position": 2, "name": "База знаний", "item": "https://kaznaexpert.ru/baza-znaniy/"}, {"@type": "ListItem", "position": 3, "name": "Условие о КС в контракте", "item": "https://kaznaexpert.ru/baza-znaniy/uslovie-o-kaznacheyskom-soprovozhdenii-v-kontrakte/"}]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [
{"@type": "Question", "name": "Обязательно ли условие о КС в контракте?", "acceptedAnswer": {"@type": "Answer", "text": "Да, если контракт попадает под сопровождение по бюджетному законодательству. Тогда заказчик обязан прописать сопровождение в тексте контракта — это требование закона, а не выбор сторон."}},
...
{"@type": "Question", "name": "Относится ли это к 223-ФЗ?", "acceptedAnswer": {"@type": "Answer", "text": "Да, по тому же принципу: если договор по 223-ФЗ оплачивается целевыми средствами, условие о сопровождении включается аналогично. Закупки за счёт собственных средств заказчика под КС не попадают."}},
...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "DefinedTermSet", "name": "Глоссарий: условие о КС в контракте", "inLanguage": "ru-RU", "hasDefinedTerm": [
{"@type": "DefinedTerm", "name": "Условие о КС", "description": "Набор положений контракта, устанавливающих расчёты через лицевой счёт в казначействе с санкционированием операций."},
...
<meta property="og:description" content="Условие о КС в контракте: когда обязательно, обязательные элементы (лицевой счёт в ТОФК, идентификатор, санкционирование, отчётность, кооперация), образец формулировки и чек-лист проверки.">
...
<meta name="twitter:description" content="Условие о КС в контракте: когда обязательно, обязательные элементы (лицевой счёт в ТОФК, идентификатор, санкционирование, отчётность, кооперация), образец формулировки и чек-лист проверки.">
...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/baza-znaniy/">База знаний</a> › Условие о КС в контракте</nav>

  <aside class="toc" aria-label="Содержание">
    <div class="toc__label">Содержание</div>
    <ul class="toc__list" id="tocList">
      <li><a href="#glavnoe">Когда условие о КС включается в контракт</a></li>
      ...
      <li><a href="#223-subsidii">Условие о КС для 223-ФЗ и субсидий</a></li>
  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        <li><a href="#glavnoe">Когда условие о КС включается в контракт</a></li><li><a href="#pravovaya">Правовая база</a></li><li><a href="#sostav">Что должно быть в условии о сопровождении</a></li><li><a href="#obrazec">Образец формулировки условия</a></li><li><a href="#chto-menyaet">Что условие меняет для исполнителя</a></li><li><a href="#proverit">Как проверить условие перед подписанием</a></li><li><a href="#223-subsidii">Условие о КС для 223-ФЗ и субсидий</a></li><li><a href="#dop">Дополнительные условия и приложения</a></li><li><a href="#riski">Чем грозит отсутствие или неточность условия</a></li><li><a href="#cheklist">Чек-лист: что проверить в условии</a></li><li><a href="#otvetstvennost">Условие о сопровождении и режим расходования</a></li><li><a href="#oshibki">Частые ошибки</a></li><li><a href="#keys">Пример из практики</a></li><li><a href="#glossary">Глоссарий</a></li><li><a href="#faq">Частые вопросы</a></li>
      </ol>
    </details>
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        <div class="kf"><div class="kf__n">обязат.</div><div class="kf__t"><b>Когда</b> — если контракт под КС, условие в тексте обязательно</div></div>
    ...
    <h2 id="glavnoe">Когда условие о КС включается в контракт</h2>
    ...
    <table>
      <caption>Обязательные элементы условия о КС в контракте</caption>
    ...
    <table>
      <caption>Контракт без сопровождения и с условием о КС</caption>
      <tr><th>Параметр</th><th>Обычный контракт</th><th>Контракт с условием о КС</th></tr>
      ...
      <tr><td>Кооперация</td><td>Свободные договоры</td><td>Условие о КС в договорах с соисполнителями</td></tr>
    </table>
    ...
    <h2 id="223-subsidii">Условие о КС для 223-ФЗ и субсидий</h2>
    ...
    <table>
      <caption>Условие о КС в разных типах договоров</caption>
    ...
    <table>
      <caption>Последствия проблем с условием о КС</caption>
    ...
    <table>
      <caption>Типовые ошибки при работе с условием о КС</caption>
    ...
    <h2 id="cheklist">Чек-лист: что проверить в условии о КС</h2>
    ...
    <dl class="gloss">
      <div><dt>Условие о КС</dt><dd>Набор положений контракта, устанавливающих расчёты через лицевой счёт в казначействе с санкционированием операций.</dd></div>
    ...
    <div class="faq">
      <details open><summary>Обязательно ли условие о КС в контракте?</summary><p>Да, если контракт попадает под сопровождение по бюджетному законодательству. Тогда заказчик обязан прописать сопровождение в тексте контракта — это требование закона, а не выбор сторон.</p></details>
      ...
      <details><summary>Относится ли это к 223-ФЗ?</summary><p>Да, по тому же принципу: если договор по 223-ФЗ оплачивается целевыми средствами, условие о сопровождении включается аналогично. Закупки за счёт собственных средств заказчика под КС не попадают.</p></details>

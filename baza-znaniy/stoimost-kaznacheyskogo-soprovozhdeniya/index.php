...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Стоимость казначейского сопровождения в 2026 году зависит от объёма работ по контракту. Ориентировочные фиксированные цены: резервирование казначейского счёта — 19 000 ₽, открытие лицевого счёта под ключ — 29 000 ₽, ведение контракта — от 55 000 ₽ (или 89 000 ₽ в месяц), спасение контракта при возвратах и блокировках — от 29 000 ₽, аудит сопровождения — 160 000 ₽, восстановление раздельного учёта — от 99 000 ₽. Цены не зависят от региона и фиксируются в договоре до начала работ; точную стоимость называют после анализа контракта.</div>
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">Спасение контракта</div><div class="kf__t"><b>от 29 000 ₽</b> — Срочная помощь при возвратах и блокировках; аудит сопровождения — 160 000 ₽, восстановление учёта — от 99 000 ₽</div></div>
      </div>
    </section>

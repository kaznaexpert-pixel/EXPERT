...
<meta name="description" content="Сколько стоит казначейское сопровождение в 2026 году: резервирование счёта 19 000 ₽, открытие 29 000 ₽, ведение от 55 000 ₽, спасение контракта от 29 000 ₽.">
<meta name="author" content="Ярослав Михайлов">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
<meta name="theme-color" content="#F4F1EB" media="(prefers-color-scheme: light)">
<meta name="theme-color" content="#141310" media="(prefers-color-scheme: dark)">
<!-- PROD: canonical и og:url ОБЯЗАТЕЛЬНО менять под URL каждой статьи -->
<link rel="canonical" href="https://kaznaexpert.ru/baza-znaniy/stoimost-kaznacheyskogo-soprovozhdeniya/">
...
{"@context": "https://schema.org", "@type": "Article", "headline": "Стоимость казначейского сопровождения: из чего складывается цена в 2026 году", "description": "Сколько стоит казначейское сопровождение в 2026 году: резервирование счёта 19 000 ₽, открытие 29 000 ₽, ведение от 55 000 ₽, спасение контракта от 29 000 ₽.", "inLanguage": "ru-RU", "datePublished": "2026-08-10", "dateModified": "2026-08-10", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}}, "image": "https://kaznaexpert.ru/img/og-image.png", "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/stoimost-kaznacheyskogo-soprovozhdeniya/"}}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Стоимость казначейского сопровождения в 2026 году зависит от объёма работ по контракту. Ориентировочные фиксированные цены: резервирование казначейского счёта — 19 000 ₽, открытие лицевого счёта под ключ — 29 000 ₽, ведение контракта — от 55 000 ₽ (или 89 000 ₽ в месяц), спасение контракта при возвратах и блокировках — от 29 000 ₽, аудит и восстановление раздельного учёта — от 99 000 ₽. Цены не зависят от региона и фиксируются в договоре до начала работ; точную стоимость называют после анализа контракта.</div>

    <section class="keyfacts grain" aria-label="Ключевые факты">
      <h2>Коротко о главном</h2>
      <div class="keyfacts__grid">
        <div class="kf"><div class="kf__n">Резервирование счёта</div><div class="kf__t"><b>19 000 ₽</b> — Резервирование казначейского счёта заранее, до подписания контракта</div></div>
        <div class="kf"><div class="kf__n">Открытие счёта</div><div class="kf__t"><b>29 000 ₽</b> — Открытие лицевого счёта в территориальном органе казначейства под ключ</div></div>
        <div class="kf"><div class="kf__n">Ведение контракта</div><div class="kf__t"><b>от 55 000 ₽</b> — Сопровождение контракта: сведения, распоряжения, санкционирование (или 89 000 ₽/мес)</div></div>
        <div class="kf"><div class="kf__n">Спасение контракта</div><div class="kf__t"><b>от 29 000 ₽</b> — Срочная помощь при возвратах и блокировках; аудит и восстановление учёта — от 99 000 ₽</div></div>
      </div>
    </section>

    <h2 id="korotkiy-otvet">Короткий ответ: сколько стоит казначейское сопровождение</h2>
    <div class="answer reveal"><p>Казначейское сопровождение стоит от 19 000 ₽ за отдельную операцию до фиксированной цены за полное ведение контракта. Базовые ориентиры на 2026 год: резервирование казначейского счёта — 19 000 ₽, открытие лицевого счёта под ключ — 29 000 ₽, ведение контракта — от 55 000 ₽ (или 89 000 ₽ в месяц), спасение контракта — от 29 000 ₽, аудит и восстановление раздельного учёта — от 99 000 ₽. Цены не зависят от региона и фиксируются в договоре.</p></div>
    ...
    <table>
      ...
      <tr><td>Резервирование счёта</td><td>Резервирование казначейского счёта заранее, до подписания контракта</td><td>19 000 ₽</td></tr>
      <tr><td>Открытие счёта под ключ</td><td>Документы, включение в Сводный реестр, открытие лицевого счёта за 2 рабочих дня</td><td>29 000 ₽</td></tr>
      <tr><td>Ведение контракта</td><td>Сведения об операциях, распоряжения, санкционирование платежей, отчётность</td><td>от 55 000 ₽ (или 89 000 ₽/мес)</td></tr>
      <tr><td>Спасение контракта</td><td>Диагностика возвратов и блокировок, восстановление до исполнения</td><td>от 29 000 ₽</td></tr>
      <tr><td>Аудит и восстановление учёта</td><td>Проверка сопровождения, восстановление раздельного учёта</td><td>от 99 000 ₽</td></tr>
    </table>
    ...
    <div class="faq">
      ...
      <details><summary>Сколько стоит открыть казначейский счёт?</summary><p>Открытие лицевого счёта под ключ — 29 000 ₽: подготовка документов, включение в Сводный реестр и открытие счёта за два рабочих дня.</p></details>
      <details><summary>Сколько стоит ведение казначейского счёта?</summary><p>Ведение контракта — от 55 000 ₽ за весь срок или 89 000 ₽ в месяц: сведения об операциях, распоряжения, санкционирование платежей и отчётность без лимита операций.</p></details>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Цены ориентировочные и фиксируются в договоре по итогам анализа конкретного контракта. Материал носит справочный характер. Проверено экспертом КазнаЭксперт. Дата актуализации — 10 августа 2026.</p>
    </div>
  </article>
...
<section class="kz-sub" aria-labelledby="kzSubTitle" data-source="stoimost-kaznacheyskogo-soprovozhdeniya">
  <style>

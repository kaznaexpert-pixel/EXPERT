...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__uchet-rashodov-na-usn-pri-ks-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__uchet-rashodov-na-usn-pri-ks-16x9.jpg">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <p class="lead-p">Упрощенец на сопровождаемом контракте признаёт расход по кассовому методу — на дату списания денег с лицевого счёта (пункт 2 статьи 346.17 НК) и только если затрата названа в закрытом перечне пункта 1 статьи 346.16. Санкционирование казначейства подтверждает целевой характер платежа, но само по себе расход для налога не создаёт.</p>
    </div>
    ...
    <h3 id="menyaetsya-disciplina">Что меняется в дисциплине учёта при сопровождении</h3>
    ...
    <h3 id="dva-kontrolyora">Чем небрежность в документах грозит упрощенцу</h3>
    ...
    <h3 id="tri-daty">Какие три даты нельзя путать при оплате с лицевого счёта</h3>
    ...
    <h3 id="oplata-ne-dostatochno">Достаточно ли одной оплаты для признания расхода</h3>
    ...
    <h3 id="smeta-po-perechnyu">Зачем раскладывать смету контракта по перечню 346.16</h3>
    ...
    <h3 id="nalogi-v-rashodah">Как учитываются уплаченные налоги и сборы</h3>
    ...
    <h3 id="vid-scheta-ne-vliyaet">Зависят ли правила признания от вида счёта</h3>
    ...
    <h3 id="pervichka-dva-adresata">Какие документы работают и для казначейства, и для налоговой</h3>
    ...
    <h3 id="vypiska-data-oplaty">Чем упрощенец подтверждает дату оплаты</h3>
    ...
    <h3 id="razdelnyy-uchet-obyazan">Обязан ли упрощенец вести раздельный учёт по контракту</h3>
    ...
    <h3 id="kudir-vs-razdelnyy">Чем КУДиР отличается от раздельного учёта</h3>
    ...
    <h3 id="minimalnyy-nalog">Что платить, если расходы съели почти всю выручку</h3>
    ...
    <h3 id="perenos-ubytka">Можно ли перенести убыток по контракту на будущий год</h3>
    ...
    <h3 id="stavki-i-limity">Какие ставки и лимиты действуют на упрощёнке</h3>
    ...
    <h3 id="nds-i-goskontrakt">Как порог НДС влияет на исполнителя госконтракта</h3>
    ...
    <h3 id="porog-nds-dalshe">До какого уровня снизится порог НДС</h3>
    ...
    <p data-ctx="kontr-0909:nds">Для организаций на общей системе вопрос вычета НДС по целевым средствам решается статьёй 170 НК — контракт даёт полный вычет, субсидия его ограничивает; разбор в статье <a href="/baza-znaniy/razdelnyy-uchet-nds-pri-ks/">раздельный учёт НДС при казначейском сопровождении</a>.</p>

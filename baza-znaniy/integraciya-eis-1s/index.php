...
{"@context": "https://schema.org", "@type": "Article", "headline": "Интеграция ЕИС и 1С: обмен для электронного актирования и работа с казначейскими системами", "description": "Как связать 1С с ЕИС: обмен для электронного актирования из «1С:Бухгалтерии 8» КОРП, ИГК в УПД, обмен с казначейством в форматах ФК и типовые ошибки настройки.", "inLanguage": "ru-RU", "datePublished": "2026-07-02", "dateModified": "2026-07-02", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}}, "image": "https://kaznaexpert.ru/img/og-image.png", "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/integraciya-eis-1s/"}}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <article class="content" id="main">
    <div class="hero">
      ...
      <div class="eyebrow">База знаний · Системы и сервисы <span class="fresh">Актуально на 2026</span></div>
    ...
    <ul>
      ...
      <li><b>Настроить организацию и подпись.</b> Сертификат квалифицированной подписи должен быть установлен и привязан; реквизиты организации в 1С — совпадать с данными регистрации в ЕИС (ЕРУЗ).</li>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 94, части 13–14 — электронное актирование: документ о приёмке в ЕИС (ред. от 28.12.2025).</li>

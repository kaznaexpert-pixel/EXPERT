...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <table>
      ...
      <tr><td>Не подключён компонент казначейского сопровождения</td><td>Проверить подключение организации к КС</td></tr>
    ...
    <table>
      ...
      <tr><td>Сумма и назначение платежа</td><td>Сумма цифрами; назначение — с идентификаторами (ИГК при КС)</td></tr>
    ...
    <table>
      ...
      <tr><td>4. Проставить коды и основание</td><td>Указать ИГК (при КС), коды цели/КБК, документ-основание</td></tr>
    ...
    <table>
      ...
      <tr><td>Несоответствие назначения платежа</td><td>Уточнить формулировку, добавить ИГК и код цели при КС</td></tr>
      ...
      <tr><td>Не пройден контроль санкционирования</td><td>Устранить замечание по сведениям/обоснованию (при КС)</td></tr>
    ...
    <table>
      ...
      <tr><td>Не указали ИГК в назначении платежа</td><td>Проставлять идентификатор контракта при КС в каждом платеже</td></tr>
    ...
    <div class="takeaways">
      ...
      <ol>
        ...
        <li>При КС в назначении платежа обязателен ИГК; распоряжение проходит санкционирование.</li>
      </ol>
    </div>
    ...
    <dl class="gloss">
      ...
      <div><dt>ИГК</dt><dd>Идентификатор государственного контракта — указывается при КС.</dd></div>
    </dl>
    ...
    <div class="faq">
      ...
      <details><summary>Кто поможет с распоряжениями и платежами при КС?</summary><p>Подготовку распоряжений, проверку реквизитов и проведение платежей можно передать на сопровождение. Эксперт проверит назначение платежа и ИГК и проведёт операции. Оставьте заявку — разберём вашу ситуацию.</p></details>
    </div>

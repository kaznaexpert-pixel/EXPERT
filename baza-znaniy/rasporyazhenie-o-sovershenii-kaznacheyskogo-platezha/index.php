...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию. Формы и реквизиты распоряжений устанавливаются нормативными актами Федерального казначейства и могут уточняться; названия полей в конкретном ПО различаются. Проверено экспертом КазнаЭксперт. Дата актуализации — 10 августа 2026.</p>
    </div>

...
<title>Распоряжение о совершении казначейского платежа: формы и сроки</title>
<meta name="description" content="Где формируется распоряжение о совершении казначейского платежа: ЕИС или «Электронный бюджет», формы по КФД, уточнение платежа, сроки исполнения и возврат.">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию. Формы и реквизиты распоряжений устанавливаются нормативными актами Федерального казначейства и могут уточняться; названия полей в конкретном ПО различаются. Проверено экспертом КазнаЭксперт. Дата актуализации — 21 августа 2026.</p>
    </div>

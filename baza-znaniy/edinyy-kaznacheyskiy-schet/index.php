...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Единый казначейский счёт (ЕКС) — это счёт Федерального казначейства в Банке России (балансовый счёт 40102), на котором аккумулируются средства всей бюджетной системы; ведёт его Федеральное казначейство. От счёта участника казначейского сопровождения ЕКС отличается ролью: участнику открывают лицевой счёт с его средствами, а ЕКС — общий счёт системы, к которому эти лицевые счета привязаны. В платёжном поручении ЕКС указывают в поле 15 «Счёт банка получателя», а в поле 17 — казначейский счёт, начинающийся с 03.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></div>

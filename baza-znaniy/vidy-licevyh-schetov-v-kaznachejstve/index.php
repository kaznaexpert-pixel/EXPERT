  ...
  <article class="content" id="main">
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">Код 71</div><div class="kf__t"><b>КС</b> — лицевой счёт участника казначейского сопровождения</div></div>
    ...
    <table>
      ...
      <tr><td>71</td><td>Участник казначейского сопровождения</td><td>Учёт операций с целевыми средствами по контрактам и соглашениям под КС</td></tr>
    </table>
    ...
    <ul class="check">
      <li><b>Кому.</b> Юридическим лицам, ИП и иным неучастникам бюджетного процесса — исполнителям контрактов и получателям целевых средств под КС.</li>
    ...
    <ol class="howto">
      ...
      <li><b>Сопоставьте с кодом.</b> Для средств под КС — код 71; для иной субсидии получателю из бюджета — код 41; для казённого учреждения — код 03.</li>
    ...
    <p>Если средства идут под казначейское сопровождение, вам почти наверняка нужен счёт 71. Проверить, попадаете ли вы под КС, помогает материал о том, <a href="/baza-znaniy/kto-popadaet-pod-kaznacheyskoe-soprovozhdenie/">кто попадает под казначейское сопровождение</a>.</p>
    ...
    <div class="faq">
      ...
      <details><summary>Какой лицевой счёт нужен исполнителю госконтракта под КС?</summary><p>Как правило, лицевой счёт с кодом 71. Его резервируют и открывают в ТОФК через ГИИС «Электронный бюджет». Если контракт под банковским, а не казначейским сопровождением, открывают отдельный счёт в уполномоченном банке, а не лицевой счёт.</p></details>
...
<section class="related" aria-labelledby="relTitle">
  ...
  <div class="related__grid">
    ...
    <a class="card reveal" href="/baza-znaniy/chto-takoe-kaznacheyskoe-soprovozhdenie/"><div class="card__cover"><span>КС</span></div><div class="card__body"><span class="card__cat">База знаний</span><h3 class="card__title">Казначейское сопровождение: что это и кому нужно</h3><div class="card__meta">Пиллар · 20 мин</div></div></a>
  </div>
</section>

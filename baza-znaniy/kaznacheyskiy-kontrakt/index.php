...
{"@type": "Question", "name": "Нужно ли включать условия о КС в договоры с субподрядчиками?", "acceptedAnswer": {"@type": "Answer", "text": "Да, если средства соисполнителей подлежат сопровождению: лицевые счета, ИГК, раздельный учёт и порядок расчётов транслируются вниз по цепочке."}},
  ...
  <article class="content" id="main">
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        <div class="kf"><div class="kf__n">обиход</div><div class="kf__t"><b>Термин</b> — в законе его нет, юридически это контракт с условием о КС</div></div>
    ...
    <p>Если признаков в проекте контракта нет, но параметры сделки попадают под случаи сопровождения (по ст. 5 закона о бюджете на 2026 год: авансы по госконтрактам от 100 млн ₽, контракты БУ/АУ за счёт субсидий от 10 млн ₽, единственный поставщик и ГОЗ свыше 3 млн ₽ и др.) — условие о КС появится: без него заказчик нарушит бюджетное законодательство. Полный перечень случаев и порогов — в разборе <a href="/baza-znaniy/kto-popadaet-pod-kaznacheyskoe-soprovozhdenie/">«Кто попадает под казначейское сопровождение»</a>.<a class="fn" href="#ref-2" aria-label="Источник 2">[2]</a></p>
    ...
    <table>
      ...
      <tr><td>Госконтракт по 44-ФЗ</td><td>Классический случай: условие о КС включается по требованиям БК и закона о бюджете; ИГК, лицевой счёт 71, санкционирование</td></tr>
    ...
    <table>
      ...
      <tr><td>«Казначейские» условия не включены в договоры субподряда</td><td>Цепочка расчётов блокируется</td><td>Транслировать условия КС вниз по кооперации</td></tr>
    </table>
    ...
    <div class="takeaways">
      ...
      <ol>
        ...
        <li>Признаки: условие о КС, требование открыть лицевой счёт 71 в ТОФК, ИГК в реквизитах.</li>
        ...
        <li>С 01.01.2026 за нарушения при КС действуют штрафы КоАП: ст. 15.37.1 (раздельный учёт, до 500 тыс. ₽ для юрлиц) и ст. 15.49 (срок утверждения сведений).</li>
    ...
    <div class="faq">
      ...
      <details><summary>Нужно ли включать условия о КС в договоры с субподрядчиками?</summary><p>Да, если средства соисполнителей тоже подлежат сопровождению: лицевые счета, ИГК, раздельный учёт и порядок расчётов транслируются вниз по цепочке кооперации.</p></details>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-2">Федеральный закон от 28.11.2025 № 426-ФЗ «О федеральном бюджете на 2026 год…», ст. 5 (случаи и пороги КС в 2026 году) — <a href="https://www.consultant.ru/document/cons_doc_LAW_520057/" target="_blank" rel="noopener">consultant.ru</a></li>

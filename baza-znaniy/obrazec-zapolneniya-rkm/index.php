...
<meta name="description" content="Как заполнить РКМ по ГОЗ: разбор комплекта на условном примере — трудоёмкость, зарплата, материалы, накладные, прибыль и цена. Проверка полноты перед сдачей.">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#polnota">Полнота комплекта</a></li>
        <li><a href="#peredacha">Как передать комплект</a></li>
        <li><a href="#keys-vozvrat">Ситуация: возврат комплекта</a></li>
        <li><a href="#zamechaniya">Ответ на замечания</a></li>
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>13 мин чтения</span><span class="dot">·</span><span>Обновлено 8 сентября 2026</span></div>
    </div>
    ...
    <p data-ctx="radar-0917:osvoenie">Если изделие осваивается заново — возобновление после перерыва от двух лет или рост выпуска в два раза, — между шагами 3 и 4 появляется форма № 17: как рассчитать норму погашения на единицу и что в неё включать — в статье <a href="/baza-znaniy/zatraty-na-podgotovku-i-osvoenie-proizvodstva-goz/">затраты на подготовку и освоение производства в РКМ</a>.</p>
    ...
    <h2 id="polnota">Полнота комплекта: что проверяют раньше цифр</h2>
    <p>Цифры смотрят вторыми. Сначала сверяют состав: пункт 109 Положения № 1465 в редакции февраля 2026 года приравнивает неполный объём запрошенной информации к неподаче — предложение о цене считается непредставленным.<a class="fn" href="#ref-4" aria-label="Источник 4">[4]</a> Поэтому пропущенная расшифровка обходится дороже спорной цифры внутри формы.</p>

    <h3 id="polnota-shagi">Пять шагов перед отправкой</h3>
    <ol>
      <li><b>Зафиксируйте состав письменно.</b> Запрос заказчика или военного представительства с перечнем форм — основание комплекта; устная договорённость таким основанием не является.</li>
      <li><b>Сверьте перечень с приложением № 5.</b> Формы без индекса — на год, с индексом «д» — на несколько лет; для НИР и ОКР свои версии бланков.</li>
      <li><b>Проверьте разовые формы.</b> Общезаводские нормативы могли уйти заказчику раньше — уточните, нужны ли они повторно в этом предложении.</li>
      <li><b>Соберите опись.</b> Нумерация форм, количество листов, дата подписания каждой — это документ, который потом доказывает дату подачи.</li>
      <li><b>Проверьте редакцию бланков.</b> С 1 марта 2026 года применяется редакция приказа № 995/22 с изменениями приказа ФАС России от 18.12.2025 № 1113/25.<a class="fn" href="#ref-5" aria-label="Источник 5">[5]</a></li>
    </ol>
<p data-ctx="auto-ctx:p77-kalk-check">Перед передачей комплекта полезно пройти отдельный <a href="/baza-znaniy/planovaya-i-otchetnaya-kalkulyaciya-goz/#checklist">чек-лист самопроверки по калькуляциям</a>: итоги расшифровок против строк, трудоёмкость против зарплаты, нормативы против применённых процентов.</p>

    
    <h2 id="peredacha">Как передать комплект: носитель, форматы, опись</h2>
    <p>Комплект сдаётся в двух видах: бумажный экземпляр с подписями и электронная версия. Требование к электронному носителю в феврале 2026 года переписали — теперь это съёмные оптические машинные носители информации с функцией однократной записи.<a class="fn" href="#ref-4" aria-label="Источник 4">[4]</a> Перезаписываемый диск и флешка требованию не отвечают.</p>

    <h3 id="peredacha-formaty">Два файла на одном диске</h3>
    <p>Электронная часть — это копии подписанного комплекта и живые таблицы с формулами. Проверяющий пересчитывает итоги, поэтому таблица с числами, вбитыми руками вместо расчёта, вызывает вопросы быстрее любой другой ошибки.</p>

    <h3 id="peredacha-data">Чем подтверждается дата подачи</h3>
    <p>Дату фиксируют сопроводительное письмо с описью, отметка о приёме и реестр вложений. Это не формальность: срок представления обосновывающих документов суды считают самостоятельным обязательством по контракту, а неустойку за его нарушение — договорной.<a class="fn" href="#ref-6" aria-label="Источник 6">[6]</a></p>
    ...
    <table>
      ...
      <tr><td>Носитель</td><td>Бумажный комплект плюс электронный вид на съёмном оптическом носителе с однократной записью — копии и живые таблицы</td></tr>
    </table>
    ...
    <h2 id="keys-vozvrat">Типовая ситуация: комплект признали непредставленным</h2>
    <p>Пример обобщённый, собран из практики сопровождения и приведён как иллюстрация — без обещания результата по конкретному контракту.</p>
    <p>Исполнитель отправил предложение о цене на серийное изделие: калькуляция, расшифровки материалов, расчёт прибыли. Расчёт трудоёмкости по одной операции не приложил — счёл цифру очевидной. Ответ пришёл не как замечание, а как возврат: предложение с неполным объёмом информации считается непредставленным, значит, срок подачи не соблюдён.</p>
    <p>Разбор ситуации обычно упирается в две вещи: не был письменно зафиксирован запрошенный состав документов и не велась опись вложений, поэтому спорить о дате подачи оказалось нечем.</p>

    <h2 id="zamechaniya">Что делать, когда пришли замечания</h2>
    <p>Замечание и возврат — разные события. Замечание касается содержания формы: цифра не подтверждена, норматив не совпал, база прибыли посчитана не от того разреза. Возврат означает, что комплекта как юридического факта не было.</p>
    <ul>
      <li><b>На замечание</b> отвечают адресно: правят конкретную форму, прикладывают документ-основание и поясняют расхождение в записке.</li>
      <li><b>На возврат</b> подают комплект заново — целиком, с новой описью и новой датой, а не «дополнением к ранее направленному».</li>
      <li><b>Спорные затраты</b> фиксируют письменно: позиция исполнителя с расчётом важнее устного согласования, если дело дойдёт до проверки цены.</li>
    </ul>
...
<details><summary>Что проверить в комплекте в последнюю очередь?</summary><p>Сквозную сверку: итоги расшифровок равны строкам калькуляции, заработная плата выведена из трудоёмкости, нормативы в форме № 22 совпадают с применёнными, строка 1700 раскрыта на привнесённые и собственные затраты, прибыль не превышает предел, бланки взяты из действующей редакции приказа, а период в шапке соответствует форме.</p></details>
<details><summary>Чем возврат комплекта отличается от замечаний?</summary><p>Замечание относится к содержанию конкретной формы, и его отрабатывают адресно. Возврат означает, что предложение о цене считается непредставленным по пункту 109 Положения № 1465: комплект подают заново целиком, с новой описью и новой датой.</p></details>
<details><summary>На каком носителе сдавать электронную часть комплекта в 2026 году?</summary><p>На съёмном оптическом машинном носителе информации с функцией однократной записи — так пункт 76 Положения № 1465 сформулирован после изменений от 14.02.2026. Флешка и перезаписываемый диск не подходят, бумажный экземпляр обязателен.</p></details>
<details><summary>Чем подтвердить дату подачи РКМ?</summary><p>Сопроводительным письмом с описью вложений и отметкой о приёме. Это важно, потому что срок представления обосновывающих документов суды считают самостоятельным обязательством по контракту, а неустойку за просрочку — договорной.</p></details>
<details><summary>Можно ли досылать недостающую форму отдельным письмом?</summary><p>Если комплект вернули как непредставленный, дослать одну форму недостаточно: предложение о цене подаётся заново в полном составе. Отдельным документом отрабатывают только замечания к уже принятому комплекту.</p></details></div>

...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Чем КС-2 отличается от КС-3?", "acceptedAnswer": {"@type": "Answer", "text": "КС-2 — акт о приёмке выполненных работ: он подтверждает объём и виды фактически выполненных за период работ. КС-3 — справка о стоимости работ и затрат: она показывает сумму к оплате за период и нарастающим итогом. КС-3 составляется на основании КС-2, поэтому цифры в них должны сходиться."}}, {"@type": "Question", "name": "Обязательно ли применять формы КС-2 и КС-3 в 2026 году?", "acceptedAnswer": {"@type": "Answer", "text": "Строго формально — нет: с 2013 года унифицированные формы первички не обязательны (ст. 9 Федерального закона № 402-ФЗ). Но их применение часто прямо предусмотрено контрактом, и тогда они обязательны по условиям договора; в строительстве КС-2 и КС-3 остаются фактическим стандартом."}}, {"@type": "Question", "name": "Как казначейство санкционирует оплату по КС-2 и КС-3?", "acceptedAnswer": {"@type": "Answer", "text": "Казначейство сверяет объём выполненных работ по КС-2, сумму к оплате по КС-3, соответствие оплаты условиям контракта и смете, а также реквизиты платежа в распоряжении — ИГК, код направления расходования, назначение. При совпадении оплата санкционируется."}}, {"@type": "Question", "name": "Нужно ли оформлять КС-2 и КС-3, если работает электронное актирование в ЕИС?", "acceptedAnswer": {"@type": "Answer", "text": "Если оформлен структурированный электронный документ о приёмке в ЕИС (ч. 13 ст. 94 № 44-ФЗ), дополнительно составлять бумажные КС-2 и КС-3 не требуется. Но содержательные данные об объёмах и стоимости переносятся в электронный документ и всё равно сверяются казначейством."}}, {"@type": "Question", "name": "Почему казначейство возвращает распоряжение по строительным работам?", "acceptedAnswer": {"@type": "Answer", "text": "Чаще всего — из-за расхождений в КС-2 и КС-3, сломанного нарастающего итога, несоответствия работ смете и контракту, неверного кода направления расходования или небрежного назначения платежа. Это возврат на доработку, а не отказ; после исправления распоряжение подают заново."}}, {"@type": "Question", "name": "Что такое нарастающий итог в КС-3 и почему он важен?", "acceptedAnswer": {"@type": "Answer", "text": "Это стоимость выполненных работ с начала строительства и с начала года. Казначейство сверяет его с ранее оплаченным: если сумма не бьётся, возникает расхождение и распоряжение возвращают. Поэтому КС-3 ведут как единую цепочку от периода к периоду."}}, {"@type": "Question", "name": "Какие ещё формы есть кроме КС-2 и КС-3?", "acceptedAnswer": {"@type": "Answer", "text": "Постановлением Госкомстата № 100 утверждены также журнал учёта выполненных работ (КС-6а), общий журнал работ (КС-6), акт приёмки (КС-11) и акт приёмки законченного строительством объекта приёмочной комиссией (КС-14). Для периодических расчётов чаще всего используют КС-2 и КС-3."}}, {"@type": "Question", "name": "Кто подписывает КС-2 и КС-3?", "acceptedAnswer": {"@type": "Answer", "text": "Документы подписывают уполномоченные представители подрядчика и заказчика. Важно проверить полномочия подписантов, а при электронной приёмке — наличие действующей квалифицированной электронной подписи."}}]}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#kak">Как заполнить КС-2 и КС-3 без расхождений</a></li>
  ...
  <article class="content" id="main">
    ...
    <p>Обе формы утверждены Постановлением Госкомстата России от 11.11.1999 № 100 — тем же, что ввело журнал работ КС-6 и акты приёмки завершённого объекта КС-11 и КС-14. КС-2 и КС-3 применяют чаще всего, потому что именно они закрывают периодические расчёты по ходу стройки.</p>
    ...
    <p>КС-2 и КС-3 — не единственные документы стройки. Тем же Постановлением Госкомстата № 100 введён набор форм, которые сопровождают объект на разных стадиях. Знать их полезно: при сопровождении казначейство иногда запрашивает подтверждающие документы помимо акта и справки, а при проверке эти формы восстанавливают полную картину.</p>
    <table>
      <thead><tr><th>Форма</th><th>Назначение</th></tr></thead>
      <tbody>
        <tr><td>КС-6 — общий журнал работ</td><td>хронология выполнения всех работ на объекте от начала до завершения</td></tr>
        <tr><td>КС-6а — журнал учёта выполненных работ</td><td>накопительный учёт объёмов по видам работ, на основе которого формируют КС-2</td></tr>
        <tr><td>КС-11 — акт приёмки законченного строительством объекта</td><td>приёмка объекта заказчиком после завершения строительства</td></tr>
        <tr><td>КС-14 — акт приёмочной комиссии</td><td>приёмка законченного объекта приёмочной комиссией (итоговый документ)</td></tr>
      </tbody>
    </table>
    ...
    <dl class="gloss">
      ...
      <div><dt>Постановление Госкомстата № 100</dt><dd>документ от 11.11.1999, которым утверждены унифицированные формы первичного учёта в строительстве, включая КС-2 и КС-3.</dd></div>
    </dl>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Постановление Госкомстата России от 11.11.1999 № 100 — унифицированные формы первичной учётной документации в строительстве (КС-2 — акт о приёмке выполненных работ, КС-3 — справка о стоимости работ и затрат, а также КС-6, КС-11, КС-14).</li>
        ...
        <li id="ref-3">Гражданский кодекс РФ, ст. 720, 753 — приёмка результата работ по акту, подписанному сторонами. <a href="https://www.consultant.ru/document/cons_doc_LAW_5142/" target="_blank" rel="noopener">КонсультантПлюс</a></li>

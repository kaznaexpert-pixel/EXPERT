...
<meta name="description" content="Казначейское сопровождение муниципальных контрактов: когда применяется, кто решает и кто сопровождает средства местного бюджета и чем отличается от федерального КС.">
...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/baza-znaniy/">База знаний</a> › КС муниципальных контрактов</nav>

  <aside class="toc" aria-label="Содержание">
    <div class="toc__label">Содержание</div>
    <ul class="toc__list" id="tocList">
      <li><a href="#chto-takoe">Что такое КС муниципальных контрактов</a></li>
      <li><a href="#pravovaya-osnova">Правовая база: статьи 242.26 и 242.23 БК</a></li>
      <li><a href="#kto-reshaet">Кто решает, что контракт под КС</a></li>
      <li><a href="#kto-soprovozhdaet">Кто сопровождает: финорган или казначейство</a></li>
      <li><a href="#kakie-kontrakty">Какие муниципальные контракты попадают под КС</a></li>
      ...
      <li><a href="#avansy">Авансы по муниципальным контрактам и КС</a></li>
  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        <li><a href="#chto-takoe">Что такое КС муниципальных контрактов</a></li><li><a href="#pravovaya-osnova">Правовая база: статьи 242.26 и 242.23 БК</a></li><li><a href="#kto-reshaet">Кто решает, что контракт под КС</a></li><li><a href="#kto-soprovozhdaet">Кто сопровождает: финорган или казначейство</a></li><li><a href="#kakie-kontrakty">Какие муниципальные контракты попадают под КС</a></li><li><a href="#otlichie">Отличие от федерального казначейского сопровождения</a></li><li><a href="#kak-rabotaet">Как это работает для подрядчика</a></li><li><a href="#avansy">Авансы по муниципальным контрактам и КС</a></li><li><a href="#kontrol">Что проверяют при санкционировании</a></li><li><a href="#howto">Что делать исполнителю: порядок</a></li><li><a href="#region-munic">Региональный и муниципальный уровень</a></li><li><a href="#oshibki">Частые вопросы и заблуждения</a></li><li><a href="#keys">Пример из практики</a></li><li><a href="#glossary">Глоссарий</a></li><li><a href="#faq">Частые вопросы</a></li>
      </ol>
    </details>

    <div class="tldr">Казначейское сопровождение муниципальных контрактов — это контроль целевого использования средств местного бюджета, переданных по муниципальному контракту. Его основа — статья 242.26 Бюджетного кодекса. Случаи, когда контракт попадает под КС, определяет муниципальный правовой акт представительного органа о местном бюджете и решение местной администрации, а сопровождает средства финансовый орган муниципалитета либо Федеральное казначейство, если ему переданы соответствующие функции. Единого федерального порога для муниципального уровня нет — случаи устанавливаются на месте.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></div>

    <section class="keyfacts grain" aria-label="Ключевые факты">
      <h2>Коротко о главном</h2>
      <div class="keyfacts__grid">
        <div class="kf"><div class="kf__n">Статья 242.26</div><div class="kf__t"><b>Основа</b> — КС средств местного бюджета — статья 242.26 БК РФ</div></div>
        <div class="kf"><div class="kf__n">Местный акт</div><div class="kf__t"><b>Решение</b> — случаи КС определяет муниципальный правовой акт о бюджете</div></div>
    ...
    <table>
      <caption>Нормы о КС муниципальных контрактов</caption>
      ...
      <tr><td>Статья 242.26 БК</td><td>Средства из бюджета субъекта РФ и местного бюджета, подлежащие КС</td></tr>
    ...
    <p>То есть конкретный перечень случаев и условий КС муниципальных контрактов задаёт сам муниципалитет — в решении о бюджете на год и в актах администрации. Поэтому ответ на вопрос «попадает ли мой контракт под КС» начинается с изучения местных документов, а не только федерального закона. Кроме того, по подпункту 2 статьи 242.26 КС подлежат средства, получаемые участниками КС в случаях, установленных федеральными законами и решениями Правительства РФ.</p>
    ...
    <table>
      <caption>Кто осуществляет КС средств местного бюджета</caption>
    ...
    <h2 id="kakie-kontrakty">Какие муниципальные контракты попадают под КС</h2>
    <p>Прямого единого перечня «все контракты дороже такой-то суммы» для муниципального уровня в федеральном законе нет — случаи устанавливает муниципалитет. Но ориентиры есть, и они повторяют общую логику КС.</p>
    <ul class="check">
      <li><b>Муниципальные контракты по 44-ФЗ</b>, оплачиваемые из местного бюджета, — если они отнесены к КС местным актом.</li>
    ...
    <table>
      <caption>Федеральное и муниципальное КС: что различается</caption>
    ...
    <p>Главный вывод: механика для исполнителя одинаковая — целевой лицевой счёт, санкционирование расходов, раздельный учёт. Различается «кто и на основании чего» включил контракт в КС. Поэтому подрядчику не нужно осваивать «другое» сопровождение — нужно лишь понимать источник и местные правила.</p>
    ...
    <p>Когда муниципальный контракт отнесён к КС, исполнитель работает по тем же правилам, что и на федеральном уровне.</p>
    <ul class="check">
    ...
    <h2 id="avansy">Авансы по муниципальным контрактам и КС</h2>
    ...
    <p>Алгоритм для подрядчика по муниципальному контракту, попавшему под КС, выглядит так.</p>
    <ol class="howto">
      <li><b>Уточнить режим контракта.</b> Проверить, отнесён ли контракт к КС: смотрят условия контракта и муниципальный акт о местном бюджете.</li>
    ...
    <ul class="check">
      <li><b>«Муниципальные контракты под КС не попадают».</b> Попадают, если отнесены к сопровождению муниципальным актом о бюджете (статья 242.26 БК).</li>
      <li><b>«КС всегда ведёт федеральное казначейство».</b> На муниципальном уровне сопровождать может финансовый орган муниципалитета.</li>
      ...
      <li><b>Игнорировать местный акт о бюджете.</b> Именно он определяет, какие контракты муниципалитета под КС.</li>
    </ul>
    ...
    <p class="muted">Пример обобщённый и иллюстративный, не описывает конкретного клиента и не гарантирует результата: условия КС муниципального контракта определяются местными актами в каждом случае.</p>

    <div class="takeaways">
      <h2>Что важно запомнить</h2>
      <ol>
        <li>Казначейское сопровождение муниципальных контрактов основано на статье 242.26 Бюджетного кодекса.</li>
        <li>Случаи КС определяет муниципальный правовой акт о местном бюджете и решение местной администрации, а не только федеральный закон.</li>
    ...
    <dl class="gloss">
      <div><dt>КС муниципального контракта</dt><dd>Режим контроля целевого использования средств местного бюджета, переданных исполнителю по муниципальному контракту.</dd></div>
      ...
      <div><dt>Муниципальный правовой акт о бюджете</dt><dd>Решение представительного органа муниципального образования о местном бюджете, которое в том числе определяет случаи КС.</dd></div>
    ...
    <div class="faq">
      ...
      <details><summary>Чем муниципальное КС отличается от федерального?</summary><p>Источником средств (местный бюджет вместо федерального), тем, кто определяет случаи (муниципальный акт вместо закона о федеральном бюджете), и тем, кто сопровождает (финорган муниципалитета или ФК). Сам режим — лицевой счёт, санкционирование, раздельный учёт — одинаковый.</p></details>
      <details><summary>Какой счёт открывают по муниципальному контракту под КС?</summary><p>Открывают лицевой счёт для учёта операций с целевыми средствами, как правило с кодом 71. Его резервируют и открывают через ГИИС «Электронный бюджет» в органе, сопровождающем средства.</p></details>
      <details><summary>Нужен ли раздельный учёт по муниципальному контракту под КС?</summary><p>Да. Целевые средства по муниципальному контракту учитываются отдельно от прочей деятельности — как и при федеральном казначейском сопровождении.</p></details>
      <details><summary>Распространяется ли КС на договоры с местным бюджетом?</summary><p>Да. Статья 242.26 называет не только муниципальные контракты, но и договоры (соглашения), источником финансового обеспечения которых являются средства местного бюджета, если они отнесены к КС.</p></details>
    </div>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-3">Статья 242.25 Бюджетного кодекса РФ — средства из федерального бюджета, подлежащие КС (для сравнения). consultant.ru.</li>
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="kaznacheyskoe-soprovozhdenie-municipalnyh-kontraktov">
      ...
      <h3 class="railform__title">Контракт с местным бюджетом под КС?</h3>

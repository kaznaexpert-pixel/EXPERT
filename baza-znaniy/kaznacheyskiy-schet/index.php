...
<div class="author">
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию; точные реквизиты счёта определяет ТОФК, а применимость казначейского сопровождения — условия контракта и НПА на дату его заключения. Проверено экспертом КазнаЭксперт. Дата актуализации — 14 августа 2026.</p>
    </div>

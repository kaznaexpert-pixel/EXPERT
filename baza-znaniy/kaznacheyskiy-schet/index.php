...
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type": "Question", "name": "Закроют ли казначейский счёт, если по нему долго нет операций?", "acceptedAnswer": {"@type": "Answer", "text": "Нет, автоматического закрытия «за простой» через год или два нормативная база не предусматривает. По Приказу Казначейства № 44н счёт закрывается при отсутствии учтённых показателей и остатка средств, а отдельный раздел на счёте — при отсутствии остатка в нём. Закрытие оформляется заявлением в ТОФК после завершения операций и сверки."}},
{"@type":"Question","name":"Что такое казначейский счёт простыми словами?","acceptedAnswer":{"@type":"Answer","text":"Это счёт, который Федеральное казначейство открывает в Банке России для операций со средствами бюджета. Организация распоряжается своей частью средств через лицевой счёт в ТОФК, а не напрямую."}},
{"@type":"Question","name":"Чем казначейский счёт отличается от банковского?","acceptedAnswer":{"@type":"Answer","text":"Он открыт в Банке России, а не в коммерческом банке; средствами нельзя распоряжаться свободно — каждая операция санкционируется казначейством; нет процентов, овердрафта и риска блокировки банком."}},
{"@type":"Question","name":"Что такое лицевой счёт 71?","acceptedAnswer":{"@type":"Answer","text":"Это лицевой счёт участника казначейского сопровождения, не являющегося участником бюджетного процесса. На нём учитываются целевые средства по контракту; открывается один раз, под каждый контракт заводится отдельный раздел."}},
{"@type":"Question","name":"Чем ЕКС отличается от казначейского счёта?","acceptedAnswer":{"@type":"Answer","text":"ЕКС (единый казначейский счёт) — один счёт ФК в Банке России, где аккумулируются средства бюджета; казначейские счета — счета для операций конкретных типов средств, привязанные к ЕКС. В платёжке указываются оба реквизита."}},
{"@type":"Question","name":"Какие реквизиты указывать в платёжке?","acceptedAnswer":{"@type":"Answer","text":"Банк получателя и БИК (ТОФК), единый казначейский счёт (поле 15, начинается с 40102), номер казначейского счёта (поле 17, начинается с 03) и лицевой счёт получателя в назначении. Оба счёта обязательны."}},
{"@type":"Question","name":"Нужно ли мне открывать казначейский счёт?","acceptedAnswer":{"@type":"Answer","text":"Только если контракт или субсидия попали под казначейское сопровождение и это прописано в контракте. В 2026 году для части исполнителей действует упрощённый порядок расчётов на банковский счёт без открытия счёта в ТОФК."}},
{"@type":"Question","name":"Можно ли снять деньги с казначейского счёта наличными?","acceptedAnswer":{"@type":"Answer","text":"Свободно — нет. Операции возможны только в установленных случаях и после санкционирования; целевой характер средств сохраняется до подтверждения расходов."}},
{"@type":"Question","name":"Где взять реквизиты казначейского счёта?","acceptedAnswer":{"@type":"Answer","text":"Их выдаёт ТОФК при открытии лицевого счёта. Перед первым платежом реквизиты обязательно сверяют, чтобы не перепутать ЕКС и номер казначейского счёта."}}
]}
</script>
<script type="application/ld+json">

...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tip"><p><b>Практический вывод.</b> Одновременное присутствие в калькуляции заполненных строк 0900 и 1600 — формальное основание для замечания. Выбор между ними делается не под конкретный контракт, а закрепляется учётной политикой организации и должен быть единым для всей отчётности.</p></div>

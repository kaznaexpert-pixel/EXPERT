...
{"@type":"Question","name":"В какой срок нужно утвердить сведения?","acceptedAnswer":{"@type":"Answer","text":"Заказчик утверждает сведения не позднее 10-го рабочего дня после их получения от участника. До утверждения платежи по заявленным кодам не проходят."}},

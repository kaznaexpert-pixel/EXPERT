  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        ...
        <li><a href="#sroki">Сроки и где формируется</a></li><li><a href="#subsidii">Сведения по субсидиям</a></li><li><a href="#oshibki">Частые ошибки</a></li>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию; актуальные форма, перечни кодов и порядок устанавливаются НПА и могут уточняться. Проверено экспертом КазнаЭксперт. Дата актуализации — 27 августа 2026.</p>
    </div>

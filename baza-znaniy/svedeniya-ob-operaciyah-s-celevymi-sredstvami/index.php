...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#kto-utverzhdaet">Кто формирует и утверждает</a></li>
  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        ...
        <li><a href="#proverka">Что проверяет казначейство</a></li><li><a href="#kto-utverzhdaet">Кто формирует и утверждает</a></li><li><a href="#kak-zapolnit">Как заполнить</a></li>

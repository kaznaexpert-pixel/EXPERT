...
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type": "Question", "name": "Какой штраф за нарушение срока утверждения сведений об операциях?", "acceptedAnswer": {"@type": "Answer", "text": "С 1 января 2026 года за нарушение установленного срока утверждения сведений об операциях (не позднее 10-го рабочего дня) введена административная ответственность по статье 15.49 КоАП РФ. Штраф для должностных лиц — 10 000–50 000 ₽, для юридических лиц — 1–5% цены контракта, но не более 200 000 ₽. Срок утверждает заказчик, поэтому ответственность за его нарушение несёт он."}},
{"@type":"Question","name":"Что такое сведения об операциях с целевыми средствами?","acceptedAnswer":{"@type":"Answer","text":"Это документ по форме 0501213, в котором исполнитель заранее раскрывает плановые поступления и расходы по контракту в разрезе кодов направления расходования. На их основе казначейство санкционирует платежи."}},
{"@type":"Question","name":"По какой форме составляются сведения?","acceptedAnswer":{"@type":"Answer","text":"По форме с кодом по ОКУД 0501213, предусмотренной Порядком санкционирования операций (приказ Минфина России № 214н). Источники поступлений и направления расходования берутся из приложений к Порядку."}},
{"@type":"Question","name":"Кто утверждает сведения об операциях?","acceptedAnswer":{"@type":"Answer","text":"Как правило, заказчик. Исполнитель может утвердить сведения самостоятельно, если заказчик направил разрешение на самостоятельное утверждение."}},
{"@type":"Question","name":"В какой срок нужно утвердить сведения?","acceptedAnswer":{"@type":"Answer","text":"Заказчик утверждает сведения не позднее 10-го рабочего дня после их получения от участника. До утверждения платежи по заявленным кодам не проходят. С 1 января 2026 года за нарушение заказчиком этого срока введена административная ответственность — статья 15.49 КоАП РФ (введена Федеральным законом от 28.12.2025 № 506-ФЗ): для юридических лиц штраф составляет 1–5% цены контракта, но не более 200 000 ₽."}},
{"@type":"Question","name":"Где формируются сведения?","acceptedAnswer":{"@type":"Answer","text":"В государственной системе «Электронный бюджет» с использованием электронной подписи. Там они хранятся, корректируются и связываются с операциями по счёту."}},
{"@type":"Question","name":"Что будет, если кода нет в сведениях?","acceptedAnswer":{"@type":"Answer","text":"Платёж по этому коду не пройдёт санкционирование. Нужно дополнить сведения нужным направлением, переутвердить их и затем направить платёж."}},
{"@type":"Question","name":"Можно ли изменить сведения после утверждения?","acceptedAnswer":{"@type":"Answer","text":"Да. При изменении плана расходов, появлении новых направлений или корректировке сумм сведения дополняют и переутверждают. Их поддержание в актуальном состоянии обязательно."}}
]}
</script>
<script type="application/ld+json">

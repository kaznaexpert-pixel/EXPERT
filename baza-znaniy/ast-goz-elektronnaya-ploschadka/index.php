...
{"@type":"Question","name":"Что такое АСТ ГОЗ?","acceptedAnswer":{"@type":"Answer","text":"Это специализированная электронная площадка для проведения закрытых конкурентных закупок в электронной форме, в том числе по гособоронзаказу и закупкам со сведениями гостайны. Включена в перечень операторов специализированных площадок распоряжением Правительства РФ от 12.07.2018 № 1447-р."}},
{"@type":"Question","name":"Кто оператор АСТ ГОЗ?","acceptedAnswer":{"@type":"Answer","text":"Оператор — ООО «Автоматизированная система торгов государственного оборонного заказа» (ООО «АСТ ГОЗ»). Организационно-правовая форма — общество с ограниченной ответственностью, а не акционерное общество."}},
{"@type":"Question","name":"На каком основании работает площадка?","acceptedAnswer":{"@type":"Answer","text":"На основании распоряжения Правительства РФ от 12.07.2018 № 1447-р (в редакции от 23.11.2022), которым утверждены перечни операторов электронных и специализированных электронных площадок."}},
{"@type":"Question","name":"Чем АСТ ГОЗ отличается от обычных площадок?","acceptedAnswer":{"@type":"Answer","text":"Обычные восемь федеральных площадок проводят открытые процедуры через интернет. АСТ ГОЗ ведёт закрытые процедуры в защищённом контуре, сведения о которых не публикуются открыто, а участие требует допуска к гостайне и аттестованного рабочего места."}},
{"@type":"Question","name":"АСТ ГОЗ — единственная площадка для ГОЗ?","acceptedAnswer":{"@type":"Answer","text":"Нет. С конца 2022 года перечень специализированных площадок расширен, и их несколько. Утверждение об единственной площадке устарело."}},
{"@type":"Question","name":"Что нужно для работы на площадке?","acceptedAnswer":{"@type":"Answer","text":"Как правило: усиленная квалифицированная электронная подпись, сертифицированные СКЗИ, аттестованное защищённое рабочее место, при работе с гостайной — лицензия ФСБ, а также аккредитация на площадке. Точные требования задаёт оператор."}},
{"@type":"Question","name":"Как связаны АСТ ГОЗ и казначейское сопровождение?","acceptedAnswer":{"@type":"Answer","text":"Площадка закрывает этап заключения контракта. Его дальнейшее исполнение и расчёты подпадают под казначейское или банковское сопровождение ГОЗ: присваивается ИГК, открывается отдельный счёт, ведётся раздельный учёт."}},
{"@type":"Question","name":"Где найти точный регламент регистрации?","acceptedAnswer":{"@type":"Answer","text":"Регламент доступа и аккредитации устанавливает оператор площадки. Поскольку часть процедур идёт в защищённом контуре, актуальные инструкции и требования уточняют непосредственно у оператора и в своём удостоверяющем центре."}}
]}
</script>
<script type="application/ld+json">

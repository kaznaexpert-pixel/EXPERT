...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>13 мин чтения</span><span class="dot">·</span><span>Обновлено 18 августа 2026</span></div>
    </div>
...
<h2 id="faq">Частые вопросы</h2>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет инструкции оператора площадки. Перечень специализированных площадок и требования к участникам могут меняться; технические условия и регламент аккредитации задаёт оператор АСТ ГОЗ. Сведения проверены по распоряжению № 1447-р и 44-ФЗ. Проверено экспертом КазнаЭксперт. Дата актуализации — 18 августа 2026.</p>
    </div>

...
<title>АСТ ГОЗ: аккредитация, вход в личный кабинет и работа в 2026</title>
<meta name="description" content="АСТ ГОЗ: аккредитация по постановлению № 223 (срок 3 года), вход в личный кабинет по подписи и защищённому каналу, лицензия для закупок с гостайной.">
...
<meta property="og:title" content="АСТ ГОЗ: что это и как работает электронная площадка">
<meta property="og:description" content="АСТ ГОЗ: аккредитация по постановлению № 223 (срок 3 года), вход в личный кабинет по подписи и защищённому каналу, лицензия для закупок с гостайной.">
...
<meta name="twitter:title" content="АСТ ГОЗ: что это и как работает электронная площадка">
<meta name="twitter:description" content="АСТ ГОЗ: аккредитация по постановлению № 223 (срок 3 года), вход в личный кабинет по подписи и защищённому каналу, лицензия для закупок с гостайной.">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <table>
      ...
      <tr><td>44-ФЗ, статьи 75, 76, 84–86</td><td>Порядок закрытых электронных процедур и требования к участникам</td></tr>
...
<h2 id="faq">Частые вопросы</h2>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-2">Федеральный закон от 05.04.2013 № 44-ФЗ, ст. 75, 76, 84–86 (закрытые электронные процедуры) — <a href="https://www.consultant.ru/document/cons_doc_LAW_144624/74fd366280bf5a8a071c18cc77f48daf80f5102f/" target="_blank" rel="noopener">consultant.ru</a></li>
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет инструкции оператора площадки. Перечень специализированных площадок и требования к участникам могут меняться; технические условия и регламент аккредитации задаёт оператор АСТ ГОЗ. Сведения проверены по распоряжению № 1447-р и 44-ФЗ. Проверено экспертом КазнаЭксперт. Дата актуализации — 4 августа 2026.</p>
    </div>

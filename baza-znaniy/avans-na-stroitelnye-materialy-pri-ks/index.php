...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>14 мин чтения</span><span class="dot">·</span><span>Обновлено 15 июля 2026</span></div>
    </div>
...
<div class="related-inline"><b>Справочно:</b> в сведениях об операциях аванс контрагенту проводится по коду направления расходования <a href="/baza-znaniy/kody/0610/">0610</a>.</div>
    ...
    <p>У правила про материалы есть дополнительное условие. Для строительных материалов и оборудования, включённых в перечень, утверждённый Минстроем России (приказ от 16.12.2025 № 804/пр), аванс поставщику перечисляется, только если эти материалы приобретены <b>посредством закупки в электронной форме на электронной площадке или на организованных торгах</b>. Перечень Минстроя действует до 31 декабря 2026 года.</p>
    ...
    <div class="faq">
      ...
      <details><summary>Что за перечень Минстроя № 804/пр и зачем он нужен?</summary><p>Это утверждённый Минстроем России перечень строительных материалов и оборудования (коды по классификатору строительных ресурсов). Для позиций из перечня аванс поставщику перечисляется, только если материалы приобретены на электронной площадке или организованных торгах. Перечень действует до 31 декабря 2026 года.</p></details>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-3">Федеральный закон от 28.11.2025 № 431-ФЗ, ст. 15 — упрощённый порядок расчётов и аванс на строительные материалы и оборудование по перечню из проектной документации (продлён до 01.01.2027).</li>
        <li id="ref-4">Приказ Минстроя России от 16.12.2025 № 804/пр — перечень строительных материалов и оборудования (действует до 31.12.2026; условие — приобретение на электронной площадке или организованных торгах).</li>

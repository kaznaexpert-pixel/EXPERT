...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>17 мин чтения</span><span class="dot">·</span><span>Обновлено 19 июня 2026</span></div>
    </div>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Федеральный закон от 29.12.2012 № 275-ФЗ «О государственном оборонном заказе», глава 3.1 «Банковское сопровождение» (ст. 8.1–8.6) — уполномоченный банк, отдельный счёт, режим использования. Тексты: consultant.ru, garant.ru, pravo.gov.ru.</li>
        ...
        <li id="ref-3">Статья 8.3 закона № 275-ФЗ — режим использования отдельного счёта (разрешённые операции). consultant.ru.</li>
        <li id="ref-4">Статья 8.4 закона № 275-ФЗ — операции, совершение которых по отдельному счёту не допускается. consultant.ru.</li>

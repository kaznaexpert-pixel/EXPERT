...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>17 мин чтения</span><span class="dot">·</span><span>Обновлено 14 июля 2026 · статус ПСБ как опорного банка ОПК (ФЗ № 517-ФЗ) и концентрация сопровождения ГОЗ в ПСБ подтверждены на июль 2026</span></div>
    </div>
    ...
    <p>Всё банковское сопровождение гособоронзаказа держится на одной главе закона. Знать её структуру полезно — это снимает большую часть вопросов «а почему банк требует то или это».</p>
    <table>

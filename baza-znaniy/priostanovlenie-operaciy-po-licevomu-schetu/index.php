...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Если казначейство приостановило операции по лицевому счёту, это, как правило, мера реагирования в рамках <b>казначейского мониторинга</b> в системе казначейских платежей (статья 242.13-1 Бюджетного кодекса), а не обычный возврат распоряжения на доработку. Правила мониторинга и перечень мер реагирования установлены постановлением Правительства РФ № 2483 от 25.12.2021: помимо приостановления операции есть отказ в открытии счёта, приостановление открытия, запрет операций, отказ в операции и предупреждение. При приостановлении казначейство информирует заказчика, а заказчик в установленный срок подтверждает, обоснованно или необоснованно приостановление; если заказчик не отреагировал в срок, казначейство возобновляет операции. Исполнителю важно не паниковать: нужно быстро выяснить основание, связаться с заказчиком и казначейством, устранить причину и представить пояснения. Ниже разберём, чем приостановление отличается от отказа, какие бывают меры, как устроена процедура и сроки и что делать шаг за шагом, чтобы возобновить платежи и не сорвать контракт.</div>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr><td>Отказ в санкционировании</td><td>расход не соответствует условиям расходования целевых средств</td><td>санкционирование (статья 269.1 БК, № 214н)</td></tr>
    ...
    <dl class="gloss">
      ...
      <div><dt>Отказ в санкционировании</dt><dd>Отказ провести расход, не соответствующий условиям расходования целевых средств (санкционирование, ст. 269.1 БК, приказ № 214н); отличается от приостановления в рамках мониторинга.</dd></div>
    ...
    <div class="faq">
      ...
      <details><summary>Чем приостановление отличается от отказа в санкционировании?</summary><p>Отказ в санкционировании — это отказ провести расход, не соответствующий условиям расходования целевых средств (санкционирование по ст. 269.1 БК и приказу № 214н). Приостановление операции — мера реагирования в рамках мониторинга (ст. 242.13-1 БК, ПП № 2483) с отдельной процедурой и участием заказчика. Возврат распоряжения на доработку — третий, самый простой случай.</p></details>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-3">Постановление Правительства РФ от 24.11.2021 № 2024 «О казначейском сопровождении» (режим лицевого счёта и целевых средств).</li>
        <li id="ref-4">Приказ Минфина России от 17.12.2021 № 214н (санкционирование операций со средствами участников казначейского сопровождения) — для отграничения от возврата и отказа в санкционировании.</li>
        <li id="ref-5">Бюджетный кодекс РФ, статья 269.1 (санкционирование операций) и статья 269.2 (последующий государственный финансовый контроль) — смежные механизмы контроля.</li>
      </ol>

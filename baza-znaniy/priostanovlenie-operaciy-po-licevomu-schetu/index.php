...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__priostanovlenie-operaciy-po-licevomu-schetu-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__priostanovlenie-operaciy-po-licevomu-schetu-16x9.jpg">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>15 мин чтения</span><span class="dot">·</span><span>Обновлено 8 сентября 2026</span></div>
    </div>
...
<p class="lead-p">Правила мониторинга и перечень мер реагирования установлены постановлением Правительства РФ № 2483 от 25.12.2021: помимо приостановления операции есть отказ в открытии счёта, приостановление открытия, запрет операций, отказ в операции и предупреждение. Исполнителю важно не паниковать: нужно быстро выяснить основание, связаться с заказчиком и казначейством, устранить причину и представить пояснения. Ниже разберём, чем приостановление отличается от отказа, какие бывают меры, как устроена процедура и сроки и что делать шаг за шагом, чтобы возобновить платежи и не сорвать контракт.</p>
    ...
    <div class="answer reveal">
      <p class="lead-p">Приостановление операции по лицевому счёту — мера реагирования казначейского мониторинга по статье 242.13-1 Бюджетного кодекса, а не возврат распоряжения на доработку. Казначейство информирует заказчика, заказчик подтверждает обоснованность меры. Если заказчик не ответил в срок, операции возобновляются.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></p>
    </div>
    ...
    <p class="note">Приостановление касается операций по лицевому счёту с кодом 71 — счёту участника казначейского сопровождения, открытому по приказу № 44н. Порядок его открытия разобран отдельно: <a href="/baza-znaniy/licevoy-schet-71-kak-otkryt/">лицевой счёт 71 &rarr;</a>, а коды направления расходования, по которым проверяют каждый платёж, — в <a href="/baza-znaniy/kody/">справочнике кодов &rarr;</a>.</p>
    ...
    <h2 id="norma">Правовая основа: статья 242.13-1 БК, постановления № 2483 и № 941</h2>
    <p>Казначейский мониторинг закреплён в статье 242.13-1 Бюджетного кодекса — это мониторинг в системе казначейских платежей, в рамках которого Федеральное казначейство выявляет риски и применяет меры реагирования. Норма развивалась: её наименование было изменено федеральным законом № 84-ФЗ от 21 апреля 2025 года, а новая редакция вступила в силу 01.09.2026 (федеральный закон № 158-ФЗ) и применяется сейчас — именно её формулировки нужно брать за основу. Сверка по первоисточнику на 08.09.2026: новая редакция расширила круг лиц, в отношении которых проводится казначейский мониторинг, а в пункте 14 статьи 242.13-1 мера реагирования сформулирована как предупреждение о наличии признаков финансовых нарушений.</p>
    <h3>Порядок мониторинга: постановление № 2483</h3>
    ...
    <h3 id="pp-941">С 1 сентября 2026 года действует постановление № 941</h3>
    <p>Правила проведения казначейского мониторинга и применения мер реагирования утверждены постановлением Правительства от 27.07.2026 № 941 и применяются с 1 сентября 2026 года; постановление № 2483 с этой даты утратило силу.<a class="fn" href="#ref-6" aria-label="Источник 6">[6]</a> Приостановление операции как мера сохранилось — сменился акт, в котором записана процедура.</p>
    <p>Сверка 1 сентября 2026 года: переход прошёл в заявленный срок, без отсрочки. С этой даты процедура приостановления применяется по Правилам из постановления № 941 от 27.07.2026, а постановление № 2483 от 25.12.2021 утратило силу; процедуры мониторинга исключены из Порядка № 44н приказом Казначейства от 22.06.2026 № 14н (Минюст 23.07.2026, № 87587).</p>
    <p>Новые Правила охватывают проверку сведений при открытии лицевых счетов участникам системы казначейских платежей и при операциях по таким счетам, взаимодействие казначейства с финансовыми органами и государственными внебюджетными фондами, сроки принятия решений и направления уведомлений. Параллельно приказ Казначейства от 22.06.2026 № 14н убирает процедуры мониторинга из Порядка открытия лицевых счетов № 44н.<a class="fn" href="#ref-7" aria-label="Источник 7">[7]</a></p>

    <h3>Почему это важно исполнителю</h3>
    ...
    <h3>Чем быстрее устранена причина, тем короче пауза</h3>
    ...
    <div class="faq">
      <details><summary>За что казначейство приостанавливает операции по счёту с кодом 71?</summary><p>Основание — казначейский мониторинг по статье 242.13-1 Бюджетного кодекса: приостановление применяется как мера реагирования, когда операция по лицевому счёту участника казначейского сопровождения вызывает вопросы о соблюдении условий расходования целевых средств. Это не доказанное нарушение, а приостановка до выяснения: исполнителю направляется уведомление, и до устранения причины операции по счёту не проводятся.</p></details>
      ...
      <details><summary>По каким правилам операции приостанавливают после 1 сентября 2026 года?</summary><p>По постановлению Правительства от 27.07.2026 № 941 — оно применяется с 1 сентября 2026 года взамен постановления № 2483. Мера приостановления операции остаётся в пункте 3 статьи 242.13-1 Бюджетного кодекса, меняется только акт с процедурой.</p></details>
      <details><summary>Что делать, если в договоре или регламенте стоит ссылка на постановление № 2483?</summary><p>С 1 сентября 2026 года эта ссылка ведёт на недействующий акт. Замените её на постановление Правительства от 27.07.2026 № 941; документы и уведомления, оформленные до этой даты по № 2483, силы не теряют.</p></details>
    </div>
...
<div class="refs">
      ...
      <ol>
        ...
        <li id="ref-6">Постановление Правительства РФ от 27.07.2026 № 941 «Об утверждении Правил проведения казначейского мониторинга и применения мер реагирования» — применяется с 01.09.2026, постановление № 2483 утратило силу с этой же даты; официально опубликовано 27.07.2026. pravo.gov.ru, garant.ru.</li>
        <li id="ref-7">Приказ Федерального казначейства от 22.06.2026 № 14н — исключение процедур мониторинга из Порядка № 44н с 01.09.2026 (утрата силы пунктов 7, 31–33, 35.1, 36, 40 и приложений № 4 – № 8). Минюст 23.07.2026 № 87587. pravo.gov.ru, normativ.kontur.ru.</li>
      </ol>
      <p class="refs__note">Нормы приведены по состоянию на 8 сентября 2026 года. Статья 242.13-1 БК и Правила № 2483 менялись, новая редакция статьи действует с 1 сентября 2026 года — перед действиями сверяйтесь с актуальной редакцией и разъяснениями Федерального казначейства. Материал носит справочный характер, не является юридической консультацией и не гарантирует конкретный результат: каждая ситуация оценивается индивидуально.</p>
    </div>

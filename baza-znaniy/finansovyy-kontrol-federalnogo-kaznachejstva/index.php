...
{"@context": "https://schema.org", "@type": "Article", "headline": "Финансовый контроль Федерального казначейства: проверки, ревизии и предписания", "description": "Государственный финансовый контроль казначейства: что проверяет, по каким стандартам, чем грозят проверки и ревизии, что такое представление и предписание.", "inLanguage": "ru-RU", "datePublished": "2026-06-18", "dateModified": "2026-08-08", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/", "@id": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/#person"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}, "@id": "https://kaznaexpert.ru/#organization"}, "image": "https://kaznaexpert.ru/img/og-image.png", "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/finansovyy-kontrol-federalnogo-kaznachejstva/"}, "citation": ["https://www.consultant.ru/document/cons_doc_LAW_19702/f9326f84473ca91312e73a717befd43c925de20f/", "https://www.consultant.ru/document/cons_doc_LAW_19702/", "https://base.garant.ru/74539617/", "https://www.consultant.ru/document/cons_doc_LAW_287405/", "https://roskazna.gov.ru/kontrol/"]}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      ...
      <p>Важно не путать этот контроль с тем, что казначейство делает при каждом платеже. Когда оно санкционирует расход с лицевого счёта, это <b>текущий</b> контроль по статье 269.1 БК — он происходит до операции и без него деньги просто не уйдут. А государственный финансовый контроль по статье 269.2 — это <b>последующий</b> контроль: ведомство приходит уже после того, как средства потрачены, и оценивает законность всей картины за период.</p>
    </div>
    ...
    <table>
      ...
      <tr><td>Предварительный (текущий)</td><td>Санкционирование операций — проверка до платежа (ст. 269.1 БК)</td></tr>
    ...
    <div class="faq">
      ...
      <details><summary>Чем контроль отличается от санкционирования платежей?</summary><p>Санкционирование — это текущий контроль до платежа по статье 269.1 БК: без него расход с лицевого счёта не пройдёт. Финансовый контроль по статье 269.2 — последующий: казначейство проверяет уже потраченные средства за период.</p></details>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-2">Бюджетный кодекс РФ, ст. 265, 266.1, 269.1, 270.2 — виды контроля, объекты, санкционирование, представления и предписания — <a href="https://www.consultant.ru/document/cons_doc_LAW_19702/" target="_blank" rel="noopener">consultant.ru</a></li>

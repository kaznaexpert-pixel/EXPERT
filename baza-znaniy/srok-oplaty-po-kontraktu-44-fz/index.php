...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__srok-oplaty-po-kontraktu-44-fz-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__srok-oplaty-po-kontraktu-44-fz-16x9.jpg">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>13 мин чтения</span><span class="dot">·</span><span>Обновлено 4 сентября 2026</span></div>
    </div>
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">10-50 тыс ₽</div><div class="kf__t"><b>Штраф</b> — за нарушение срока оплаты должностное лицо заказчика штрафуют по части 8 статьи 7.30.2 КоАП, повторно — дисквалификация</div></div>
      </div>
    </section>
    <!-- svc-cta:top -->
    ...
    <p>Точка отсчёта срока оплаты — дата подписания заказчиком документа о приёмке, предусмотренного частью 7 статьи 94 Закона № 44-ФЗ. При электронном актировании это дата, когда заказчик подписал структурированный документ о приёмке в ЕИС усиленной квалифицированной подписью. Пока подписи нет, срок оплаты не начинает течь вовсе — что делать, если <a href="/baza-znaniy/zakazchik-ne-podpisyvaet-akt-priyomki/">заказчик не подписывает акт приёмки</a>, мы разобрали отдельно.</p>
    ...
    <p>Гражданско-правовая ответственность наступает по части 5 статьи 34 Закона № 44-ФЗ: за каждый день просрочки исполнения заказчиком денежного обязательства поставщик вправе требовать пеню. Административная — по части 8 статьи 7.30.2 КоАП РФ, и привлекают к ней конкретное должностное лицо заказчика, ответственное за оплату.</p>
    ...
    <p>За нарушение срока и порядка оплаты товаров, работ и услуг по государственным и муниципальным контрактам предусмотрена административная ответственность по части 8 статьи 7.30.2 КоАП РФ. Под неё подпадает и неисполнение обязанности по авансированию, если оно предусмотрено контрактом.</p>
    <ul>
      <li><b>За первое нарушение</b> — административный штраф на должностное лицо заказчика в размере 1 процента цены контракта (этапа исполнения контракта, аванса, предусмотренного контрактом), но не менее десяти тысяч и не более пятидесяти тысяч рублей.</li>
    ...
    <p>Дела по части 8 статьи 7.30.2 рассматривают контрольные органы в сфере закупок — антимонопольный орган и его территориальные управления (статья 23.66 КоАП), а поводом часто становится обращение поставщика. Это сильный аргумент в переговорах: для должностного лица заказчика риск штрафа и тем более дисквалификации — серьёзный стимул не затягивать оплату. Состав введён Федеральным законом от 28.12.2024 № 500-ФЗ и применяется с 1 марта 2025 года — прежняя статья 7.32.5 КоАП с фиксированным штрафом 30-50 тысяч рублей с этой даты утратила силу. При обращении имеет смысл приложить доказательства даты приёмки и факта просрочки: размер штрафа теперь считается от цены контракта, поэтому цена и сумма просроченного платежа в обращении обязательны.</p>
    ...
    <ul>
      ...
      <li>Параллельно обратитесь в антимонопольный орган по части 8 статьи 7.30.2 КоАП.</li>
    </ul>
    ...
    <dl class="gloss">
      ...
      <div><dt>Часть 8 статьи 7.30.2 КоАП</dt><dd>Состав об административной ответственности за нарушение срока и порядка оплаты по госконтракту: штраф, при повторе — дисквалификация.</dd></div>
    ...
    <p data-ctx="2026-08-12">Отдельный сюжет — попытка растянуть оплату через удержание части цены на срок гарантии: почему в контракте по 44-ФЗ это спорно и чем рискует заказчик, разобрано в статье про <a href="/baza-znaniy/garantiynoe-uderzhanie-po-kontraktu/#srok-oplaty">гарантийное удержание и предельный срок оплаты</a>.</p><p data-ctx="auto-ctx:lbo-0903-2">Ссылка заказчика на «отсутствие лимитов» или «сокращение ассигнований» срок оплаты не сдвигает: что стоит за этими словами и как они соотносятся по Бюджетному кодексу — в статье <a href="/baza-znaniy/byudzhetnye-assignovaniya-i-lbo/">о бюджетных ассигнованиях, ЛБО и обязательствах</a>.</p>
    ...
    <div class="faq">
      ...
      <details><summary>Куда обращаться при задержке оплаты?</summary><p>Сначала направить заказчику претензию с расчётом долга и пени. При отсутствии оплаты — взыскать долг и неустойку через суд и параллельно обратиться в антимонопольный орган по части 8 статьи 7.30.2 КоАП.</p></details>
    ...
    <p data-ctx="auto-ctx:limity-byudzhetnyh-obyazatelstv-i-oplata-kontrakta">Самое частое объяснение просрочки со стороны заказчика — «не довели лимиты»: почему это не освобождает от оплаты, когда уменьшение лимитов действительно меняет контракт и как исполнителю действовать, разобрано в статье про <a href="/baza-znaniy/limity-byudzhetnyh-obyazatelstv-i-oplata-kontrakta/">отсутствие лимитов бюджетных обязательств</a>.</p>
    <p data-ctx="auto-ctx:vzyskanie-dolga-s-zakazchika-po-goskontraktu">Когда сроки прошли, а денег нет, дальше работает судебный маршрут — претензия с 30-дневным сроком, иск с пенёй и госпошлиной, исполнение через казначейство: пошаговый разбор в статье про <a href="/baza-znaniy/vzyskanie-dolga-s-zakazchika-po-goskontraktu/">взыскание долга с заказчика по госконтракту</a>.</p>
    <div class="author">
...
<div class="refs">
      ...
      <ol>
        ...
        <li id="ref-2">Федеральный закон от 05.04.2013 № 44-ФЗ, часть 5 статьи 34 (пеня за просрочку обязательств заказчика). <a href="https://www.consultant.ru/document/cons_doc_LAW_144624/" target="_blank" rel="noopener">КонсультантПлюс</a></li>
        <li id="ref-3">Федеральный закон от 05.04.2013 № 44-ФЗ, часть 7 статьи 94 (документ о приёмке как точка отсчёта). <a href="https://www.consultant.ru/document/cons_doc_LAW_144624/" target="_blank" rel="noopener">КонсультантПлюс</a></li>
      ...
      <p class="refs__note">Нормы приведены в редакции, действующей на 4 сентября 2026 года. Материал носит справочный характер и не заменяет юридическую консультацию по конкретному спору.</p>
    </div>

...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__zaklyuchenie-kontrakta-44-fz-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__zaklyuchenie-kontrakta-44-fz-16x9.jpg">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>16 мин чтения</span><span class="dot">·</span><span>Обновлено 2 сентября 2026 · добавлен график подписания контракта по статье 51</span></div>
    </div>
    ...
    <h3>График подписания по статье 51: шаг за шагом</h3>
    <table>
    ...
    <h3 id="posle-itogovogo-protokola">Что происходит после итогового протокола</h3>
    ...
    <h3 id="edinstvennyy-postavshchik-poryadok">Единственный поставщик и закрытые процедуры</h3>
    ...
    <h3 id="shagi-i-sroki">Шаги и сроки: от проекта до подписи заказчика</h3>
    <table>
    ...
    <h3 id="cepochka-podpisaniya">Цепочка с протоколом разногласий и без него</h3>
    ...
    <h3 id="rabochie-dni">Почему сроки считают в рабочих днях</h3>
    ...
    <h3 id="isklyucheniya-10-dney">Исключения из правила десяти дней</h3>
    ...
    <h3 id="chto-esche-v-proekte">Что ещё есть в проекте, кроме цены</h3>
    ...
    <h3 id="uvelichenie-kolichestva">Увеличение количества товара за счёт экономии</h3>
    ...
    <h3 id="protokol-odin-raz">Протокол разногласий подают только один раз</h3>
    ...
    <h3 id="kogda-umesten-protokol">Когда протокол разногласий уместен, а когда нет</h3>
    ...
    <h3 id="razmer-obespecheniya">Как считают размер обеспечения</h3>
    <p>Размер обеспечения устанавливается извещением в процентах от начальной максимальной цены контракта. Когда контракт заключается со снижением цены на 25% и более, вступают в силу антидемпинговые меры: обеспечение увеличивается в полтора раза либо победитель подтверждает добросовестность тремя исполненными контрактами. С 1 января 2026 года у этого правила появилось условие: Федеральный закон от 26.12.2024 № 484-ФЗ дополнил части 1, 2, 4 и 6 статьи 37 оговоркой «если требование обеспечения исполнения контракта установлено в соответствии со статьёй 96». Не установил заказчик обеспечение — полуторакратного тоже нет. Для контрактов с казначейским сопровождением это особенно важно: по части 6.1 статьи 96 заказчик вправе вовсе не устанавливать обеспечение либо ограничить его 10 процентами начальной цены (подробнее — <a href="/baza-znaniy/antidempingovye-mery-44-fz/#ogovorka-96">оговорка 484-ФЗ</a>). Поэтому ещё до подписания стоит просчитать итоговую сумму обеспечения и заранее оформить гарантию — на это уходит время, а срок подписания не останавливается.</p>
    <h3 id="umenshenie-na-avans">Когда обеспечение уменьшают на сумму аванса</h3>
    ...
    <h3 id="oformlenie-ukloneniya">Как заказчик оформляет уклонение</h3>
    ...
    <h3 id="raznoglasiya-ne-uklonenie">Протокол разногласий — это не уклонение</h3>
    ...
    <h3 id="finansovye-posledstviya">Обеспечение заявки и убытки заказчика</h3>
    ...
    <h3 id="chto-proverit-ks">Что проверить в проекте под казначейским сопровождением</h3>
    ...
    <h3 id="pyat-oshibok">Пять ошибок, из-за которых срывается подписание</h3>
    <ul>
      ...
      <li><b>Не учли антидемпинговое повышение обеспечения.</b> При снижении цены на 25% и более обеспечение возрастает в полтора раза, и его не хватает по обычному расчёту. Зеркальная ошибка 2026 года — внести полуторакратное обеспечение там, где заказчик обеспечение вообще не устанавливал: после 484-ФЗ такой обязанности нет.</li>
    </ul>
    <h3 id="primer-uklonenie">Пример: снижение цены более 25% и уклонение</h3>
...
<section class="related" aria-labelledby="relTitle">
  ...
  <div class="related__grid">
    <a class="card reveal" href="/baza-znaniy/obespechitelnyy-platezh-po-goskontraktu/"><div class="card__cover"><span>База знаний</span></div><div class="card__body"><span class="card__cat">База знаний</span><h3 class="card__title">Обеспечительный платёж по госконтракту: размер и возврат</h3><div class="card__meta">44-ФЗ · 12 мин</div></div></a>

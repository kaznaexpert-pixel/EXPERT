...
<meta name="description" content="ПИВ АСУ ГФ — система документооборота с Казначейством Москвы: что это, как получить доступ через Депфин, вход на asugf.mos.ru, настройка обмена с 1С и типовые ошибки.">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>12 мин чтения</span><span class="dot">·</span><span>Обновлено 4 сентября 2026 · добавлены разделы об официальном сайте и адресах, электронной подписи, техподдержке и месте ПИВ в цепочке сопровождения; глоссарий</span></div>
    </div>
...
<p><b>ПИВ АСУ ГФ</b> — подсистема информационного взаимодействия (ПИВ) автоматизированной системы управления городскими финансами города Москвы (АСУ ГФ). Сама АСУ ГФ создана постановлением Правительства Москвы от 21 марта 2013 года и служит городским аналогом федеральных казначейских систем: в ней Департамент финансов Москвы ведёт лицевые счета, санкционирует расходы и принимает отчётность по средствам бюджета города.</p>
...
<p>Если контракт уже «встал» из-за возвратов — неважно, в федеральном контуре или московском, — разбор причин и доведение платежей мы берём на себя: <a href="/uslugi/spasenie-kontrakta/">услуга «Спасение контракта»</a>, а полное ведение московского контракта — в рамках <a href="/uslugi/kaznacheyskoe-soprovozhdenie/">казначейского сопровождения под ключ</a>.</p>
    ...
    <div class="answer reveal">
      <p>Поддержку пользователей ПИВ ведёт Департамент финансов города Москвы как оператор АСУ ГФ: вопросы доступа, блокировки учётной записи, восстановления пароля и полномочий решаются через его операционное подразделение по работе с клиентами; технические сбои системы — через службу поддержки АСУ ГФ. Актуальные телефоны и адреса почты публикуются на страницах Депфина на mos.ru и в самой системе после входа.</p>
    </div>
...
<details><summary>Документ не уходит из 1С — почему?</summary><p>Проверьте имя настройки обмена («Взаимодействие с ПИВ АСУ ГФ» — точно) и код УБП из реквизитов личного кабинета. Это две самые частые причины.</p></details>
      ...
      <details><summary>Контракт федеральный, но заказчик из Москвы — нужна ли ПИВ АСУ ГФ?</summary><p>Систему определяет источник денег, а не адрес заказчика. Если контракт оплачивается из федерального бюджета и сопровождается в УФК (счёт с кодом 71) — работа в «Электронном бюджете»; если из бюджета города Москвы (счёт с кодом 44 в Казначействе Москвы) — в ПИВ АСУ ГФ.</p></details>

<h2>Источники и нормативная база</h2>
<ul>
<li>Постановление Правительства Москвы от 21.03.2013 об АСУ ГФ (<a href="https://www.garant.ru/products/ipo/prime/doc/70247500/" target="_blank" rel="noopener nofollow">текст на Гарант</a>);</li>
...
<p>Материал проверен по состоянию на 4 сентября 2026 года. Автор — Ярослав Михайлов, главный эксперт КазнаЭксперт, 15+ лет в Казначействе.</p>
  </article>

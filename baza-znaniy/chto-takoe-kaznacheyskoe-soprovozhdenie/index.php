...
<div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию; применимость казначейского сопровождения к конкретному контракту определяется условиями контракта и НПА на дату его заключения. Проверено экспертом КазнаЭксперт. Дата актуализации — 23 июля 2026.</p>
    </div>

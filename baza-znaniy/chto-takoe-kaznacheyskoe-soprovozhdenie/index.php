...
<meta name="description" content="Что такое казначейское сопровождение в 2026 году: кому нужно и от какой суммы, обычное и расширенное КС, отличие от банковского, пороги по 426-ФЗ, санкционирование.">
...
{"@type":"Question","name":"Какие контракты попадают под КС в 2026 году?","acceptedAnswer":{"@type":"Answer","text":"В первую очередь крупные: госконтракты для федеральных нужд от 100 млн рублей, контракты бюджетных и автономных учреждений от 10 млн рублей, а также субсидии, бюджетные инвестиции и средства по концессиям в случаях, установленных законом № 426-ФЗ."}},
...
{"@type":"Question","name":"Можно ли вывести деньги со счёта под КС на обычный счёт?","acceptedAnswer":{"@type":"Answer","text":"Свободно — нет. Средства целевые; перечисление возможно только в установленных случаях и после санкционирования операции. Расходы вне режима счёта казначейство не пропустит."}},
{"@type":"Question","name":"Распространяется ли КС на соисполнителей?","acceptedAnswer":{"@type":"Answer","text":"Да. Если головной контракт под казначейским сопровождением, договоры с соисполнителями в рамках его исполнения подпадают под тот же режим. Это нужно учитывать при выборе поставщиков."}},
...
<meta property="og:description" content="Кому нужно КС и от какой суммы, обычное и расширенное сопровождение, отличие от банковского, пороги 2026 и как проходит санкционирование платежей.">
...
<meta name="twitter:description" content="Кому нужно КС, от какой суммы, обычное и расширенное, отличие от банковского. Со ссылками на НПА.">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#ks-vs-bank">КС или банковское</a></li>
  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        ...
        <li><a href="#obychnoe-rasshirennoe">Обычное и расширенное</a></li><li><a href="#ks-vs-bank">КС или банковское</a></li>
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">100 млн</div><div class="kf__t"><b>Госконтракт</b> для федеральных нужд от 100 млн ₽ — под КС</div></div>
    ...
    <table>
      ...
      <tr><td>Бюджетный кодекс РФ, глава 24.4 (ст. 242.23–242.27)</td><td>Основы КС: какие средства сопровождаются, что такое расширенное КС, полномочия казначейства</td></tr>
      <tr><td>Постановление Правительства РФ от 24.11.2021 № 2024</td><td>Правила казначейского сопровождения и расширенного КС: счета, операции, документы</td></tr>
      <tr><td>Закон о федеральном бюджете на год (на 2026 — № 426-ФЗ от 28.11.2025, ст. 5)</td><td>Конкретные пороги сумм, перечень средств под КС и исключения на текущий год</td></tr>
    ...
    <table>
      ...
      <tr><td>Контракты для нужд субъекта РФ и муниципальных нужд</td><td>По решению о КС соответствующего бюджета (как правило, от 100 млн ₽)</td></tr>
    ...
    <div class="note"><b>Нюанс.</b> Под КС попадают не только головной исполнитель, но и соисполнители по цепочке. Если головной контракт сопровождается, то и договоры с субподрядчиками в рамках его исполнения подпадают под тот же режим — это нужно учитывать при планировании работы с поставщиками. Точные основания удобнее разбирать в отдельном материале <a href="/baza-znaniy/prichiny-otkaza-kaznacheystva-v-sankcionirovanii/">о санкционировании операций</a>.</div>
    ...
    <table>
      <caption>Чем отличается обычное КС от расширенного</caption>
      <tr><th>Параметр</th><th>Обычное КС</th><th>Расширенное КС</th></tr>
      ...
      <tr><td>Где применяется</td><td>Большинство контрактов и субсидий под КС</td><td>Капвложения, отдельные субсидии, гособоронзаказ — по решению</td></tr>
    ...
    <div class="note"><b>Главное в механизме.</b> Деньги на счёте под КС нельзя потратить «как угодно». Любой платёж — это заявка, которую казначейство сверяет с контрактом и документами. Если расход не подтверждён или не целевой, операцию вернут. Поэтому работа при КС — это в первую очередь дисциплина документов и кодов, а не просто наличие денег на счёте.</div>

    <h2 id="schet-raschety">Казначейский счёт и расчёты в 2026 году</h2>
    <div class="answer reveal">
      <p>Технически средства под КС учитываются на лицевом счёте, который ТОФК открывает участнику сопровождения (для исполнителей это счёт с кодом «71»). С него и проводятся санкционированные операции. Подробно процедуру открытия мы разбираем в инструкции <a href="/baza-znaniy/licevoy-schet-71-kak-otkryt/">«Как открыть лицевой счёт 71 в ТОФК»</a>. Что представляет собой сам счёт, его виды и реквизиты — в материале <a href="/baza-znaniy/kaznacheyskiy-schet/">«Казначейский счёт»</a>, а как получить подпись для «Электронного бюджета» — в разборе <a href="/baza-znaniy/sertifikat-ecp-kaznachejstvo/">«Сертификат и ЭЦП казначейства»</a>.</p>
    ...
    <div class="answer reveal">
      <p>Сроки в КС задаются не «по договорённости», а Порядком санкционирования, утверждённым приказом Минфина<a class="fn" href="#ref-6" aria-label="Источник 6">[6]</a>, и Правилами сопровождения. Их знание помогает планировать платежи так, чтобы деньги доходили до поставщиков вовремя, а не зависали в проверках.</p>
    </div>
    <table>
    ...
    <table>
      ...
      <tr><td>Заказчик / получатель средств</td><td>Включает условие о КС в контракт, перечисляет средства, утверждает сведения об операциях исполнителя</td></tr>
    ...
    <table>
      ...
      <tr><td>Пороги по учреждениям</td><td>Контракты бюджетных и автономных учреждений попадают под КС от 10 млн ₽</td></tr>
      <tr><td>Расширение перечня средств</td><td>Под КС подпадает более широкий круг целевых трансфертов и субсидий, чем годом ранее</td></tr>
    ...
    <div class="note"><b>Разъяснения.</b> Порядок применения новых норм Минфин и Казначейство уточняют письмами в течение года<a class="fn" href="#ref-5" aria-label="Источник 5">[5]</a>. Перед заключением крупного контракта стоит свериться с актуальными разъяснениями — формулировки условий о КС и режим расчётов могут отличаться от прошлогодних.</div>
    ...
    <div class="answer reveal">
      ...
      <p>Для бизнеса это означает, что компания может столкнуться с КС, даже не участвуя в госзакупках напрямую: например, получив целевую субсидию на проект. Принцип работы при этом сохраняется — отдельный счёт или режим расчётов, сведения об операциях, подтверждающие документы под каждый расход. Конкретные категории субсидий под сопровождением и пороги на текущий год определяются законом о бюджете и решениями о предоставлении средств, поэтому проверять условия нужно по своему договору (соглашению).</p>
    </div>

    <h2 id="oshibki">Частые ошибки исполнителей при казначейском сопровождении</h2>
    <div class="answer reveal">
      <p>Большинство проблем при КС возникает не из-за сложности норм, а из-за того, что режим воспринимают как обычный коммерческий договор. Ниже — типовые ошибки, которые на практике приводят к возвратам платежей, срыву сроков оплаты поставщикам и спорам с заказчиком, и как их не допустить.</p>
    </div>
    <table>
      ...
      <tr><td>Не проверили условие о КС в контракте</td><td>Деньги приходят на счёт под контролем, а схема расчётов не готова</td><td>До подписания проверить, попадает ли контракт под КС и какой режим расчётов применяется</td></tr>
      ...
      <tr><td>Договоры с соисполнителями без учёта КС</td><td>Расчёты с субподрядом «стопорятся»</td><td>Включать условия КС в договоры с соисполнителями заранее</td></tr>
      ...
      <tr><td>Игнорируют раздельный учёт при расширенном КС</td><td>Вопросы к обоснованности затрат, риск претензий</td><td>Вести раздельный учёт по контракту с первого дня</td></tr>
    </table>
    <div class="answer reveal">
    ...
    <div class="takeaways">
      ...
      <ol>
        ...
        <li>Различают обычное и расширенное КС; расширенное добавляет контроль фактических затрат и обязательный раздельный учёт.</li>
    ...
    <dl class="gloss">
      ...
      <div><dt>Расширенное КС</dt><dd>Режим с дополнительным контролем фактических затрат и раздельным учётом.</dd></div>
      ...
      <div><dt>Режим счёта</dt><dd>Установленные Правилами условия использования счёта под КС.</dd></div>
    </dl>
    ...
    <div class="faq">
      ...
      <details><summary>Какие контракты попадают под КС в 2026 году?</summary><p>В первую очередь крупные: госконтракты для федеральных нужд от 100 млн ₽, контракты бюджетных и автономных учреждений от 10 млн ₽, а также субсидии, бюджетные инвестиции и средства по концессиям в случаях, установленных законом № 426-ФЗ.</p></details>
      ...
      <details><summary>Можно ли вывести деньги со счёта под КС на обычный счёт?</summary><p>Свободно — нет. Средства целевые; перечисление возможно только в установленных случаях и после санкционирования операции. Расходы вне режима счёта казначейство не пропустит.</p></details>
      ...
      <details><summary>Что будет, если нарушить порядок КС?</summary><p>Конкретный платёж вернут без исполнения, а при нецелевом использовании средств возможна административная ответственность. Системные нарушения создают риск претензий по контракту, поэтому дисциплина документов критична.</p></details>
      <details><summary>Распространяется ли КС на соисполнителей?</summary><p>Да. Если головной контракт под казначейским сопровождением, договоры с соисполнителями в рамках его исполнения подпадают под тот же режим. Это нужно учитывать при выборе поставщиков.</p></details>

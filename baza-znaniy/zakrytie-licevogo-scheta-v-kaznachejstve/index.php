...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#izmeneniya">Что меняется с 1 сентября 2026 года</a></li>
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>6 мин чтения</span><span class="dot">·</span><span>Обновлено 17 августа 2026</span></div>
    </div>
...
<p>Остаток нельзя «оставить на счёте»: клиент подаёт распоряжение о совершении казначейских платежей и перечисляет средства по назначению (пункт 52). Закрытие раздела по конкретному контракту — отдельная и более быстрая процедура: заявление не подаётся, достаточно информации об исполнении или расторжении.</p></div>
    ...
    <div class="faq">
      ...
      <details><summary>Что изменится в закрытии счетов с 1 сентября 2026 года?</summary><p>Приказ Федерального казначейства от 22.06.2026 № 14н вводит возврат аванса при ликвидации поставщика: казначейство возвращает аванс по обращению государственного заказчика (приложение № 15), проверяя сведения не позднее трёх рабочих дней. Аванс отчётного года уходит в федеральный бюджет, аванс текущего года — на лицевой счёт заказчика.</p></details>
    </div>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-3">Приказ Федерального казначейства от 22.06.2026 № 14н (вступает в силу с 01.09.2026) — новая редакция пункта 51 Порядка № 44н и приложение № 15 «Обращение государственного заказчика о возврате аванса (остатка аванса) по государственному контракту».</li>

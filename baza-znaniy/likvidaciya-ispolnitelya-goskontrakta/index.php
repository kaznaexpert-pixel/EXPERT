...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__likvidaciya-ispolnitelya-goskontrakta-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__likvidaciya-ispolnitelya-goskontrakta-16x9.jpg">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <p class="lead-p">Ликвидация несовместима с действующим госконтрактом: как только в ЕГРЮЛ появляется запись «в процессе ликвидации», исполнитель перестаёт отвечать пункту 3 части 1 статьи 31 закона № 44-ФЗ, и заказчик обязан отказаться от контракта — с реестром недобросовестных поставщиков. Сначала закрывайте контракт и лицевой счёт, потом ликвидируйтесь.</p>
    </div>
    ...
    <h3 id="dve-daty">Две даты, которые всё решают</h3>
    ...
    <h3 id="srok-likvidacii">Сколько длится ликвидация ООО</h3>
    ...
    <h3 id="obyazan-otkazatsya">Заказчик обязан отказаться от контракта</h3>
    ...
    <h3 id="likvidaciya-strozhe">Почему ликвидация строже банкротства</h3>
    ...
    <h3 id="reestr-po-lyudyam">Реестр бьёт по людям, а не по компании</h3>
    ...
    <h3 id="otbitsya-ot-reestra">Можно ли отбиться от реестра</h3>
    ...
    <h3 id="do-i-posle-zapisi">Что можно до записи о ликвидации и что после</h3>
    <table>
    ...
    <h3 id="rastorzhenie-po-soglasheniyu">Расторжение по соглашению сторон — чистый выход</h3>
    ...
    <h3 id="pravo-podpisi-likvidatora">Кто подписывает документы после старта ликвидации</h3>
    ...
    <h3 id="ostatok-na-schete">Куда девать остаток на лицевом счёте</h3>
    ...
    <h3 id="raskladka-sredstv">Что заработано, а что долг перед заказчиком</h3>
    ...
    <h3 id="nedostatochnost-imushchestva">Если имущества не хватает: ликвидация уходит в банкротство</h3>
    ...
    <h3 id="brosit-kompaniyu">Почему «бросить компанию» — не выход</h3>
    ...
    <h3 id="vozvrat-ot-kontragenta">Куда возвращать деньги от контрагента</h3>
    ...
    <h3 id="kejs-uvedomlenie">Уведомление в налоговую раньше времени: чем это кончилось</h3>

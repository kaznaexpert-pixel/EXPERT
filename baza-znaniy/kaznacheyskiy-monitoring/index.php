...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Что такое казначейский мониторинг простыми словами?", "acceptedAnswer": {"@type": "Answer", "text": "Это наблюдение казначейства за операциями участников казначейского сопровождения, чтобы заранее выявлять риски финансовых нарушений. При срабатывании риска казначейство приостанавливает операцию или направляет предупреждение. Основание — статья 242.13-1 Бюджетного кодекса."}}, {"@type": "Question", "name": "Чем казначейский мониторинг отличается от бюджетного?", "acceptedAnswer": {"@type": "Answer", "text": "Это один и тот же институт. Статья 242.13-1 раньше называлась «Бюджетный мониторинг в системе казначейских платежей», а с 21 апреля 2025 года — «Казначейский мониторинг». Механизм не изменился."}}, {"@type": "Question", "name": "Какие меры реагирования применяет казначейство?", "acceptedAnswer": {"@type": "Answer", "text": "Две: приостановление операции на лицевом счёте и предупреждение (информирование). Приостановление останавливает платёж до устранения причины, предупреждение — это сигнал о риске."}}, {"@type": "Question", "name": "Это штраф?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Мониторинг — превентивный контроль, а не наказание. Меры реагирования не являются административным штрафом; ответственность наступает по отдельным основаниям КоАП."}}, {"@type": "Question", "name": "Кого касается мониторинг?", "acceptedAnswer": {"@type": "Answer", "text": "Участников казначейского сопровождения — тех, кому открыты лицевые счета для работы с целевыми средствами: исполнителей и соисполнителей контрактов, получателей субсидий и бюджетных инвестиций."}}, {"@type": "Question", "name": "Чем мониторинг отличается от санкционирования?", "acceptedAnswer": {"@type": "Answer", "text": "Санкционирование проверяет конкретный платёж перед его проведением, а мониторинг — это непрерывная риск-оценка при открытии счёта и операциях. Это два параллельных фильтра."}}, {"@type": "Question", "name": "Что делать, если операцию приостановили?", "acceptedAnswer": {"@type": "Answer", "text": "Узнать причину в казначействе, проверить реквизиты распоряжения, собрать подтверждающие документы и направить пояснения. После устранения основания операцию проводят."}}, {"@type": "Question", "name": "Что меняется с 1 сентября 2026 года?", "acceptedAnswer": {"@type": "Answer", "text": "Статья 242.13-1 действует в новой редакции (Федеральный закон от 24.06.2025 № 158-ФЗ). До этой даты установлены переходные особенности информирования о мерах реагирования (часть 9 статьи 5 Закона о бюджете на 2026 год)."}}, {"@type": "Question", "name": "Постановление № 2483 ещё действует?", "acceptedAnswer": {"@type": "Answer", "text": "До 31 августа 2026 года включительно — да. С 1 сентября 2026 года правила казначейского мониторинга применяются по постановлению Правительства от 27.07.2026 № 941, а постановление от 25.12.2021 № 2483 утрачивает силу."}}, {"@type": "Question", "name": "Останется ли приостановление открытия лицевого счёта после 1 сентября 2026 года?", "acceptedAnswer": {"@type": "Answer", "text": "Сама мера остаётся в статье 242.13-1 Бюджетного кодекса, но её процедура уходит из Порядка № 44н: приказ Казначейства от 22.06.2026 № 14н отменяет пункты 31–33 и приложения № 4 – № 8. Порядок применения смотрите в постановлении № 941."}}]}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#indikatory">Типовые основания для мер реагирования</a></li>
  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        <li><a href="#chto-takoe">Казначейский мониторинг: коротко</a></li><li><a href="#osnova">Правовая основа: статья 242.13-1 БК и постановление № 2483</a></li><li><a href="#terminy">Бюджетный или казначейский мониторинг: как менялось название</a></li><li><a href="#kto-pod">Кого касается мониторинг</a></li><li><a href="#kak-rabotaet">Как проводится мониторинг: система управления рисками</a></li><li><a href="#mery">Меры реагирования: приостановление и предупреждение</a></li><li><a href="#indikatory">Типовые основания для мер реагирования</a></li><li><a href="#posledstviya">Последствия для бизнеса и как оспорить меру</a></li><li><a href="#otlichiya">Мониторинг, санкционирование и госфинконтроль: разница</a></li><li><a href="#izmeneniya">Что меняется с 1 сентября 2026 года</a></li><li><a href="#kak-snizit">Как снизить риск мер реагирования: чек-лист</a></li><li><a href="#howto">Что делать при приостановлении операции: пошагово</a></li><li><a href="#oshibki">Частые ошибки и заблуждения</a></li><li><a href="#keys">Пример из практики</a></li><li><a href="#glossary">Глоссарий</a></li><li><a href="#faq">Частые вопросы</a></li>
      </ol>
    </details>
    ...
    <h2 id="osnova">Правовая основа: статья 242.13-1 БК, постановления № 2483 и № 941</h2>
    ...
    <p>Срок жизни у постановления № 2483 ограничен: с 1 сентября 2026 года оно утрачивает силу, а правила мониторинга применяются по постановлению Правительства от 27.07.2026 № 941.<a class="fn" href="#ref-6" aria-label="Источник 6">[6]</a> Разбор перехода — ниже, в разделе <a href="#izmeneniya">что меняется с 1 сентября 2026 года</a>.</p>
    <table>
      ...
      <tr><td>Постановление Правительства № 2483</td><td>Порядок проведения и применения мер реагирования — до 31 августа 2026 года</td></tr>
      <tr><td>Постановление Правительства № 941</td><td>Правила проведения мониторинга — с 1 сентября 2026 года, взамен № 2483</td></tr>
    ...
    <h2 id="indikatory">Типовые основания для мер реагирования</h2>
    <p>Конкретный перечень индикаторов риска устанавливается подзаконными актами и носит технический характер, но на практике большинство срабатываний сводится к нескольким понятным группам. Знание этих оснований помогает заранее настроить документооборот так, чтобы операции не «зависали».</p>
    <table>
    ...
    <p>Меняются сразу три уровня регулирования: статья 242.13-1 Бюджетного кодекса действует в новой редакции, порядок мониторинга переезжает из постановления № 2483 в постановление № 941, а из Порядка открытия лицевых счетов № 44н процедуры мониторинга исключаются целиком.</p>

    <h3 id="izm-941">Постановление № 941 вместо постановления № 2483</h3>
    <p>Правила проведения казначейского мониторинга утверждены постановлением Правительства от 27.07.2026 № 941 и применяются с 1 сентября 2026 года. С этой же даты постановление от 25.12.2021 № 2483 утрачивает силу.<a class="fn" href="#ref-6" aria-label="Источник 6">[6]</a> Ссылки на № 2483 в регламентах и учётной политике после этой даты ведут в никуда.</p>
    ...
    <p>На переходный период установлены особенности. До 1 сентября 2026 года информация о применении мер реагирования направляется получателям бюджетных средств, доводящим лимиты на предоставление целевых средств, а также юридическим лицам и индивидуальным предпринимателям — получателям таких средств. Это закреплено в части 9 статьи 5 Федерального закона от 28.11.2025 № 426-ФЗ о федеральном бюджете на 2026 год.<a class="fn" href="#ref-5" aria-label="Источник 5">[5]</a></p>
    ...
    <div class="faq">
      ...
      <details><summary>Постановление № 2483 ещё действует?</summary><p>До 31 августа 2026 года включительно — да. С 1 сентября 2026 года правила казначейского мониторинга применяются по постановлению Правительства от 27.07.2026 № 941, а постановление от 25.12.2021 № 2483 утрачивает силу.</p></details>
    ...
    <p data-ctx="auto-ctx:poryadok-sankcionirovaniya-rashodov">Мониторинг не идёт отдельной процедурой поверх платежей: с редакции от 27.06.2025 пункт 13 приказа Минфина России № 214н прямо говорит, что территориальный орган казначейства осуществляет проверки в рамках казначейского мониторинга <b>при санкционировании</b> операций с целевыми средствами. Как выглядит этот единый проход по распоряжению и какие сроки в нём установлены — в разборе <a href="/baza-znaniy/poryadok-sankcionirovaniya-rashodov/">санкционирования расходов при казначейском сопровождении</a>.</p>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-6">Постановление Правительства РФ от 27.07.2026 № 941 «Об утверждении Правил проведения казначейского мониторинга и применения мер реагирования» — применяется с 1 сентября 2026 года, постановление № 2483 утрачивает силу с этой же даты; официально опубликовано 27.07.2026. pravo.gov.ru, garant.ru.</li>

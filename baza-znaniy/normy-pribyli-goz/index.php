  ...
  <article class="content" id="main">
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-6">Федеральный закон от 29.12.2012 № 275-ФЗ «О государственном оборонном заказе»: статья 8 (ч. 3 — запрет необоснованного завышения цены), статья 9 (цели и принципы государственного регулирования цен).</li>
      </ol>
      <p class="refs__note">Нормы приведены по состоянию на 2 июля 2026 года по тексту Положения № 1465 в редакции от 14.02.2026. Размеры рентабельности относятся к плановой прибыли при затратном методе; по конкретной номенклатуре могут действовать отраслевые методические рекомендации (п. 56). Материал носит справочный характер и не является юридической консультацией.</p>
    </div>
  </article>

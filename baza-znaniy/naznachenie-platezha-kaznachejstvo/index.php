...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>14 мин чтения</span><span class="dot">·</span><span>Обновлено 29 июня 2026</span></div>
    </div>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Приказ Минфина России от 17.12.2021 № 214н (Порядок санкционирования операций со средствами участников казначейского сопровождения; требования к распоряжению и его реквизитам).</li>
        <li id="ref-2">Постановление Правительства РФ от 24.11.2021 № 2024 (Правила казначейского сопровождения).</li>
        <li id="ref-3">Бюджетный кодекс РФ, статья 242.23 (казначейское сопровождение; операции по лицевому счёту).</li>
      ...
      <p class="refs__note">Сведения приведены по состоянию на 29 июня 2026 года. Конкретные требования к составу и структуре назначения платежа уточняйте в действующем порядке санкционирования и в своём территориальном органе казначейства. Материал носит справочный характер и не заменяет консультацию.</p>
    </div>
  </article>

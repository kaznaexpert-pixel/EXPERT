...
<meta name="description" content="Что указывать в назначении платежа при КС: идентификатор контракта, документ-основание, предмет и НДС, чтобы платёж прошёл санкционирование.">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      <li><a href="#pochemu">Почему назначение платежа так важно при КС</a></li>
      ...
      <li><a href="#chek-list">Чек-лист: назначение платежа при КС</a></li>
  ...
  <article class="content" id="main">
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        <div class="kf"><div class="kf__n">Санкционирование</div><div class="kf__t"><b>Почему важно</b> — при КС казначейство проверяет назначение платежа на этапе санкционирования; несоответствие — возврат распоряжения</div></div>
    ...
    <h2 id="pochemu">Почему назначение платежа так важно при КС</h2>
    ...
    <h2 id="chek-list">Чек-лист: назначение платежа при КС</h2>
    ...
    <div class="faq">
      ...
      <details><summary>Почему назначение платежа так важно при КС?</summary><p>Потому что казначейство проверяет его при санкционировании. Если из назначения не видно, по какому контракту и за что идёт платёж, и не подтверждается его целевой характер, операцию не санкционируют и распоряжение возвращают.</p></details>

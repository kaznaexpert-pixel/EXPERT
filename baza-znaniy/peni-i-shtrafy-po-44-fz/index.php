...
{"@type":"HowToStep","position":2,"name":"Взять ключевую ставку","text":"Используйте ключевую ставку ЦБ, действующую на дату уплаты пеней. На июль 2026 — 14,25% годовых (действует с 22 июня 2026)."},
...
{"@type":"Question","name":"Чему равна ключевая ставка для расчёта?","acceptedAnswer":{"@type":"Answer","text":"Берётся ключевая ставка ЦБ, действующая на дату уплаты пеней. С 22 июня 2026 года она составляет 14,25% годовых; перед расчётом проверьте актуальное значение на сайте Банка России."}},
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Неустойка по 44-ФЗ состоит из двух частей: <b>пеней</b> за просрочку и <b>штрафов</b> за иные нарушения. Пени считаются за каждый день просрочки как <b>1/300 ключевой ставки ЦБ</b> от цены контракта, уменьшенной на стоимость уже исполненного (ч. 7 ст. 34 № 44-ФЗ)<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a>. Штраф — фиксированный процент от цены контракта по постановлению Правительства № 1042<a class="fn" href="#ref-2" aria-label="Источник 2">[2]</a>. На июль 2026 ключевая ставка — 14,25% (с 22 июня 2026).</div>
<div class="related-inline"><b>Не путать:</b> здесь — договорная неустойка перед заказчиком по 44-ФЗ. Административные штрафы государства по КоАП за нарушения при казначейском сопровождении (раздельный учёт, сроки сведений) — в <a href="/baza-znaniy/shtrafy-pri-kaznacheyskom-soprovozhdenii-2026/">отдельном разборе штрафов 2026 года</a>.</div>
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">14,25%</div><div class="kf__t"><b>Ключевая ставка ЦБ</b> — действует с 22.06.2026</div></div>
    ...
    <div class="calc peni-calc" id="peniCalc">
      ...
      <div class="calc__row">
        <div>
          ...
          <input id="peniRate" type="number" min="0" step="0.25" inputmode="decimal" value="14.25">
        </div>
        <div>
    ...
    <div class="answer reveal">
      ...
      <p>В виде формулы: <b>Пени = (Ц − В) × С / 300 × Д</b>, где Ц — цена контракта, В — стоимость исполненных и принятых обязательств, С — ключевая ставка ЦБ в долях (14,25% = 0,1425), Д — число дней просрочки.</p>
    ...
    <div class="answer reveal">
      <p>Чтобы формулы стали наглядными, разберём три типовые ситуации. Везде ключевая ставка взята 14,25%.</p>
      <table>
        <caption>Расчёт пеней и штрафа на типовых суммах (ставка ЦБ 14,25%)</caption>
        <thead><tr><th>Ситуация</th><th>Расчёт</th><th>Результат</th></tr></thead>
        <tbody>
          <tr><td>Контракт 5 млн ₽, ничего не сдано, просрочка 10 дней</td><td>5 000 000 × 0,1425 / 300 × 10</td><td>≈ 23 750 ₽ пеней (0,48% цены)</td></tr>
          <tr><td>Контракт 5 млн ₽, принято на 2 млн ₽, просрочка 20 дней</td><td>(5 000 000 − 2 000 000) × 0,1425 / 300 × 20</td><td>≈ 28 500 ₽ пеней</td></tr>
    ...
    <div class="answer reveal">
      <dl class="gloss">
        ...
        <div><dt>Ключевая ставка</dt><dd>Базовая ставка Банка России; с 22 июня 2026 — 14,25% годовых.</dd></div>
    ...
    <div class="faq reveal">
      ...
      <details><summary>Чему равна ключевая ставка для расчёта?</summary><p>Берётся ключевая ставка ЦБ, действующая на дату уплаты пеней. С 22 июня 2026 года она составляет 14,25% годовых; перед расчётом проверьте актуальное значение на сайте Банка России.</p></details>

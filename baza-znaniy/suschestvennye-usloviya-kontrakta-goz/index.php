...
{"@type":"Question","name":"Какие условия контракта по ГОЗ являются существенными?","acceptedAnswer":{"@type":"Answer","text":"Предмет, цена и её вид, идентификатор государственного контракта (ИГК), условие об отдельном счёте и режиме его использования, форма сопровождения (банковское или казначейское), обязанности по кооперации, сроки и порядок приёмки."}},
{"@type":"Question","name":"Каким законом регулируется контракт по ГОЗ?","acceptedAnswer":{"@type":"Answer","text":"Общие условия — Федеральным законом № 44-ФЗ (статья 34), специальные требования гособоронзаказа — Федеральным законом от 29.12.2012 № 275-ФЗ. Часть условий приходит из типовых условий контрактов ГОЗ."}},
{"@type":"Question","name":"Зачем в контракте ГОЗ отдельный счёт?","acceptedAnswer":{"@type":"Answer","text":"Чтобы обеспечить прослеживаемость средств: расчёты по контракту идут только через отдельный счёт с режимом использования, а назначение каждого платежа контролируется банком или казначейством."}},
{"@type":"Question","name":"Чем банковское сопровождение ГОЗ отличается от казначейского?","acceptedAnswer":{"@type":"Answer","text":"При банковском сопровождении счёт открывается в уполномоченном банке, который контролирует расчёты. При казначейском — лицевой счёт в территориальном органе казначейства с санкционированием операций. По умолчанию для ГОЗ применяется банковское сопровождение, для отдельных контрактов — казначейское."}},
{"@type":"Question","name":"Нужно ли указывать ИГК в контракте по ГОЗ?","acceptedAnswer":{"@type":"Answer","text":"Да. Идентификатор государственного контракта указывают в номере контракта, в платёжных документах, во внутренних распоряжениях исполнителя и в договорах с соисполнителями. В ГОЗ применяется 25-значный идентификатор."}},
{"@type":"Question","name":"Что будет, если нарушить режим отдельного счёта?","acceptedAnswer":{"@type":"Answer","text":"Платежи не пройдут по режиму использования счёта, а нарушение существенных условий контракта может повлечь претензии заказчика и ответственность исполнителя."}},
{"@type":"Question","name":"Должны ли соисполнители открывать отдельные счета?","acceptedAnswer":{"@type":"Answer","text":"Как правило, да: каждый участник кооперации открывает отдельный счёт под тот же контракт, а головной исполнитель уведомляет соисполнителей и переносит существенные условия ГОЗ в договоры с ними."}},
{"@type":"Question","name":"Какой вид цены указывать в контракте ГОЗ?","acceptedAnswer":{"@type":"Answer","text":"Ориентировочную (уточняемую), фиксированную или возмещающую издержки — в зависимости от контракта. Вид цены и условия её перевода в фиксированную должны быть зафиксированы в контракте явно."}}
]}
</script>
<script type="application/ld+json">

...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        <li><a href="#chto-takoe">Что такое СУФД</a></li><li><a href="#komu">Кому нужен СУФД, а кому ЭБ</a></li><li><a href="#vozmozhnosti">Что можно делать в СУФД</a></li><li><a href="#podklyuchenie">Подключение: пошагово</a></li><li><a href="#trebovaniya">Требования к рабочему месту</a></li><li><a href="#vhod">Вход в систему</a></li><li><a href="#oshibki">Типовые ошибки и решения</a></li><li><a href="#checklist">Чек-лист первого платежа</a></li><li><a href="#bezopasnost">Подписи и безопасность</a></li><li><a href="#keys">Пример из практики</a></li><li><a href="#glossary">Глоссарий</a></li><li><a href="#faq">Частые вопросы</a></li>
      </ol>
    </details>
    ...
    <table>
      ...
      <tr><td>Основной сценарий</td><td>Платёжные документы, выписки, отчётность по лицевым счетам</td><td>Широкий контур: планирование, закупки, лицевые счета участников КС, отчётность</td></tr>
      <tr><td>Участники казначейского сопровождения</td><td>Используется для отдельных операций по решению УФК</td><td>Основной канал: открытие лицевых счетов 71, сведения об операциях с целевыми средствами</td></tr>
      <tr><td>Доступ</td><td>Веб-портал + сертификат УЦ ФК + СКЗИ</td><td>Личный кабинет budget.gov.ru + сертификат + СКЗИ</td></tr>
    </table>
    <div class="note"><b>Практический ориентир.</b> Если вы коммерческий подрядчик и вам открывают лицевой счёт 71 для казначейского сопровождения — ваш основной инструмент, скорее всего, «Электронный бюджет» (как открыть счёт, разбирали <a href="/baza-znaniy/licevoy-schet-71-kak-otkryt/">в отдельной инструкции</a>). СУФД чаще остаётся за «классическими» клиентами казначейства. Точный ответ всегда даёт ваше УФК — состав систем зависит от категории клиента.</div>
    ...
    <p>Технические требования скромные — портал работает на обычном офисном компьютере.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></p>
    <table>
    ...
    <p>Адрес портала для своего региона уточняйте в памятке УФК: единой публичной точки входа нет, каналы доступа настраиваются при подключении. Если рабочих мест несколько, каждое настраивается отдельно, а сертификаты сотрудников не «переносятся» между компьютерами без переустановки ключей.</p>
    ...
    <ul>
      ...
      <li>в назначении платежа есть обязательная аналитика (для участников КС — лицевой счёт и ИГК);</li>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит информационный характер. Состав ПО и порядок подключения зависят от требований вашего УФК; сверяйтесь с актуальными памятками на региональном сайте казначейства. Информация актуальна на 11 июня 2026 года.</p>
    </div>
  </article>

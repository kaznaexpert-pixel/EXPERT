...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p data-ctx="giis-root">Чем СУФД отличается от «Электронного бюджета» по назначению, понятно из устройства последнего: подсистемы, операторы и круг пользователей описаны в обзоре <a href="/baza-znaniy/giis-elektronnyy-byudzhet/">ГИИС «Электронный бюджет»: что это и кто в ней работает</a>.</p>

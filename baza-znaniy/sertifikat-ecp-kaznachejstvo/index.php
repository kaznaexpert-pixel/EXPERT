...
<meta name="description" content="Сертификат казначейства: какие бывают сертификаты УЦ ФК, кому нужна ЭЦП казначейства, документы и Портал заявителя, подключение к «Электронному бюджету», продление.">
...
<meta property="og:description" content="Сертификат казначейства: какие бывают сертификаты УЦ ФК, кому нужна ЭЦП казначейства, документы и Портал заявителя, подключение к «Электронному бюджету», продление.">
...
<meta name="twitter:description" content="Сертификат казначейства: какие бывают сертификаты УЦ ФК, кому нужна ЭЦП казначейства, документы и Портал заявителя, подключение к «Электронному бюджету», продление.">
...
<p>Квалифицированный сертификат для работы в ГИИС «Электронный бюджет» выдаёт удостоверяющий центр Федерального казначейства. Заявка подаётся дистанционно через портал заявителя (ФЗС) — fzs.roskazna.ru.</p>
<ol>
...
<!-- p47:vidy-i-roli -->
    ...
    <table>
      ...
      <tbody>
        <tr><td>Личный (пользовательский) сертификат должностного лица</td><td>Им подписывают документы в «Электронном бюджете» и других системах казначейства</td><td>Удостоверяющий центр казначейства через <a href="/baza-znaniy/portal-zayavitelya-kaznachejstva/">Портал заявителя</a></td></tr>

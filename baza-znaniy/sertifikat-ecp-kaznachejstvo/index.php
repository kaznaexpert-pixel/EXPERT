...
<title>ЭЦП казначейства: как получить и подать запрос на сертификат онлайн</title>
<meta name="description" content="Сертификат казначейства: кому УЦ ФК выдаёт ЭЦП, включая исполнителей под сопровождением (ПП № 1018), документы, подача через ФЗС, вход в «Электронный бюджет».">
...
{"@context": "https://schema.org", "@type": "Article", "headline": "ЭЦП казначейства: как получить и подать запрос на сертификат онлайн", "description": "Сертификат казначейства: какие бывают сертификаты УЦ ФК, кому нужна ЭЦП казначейства, документы и ФЗС, подключение к «Электронному бюджету», продление.", "datePublished": "2026-06-05T10:00:00+03:00", "dateModified": "2026-09-10", "inLanguage": "ru-RU", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/", "@id": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/#person", "image": "https://kaznaexpert.ru/img/team/mihailov-photo.jpg"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}, "@id": "https://kaznaexpert.ru/#organization"}, "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/sertifikat-ecp-kaznachejstvo/"}, "image": ["https://kaznaexpert.ru/img/og/baza-znaniy__sertifikat-ecp-kaznachejstvo-16x9.jpg", "https://kaznaexpert.ru/img/og/baza-znaniy__sertifikat-ecp-kaznachejstvo-4x3.webp", "https://kaznaexpert.ru/img/og/baza-znaniy__sertifikat-ecp-kaznachejstvo-1x1.webp"], "citation": ["https://roskazna.gov.ru/gis/udostoveryayushchij-centr/onlajn-servis-podachi-dokumentov-dlya-polucheniya-sertifikatov-portal-zayavitelya", "https://roskazna.gov.ru/gis/udostoveryayushchij-centr/", "https://iitrust.ru/articles/expert/elektronnaya-podpis-v-gosudarstvennyh-udostoveryaushhih-tsentrah-kak-poluchit-sertifikat-v-uts-fns-uts-fk-i-uts-banka-rossii/"]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Главная", "item": "https://kaznaexpert.ru/", "url": "https://kaznaexpert.ru/"}, {"@type": "ListItem", "position": 2, "name": "База знаний", "item": "https://kaznaexpert.ru/baza-znaniy/", "url": "https://kaznaexpert.ru/baza-znaniy/"}, {"@type": "ListItem", "position": 3, "name": "Сертификат и ЭЦП казначейства", "url": "https://kaznaexpert.ru/baza-znaniy/sertifikat-ecp-kaznachejstvo/"}]}
</script>
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "HowTo", "name": "Как получить сертификат ЭЦП казначейства", "description": "Получение квалифицированной подписи в удостоверяющем центре Федерального казначейства через ФЗС.", "step": [{"@type": "HowToStep", "position": 1, "name": "Регистрация", "text": "Зарегистрируйтесь на Портале заявителя информационной системы УЦ Федерального казначейства. Если организация ещё не работала с УЦ ФК, до первичного запроса заключается договор (соглашение) о присоединении к Регламенту удостоверяющего центра."}, {"@type": "HowToStep", "position": 2, "name": "Запрос на сертификат", "text": "Заполните форму запроса: регион, тип заявителя (организация или ИП), ОГРН/ОГРНИП и ИНН."}, {"@type": "HowToStep", "position": 3, "name": "Генерация ключа", "text": "Сформируйте ключевую пару на защищённом токене, выбрав неэкспортируемый закрытый ключ."}, {"@type": "HowToStep", "position": 4, "name": "Документы", "text": "Приложите сканы паспорта, СНИЛС и ИНН владельца и подпишите заявление."}, {"@type": "HowToStep", "position": 5, "name": "Выпуск", "text": "Дождитесь проверки (до 5 рабочих дней) и установите выпущенный сертификат на токен."}]}</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Где получить ЭЦП казначейства?", "acceptedAnswer": {"@type": "Answer", "text": "Сертификат выдаёт удостоверяющий центр Федерального казначейства. Документы подаются онлайн через ФЗС на сайте Федерального казначейства, готовый сертификат записывается на защищённый токен."}}, {"@type": "Question", "name": "Сколько делается сертификат?", "acceptedAnswer": {"@type": "Answer", "text": "На проверку документов и изготовление сертификата УЦ Федерального казначейства требуется до 5 рабочих дней с момента подачи полного комплекта."}}, {"@type": "Question", "name": "Какие документы нужны?", "acceptedAnswer": {"@type": "Answer", "text": "Паспорт, СНИЛС и ИНН владельца сертификата, а также реквизиты организации (ОГРН/ОГРНИП, ИНН) для формирования запроса. Сканы должны быть читаемыми и совпадать с данными в заявлении."}}, {"@type": "Question", "name": "Чем подпись казначейства отличается от подписи ФНС?", "acceptedAnswer": {"@type": "Answer", "text": "Подпись ФНС выдаётся юридическому лицу на руководителя и ИП — для обычной деятельности, и «Электронный бюджет» её принимает. Подпись УЦ казначейства выдаётся должностным лицам организаций из перечня № 1018, включая работников коммерческих исполнителей под сопровождением, — по одной на каждого подписанта, с подачей и сменой через ФЗС. Обе нужны часто, но не обязательно."}}, {"@type": "Question", "name": "Что значит «экспортируемый закрытый ключ»?", "acceptedAnswer": {"@type": "Answer", "text": "Это свойство ключа: экспортируемый можно скопировать с токена, неэкспортируемый — нельзя. Для работы с государственными системами рекомендуется выбирать неэкспортируемый ключ — он надёжнее."}}, {"@type": "Question", "name": "На какой срок выдаётся сертификат?", "acceptedAnswer": {"@type": "Answer", "text": "Как правило, на 12 месяцев. Продление запрашивается заранее, за 3–4 недели до окончания срока, через тот же ФЗС."}}, {"@type": "Question", "name": "Нужен ли отдельный токен и КриптоПро?", "acceptedAnswer": {"@type": "Answer", "text": "Да. Закрытый ключ хранится на защищённом токене (Рутокен, JaCarta), а для работы подписи нужно средство криптозащиты — обычно КриптоПро CSP с действующей лицензией."}}, {"@type": "Question", "name": "Что делать, если в подписи отказали?", "acceptedAnswer": {"@type": "Answer", "text": "Чаще всего причина — несоответствие данных, нечитаемые сканы или ненастроенное рабочее место. Устраните замечание и подайте запрос повторно; типовые ошибки видно ещё на этапе подготовки."}}, {"@type": "Question", "name": "Можно ли получить подпись казначейства удалённо?", "acceptedAnswer": {"@type": "Answer", "text": "Подача документов идёт онлайн через ФЗС. Само рабочее место и генерация ключа выполняются на стороне заявителя; мы помогаем настроить процесс и пройти его без возвратов по всей России."}}, {"@type": "Question", "name": "Что такое сертификат казначейства?", "acceptedAnswer": {"@type": "Answer", "text": "Это квалифицированный сертификат ключа проверки электронной подписи, который создаёт и выдаёт удостоверяющий центр Федерального казначейства. Основание — пункт 1 части 3 статьи 17.2 закона от 06.04.2011 № 63-ФЗ; порядок работы центра установлен приказом Казначейства России от 15.06.2021 № 21н."}}, {"@type": "Question", "name": "Чем сертификаты казначейства отличаются от личной подписи?", "acceptedAnswer": {"@type": "Answer", "text": "Личный сертификат должностного лица — это подпись, которой подписывают документы. Головной и подчинённые сертификаты удостоверяющего центра и списки отзыва — служебные файлы цепочки доверия: они нужны, чтобы система признала подпись действительной, но подписать ими ничего нельзя."}}, {"@type": "Question", "name": "Нужен ли исполнителю контракта сертификат казначейства?", "acceptedAnswer": {"@type": "Answer", "text": "Право есть, обязанности нет. Коммерческие организации, получающие сопровождаемые средства из бюджета, включены в перечень постановления Правительства РФ от 10.07.2020 № 1018, поэтому УЦ казначейства выдаёт сертификаты их руководителю и работникам (пункт 4 части 3 статьи 17.2 закона № 63-ФЗ, письмо Межрегионального операционного УФК от 25.08.2023 № 95-09-11/15-377). Работать в «Электронном бюджете» можно и сертификатом ФНС или иного аккредитованного центра — это подтверждено письмом Казначейства России от 02.11.2023 № 07-04-05/11-32062."}}, {"@type": "Question", "name": "Что происходит с сертификатом при увольнении владельца?", "acceptedAnswer": {"@type": "Answer", "text": "Сертификат прекращает действие: по пункту 4 части 1 и пункту 3 части 3 статьи 17.2 закона № 63-ФЗ достаточно обращения уполномоченного лица в удостоверяющий центр, порядок прекращения установлен частью 7 статьи 14. Новому подписанту выпускается собственный сертификат, поэтому замену лучше готовить заранее."}}, {"@type": "Question", "name": "Почему система пишет, что сертификат казначейства не доверен?", "acceptedAnswer": {"@type": "Answer", "text": "Чаще всего не установлен головной сертификат удостоверяющего центра или не обновлён список отзыва — то есть не строится цепочка доверия. Сначала проверяют служебные файлы на рабочем месте и только потом состояние самой подписи."}}, {"@type": "Question", "name": "Сколько сертификатов нужно организации-исполнителю?", "acceptedAnswer": {"@type": "Answer", "text": "Столько, сколько сотрудников реально подписывает документы: подпись принадлежит физическому лицу, а статья 10 закона № 63-ФЗ обязывает обеспечивать конфиденциальность ключа и не допускать его использование без согласия владельца. Рабочий минимум — сертификаты руководителя и того, кто ведёт расчёты по контракту."}}, {"@type": "Question", "name": "Можно ли подписывать документы, если срок сертификата истёк?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. По статье 11 закона № 63-ФЗ подпись признаётся действительной, если сертификат действовал на момент подписания документа либо на день проверки, когда момент подписания не определён, и срок действия ключа не истёк. Перевыпуск начинают заранее, не дожидаясь последнего дня."}}, {"@type": "Question", "name": "Можно ли работать одной подписью в ЕИС и СУФД?", "acceptedAnswer": {"@type": "Answer", "text": "В ЕИС и «Электронном бюджете» — да: сертификат ФНС России принимается в обеих системах (письмо Казначейства России от 02.11.2023 № 07-04-05/11-32062). В СУФД-портале учётная запись пользователя регистрируется через УФК под сертификат удостоверяющего центра казначейства — состав сертификатов уточняют в своём управлении. На практике исполнитель держит обе подписи, но обязательного требования об этом нет."}}, {"@type": "Question", "name": "Как подать заявку на ЭЦП в Федеральное казначейство?", "acceptedAnswer": {"@type": "Answer", "text": "Федеральное казначейство принимает заявку на ЭЦП через онлайн-сервис fzs.roskazna.ru: кнопка «Подать документы», выбор региона и ТОФК, ввод ОГРН и паспортных данных, формирование ключа на токене, заявление с подписью и сканом. После проверки через СМЭВ оператор приглашает в ТОФК для идентификации, сертификат создаётся в течение 5 рабочих дней со дня подачи заявления."}}, {"@type": "Question", "name": "Можно ли получить сертификат казначейства онлайн, без визита?", "acceptedAnswer": {"@type": "Answer", "text": "Полностью онлайн — только при смене сертификата по действующей подписи УЦ ФК: вход «по сертификату», заявление подписывается электронной подписью, файл скачивается в личном кабинете. При первичном получении онлайн проходят запрос, заявление и проверки, а идентификация по паспорту — очно в ТОФК."}}, {"@type": "Question", "name": "Как сделать ЭЦП в казначействе для исполнителя контракта?", "acceptedAnswer": {"@type": "Answer", "text": "Подать запрос на fzs.roskazna.ru от имени организации на конкретного сотрудника, приложить заверенную копию приказа о назначении на должность (руководителю, указанному в ЕГРЮЛ, приказ не нужен), пройти проверку СМЭВ и один раз посетить ТОФК для идентификации по паспорту. Сертификат создаётся в течение 5 рабочих дней; доверенности и приказы по основной деятельности вместо приказа о назначении не принимаются (пункт 19 Порядка № 21н, письмо МОУ ФК от 25.08.2023)."}}, {"@type": "Question", "name": "Чем головной сертификат отличается от сертификата казначейства?", "acceptedAnswer": {"@type": "Answer", "text": "Сертификат казначейства (ЭЦП казначейства) — ваш квалифицированный сертификат пользователя, выданный УЦ Федерального казначейства. Головной (корневой) сертификат — служебный сертификат самого удостоверяющего центра, который устанавливают на рабочее место, чтобы система доверяла вашей подписи. Первый получают по заявлению, второй просто скачивают и устанавливают."}}]}
</script>
<script type="application/ld+json">
...
<meta property="og:title" content="ЭЦП казначейства: как получить и подать запрос на сертификат онлайн">
<meta property="og:description" content="Сертификат казначейства: кому УЦ ФК выдаёт ЭЦП, включая исполнителей под сопровождением (ПП № 1018), документы, подача через ФЗС, вход в «Электронный бюджет».">
<meta property="og:url" content="https://kaznaexpert.ru/baza-znaniy/sertifikat-ecp-kaznachejstvo/">
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__sertifikat-ecp-kaznachejstvo-16x9.jpg">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="675">
<meta property="og:image:alt" content="Сертификат и ЭЦП казначейства — КазнаЭксперт">
<meta property="article:published_time" content="2026-06-05T09:00:00+03:00">
<meta property="article:modified_time" content="2026-09-10T10:00:00+03:00">
<meta property="article:author" content="https://kaznaexpert.ru/komanda/mihailov-yaroslav/">
<meta property="article:section" content="База знаний">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="ЭЦП казначейства: как получить и подать запрос на сертификат онлайн">
<meta name="twitter:description" content="Сертификат казначейства: кому УЦ ФК выдаёт ЭЦП, включая исполнителей под сопровождением (ПП № 1018), документы, подача через ФЗС, вход в «Электронный бюджет».">
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__sertifikat-ecp-kaznachejstvo-16x9.jpg">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#prodlenie">Продлить сертификат онлайн</a></li>
      <li><a href="#zapros-online">Подать запрос на сертификат онлайн</a></li>
      <li><a href="#aliasy">Головной, корневой, УЦ: что одно и то же</a></li><li><a href="#oshibki">Частые отказы</a></li>
      <li><a href="#keys">Пример из практики</a></li>
      <li><a href="#glossary">Глоссарий</a></li>
      <li><a href="#faq">Частые вопросы</a></li>
      <li><a href="#vidy-sertifikatov">Какие бывают сертификаты казначейства</a></li>
      <li><a href="#kto-poluchaet">Кто получает сертификат казначейства по закону № 63-ФЗ</a></li>
      <li><a href="#dlya-ispolnitelya">Подпись исполнителя контракта: маршрут от заявки до распоряжения</a></li>
      <li><a href="#skolko-podpisey">Сколько подписей нужно организации</a></li>
    </ul>
  </aside>
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>15 мин чтения</span><span class="dot">·</span><span>Обновлено 10 сентября 2026 · добавлен разбор названий кластера: головной, корневой, УЦ ФК, списки отзыва — куда идти по каждому</span></div>
    </div>
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        ...
        <li><a href="#prodlenie">Продлить сертификат онлайн</a></li><li><a href="#zapros-online">Подать запрос на сертификат онлайн</a></li><li><a href="#oshibki">Частые отказы</a></li>
        <li><a href="#keys">Пример</a></li><li><a href="#glossary">Глоссарий</a></li><li><a href="#faq">FAQ</a></li><li><a href="#vidy-sertifikatov">Какие бывают сертификаты казначейства</a></li><li><a href="#kto-poluchaet">Кто получает сертификат казначейства по закону № 63-ФЗ</a></li><li><a href="#dlya-ispolnitelya">Подпись исполнителя контракта: маршрут от заявки до распоряжения</a></li><li><a href="#skolko-podpisey">Сколько подписей нужно организации</a></li></ol>
    </details>

    <div class="tldr">Квалифицированную электронную подпись для работы в ГИИС «Электронный бюджет» исполнителю контракта под казначейским сопровождением выдаёт <b>удостоверяющий центр Федерального казначейства</b> (УЦ ФК): коммерческие организации, получающие сопровождаемые средства из бюджета, включены в перечень постановления Правительства РФ от 10.07.2020 № 1018<a class="fn" href="#ref-3" aria-label="Источник 3">[3]</a>. Документы подаются онлайн через <b>ФЗС</b>, изготовление занимает <b>до 5 рабочих дней</b>, срок действия сертификата — как правило, 12 месяцев. Обязательной подпись УЦ ФК не является: по письму Казначейства России от 02.11.2023 № 07-04-05/11-32062 в «Электронном бюджете» принимаются и сертификаты ФНС России и иных аккредитованных удостоверяющих центров<a class="fn" href="#ref-7" aria-label="Источник 7">[7]</a>.</div>

    <section class="keyfacts grain" aria-label="Ключевые факты">
      <h2>Коротко о главном</h2>
      <div class="keyfacts__grid">
        <div class="kf"><div class="kf__n">УЦ ФК</div><div class="kf__t"><b>Кто выдаёт</b> подпись исполнителям под сопровождением — по перечню ПП № 1018</div></div>
        <div class="kf"><div class="kf__n">Онлайн</div><div class="kf__t"><b>ФЗС</b> — подача документов на сертификат</div></div>
    ...
    <p class="answer lead-p">Без действующей подписи нельзя ни открыть казначейский счёт, ни провести платёж через «Электронный бюджет» — поэтому сертификат УЦ Федерального казначейства часто оказывается самым первым и самым непонятным шагом для подрядчика по госконтракту. Разберём по порядку: кому УЦ ФК выдаёт подпись и когда исполнителю хватит сертификата ФНС, какие документы подготовить и как пройти получение через ФЗС без возвратов. Пошаговая подача первичного запроса разобрана в материале про <a href="/baza-znaniy/portal-zayavitelya-kaznachejstva/">портал заявителя ФЗС</a>.</p>
    ...
    <div class="answer reveal">
      <p class="lead-p">Удостоверяющий центр Федерального казначейства выдаёт квалифицированные сертификаты категориям заявителей из части 3 статьи 17.2 закона № 63-ФЗ и перечня, утверждённого постановлением Правительства РФ от 10.07.2020 № 1018<a class="fn" href="#ref-3" aria-label="Источник 3">[3]</a>:</p>
      <ul>
        <li>лицам на государственных должностях и должностным лицам органов государственной власти и местного самоуправления;</li>
        <li>должностным лицам подведомственных учреждений и работникам некоммерческих организаций из перечня — государственных корпораций и компаний, государственных и муниципальных учреждений;</li>
        <li><b>работникам коммерческих организаций, которым предоставляются средства из бюджетов, подлежащие казначейскому сопровождению</b> — пункт 1 перечня № 1018. Это и есть исполнители сопровождаемых контрактов и получатели сопровождаемых субсидий.</li>
      </ul>
      <p>Третья категория — про бизнес. Как только расчёты по контракту идут через лицевой счёт в территориальном органе казначейства, у организации появляется право получить сертификаты УЦ ФК на руководителя и на сотрудников, которые ведут контракт. Индивидуальных предпринимателей в перечне нет: ИП получает подпись в удостоверяющем центре ФНС по статье 17.3 закона № 63-ФЗ.</p>
      <div class="note"><b>Главное:</b> подпись УЦ ФК — право исполнителя, а не единственный допустимый вариант. Казначейство России письмом от 02.11.2023 № 07-04-05/11-32062 подтвердило, что для работы и подписания документов в «Электронном бюджете» применяются и сертификаты, полученные в ФНС России или в иных аккредитованных удостоверяющих центрах<a class="fn" href="#ref-7" aria-label="Источник 7">[7]</a>. Выбор практический: одна подпись на все системы казначейства и плановая смена без визита через ФЗС — либо уже имеющийся сертификат ФНС.</div>
    </div>

    <p data-ctx="giis-root">Сертификат УЦ Казначейства — ключ к закрытой части ГИИС «Электронный бюджет»; как устроена система, куда именно открывает доступ подпись и какие подсистемы нужны исполнителю, — в обзоре <a href="/baza-znaniy/elektronnyy-byudzhet-dlya-ispolnitelya-kontrakta/#giis-sostav">ГИИС «Электронный бюджет»: что это, подсистемы, кто работает</a>.</p>
    ...
    <div class="answer reveal">
      ...
      <p>Ответ — в категории заявителя и в удобстве, а не в запрете. Подпись ФНС выдаётся юридическому лицу на руководителя (пункт 1 части 1 статьи 17.2 закона № 63-ФЗ) и принимается в «Электронном бюджете» наравне с подписью казначейства<a class="fn" href="#ref-7" aria-label="Источник 7">[7]</a>. Подпись УЦ ФК выдаётся должностным лицам организации по перечню № 1018 — каждому сотруднику своя, с подачей и плановой сменой через ФЗС. Поэтому исполнитель под сопровождением обычно держит обе: ФНС — для ЕГРЮЛ-деятельности, ЕИС и отчётности, казначейства — для сотрудников, которые ежедневно подписывают сведения и распоряжения. Обязательной вторая подпись не является.</p>
      <table>
        ...
        <tbody>
          <tr><td>УЦ ФНС России</td><td>Коммерческим ЮЛ (на руководителя) и ИП</td><td>Отчётность, ЭДО, ЕИС, госуслуги; принимается и в «Электронном бюджете» (письмо ФК от 02.11.2023)</td></tr>
          <tr><td>УЦ Федерального казначейства</td><td>Госорганам, учреждениям и работникам коммерческих организаций под казначейским сопровождением (ПП № 1018)</td><td>«Электронный бюджет», СУФД, ПОИБ СОБИ, ФЗС</td></tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="answer reveal">
      ...
      <ul>
        ...
        <li>средство криптозащиты (СКЗИ) — как правило, <a href="/baza-znaniy/nastroyka-arm-elektronnyy-byudzhet/#kriptopro-gde">КриптоПро CSP</a> с действующей лицензией;</li>
    ...
    <h2 id="poshagovo">Как получить сертификат казначейства: маршрут коротко</h2>
    <div class="answer reveal">
      <p>Документы на сертификат подаются онлайн через ФЗС информационной системы УЦ — отдельный сервис на сайте Федерального казначейства<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a>.</p>
      ...
      <ol>
        <li><b>Регистрация на Портале заявителя.</b> Создаёте учётную запись организации и владельца сертификата. Если организация ещё не работала с УЦ ФК, до первичного запроса с территориальным органом Казначейства заключается договор (соглашение) о присоединении к Регламенту удостоверяющего центра.</li>
        ...
        <li><b>Проверка и выпуск.</b> УЦ проверяет комплект — до 5 рабочих дней — и выпускает сертификат. Вы скачиваете и устанавливаете его на токен вместе с корневыми сертификатами удостоверяющего центра.</li>
      </ol>
      <p>Каждый шаг с экранами портала, статусами запроса и сроками по Порядку № 21н разобран ниже — в разделе <a href="#zapros-online">«Как подать запрос на сертификат онлайн: пошагово»</a>.</p>
    </div>
    ...
    <h3 id="ustanovka-na-kompyuter">Как установить ЭЦП казначейства на компьютер: пять действий</h3>
    <p>Как установить ЭЦП казначейства на компьютер: сначала криптопровайдер, затем личный сертификат с привязкой к контейнеру, затем цепочка удостоверяющего центра, и только потом браузер.</p>
    <ol>
    ...
    <h2 id="prodlenie">Как продлить сертификат электронной подписи казначейства онлайн</h2>
    <div class="answer reveal">
      <p>Продлить сертификат электронной подписи казначейства онлайн можно без визита в ТОФК: пока действует текущая подпись УЦ ФК, смена сертификата подаётся на fzs.roskazna.ru по кнопке «Войти по сертификату», а заявление подписывается действующей электронной подписью (пункты 12–16 Порядка, утверждённого приказом Казначейства России от 15.06.2021 № 21н)<a class="fn" href="#ref-5" aria-label="Источник 5">[5]</a>. Визит нужен, только если сведения о владельце изменились.</p>
      <h3 id="prodlit-online">Казначейство: продлить сертификат онлайн по действующей подписи — шаги</h3>
      <p>Запрос подают за 3–4 недели до окончания срока: истёкшая подпись закрывает «Электронный бюджет». Шаги по инструкции УЦ ФК<a class="fn" href="#ref-6" aria-label="Источник 6">[6]</a>:</p>
      <ol>
        <li>Подключите токен и на fzs.roskazna.ru в блоке «Смена сертификата» нажмите «Войти по сертификату» (закрытая часть — lk-fzs.roskazna.ru).</li>
        <li>Выберите субъект РФ, ТОФК и тип сертификата; кнопкой «Обзор» подтяните сведения из текущего сертификата.</li>
        <li>«Сохранить и сформировать запрос на сертификат» → «Сформировать»; пароль контейнера восстановить нельзя.</li>
        <li>Сформируйте заявление и нажмите «Подписать сведения ЭП и подать запрос».</li>
        <li>После проверки СМЭВ (до 5 рабочих дней) и решения оператора нажмите в личном кабинете «Скачать сертификат», подпишите расписку и <a href="#ustanovka">установите файл</a>.</li>
      </ol>
      <h3>Отзыв</h3>
    ...
    <h2 id="zapros-online">Как подать запрос на сертификат в Федеральное казначейство онлайн: пошагово</h2>
    <div class="answer reveal"><p>Подать запрос на сертификат в Федеральное казначейство онлайн можно через сервис подачи документов УЦ ФК — fzs.roskazna.ru (официальное название сервиса — «Онлайн сервис подачи документов для получения сертификатов»)<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a>. Запрос, ключ и заявление формируются на вашем компьютере, сведения проверяет СМЭВ, а визит в ТОФК при первичном получении нужен один раз — для идентификации по паспорту. Сертификат создаётся в течение 5 рабочих дней со дня подачи заявления<a class="fn" href="#ref-5" aria-label="Источник 5">[5]</a>.</p></div>

    <h3 id="zapros-shag-1">Шаг 1. Проверить рабочее место и открыть fzs.roskazna.ru</h3>
    <p>Перед подачей УЦ ФК просит пройти автоматическую проверку рабочего места на arm-fzs.roskazna.gov.ru: браузер с поддержкой ГОСТ (Яндекс.Браузер или Chromium ГОСТ), КриптоПро CSP 5.0 либо ViPNet PKI Client 1.6+, «КриптоПро ЭЦП Browser Plugin» 2.0, драйвер токена и установленные сертификаты Минцифры (ГУЦ) и УЦ ФК<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a>. Состав комплекта и настройка описаны в разделах <a href="#chto-nuzhno">«Что подготовить до подачи»</a> и <a href="#ustanovka">«Установка сертификата»</a>. Без проверки форма запроса просто не сформирует ключ на токене.</p>

    <h3 id="zapros-shag-2">Шаг 2. Сформировать запрос: регион, ТОФК, тип сертификата</h3>
    <p>На главной странице портала в блоке «Получение сертификата» нажмите «Подать документы». Дальше — по инструкции УЦ ФК<a class="fn" href="#ref-4" aria-label="Источник 4">[4]</a>:</p>
    <ol>
      <li>Способ заполнения: вручную или «Войти через Госуслуги (ЕСИА)» — часть полей подставится сама.</li>
      <li>Субъект РФ, тип заявителя («Организация» или «Индивидуальный предприниматель»), ОГРН либо ОГРНИП, код с картинки → «Далее».</li>
      <li>Поле «ТОФК» — орган, в котором будете проходить идентификацию.</li>
      <li>Для организации — тип сертификата: должностного лица, юридического лица или юридического лица без ФИО; для ИП шаг пропускается.</li>
      <li>Данные паспорта, токен в порт, полномочия для систем Казначейства → «Сохранить и сформировать запрос на сертификат» → «Сформировать». Пароль контейнера восстановить нельзя.</li>
    </ol>

    <h3 id="zapros-shag-3">Шаг 3. Подать заявление на электронную подпись в казначейство: что прикладывать</h3>
    <p>В разделе «Заявление на сертификат» нажмите «Сформировать заявление», заполните поля, распечатайте форму двусторонней печатью, подпишите в поле «(подпись)», отсканируйте и загрузите кнопкой «Обзор» в раздел «Документы для получения сертификата»<a class="fn" href="#ref-4" aria-label="Источник 4">[4]</a>. Если владелец сертификата не вправе действовать без доверенности, заполните раздел «Документ или сведения, подтверждающие полномочия получателя сертификата» — для представителя это машиночитаемая доверенность. Сохраните ссылку на запрос и его номер, при необходимости добавьте дополнительный e-mail для уведомлений и нажмите «Подать запрос» → «Да» в окне «Передать сведения запроса в УЦ ФК?». Портал выдаст памятку о комплекте для визита — распечатайте её.</p>

    <h3 id="zapros-statusy">Шаг 4. Статусы запроса: проверка СМЭВ, решение оператора, отклонение</h3>
    <p>После подачи запрос уходит на проверку сведений через СМЭВ; при расхождении с данными госорганов, полученными через СМЭВ, он получает статус «Отклонён», а на e-mail приходит уведомление со ссылкой на причину<a class="fn" href="#ref-4" aria-label="Источник 4">[4]</a>. Если проверки пройдены, запрос попадает оператору УЦ в подсистему реестра сертификатов: он либо одобряет и приглашает вас в ТОФК с оригиналами, либо отклоняет. Причину отклонения смотрят по номеру запроса, ОГРН (ОГРНИП) и ИНН, а из уведомления можно создать копию запроса и подать его заново, не заполняя форму с нуля.</p>

    <h3 id="zapros-srok">Шаг 5. Визит в ТОФК, срок выпуска и получение сертификата</h3>
    <p>Идентификация при первичном получении проходит при личном присутствии по паспорту (пункт 21 Порядка № 21н); одновременно с заявлением представляются документ, удостоверяющий личность, документ о замещении должности и, для представителя, документ о праве обращаться за сертификатом (пункт 19)<a class="fn" href="#ref-5" aria-label="Источник 5">[5]</a>. Сертификат создаётся в течение 5 рабочих дней со дня подачи заявления; срок могут продлить до 30 рабочих дней, если госорганы не ответили вовремя, а срочного выпуска нет (пункт 22). Выдаётся сертификат в форме электронного документа через ИС УЦ после ознакомления с его содержанием (пункт 23) — дальше <a href="#ustanovka">установка на рабочее место</a>.</p>

    <h3 id="poluchit-online">Получить сертификат казначейства онлайн: что реально дистанционно, а что нет</h3>
    <p>Получить ЭЦП в казначействе онлайн без единого визита можно только при смене сертификата по действующей подписи УЦ ФК — см. <a href="#prodlenie">«Как продлить сертификат онлайн»</a>. При первичном получении очный этап один — идентификация в ТОФК.</p>
    <table>
      <thead><tr><th>Этап</th><th>Первичное получение</th><th>Смена по действующей подписи</th></tr></thead>
      <tbody>
        <tr><td>Вход на портал</td><td>Без подписи, «Подать документы»</td><td>«Войти по сертификату»</td></tr>
        <tr><td>Заявление</td><td>Печать, подпись от руки, скан</td><td>Подписывается электронной подписью</td></tr>
        <tr><td>Визит в ТОФК</td><td>Обязателен: паспорт и оригиналы</td><td>Только если сведения изменились</td></tr>
        <tr><td>Получение файла</td><td>Через ИС УЦ после идентификации</td><td>«Скачать сертификат» в личном кабинете</td></tr>
      </tbody>
    </table>

    <h2 id="aliasy">«Головной», «корневой», «сертификат УЦ ФК», «росказна сертификат» — что из этого одно и то же</h2>
    <div class="answer reveal">
      <p>В запросах и письмах одну и ту же сущность называют по-разному: «сертификат казначейства», «ЭЦП казначейства», «росказна сертификат» — это квалифицированный сертификат пользователя, который выдаёт удостоверяющий центр Федерального казначейства и о котором эта статья; «головной» и «корневой» сертификат — служебные сертификаты самого УЦ, которые устанавливают на рабочее место для цепочки доверия; «список отзыва» (СОС, CRL) — перечень отозванных сертификатов УЦ, без свежей копии которого подпись не проходит проверку.</p>
    </div>
    <table>
      <caption>Как называют сертификаты казначейства и где что искать</caption>
      <tr><th>Как говорят</th><th>Что это</th><th>Где разобрано</th></tr>
      <tr><td>Сертификат казначейства, ЭЦП казначейства, росказна сертификат, казначейство ЭЦП</td><td>Квалифицированный сертификат пользователя от УЦ ФК — получение, документы, срок, установка</td><td>Эта статья</td></tr>
      <tr><td>Головной сертификат, корневой сертификат УЦ ФК, сертификат Минцифры</td><td>Сертификаты удостоверяющих центров для цепочки доверия; ставятся в хранилища «Доверенные корневые» и «Промежуточные»</td><td><a href="/baza-znaniy/kornevye-sertifikaty-kaznachejstva/">Корневые сертификаты УЦ казначейства: как установить</a></td></tr>
      <tr><td>Список отзыва, СОС, CRL, «сертификат не доверен»</td><td>Актуальные списки отозванных сертификатов и сами сертификаты УЦ — где скачать и как обновить</td><td><a href="/baza-znaniy/sertifikaty-i-spiski-otzyva-uc-kaznachejstva/">Сертификаты и списки отзыва УЦ казначейства</a></td></tr>
      <tr><td>Продлить сертификат, отозвать ЭЦП, перевыпуск</td><td>Плановая замена по истечении срока и досрочный отзыв при увольнении или компрометации</td><td><a href="/baza-znaniy/kak-prodlit-i-otozvat-ecp-kaznachejstva/">Как продлить и отозвать ЭЦП казначейства</a></td></tr>
      <tr><td>Получить ЭЦП в казначействе, запрос на сертификат онлайн, ФЗС</td><td>Подача заявления через портал заявителя ФЗС и получение сертификата</td><td>Разделы <a href="#zapros-online">«Как подать запрос онлайн»</a> и <a href="#prodlenie">«Как продлить»</a> этой статьи</td></tr>
    </table>
    <p>Практическое правило: если система пишет «сертификат не доверен» или «не удалось построить цепочку», проблема в служебных сертификатах и списках отзыва, а не в вашей подписи; если «сертификат истёк» или «не найден закрытый ключ» — в пользовательском сертификате и носителе. От этого зависит, какую из четырёх страниц открывать.</p>
    ...
    <h3 id="otkaz-chto-delat">Отказ в выпуске и «Электронный бюджет» не видит сертификат: что делать</h3>
    <table id="otkazy-sertifikat">
    <thead><tr><th>Проблема</th><th>Как устранить</th></tr></thead>
    <tbody>
    <tr><td>Запрос вернули на доработку</td><td>Исправить указанное в уведомлении расхождение в сведениях и подать повторно</td></tr>
    <tr><td>Нет договора присоединения с ТОФК</td><td>Оформить соглашение о присоединении до подачи первичного запроса</td></tr>
    <tr><td>Данные владельца не совпадают со СНИЛС</td><td>Привести ФИО и СНИЛС в точное соответствие документам</td></tr>
    <tr><td>«Электронный бюджет» не видит сертификат</td><td>Установить корневые сертификаты УЦ ФК и проверить цепочку доверия, настроить рабочее место</td></tr>
    <tr><td>Истёк срок действия сертификата</td><td>Заблаговременно подать запрос на плановую замену (перевыпуск)</td></tr>
    </tbody>
    </table>
    <p>Большинство отказов связано не с сутью, а с оформлением запроса и настройкой рабочего места — их снимают на этапе подготовки.</p>
    ...
    <div class="answer reveal">
      <dl class="gloss">
        ...
        <div><dt>ФЗС</dt><dd>Онлайн-сервис подачи документов на сертификат на сайте Федерального казначейства.</dd></div>
...
<h2 id="faq">Частые вопросы</h2>
    <div class="faq reveal">
      <details><summary>Можно ли работать одной подписью в ЕИС и СУФД?</summary><p>В ЕИС и «Электронном бюджете» — да: сертификат ФНС России принимается в обеих системах (письмо Казначейства России от 02.11.2023 № 07-04-05/11-32062). В СУФД-портале учётная запись пользователя регистрируется через УФК под сертификат удостоверяющего центра казначейства — состав сертификатов уточняют в своём управлении. На практике исполнитель держит обе подписи, но обязательного требования об этом нет.</p></details>
      <details open><summary>Где получить ЭЦП казначейства?</summary><p>Сертификат выдаёт удостоверяющий центр Федерального казначейства. Документы подаются онлайн через ФЗС на сайте Федерального казначейства, готовый сертификат записывается на защищённый токен.</p></details>
      ...
      <details><summary>Чем подпись казначейства отличается от подписи ФНС?</summary><p>Подпись ФНС выдаётся юридическому лицу на руководителя и ИП — для обычной деятельности, и «Электронный бюджет» её принимает. Подпись УЦ казначейства выдаётся должностным лицам организаций из перечня № 1018, включая работников коммерческих исполнителей под сопровождением, — по одной на каждого подписанта, с подачей и сменой через ФЗС. Обе нужны часто, но не обязательно.</p></details>
      ...
      <details><summary>На какой срок выдаётся сертификат?</summary><p>Как правило, на 12 месяцев. Продление запрашивается заранее, за 3–4 недели до окончания срока, через тот же ФЗС.</p></details>
      ...
      <details><summary>Можно ли получить подпись казначейства удалённо?</summary><p>Подача документов идёт онлайн через ФЗС. Само рабочее место и генерация ключа выполняются на стороне заявителя; мы помогаем настроить процесс и пройти его без возвратов по всей России.</p></details>
      <details><summary>Что такое сертификат казначейства?</summary><p>Это квалифицированный сертификат ключа проверки электронной подписи, который создаёт и выдаёт удостоверяющий центр Федерального казначейства. Основание — пункт 1 части 3 статьи 17.2 закона от 06.04.2011 № 63-ФЗ; порядок работы центра установлен приказом Казначейства России от 15.06.2021 № 21н.</p></details>
      <details><summary>Чем сертификаты казначейства отличаются от личной подписи?</summary><p>Личный сертификат должностного лица — это подпись, которой подписывают документы. Головной и подчинённые сертификаты удостоверяющего центра и списки отзыва — служебные файлы цепочки доверия: они нужны, чтобы система признала подпись действительной, но подписать ими ничего нельзя.</p></details>
      <details><summary>Нужен ли исполнителю контракта сертификат казначейства?</summary><p>Право есть, обязанности нет. Коммерческие организации, получающие сопровождаемые средства из бюджета, включены в перечень постановления Правительства РФ от 10.07.2020 № 1018, поэтому УЦ казначейства выдаёт сертификаты их руководителю и работникам (пункт 4 части 3 статьи 17.2 закона № 63-ФЗ, письмо Межрегионального операционного УФК от 25.08.2023 № 95-09-11/15-377). Работать в «Электронном бюджете» можно и сертификатом ФНС или иного аккредитованного центра — это подтверждено письмом Казначейства России от 02.11.2023 № 07-04-05/11-32062.</p></details>
      <details><summary>Что происходит с сертификатом при увольнении владельца?</summary><p>Сертификат прекращает действие: по пункту 4 части 1 и пункту 3 части 3 статьи 17.2 закона № 63-ФЗ достаточно обращения уполномоченного лица в удостоверяющий центр, порядок прекращения установлен частью 7 статьи 14. Новому подписанту выпускается собственный сертификат, поэтому замену лучше готовить заранее.</p></details>
      <details><summary>Почему система пишет, что сертификат казначейства не доверен?</summary><p>Чаще всего не установлен головной сертификат удостоверяющего центра или не обновлён список отзыва — то есть не строится цепочка доверия. Сначала проверяют служебные файлы на рабочем месте и только потом состояние самой подписи.</p></details>
      <details><summary>Сколько сертификатов нужно организации-исполнителю?</summary><p>Столько, сколько сотрудников реально подписывает документы: подпись принадлежит физическому лицу, а статья 10 закона № 63-ФЗ обязывает обеспечивать конфиденциальность ключа и не допускать его использование без согласия владельца. Рабочий минимум — сертификаты руководителя и того, кто ведёт расчёты по контракту.</p></details>
      <details><summary>Как подать заявку на ЭЦП в Федеральное казначейство?</summary><p>Федеральное казначейство принимает заявку на ЭЦП через онлайн-сервис fzs.roskazna.ru: кнопка «Подать документы», выбор региона и ТОФК, ввод ОГРН и паспортных данных, формирование ключа на токене, заявление с подписью и сканом. После проверки через СМЭВ оператор приглашает в ТОФК для идентификации, сертификат создаётся в течение 5 рабочих дней со дня подачи заявления.</p></details>
      <details><summary>Можно ли получить сертификат казначейства онлайн, без визита?</summary><p>Полностью онлайн — только при смене сертификата по действующей подписи УЦ ФК: вход «по сертификату», заявление подписывается электронной подписью, файл скачивается в личном кабинете. При первичном получении онлайн проходят запрос, заявление и проверки, а идентификация по паспорту — очно в ТОФК.</p></details>
      <details><summary>Как сделать ЭЦП в казначействе для исполнителя контракта?</summary><p>Подать запрос на fzs.roskazna.ru от имени организации на конкретного сотрудника, приложить заверенную копию приказа о назначении на должность (руководителю, указанному в ЕГРЮЛ, приказ не нужен), пройти проверку СМЭВ и один раз посетить ТОФК для идентификации по паспорту. Сертификат создаётся в течение 5 рабочих дней; доверенности и приказы по основной деятельности вместо приказа о назначении не принимаются (пункт 19 Порядка № 21н, письмо МОУ ФК от 25.08.2023).</p></details>
      <details><summary>Можно ли подписывать документы, если срок сертификата истёк?</summary><p>Нет. По статье 11 закона № 63-ФЗ подпись признаётся действительной, если сертификат действовал на момент подписания документа либо на день проверки, когда момент подписания не определён, и срок действия ключа не истёк. Перевыпуск начинают заранее, не дожидаясь последнего дня.</p></details>
          <details><summary>Чем головной сертификат отличается от сертификата казначейства?</summary><p>Сертификат казначейства (ЭЦП казначейства) — ваш квалифицированный сертификат пользователя, выданный УЦ Федерального казначейства. Головной (корневой) сертификат — служебный сертификат самого удостоверяющего центра, который устанавливают на рабочее место, чтобы система доверяла вашей подписи. Первый получают по заявлению, второй просто скачивают и устанавливают.</p></details>
</div>
...
<!-- p47:vidy-i-roli -->
    ...
    <h2 id="vidy-sertifikatov">Какие бывают сертификаты казначейства</h2>
    <p>Словом «сертификат казначейства» называют четыре разных объекта, и половина проблем с настройкой рабочего места начинается с того, что человек ищет одно, а скачивает другое. Личный сертификат — это ваша подпись. Сертификат самого удостоверяющего центра и список отзыва — служебные файлы, которые делают вашу подпись проверяемой. Подписать ими ничего нельзя.</p>
    <table>
      <thead><tr><th>Что это</th><th>Зачем нужно</th><th>Где брать</th></tr></thead>
      <tbody>
        <tr><td>Личный (пользовательский) сертификат должностного лица</td><td>Им подписывают документы в «Электронном бюджете» и других системах казначейства</td><td>Удостоверяющий центр казначейства через <a href="/baza-znaniy/portal-zayavitelya-kaznachejstva/">ФЗС</a></td></tr>
        <tr><td>Головной и подчинённые сертификаты удостоверяющего центра</td><td>Строят цепочку доверия: без них система не признает вашу подпись действительной</td><td>Раздел удостоверяющего центра на сайте казначейства, см. <a href="/baza-znaniy/kornevye-sertifikaty-kaznachejstva/">установку корневых сертификатов</a></td></tr>
        <tr><td>Список отзыва сертификатов (СОС, он же CRL)</td><td>Перечень аннулированных сертификатов; по нему проверяется, не отозвана ли подпись</td><td>Тот же раздел, см. <a href="/baza-znaniy/sertifikaty-i-spiski-otzyva-uc-kaznachejstva/">сертификаты и списки отзыва</a></td></tr>
        <tr><td>Сертификат информационной системы</td><td>Автоматическое подписание и проверка подписи без участия человека</td><td>Выдаётся оператору системы; частный случай по части 1 статьи 17.2 закона № 63-ФЗ</td></tr>
      </tbody>
    </table>
    <p>Отсюда практическое правило диагностики. Если система пишет «сертификат не доверен» или «не удалось построить цепочку», проблема почти всегда в служебных файлах, а не в вашей подписи: не установлен головной сертификат либо не обновлён список отзыва. Если же система вообще не видит подпись, разбираться нужно с носителем, криптопровайдером и правами пользователя, а не скачивать сертификаты заново.</p>

    <h2 id="kto-poluchaet">Кто получает сертификат казначейства по закону № 63-ФЗ</h2>
    <p>Маршрут за подписью определяет не желание организации, а её статус. Закон «Об электронной подписи» жёстко распределил заявителей между тремя государственными удостоверяющими центрами, и в статье 17.2 это описано по категориям.</p>
    <table>
      <thead><tr><th>Кто вы</th><th>Куда идти за подписью</th><th>Основание</th></tr></thead>
      <tbody>
        <tr><td>Должностное лицо государственного органа или органа местного самоуправления</td><td>Удостоверяющий центр казначейства</td><td>Пункт 1 части 3 статьи 17.2</td></tr>
        <tr><td>Работник подведомственного учреждения или иной организации из перечня Правительства</td><td>Удостоверяющий центр казначейства</td><td>Пункт 1 и пункт 4 части 3 статьи 17.2, постановление Правительства РФ от 10.07.2020 № 1018</td></tr>
        <tr><td>Коммерческая организация — исполнитель сопровождаемого контракта, её руководитель и работники</td><td>Удостоверяющий центр казначейства — по перечню № 1018; альтернатива — сертификат юридического лица от удостоверяющего центра налоговой службы на лицо, действующее без доверенности</td><td>Пункт 4 части 3 статьи 17.2 и пункт 1 перечня, утверждённого постановлением № 1018; пункт 1 части 1 статьи 17.2</td></tr>
        <tr><td>Сотрудник такой организации, подписывающий документы за руководителя</td><td>Сертификат должностного лица от удостоверяющего центра казначейства по приказу о назначении либо личный сертификат физического лица из аккредитованного центра; полномочия в системах подтверждает <a href="/baza-znaniy/mashinochitaemaya-doverennost-kaznachejstvo/">машиночитаемая доверенность</a></td><td>Пункт 4 части 3 и пункт 2 части 1 статьи 17.2</td></tr>
        <tr><td>Индивидуальный предприниматель</td><td>Удостоверяющий центр налоговой службы</td><td>Статья 17.3</td></tr>
        <tr><td>Банк, участник финансового рынка</td><td>Удостоверяющий центр Банка России</td><td>Часть 2 статьи 17.2</td></tr>
      </tbody>
    </table>
    <p>Для исполнителя контракта под казначейским сопровождением из таблицы следует вещь, которую стоит проверить до подачи документов: у него два законных маршрута. Первый — удостоверяющий центр казначейства: перечень № 1018 прямо называет коммерческие организации, которым предоставляются сопровождаемые средства, а Межрегиональное операционное УФК письмом от 25.08.2023 № 95-09-11/15-377 перечислило сотрудников таких организаций среди заявителей<a class="fn" href="#ref-8" aria-label="Источник 8">[8]</a>. Второй — сертификат ФНС или иного аккредитованного центра: Казначейство России письмом от 02.11.2023 № 07-04-05/11-32062 подтвердило, что в «Электронном бюджете» такие сертификаты применяются наравне с казначейскими<a class="fn" href="#ref-7" aria-label="Источник 7">[7]</a>. Бюджетная сторона — заказчик, учреждение, орган — выбора не имеет и идёт в удостоверяющий центр казначейства. Подробное сравнение двух центров — в разборе про <a href="/baza-znaniy/udostoveryayushchiy-centr-kaznachejstva/">удостоверяющий центр казначейства</a>.</p>
    <p>Отдельный сюжет — смена людей. Сертификат привязан к конкретному физическому лицу и его полномочиям. Когда руководитель или должностное лицо перестаёт исполнять обязанности, сертификат прекращает действие: по пункту 4 части 1 и пункту 3 части 3 статьи 17.2 для этого достаточно обращения уполномоченного лица в удостоверяющий центр, а сам порядок прекращения установлен частью 7 статьи 14 закона № 63-ФЗ. Практический вывод простой: увольнение подписанта — это не кадровое событие, а операционный риск, потому что расчёты по контракту встают до выпуска новой подписи. Как проходит перевыпуск, разобрано в материале про <a href="/baza-znaniy/kak-prodlit-i-otozvat-ecp-kaznachejstva/">продление и отзыв подписи казначейства</a>.</p>

<!-- p47b:ispolnitel-i-kolichestvo -->

    <h2 id="dlya-ispolnitelya">Подпись исполнителя контракта: маршрут от заявки до распоряжения</h2>
    <p>У исполнителя сопровождаемого контракта подпись — не самоцель, а условие того, чтобы деньги с лицевого счёта вообще двинулись. Маршрут занимает от нескольких дней до пары недель, и почти всегда его начинают слишком поздно: заявку на подпись подают уже после подписания контракта, когда заказчик ждёт реквизиты, а бухгалтерия — аванс.</p>
    <ol>
      <li><b>Сертификаты подписантов.</b> У коммерческой компании под сопровождением два варианта: сертификаты должностных лиц от удостоверяющего центра казначейства по перечню № 1018 — на руководителя и на каждого сотрудника, который будет подписывать, — либо сертификат юридического лица от удостоверяющего центра налоговой службы на лицо, действующее без доверенности (пункт 1 части 1 статьи 17.2 закона № 63-ФЗ). В «Электронном бюджете» принимаются оба.</li>
      <li><b>Личные сертификаты сотрудников и доверенность.</b> Если документы подписывает не руководитель, сотруднику нужен собственный сертификат физического лица плюс <a href="/baza-znaniy/mashinochitaemaya-doverennost-kaznachejstvo/">машиночитаемая доверенность</a> — по пункту 2 части 1 той же статьи доверенность включается в пакет электронных документов.</li>
      <li><b>Рабочее место.</b> Криптопровайдер, носитель, плагин браузера, головные сертификаты и списки отзыва — до этого этапа система подпись просто не увидит, см. <a href="/baza-znaniy/nastroyka-arm-elektronnyy-byudzhet/">настройку рабочего места</a>.</li>
      <li><b>Полномочия в «Электронном бюджете».</b> Наличие сертификата и наличие прав — разные вещи: роли заводятся отдельно, см. <a href="/baza-znaniy/elektronnyy-byudzhet-dlya-ispolnitelya-kontrakta/">подключение исполнителя к системе</a>.</li>
      <li><b>Подписание документов по контракту.</b> Сведения об операциях с целевыми средствами, распоряжения о совершении казначейского платежа, отчётность — всё уходит подписанным, и любой сбой на предыдущих шагах останавливает платёж.</li>
    </ol>
    <p>Где чаще всего теряют время: подают запрос в удостоверяющий центр казначейства без заверенной копии приказа о назначении сотрудника на должность — доверенность вместо неё не принимают; заводят одну подпись на руководителя, а подписывать регулярно должен бухгалтер; выпускают подпись, но забывают про полномочия в системе. Каждая из трёх ошибок стоит нескольких дней, а в конце квартала — сорванного платежа.</p>

    <h2 id="skolko-podpisey">Сколько подписей нужно организации</h2>
    <p>Ответ, который экономит деньги и нервы: столько, сколько людей реально подписывает документы. Электронная подпись принадлежит физическому лицу, и «одна подпись на всю компанию» — не экономия, а нарушение. Статья 10 закона № 63-ФЗ прямо обязывает участников электронного взаимодействия обеспечивать конфиденциальность ключей, не допускать их использование без согласия владельца, не использовать ключ, если есть основания полагать, что конфиденциальность нарушена, и уведомить удостоверяющий центр о таком нарушении не позднее одного рабочего дня со дня, когда стало известно.</p>
...
<div class="author">
    ...
    <section class="refs" aria-label="Источники">
      <h2>Источники</h2>
      <ol>
        <li id="ref-1">Онлайн-сервис подачи документов для получения сертификатов (ФЗС). <a href="https://roskazna.gov.ru/gis/udostoveryayushchij-centr/onlajn-servis-podachi-dokumentov-dlya-polucheniya-sertifikatov-portal-zayavitelya" target="_blank" rel="noopener">Казначейство России</a></li>
        ...
        <li id="ref-3">Постановление Правительства РФ от 10.07.2020 № 1018 «О видах юридических лиц и подведомственных им организаций, которым и работникам которых создаются и выдаются квалифицированные сертификаты ключей проверки электронной подписи удостоверяющим центром…» (в силе с 01.01.2022), пункт 1 перечня — коммерческие организации, которым предоставляются средства из бюджетов, подлежащие казначейскому сопровождению; Федеральный закон от 06.04.2011 № 63-ФЗ (ред. от 31.07.2025), пункт 4 части 3 статьи 17.2 — <a href="http://publication.pravo.gov.ru/Document/View/0001202007130022" target="_blank" rel="noopener">publication.pravo.gov.ru</a>, <a href="https://www.consultant.ru/document/cons_doc_LAW_112701/e051fd84282463756121b8992b8fa4df155f2886/" target="_blank" rel="noopener">КонсультантПлюс</a></li>
        <li id="ref-4">Инструкция подачи запроса на сертификат без использования электронной подписи (требуется посещение ТОФК): шаги формирования запроса, заявления, проверки СМЭВ и статусы. <a href="https://roskazna.gov.ru/uploads/migrate/roskaznagovru/documents/gis/udostoveryayushchij-centr/Instruktsiya_podachi_zaprosa_na_sertifikat_bez_ispolzovaniya_EP.pdf" target="_blank" rel="noopener">Казначейство России, PDF</a></li>
        <li id="ref-5">Приказ Федерального казначейства от 15.06.2021 № 21н «Об утверждении Порядка реализации Федеральным казначейством функций аккредитованного удостоверяющего центра и исполнения его обязанностей» (зарегистрирован Минюстом 09.08.2021 № 64574): пункты 12–16 (смена ключа по заявлению через ИС УЦ), 19, 21–23 (документы, идентификация при личном присутствии, срок 5 рабочих дней с продлением до 30). <a href="https://roskazna.gov.ru/gis/udostoveryayushchij-centr/normativnye-dokumenty/" target="_blank" rel="noopener">roskazna.gov.ru</a></li>
        <li id="ref-6">Инструкция по смене квалифицированного сертификата с использованием электронной подписи (не требуется посещение ТОФК): вход по сертификату, подписание сведений, скачивание сертификата в личном кабинете. <a href="https://roskazna.gov.ru/uploads/migrate/roskaznagovru/documents/gis/udostoveryayushchij-centr/Instruktsiya_podachi_zaprosa_na_sertifikat_s_ispolzovaniem_EP.pdf" target="_blank" rel="noopener">Казначейство России, PDF</a></li>
        <li id="ref-7">Письмо Казначейства России от 02.11.2023 № 07-04-05/11-32062 «О применении сертификатов»: для работы и подписания документов в ГИИС «Электронный бюджет» помимо сертификатов Федерального казначейства применяются сертификаты ФНС России и иных аккредитованных удостоверяющих центров — <a href="https://www.consultant.ru/document/cons_doc_LAW_461566/" target="_blank" rel="noopener">КонсультантПлюс</a></li>
        <li id="ref-8">Письмо Межрегионального операционного УФК от 25.08.2023 № 95-09-11/15-377 «О вопросах создания и выдачи сертификатов»: перечень заявителей УЦ ФК, включая сотрудников коммерческих организаций под казначейским сопровождением; приказ о назначении на должность (пункт 19 Порядка № 21н), срок создания сертификата 5 рабочих дней, смена сертификата без визита — <a href="https://www.consultant.ru/document/cons_doc_LAW_455630/" target="_blank" rel="noopener">КонсультантПлюс</a></li>
      </ol>
...
<section class="related" aria-labelledby="relTitle">
  ...
  <div class="related__grid">
    ...
    <a class="card reveal" href="/baza-znaniy/chto-takoe-kaznacheyskoe-soprovozhdenie/"><div class="card__cover"><span>Что такое казначейского сопровождения</span></div><div class="card__body"><span class="card__cat">База знаний</span><h3 class="card__title">Казначейское сопровождение: что это и кому нужно</h3><div class="card__meta">Основы · 14 мин</div></div></a>
    ...
    <!-- auto-related:kak-prodlit-i-otozvat-ecp-kaznachejstva --><a class="card reveal" href="/baza-znaniy/kak-prodlit-i-otozvat-ecp-kaznachejstva/"><div class="card__cover"><span>Продление ЭП</span></div><div class="card__body"><span class="card__cat">База знаний</span><h3 class="card__title">Как продлить и отозвать ЭЦП казначейства</h3><div class="card__meta">Электронная подпись · 13 мин</div></div></a>

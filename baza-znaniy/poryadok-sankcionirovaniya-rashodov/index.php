...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      ...
      <div class="note"><b>Главное:</b> санкционируется не контракт в целом, а <b>каждая операция</b> по нему. Один и тот же поставщик по одному контракту может получить и санкционирование, и отказ — на разных платежах.</div>
    </div>
...
<section class="related" aria-labelledby="relTitle">
  ...
  <div class="related__grid">
    ...
    <a class="card reveal" href="/uslugi/soprovozhdenie-postoplata/"><div class="card__cover"><span>Под ключ</span></div><div class="card__body"><span class="card__cat">Услуга</span><h3 class="card__title">Сопровождение постоплаты без возвратов</h3><div class="card__meta">Услуга · от 55 000 ₽</div></div></a>

...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <p>Санкционирование — это разрешительная процедура: территориальный орган Федерального казначейства проверяет каждую расходную операцию по контракту, попавшему под казначейское сопровождение, на законность и обоснованность, и только после положительного результата проводит платёж.</p>

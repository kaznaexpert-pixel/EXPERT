...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#osnova">Правовая основа</a></li>
  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        <li><a href="#chto">Что такое санкционирование</a></li><li><a href="#osnova">Правовая основа</a></li>
        <li><a href="#kak">Как устроено</a></li><li><a href="#proverka">Что проверяет ТОФК</a></li>
        <li><a href="#otkaz">Основания для отказа</a></li><li><a href="#sroki">Сроки</a></li>
...
<figcaption style="font-size:13px;color:#6E6B66;font-style:italic;margin-top:8px">Пять шагов санкционирования: от утверждения сведений до списания денег; возврат с кодом причины — на любом несоответствии.</figcaption>
    ...
    <h2 id="sroki">Сроки санкционирования</h2>
    <div class="answer reveal">
      <p>Срок санкционирования установлен порядком Минфина и отсчитывается с момента поступления в ТОФК полного комплекта — распоряжения и документов-оснований. При корректно оформленных документах операция санкционируется в течение нескольких рабочих дней; при замечаниях платёж возвращается, и срок отсчитывается заново после повторной подачи. Поэтому реальная скорость зависит не от казначейства, а от качества подготовки документов на стороне исполнителя.</p>
    </div>
...
<h2 id="faq">Частые вопросы</h2>
    <div class="faq reveal">
      ...
      <details><summary>Сколько длится санкционирование?</summary><p>При корректных документах — несколько рабочих дней с момента поступления полного комплекта в ТОФК. При замечаниях платёж возвращается, и срок отсчитывается заново после повторной подачи.</p></details>
      ...
      <details><summary>Какие сроки рассмотрения документов в УФК?</summary><p>Зависит от процедуры: санкционирование распоряжения и проверку Сведений об операциях казначейство проводит, как правило, до 3 рабочих дней с момента полного комплекта; лицевой счёт открывают не позднее следующего рабочего дня; зарезервированный номер счёта действует до 6 месяцев. При замечаниях срок отсчитывается заново после повторной подачи.</p></details>
    </div>
    ...
    <section class="refs" aria-label="Источники">
      ...
      <ol>
        ...
        <li id="ref-2">Приказ Минфина России от 17.12.2021 № 214н «О Порядке санкционирования операций со средствами участников казначейского сопровождения» — <a href="https://www.consultant.ru/document/cons_doc_LAW_405138/" target="_blank" rel="noopener">consultant.ru</a></li>
        <li id="ref-3">Постановление Правительства РФ от 24.11.2021 № 2024 «О правилах казначейского сопровождения». <a href="https://www.consultant.ru/document/cons_doc_LAW_401819/" target="_blank" rel="noopener">КонсультантПлюс</a></li>
      </ol>

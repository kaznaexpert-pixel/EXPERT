...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <p>Санкционирование операций с целевыми средствами при казначейском сопровождении опирается на <b>статью 242.23 Бюджетного кодекса РФ</b><a class="fn" href="#ref-2" aria-label="Источник 2">[2]</a>. Конкретный порядок — какие документы представлять, по какой форме и в какие сроки — утверждает Министерство финансов РФ.</p>
    ...
    <section class="refs" aria-label="Источники">
      ...
      <ol>
        ...
        <li id="ref-2">Порядок санкционирования операций с целевыми средствами — Министерство финансов РФ. <a href="https://minfin.gov.ru/" target="_blank" rel="noopener">minfin.gov.ru</a></li>

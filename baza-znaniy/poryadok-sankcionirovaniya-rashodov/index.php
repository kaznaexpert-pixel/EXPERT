...
{"@type":"Question","name":"Что такое санкционирование расходов простыми словами?","acceptedAnswer":{"@type":"Answer","text":"Это разрешение казначейства на платёж: ТОФК проверяет, что расход связан с контрактом и является целевым, и только после этого проводит операцию. Без санкционирования платёж по контракту под казначейским сопровождением не уходит."}},
{"@type":"Question","name":"Кто санкционирует операции?","acceptedAnswer":{"@type":"Answer","text":"Территориальный орган Федерального казначейства (ТОФК) по месту открытия лицевого счёта, на основании порядка, установленного Минфином в соответствии со ст. 242.23 Бюджетного кодекса РФ."}},
{"@type":"Question","name":"Почему казначейство возвращает платёж?","acceptedAnswer":{"@type":"Answer","text":"Чаще всего — из-за неверного назначения платежа, неправильного кода КВР/КОСГУ, отсутствия операции в сведениях, неполного комплекта документов или отсутствия связи с контрактом."}},
{"@type":"Question","name":"Сколько длится санкционирование?","acceptedAnswer":{"@type":"Answer","text":"При корректных документах — несколько рабочих дней с момента поступления полного комплекта в ТОФК. При замечаниях платёж возвращается, и срок отсчитывается заново после повторной подачи."}},
{"@type":"Question","name":"Чем отличается расширенное санкционирование?","acceptedAnswer":{"@type":"Answer","text":"В расширенном режиме (крупные контракты, ГОЗ) казначейство дополнительно проверяет обоснованность затрат и соответствие расходов структуре цены контракта, а не только связь платежа с контрактом."}},
{"@type":"Question","name":"Что такое сведения об операциях с целевыми средствами?","acceptedAnswer":{"@type":"Answer","text":"Это утверждаемый документ, в котором отражаются плановые операции с целевыми средствами по контракту. Санкционирование идёт в соответствии с этими сведениями."}},

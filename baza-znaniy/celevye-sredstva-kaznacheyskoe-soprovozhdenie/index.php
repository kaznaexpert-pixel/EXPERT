...
{"@type": "Question", "name": "Что такое целевые средства простыми словами?", "acceptedAnswer": {"@type": "Answer", "text": "Это окрашенные бюджетные деньги: они выданы под конкретную цель, хранятся на отдельном счёте в казначействе и тратятся только на эту цель после проверки. Аванс по госконтракту под сопровождением — это целевые средства."}},
{"@type": "Question", "name": "На каком счёте лежат целевые средства?", "acceptedAnswer": {"@type": "Answer", "text": "На отдельном лицевом счёте с кодом 71 в территориальном органе казначейства, а не на банковском расчётном счёте. Под каждый сопровождаемый контракт обычно открывается свой счёт."}},
{"@type": "Question", "name": "Какие средства относятся к целевым в 2026 году?", "acceptedAnswer": {"@type": "Answer", "text": "Авансы по госконтрактам сверх порога, субсидии юрлицам, бюджетные инвестиции, средства по ГОЗ и кооперации. Точный перечень задаёт статья 5 Закона № 426-ФЗ о бюджете на 2026 год."}},
{"@type": "Question", "name": "Можно ли снять целевые средства наличными?", "acceptedAnswer": {"@type": "Answer", "text": "Как правило, нет. Снятие наличных и перевод на собственный расчётный счёт про запас запрещены. Расход допустим только на цель контракта после санкционирования."}},
{"@type": "Question", "name": "Чем целевые средства отличаются от обычной оплаты?", "acceptedAnswer": {"@type": "Answer", "text": "Местом хранения (казначейство, а не банк), обязательным санкционированием каждого платежа, маркировкой ИГК и кодами и возвратом неиспользованного остатка источнику."}},
{"@type": "Question", "name": "Зачем нужны коды направления и источника?", "acceptedAnswer": {"@type": "Answer", "text": "Они классифицируют, на что тратятся и откуда пришли целевые средства. Коды задаёт приказ Минфина № 214н; ошибка в коде — частая причина отказа в санкционировании."}},
{"@type": "Question", "name": "Что будет за нецелевой расход?", "acceptedAnswer": {"@type": "Answer", "text": "Ответственность по статье 15.14 КоАП РФ, возврат средств, фиксация нарушения режима, а в тяжёлых случаях — расторжение контракта."}},
{"@type": "Question", "name": "Заберёт ли казначейство прибыль?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Прибыль и экономия — не целевой остаток. После подтверждения исполнения заработок выводится на обычный расчётный счёт по правилам года."}},
{"@type": "Question", "name": "Что происходит с остатком целевых средств в конце?", "acceptedAnswer": {"@type": "Answer", "text": "Неизрасходованный целевой остаток возвращается источнику — заказчику или в доход бюджета, после чего лицевой счёт закрывается."}},
{"@type": "Question", "name": "Как понять, попадает ли мой контракт под сопровождение?", "acceptedAnswer": {"@type": "Answer", "text": "Сверьте предмет и сумму контракта с перечнем в статье 5 действующего годового закона о бюджете (на 2026 — № 426-ФЗ) и с условиями контракта."}}
]}
</script>
<script type="application/ld+json">

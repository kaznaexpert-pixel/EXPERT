...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="faq">
      <details open><summary>Сколько видов цен на продукцию ГОЗ существует?</summary><p>Три: ориентировочная (уточняемая) цена, фиксированная цена и цена, возмещающая издержки. Это закрытый перечень по статье 11 Федерального закона № 275-ФЗ.</p></details>

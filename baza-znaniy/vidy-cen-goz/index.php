  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        ...
        <li><a href="#ks">Цена и казначейское сопровождение</a></li><li><a href="#oshibki">Частые ошибки</a></li>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию; актуальные виды цен, методы и порядок устанавливаются НПА и могут уточняться. Проверено экспертом КазнаЭксперт. Дата актуализации — 4 августа 2026.</p>
    </div>

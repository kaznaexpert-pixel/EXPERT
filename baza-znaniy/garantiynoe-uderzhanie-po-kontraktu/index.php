...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Что такое гарантийное удержание по контракту?", "acceptedAnswer": {"@type": "Answer", "text": "Это особый порядок оплаты, при котором заказчик выплачивает не всю цену сразу, а удерживает часть (обычно 5–10%) до истечения гарантийного срока или устранения недостатков. ВАС РФ признал такой порядок не противоречащим п. 2 ст. 746 ГК."}}, {"@type": "Question", "name": "Чем гарантийное удержание отличается от обеспечения гарантийных обязательств?", "acceptedAnswer": {"@type": "Answer", "text": "При гарантийном удержании заказчик не выплачивает часть цены. При обеспечении гарантийных обязательств (ст. 96 Закона № 44-ФЗ) исполнитель получает всю цену, но отдельно предоставляет обеспечение деньгами или независимой гарантией. Это зеркальные механизмы."}}, {"@type": "Question", "name": "Законно ли гарантийное удержание в госконтрактах по 44-ФЗ?", "acceptedAnswer": {"@type": "Answer", "text": "В госконтрактах по 44-ФЗ приоритетен механизм обеспечения гарантийных обязательств (ст. 96), поэтому применение классического удержания части цены ограничено и зависит от условий контракта: оно не должно противоречить правилам закона об оплате принятых результатов."}}, {"@type": "Question", "name": "Когда возвращается гарантийное удержание?", "acceptedAnswer": {"@type": "Answer", "text": "Когда наступает согласованное условие: истёк гарантийный срок без претензий, устранены выявленные дефекты или подписан акт об отсутствии претензий. Судебная практика поддерживает возврат подрядчику, выполнившему свою часть."}}, {"@type": "Question", "name": "Как возвращается удержание при казначейском сопровождении?", "acceptedAnswer": {"@type": "Answer", "text": "Удержанная часть цены не поступает на лицевой счёт до наступления условия. К моменту возврата сопровождение обычно завершено, а лицевой счёт закрыт, поэтому удержание выплачивается в общем порядке на расчётный счёт исполнителя."}}, {"@type": "Question", "name": "Может ли заказчик не возвращать удержание, ссылаясь на закрытый лицевой счёт?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Закрытие лицевого счёта не освобождает заказчика от обязанности выплатить заработанное. Удержание возвращается в общем порядке; при отказе его взыскивают как задолженность по оплате работ."}}, {"@type": "Question", "name": "Какой размер гарантийного удержания считается разумным?", "acceptedAnswer": {"@type": "Answer", "text": "Обычно 5–10% цены работ или этапа. Точный размер определяется договором. Удержание, явно превышающее разумные пределы или стоимость устранения возможных дефектов, суды могут снизить."}}, {"@type": "Question", "name": "Что делать, если условие возврата в договоре сформулировано нечётко?", "acceptedAnswer": {"@type": "Answer", "text": "Неопределённые формулировки суды толкуют в пользу подрядчика: неопределённость не должна бесконечно откладывать оплату заработанного. Зафиксируйте разумный момент возврата и требуйте выплаты."}}, {"@type": "Question", "name": "Можно ли направить гарантийное удержание на устранение дефектов?", "acceptedAnswer": {"@type": "Answer", "text": "Да, если это предусмотрено договором. При выявлении недостатков в гарантийный срок удержанное направляется на их устранение по согласованному порядку, а остаток выплачивается подрядчику."}}, {"@type": "Question", "name": "Гарантийное удержание — это то же, что удержание неустойки?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Гарантийное удержание — отложенная часть заработанной цены под гарантию качества. Удержание неустойки — санкция за нарушение контракта. Это разные механизмы с разными правилами."}}]}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#44fz">Гарантийное удержание в госконтрактах по 44-ФЗ</a></li>
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>14 мин чтения</span><span class="dot">·</span><span>Обновлено 8 июля 2026</span></div>
    </div>
    ...
    <p>Здесь нужна честность. Гарантийное удержание — инструмент прежде всего гражданского подряда. В контрактах по Закону № 44-ФЗ для той же цели предусмотрен свой механизм — обеспечение гарантийных обязательств (ст. 96), и закон детально регулирует его размер, сроки и возврат. Поэтому применение классического гарантийного удержания в госконтрактах ограничено и зависит от того, как составлен контракт: заказчик не может произвольно «придумать» удержание вопреки правилам 44-ФЗ об оплате и обеспечении.</p>
    <p>На практике это выражается так:</p>
    <ul>
      <li>если контракт по 44-ФЗ предусматривает обеспечение гарантийных обязательств — работает именно оно, а не удержание части цены;</li>
      <li>условие о гарантийном удержании в госконтракте должно не противоречить требованиям 44-ФЗ об оплате принятых результатов и о сроках оплаты;</li>
      <li>в отношениях, где 44-ФЗ не применяется напрямую (отдельные договоры по 223-ФЗ, гражданский подряд), гарантийное удержание применяется свободнее.</li>
    </ul>
    <p>Вывод для сторон: прежде чем спорить о гарантийном удержании в госконтракте, нужно понять, какой инструмент реально закреплён в контракте — удержание части цены или обеспечение гарантийных обязательств. От этого зависит и порядок возврата, и сроки.</p>

...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p>Все ссылки даны на действующую редакцию № 275-ФЗ от 15.12.2025. Какой банк сопровождает вашу сделку, определяется условиями контракта: государственный заказчик указывает уполномоченный банк, в котором головной исполнитель и кооперация открывают отдельные счета.<a class="fn" href="#ref-3" aria-label="Источник 3">[3]</a></p>
...
<h2 id="faq">Частые вопросы</h2>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал отражает редакцию № 275-ФЗ от 15.12.2025 по состоянию на 12 июня 2026 года и носит информационный характер: применение режима отдельного счёта к конкретной сделке зависит от условий контракта и позиции уполномоченного банка.</p>
    </div>

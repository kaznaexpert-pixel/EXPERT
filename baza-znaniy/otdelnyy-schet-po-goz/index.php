...
<meta property="og:title" content="Отдельный счёт по ГОЗ: режим использования и вывод прибыли">
...
<meta name="twitter:title" content="Отдельный счёт по ГОЗ: режим использования и вывод прибыли">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#rezhim">Режим счёта: что разрешено</a></li>
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>18 мин чтения</span><span class="dot">·</span><span>Обновлено 14 августа 2026 · таблица ответственности переведена на действующую статью 7.30.3 КоАП РФ (ред. от 26.07.2026); закон № 275-ФЗ сверен в редакции от 04.07.2026</span></div>
    </div>

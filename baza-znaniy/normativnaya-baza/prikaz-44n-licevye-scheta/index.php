...
<title>Приказ Казначейства № 44н: открытие лицевых счетов «71»</title>
<meta name="description" content="Приказ № 44н: открытие, переоформление и закрытие лицевых счетов участников казначейского сопровождения в ТОФК, счёт «71», форма 0531368, редакция с 01.09.2026.">
<meta name="author" content="Ярослав Михайлов">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
<meta name="theme-color" content="#F4F1EB" media="(prefers-color-scheme: light)">
<meta name="theme-color" content="#141310" media="(prefers-color-scheme: dark)">
<!-- PROD: canonical и og:url ОБЯЗАТЕЛЬНО менять под URL каждой статьи -->
<link rel="canonical" href="https://kaznaexpert.ru/baza-znaniy/normativnaya-baza/prikaz-44n-licevye-scheta/">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Чтобы работать по контракту под казначейским сопровождением, нужно открыть лицевой счёт в ТОФК. Порядок открытия, резервирования, переоформления и закрытия таких счетов задаёт приказ № 44н. С 1 сентября 2026 года он применяется с изменениями по приказу Казначейства от 22.06.2026 № 14н: уточнён электронный документооборот с органами казначейства и введён возврат аванса поставщику при его ликвидации, а положения о казначейском мониторинге из Порядка исключены.</div>

    <h2 id="reg">Что регулирует</h2>
    <div class="answer reveal"><p>44н утверждает Порядок открытия территориальными органами казначейства лицевых счетов участникам казначейского сопровождения — включая единый счёт с кодом «71».</p><p>Приказ определяет состав документов, формы, требования к их заполнению и основания для открытия, переоформления и закрытия счёта. Единственное заявление в Порядке — приложение № 1, «Заявление на резервирование/закрытие лицевого счёта» (форма 0531368).</p></div>

    <h2 id="kak">Как это работает на практике</h2><div class="answer reveal"><ol class="ol"><li>Заказчик формирует карточку контракта в ГИИС «Электронный бюджет» и направляет её исполнителю; по пункту 24 Порядка для открытия счёта представляются документ-основание, выписка из него либо эта карточка — отдельного заявления на открытие Порядок не предусматривает.</li><li>Исполнитель подписывает карточку контракта своей электронной подписью; после подписания открывается лицевой счёт.</li><li>До заключения контракта номер счёта можно зарезервировать по заявлению формы 0531368 — в нём и указывается код ТОФК (КОФК), четырёхзначный код управления по региону; если документы для открытия не представлены в течение шести месяцев с даты резервирования, запись о зарезервированном номере утрачивает силу.</li><li>ТОФК проверяет документы и открывает единый лицевой счёт с кодом «71»; по каждому контракту на нём ведётся отдельный раздел с ИГК.</li><li>Обмен документами с ТОФК идёт в электронном виде; полномочия подписанта подтверждаются машиночитаемой доверенностью, а не карточкой образцов подписей.</li><li>При изменении данных счёт переоформляется, при завершении контракта — закрывается по тому же порядку.</li></ol></div>

    <h2 id="means">Что это значит для исполнителя контракта</h2>
    <div class="answer reveal"><ul class="ul"><li>По этому порядку вы открываете лицевой счёт «71», без которого расчёты по контракту невозможны.</li><li>Открытие идёт по документу-основанию или карточке контракта из «Электронного бюджета»; отдельное заявление подаётся только на резервирование номера и на закрытие счёта.</li><li>Код ТОФК берут из справочника казначейства и указывают в заявлении на резервирование.</li><li>Один счёт «71» обслуживает несколько контрактов — операции обособляются по ИГК.</li><li>Приказ задаёт и переоформление/закрытие счёта — это важно при изменении данных и завершении контракта.</li></ul></div>

    <h2 id="norms">Ключевые нормы</h2>
    <div class="answer reveal"><table class="ctab"><thead><tr><th>Норма</th><th>Суть</th></tr></thead><tbody><tr><td class="cd">Порядок открытия</td><td>основания и документы для открытия лицевого счёта участника казначейского сопровождения.</td></tr><tr><td class="cd">Счёт «71»</td><td>единый лицевой счёт для расчётов по контрактам под сопровождением.</td></tr><tr><td class="cd">Код ТОФК (КОФК)</td><td>указывается в заявлении на резервирование лицевого счёта; берётся из справочника органов казначейства.</td></tr><tr><td class="cd">Переоформление и закрытие</td><td>процедуры при изменении данных и завершении контракта.</td></tr><tr><td class="cd">Резервирование</td><td>лицевой счёт можно зарезервировать до заключения контракта — заявление на резервирование/закрытие лицевого счёта по форме 0531368, перечень участников по форме 0531369; резервирование действует шесть месяцев.</td></tr><tr><td class="cd">Редакция</td><td>действует с учётом изменений по приказу № 14н от 22.06.2026, применяемых с 01.09.2026.</td></tr></tbody></table></div>
    ...
    <h2 id="praktika">Из практики применения</h2><div class="answer reveal"><table class="ctab"><thead><tr><th>Ситуация</th><th>Как решается</th><th>На что опереться</th></tr></thead><tbody><tr><td>Документы на открытие счёта вернули</td><td>Комплект и формы заданы приказом; чаще всего ошибка в самом заявлении или в реквизитах контракта. Карточка образцов подписей в составе документов больше не применяется — полномочия подтверждаются машиночитаемой доверенностью</td><td class="cd">приказ 44н</td></tr><tr><td>Счёт нужен срочно под аванс</td><td>Срок открытия считается с момента полного корректного комплекта — подавать заранее</td><td class="cd">приказ 44н</td></tr><tr><td>Контракт ещё не подписан, но счёт хочется подготовить</td><td>Использовать резервирование лицевого счёта до заключения контракта</td><td class="cd">приказ 44н</td></tr></tbody></table></div>
    ...
    <div class="answer reveal"><p>Сверка 1 сентября 2026 года: изменения в Порядок № 44н вступили в силу — с этой даты приказ 44н от 22.12.2021 применяется с учётом поправок, внесённых приказом Казначейства № 14н; редакция от 30.09.2025 действовала до 31 августа 2026 года включительно.</p><p>Эти изменения внёс приказ Федерального казначейства от 22.06.2026 № 14н: зарегистрирован в Минюсте 23 июля 2026 года под № 87587, официально опубликован 24 июля 2026 года, вступил в силу 1 сентября 2026 года. Он уточнил обмен электронными документами с органами казначейства и порядок возврата аванса поставщику при его ликвидации, а также исключил из Порядка № 44н положения о процедурах казначейского мониторинга — теперь мониторинг регулирует постановление Правительства от 27.07.2026 № 941. Сам приказ 44н при этом не отменяется — меняется утверждённый им Порядок.</p><p>Практический вывод: заявления, поданные до 1 сентября 2026 года, оформляются по действующим формам; при подаче в сентябре сверяйте бланки с обновлённой редакцией Порядка на сайте вашего ТОФК.</p></div>
    ...
    <div class="faq"><details><summary>Какой документ регулирует открытие лицевого счёта в казначействе?</summary><p>Приказ Федерального казначейства № 44н от 22.12.2021 в действующей редакции.</p></details><details><summary>Что такое счёт с кодом 71?</summary><p>Единый лицевой счёт участника казначейского сопровождения в ТОФК, через который идут расчёты по контракту.</p></details><details><summary>Где взять код ТОФК для заявления на резервирование?</summary><p>В справочнике казначейств по регионам — это код вашего управления (КОФК).</p></details><details><summary>Нужен ли отдельный счёт под каждый контракт?</summary><p>Нет: счёт «71» единый, но по каждому контракту на нём ведётся отдельный раздел с ИГК.</p></details><details><summary>Что изменилось в приказе 44н с 1 сентября 2026 года?</summary><p>Приказ Казначейства от 22.06.2026 № 14н уточнил обмен электронными документами с органами казначейства и ввёл возврат аванса поставщику при его ликвидации, а также исключил из Порядка положения о казначейском мониторинге.</p></details><details><summary>Нужна ли карточка образцов подписей при открытии счёта?</summary><p>Нет. Она больше не входит в комплект документов: полномочия подписанта подтверждаются машиночитаемой доверенностью в электронном документообороте с ТОФК.</p></details></div>

    <section class="refs" aria-label="Источники"><h2>Источник</h2><ol>
      <li id="ref-1">Приказ Федерального казначейства от 22.12.2021 № 44н «Об утверждении Порядка открытия лицевых счетов территориальными органами Федерального казначейства участникам казначейского сопровождения» (ред. от 30.09.2025). <a href="https://www.consultant.ru/document/cons_doc_LAW_405524/" target="_blank" rel="noopener">Первоисточник</a></li>
      <li id="ref-2">Приказ Федерального казначейства от 22.06.2026 № 14н — изменения в Порядок № 44н, зарегистрирован в Минюсте 23.07.2026 № 87587, вступил в силу 01.09.2026. <a href="https://www.garant.ru/news/2197328/" target="_blank" rel="noopener">Обзор изменений</a></li>
  ...
  <div class="related-inline"><b>Рядом в нормативной базе:</b> <a href="/baza-znaniy/normativnaya-baza/prikaz-214n/">Приказ Минфина № 214н</a> · <a href="/baza-znaniy/normativnaya-baza/">все разборы НПА</a></div>
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="npa-prikaz-44n-licevye-scheta">

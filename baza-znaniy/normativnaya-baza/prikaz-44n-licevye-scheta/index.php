...
<meta name="description" content="Порядок открытия, переоформления и закрытия лицевых счетов участников казначейского сопровождения в ТОФК (в т.ч. счёта с кодом 71). Действующая редакция от 30.09.2025; с 1 сентября 2026 года применяются изменения по приказу № 14н.">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Чтобы работать по контракту под казначейским сопровождением, нужно открыть лицевой счёт в ТОФК. Порядок открытия, резервирования, переоформления и закрытия таких счетов задаёт приказ № 44н. Сейчас он применяется в редакции от 30.09.2025, а с 1 сентября 2026 года вступают в силу изменения по приказу Казначейства от 22.06.2026 № 14н: уточняются электронный документооборот с органами казначейства и возврат аванса поставщику при его ликвидации, а положения о казначейском мониторинге из Порядка исключаются.</div>
    ...
    <div class="answer reveal"><p>Сверка 18 августа 2026 года: приказ 44н от 22.12.2021 применяется в редакции от 30.09.2025 — это подтверждает карточка документа в КонсультантПлюс, где одновременно отмечена подготовленная редакция с изменениями, не вступившими в силу.</p><p>Эти изменения внёс приказ Федерального казначейства от 22.06.2026 № 14н: зарегистрирован в Минюсте 23 июля 2026 года под № 87587, официально опубликован 24 июля 2026 года, вступает в силу с 1 сентября 2026 года. Он уточняет обмен электронными документами с органами казначейства и порядок возврата аванса поставщику при его ликвидации, а также исключает из Порядка № 44н положения о процедурах казначейского мониторинга. Сам приказ 44н при этом не отменяется — меняется утверждённый им Порядок.</p><p>Практический вывод: заявления, поданные до 1 сентября 2026 года, оформляются по действующим формам; при подаче в сентябре сверяйте бланки с обновлённой редакцией Порядка на сайте вашего ТОФК.</p></div>
    ...
    <section class="refs" aria-label="Источники"><h2>Источник</h2><ol>
      ...
      <li id="ref-2">Приказ Федерального казначейства от 22.06.2026 № 14н — изменения в Порядок № 44н, зарегистрирован в Минюсте 23.07.2026 № 87587, вступает в силу 01.09.2026. <a href="https://www.garant.ru/news/2197328/" target="_blank" rel="noopener">Обзор изменений</a></li>

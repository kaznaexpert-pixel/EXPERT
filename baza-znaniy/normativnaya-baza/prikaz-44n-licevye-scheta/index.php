...
{"@context": "https://schema.org", "@type": ["Article", "Legislation"], "headline": "Приказ Казначейства № 44н — открытие лицевых счетов участников КС в ТОФК", "description": "Порядок открытия, переоформления и закрытия лицевых счетов участников КС в ТОФК (в т.ч. счёта с кодом 71), состав документов и форм.", "datePublished": "2026-06-06T10:00:00+03:00", "dateModified": "2026-07-02T10:00:00+03:00", "inLanguage": "ru-RU", "legislationIdentifier": "44н", "about": "Приказ Федерального казначейства от 22.12.2021 № 44н «Об утверждении Порядка открытия лицевых счетов территориальными органами Федерального казначейства участникам казначейского сопровождения»", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}}, "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/normativnaya-baza/prikaz-44n-licevye-scheta/"}, "image": "https://kaznaexpert.ru/img/og-image.png"}
</script>
<script type="application/ld+json">

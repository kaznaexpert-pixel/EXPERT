...
<meta name="description" content="Порядок открытия, переоформления и закрытия лицевых счетов участников казначейского сопровождения в ТОФК (в т.ч. счёта с кодом 71). Действующая редакция — с учётом изменений по приказу № 14н, применяемых с 1 сентября 2026 года.">

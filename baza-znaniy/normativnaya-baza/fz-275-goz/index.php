...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="npa-meta"><div><span>Документ</span><b>Федеральный закон от 29.12.2012 № 275-ФЗ «О государственном оборонном заказе»</b></div><div class="npa-meta-row"><span>Дата: 29 декабря 2012</span><span>действует, ред. от 15.12.2025</span><a href="https://www.consultant.ru/document/cons_doc_LAW_140175/" target="_blank" rel="noopener nofollow">Первоисточник →</a></div></div>
    ...
    <div class="answer reveal"><p>275-ФЗ действует в редакции от 15.12.2025 (Федеральный закон № 471-ФЗ ввёл обязанность головного исполнителя и исполнителя ГОЗ представлять промежуточную бухгалтерскую (финансовую) отчётность). Режимы сопровождения ГОЗ периодически уточняются — сверяйте действующую редакцию и условия конкретного контракта.</p></div>

...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Сведения об операциях с целевыми средствами (форма 0501213) — ключевой документ участника КС: без них не начнётся санкционирование. Совместное письмо № 02-12-10/1232 разъясняет, как их формировать с учётом последних изменений.</div>
    ...
    <h2 id="sistema">Место в системе регулирования</h2><div class="answer reveal"><p>Письмо разъясняет применение приказа 214н (форма 0501213, коды) и связано с Правилами (ПП № 2024). Это «инструкция по заполнению» для главного планового документа КС; коды берутся из наших справочников направлений и источников.</p></div>

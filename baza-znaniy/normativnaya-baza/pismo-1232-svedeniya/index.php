...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Что такое Сведения об операциях с целевыми средствами?", "acceptedAnswer": {"@type": "Answer", "text": "Плановый документ (форма 0501213), в котором участник КС отражает источники и направления расходования; по нему идёт санкционирование."}}, {"@type": "Question", "name": "Чем полезно письмо № 02-12-10/1232?", "acceptedAnswer": {"@type": "Answer", "text": "Оно разъясняет, как заполнять Сведения с учётом последних изменений приказа 214н, и помогает избежать возвратов."}}, {"@type": "Question", "name": "Где взять коды для Сведений?", "acceptedAnswer": {"@type": "Answer", "text": "В приложениях к приказу 214н: источники — Прил. 2, направления — Прил. 3."}}]}
</script>
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Сведения об операциях с целевыми средствами (форма 0501213) — ключевой документ участника КС. Совместное письмо № 02-12-10/1232 разъясняет, как их формировать с учётом последних изменений.</div>

    <h2 id="reg">Что регулирует</h2>
    <div class="answer reveal"><p>Письмо Минфина и Федерального казначейства от 13.01.2025 разъясняет порядок представления Сведений (ф. 0501213) с учётом приказа № 197н: как отражать показатели на лицевом счёте, указывать коды источников и направлений.</p><p>Это не самостоятельная норма, а официальное разъяснение к приказу 214н — но именно на него опираются при спорных вопросах заполнения.</p></div>

    <h2 id="means">Что это значит для исполнителя контракта</h2>
    <div class="answer reveal"><ul class="ul"><li>Письмо помогает корректно заполнить Сведения — документ, без которого не начнётся санкционирование.</li><li>Разъясняет, как указывать коды источников поступлений и направлений расходования в Сведениях.</li><li>Снижает риск возврата Сведений на доработку из-за формальных ошибок.</li><li>Применяется вместе с действующей редакцией приказа 214н.</li></ul></div>

    <h2 id="norms">Ключевые нормы</h2>
    <div class="answer reveal"><table class="ctab"><thead><tr><th>Норма</th><th>Суть</th></tr></thead><tbody><tr><td class="cd">Форма 0501213</td><td>Сведения об операциях с целевыми средствами — основной плановый документ.</td></tr><tr><td class="cd">Коды в Сведениях</td><td>источники поступлений и направления расходования указываются по приложениям к 214н.</td></tr><tr><td class="cd">Статус</td><td>официальное разъяснение Минфина и Казначейства.</td></tr></tbody></table></div>
    ...
    <div class="faq"><details><summary>Что такое Сведения об операциях с целевыми средствами?</summary><p>Плановый документ (форма 0501213), в котором участник КС отражает источники и направления расходования; по нему идёт санкционирование.</p></details><details><summary>Чем полезно письмо № 02-12-10/1232?</summary><p>Оно разъясняет, как заполнять Сведения с учётом последних изменений приказа 214н, и помогает избежать возвратов.</p></details><details><summary>Где взять коды для Сведений?</summary><p>В приложениях к приказу 214н: источники — Прил. 2, направления — Прил. 3.</p></details></div>

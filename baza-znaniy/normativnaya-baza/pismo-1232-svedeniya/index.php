...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Что такое Сведения об операциях с целевыми средствами?", "acceptedAnswer": {"@type": "Answer", "text": "Плановый документ (форма 0501213), в котором участник казначейского сопровождения отражает источники и направления расходования; по нему идёт санкционирование."}}, {"@type": "Question", "name": "Чем полезно письмо № 02-12-10/1232?", "acceptedAnswer": {"@type": "Answer", "text": "Оно разъясняет, как заполнять Сведения с учётом последних изменений приказа 214н, и помогает избежать возвратов."}}, {"@type": "Question", "name": "Где взять коды для Сведений?", "acceptedAnswer": {"@type": "Answer", "text": "В приложениях к приказу 214н: источники — Прил. 2, направления — Прил. 3."}}, {"@type": "Question", "name": "Что будет, если платёж не предусмотрен Сведениями?", "acceptedAnswer": {"@type": "Answer", "text": "Его не санкционируют: сначала нужно скорректировать и переутвердить Сведения."}}]}
</script>
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="hero"><img class="hero__crest hero__crest--light" src="/img/logogold-crest.webp" alt="" aria-hidden="true" width="188" height="137" decoding="async" loading="lazy"><img class="hero__crest hero__crest--dark" src="/img/LogoWhite.png" alt="" aria-hidden="true" width="188" height="137" decoding="async" loading="lazy"><div class="eyebrow">База знаний · Нормативная база <span class="fresh">Актуально на 2026</span></div><h1>Письмо Минфина и Казначейства № 02-12-10/1232 — как формировать Сведения об операциях</h1><div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>Обновлено 3 июля 2026</span></div></div>
    <div class="npa-meta"><div><span>Документ</span><b>Письмо Минфина России и Федерального казначейства от 13.01.2025 № 02-12-10/1232, 07-04-05/04-344 «О порядке представления в 2025 году Сведений об операциях с целевыми средствами»</b></div><div class="npa-meta-row"><span>Дата: 13 января 2025</span><span>действует (разъяснение)</span><a href="https://www.garant.ru/products/ipo/prime/doc/411200695/" target="_blank" rel="noopener nofollow">Первоисточник →</a></div></div>
    <div class="tldr">Сведения об операциях с целевыми средствами (форма 0501213) — ключевой документ участника казначейского сопровождения: без них не начнётся санкционирование. Совместное письмо № 02-12-10/1232 разъясняет, как их формировать с учётом последних изменений.</div>

    <h2 id="reg">Что регулирует</h2>
    <div class="answer reveal"><p class="lead-p">Письмо Минфина и Федерального казначейства от 13.01.2025 разъясняет порядок представления Сведений (ф. 0501213) с учётом приказа № 197н: как отражать показатели на лицевом счёте, указывать коды источников поступлений и направлений расходования.</p><p>Это не самостоятельная норма, а официальное разъяснение к приказу 214н — но именно на него опираются при спорных вопросах заполнения Сведений.</p></div>

    <h2 id="kak">Как это работает на практике</h2><div class="answer reveal"><ol class="ol"><li>Сведения формируются по контракту: указываются источник поступления средств и плановые направления расходования по кодам.</li><li>Показатели отражаются на лицевом счёте в разрезе контракта (ИГК); письмо уточняет, как именно их разносить.</li><li>После утверждения Сведений по ним проводится санкционирование платежей; операции сверх Сведений не пройдут.</li><li>При изменениях по контракту Сведения корректируются и переутверждаются.</li></ol></div>

    <h2 id="means">Что это значит для исполнителя контракта</h2>
    <div class="answer reveal"><ul class="ul"><li>Письмо помогает корректно заполнить Сведения — документ, без которого не начнётся санкционирование.</li><li>Разъясняет, как указывать коды источников поступлений и направлений расходования.</li><li>Снижает риск возврата Сведений на доработку из-за формальных ошибок.</li><li>Применяется вместе с действующей редакцией приказа 214н.</li></ul></div>

    <h2 id="norms">Ключевые нормы</h2>
    <div class="answer reveal"><table class="ctab"><thead><tr><th>Норма</th><th>Суть</th></tr></thead><tbody><tr><td class="cd">Форма 0501213</td><td>Сведения об операциях с целевыми средствами — основной плановый документ.</td></tr><tr><td class="cd">Коды в Сведениях</td><td>источники поступлений (Прил. 2) и направления расходования (Прил. 3) приказа 214н.</td></tr><tr><td class="cd">Отражение показателей</td><td>порядок разнесения сумм на лицевом счёте в разрезе контракта.</td></tr><tr><td class="cd">Статус</td><td>официальное разъяснение Минфина и Казначейства, а не самостоятельная норма.</td></tr></tbody></table></div>

    <h2 id="oshibki">На что обратить внимание</h2><div class="answer reveal"><ul class="ul"><li>Неверный код источника или направления в Сведениях — возврат на доработку.</li><li>Плановые операции в Сведениях не покрывают реальные платежи — платёж не санкционируют.</li><li>Несвоевременная корректировка Сведений при изменении условий контракта.</li><li>Опора на устаревшее разъяснение после новой редакции 214н.</li></ul></div>

    <h2 id="praktika">Из практики применения</h2><div class="answer reveal"><table class="ctab"><thead><tr><th>Ситуация</th><th>Как решается</th><th>На что опереться</th></tr></thead><tbody><tr><td>Сведения вернули из-за избыточной детализации</td><td>Направления расходов указываются укрупнённо по кодам, без попозиционной росписи</td><td class="cd">письмо № 02-12-10/1232</td></tr><tr><td>Появились расходы, которых нет в Сведениях</td><td>Утвердить новую редакцию Сведений до платежа, а не одновременно с ним</td><td class="cd">приказ 214н</td></tr><tr><td>Остаток по коду направления исчерпан</td><td>Перераспределить суммы между кодами новой редакцией Сведений</td><td class="cd">приказ 214н</td></tr></tbody></table></div>

    <h2 id="sistema">Место в системе регулирования</h2><div class="answer reveal"><p>Письмо разъясняет применение приказа 214н (форма 0501213, коды) и связано с Правилами (ПП № 2024). Это «инструкция по заполнению» для главного планового документа казначейского сопровождения; коды берутся из наших справочников направлений и источников.</p></div>

    <h2 id="changed">Актуальная редакция и изменения</h2>
    <div class="answer reveal"><p>Письмо датировано 13.01.2025 и учитывает изменения приказа № 197н (2024). После выхода новых редакций 214н разъяснения могут обновляться — проверяйте свежие письма.</p></div>
    ...
    <div class="faq"><details><summary>Что такое Сведения об операциях с целевыми средствами?</summary><p>Плановый документ (форма 0501213), в котором участник казначейского сопровождения отражает источники и направления расходования; по нему идёт санкционирование.</p></details><details><summary>Чем полезно письмо № 02-12-10/1232?</summary><p>Оно разъясняет, как заполнять Сведения с учётом последних изменений приказа 214н, и помогает избежать возвратов.</p></details><details><summary>Где взять коды для Сведений?</summary><p>В приложениях к приказу 214н: источники — Прил. 2, направления — Прил. 3.</p></details><details><summary>Что будет, если платёж не предусмотрен Сведениями?</summary><p>Его не санкционируют: сначала нужно скорректировать и переутвердить Сведения.</p></details></div>

    <section class="refs" aria-label="Источники"><h2>Источник</h2><ol>
      <li id="ref-1">Письмо Минфина России и Федерального казначейства от 13.01.2025 № 02-12-10/1232, 07-04-05/04-344 «О порядке представления в 2025 году Сведений об операциях с целевыми средствами». <a href="https://www.garant.ru/products/ipo/prime/doc/411200695/" target="_blank" rel="noopener">Первоисточник</a></li>

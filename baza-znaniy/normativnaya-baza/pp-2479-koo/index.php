...
<title>Постановление № 2479: казначейское обеспечение обязательств</title>
<meta name="description" content="Порядок выдачи, перевода и отзыва казначейского обеспечения обязательств (КОО) по ст. 242.22 БК: сроки ТОФК — не позднее 2-го рабочего дня, проверка через «Электронный бюджет». К госконтрактам по гособоронзаказу Правила не применяются.">
<meta name="author" content="Ярослав Михайлов">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
<meta name="theme-color" content="#F4F1EB" media="(prefers-color-scheme: light)">
<meta name="theme-color" content="#141310" media="(prefers-color-scheme: dark)">
<!-- PROD: canonical и og:url ОБЯЗАТЕЛЬНО менять под URL каждой статьи -->
<link rel="canonical" href="https://kaznaexpert.ru/baza-znaniy/normativnaya-baza/pp-2479-koo/">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="hero"><img class="hero__crest hero__crest--light" src="/img/logogold-crest.webp" alt="" aria-hidden="true" width="188" height="137" decoding="async" loading="lazy"><img class="hero__crest hero__crest--dark" src="/img/LogoWhite.png" alt="" aria-hidden="true" width="188" height="137" decoding="async" loading="lazy"><div class="eyebrow">База знаний · Нормативная база <span class="fresh">Актуально на 2026</span></div><h1>Постановление № 2479 — казначейское обеспечение обязательств (КОО): зачем оно исполнителю</h1><div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>Обновлено 16 сентября 2026 · редакция от 26.03.2022 подтверждена по тексту, сроки п. 5–6 Правил не менялись</span></div></div>
    <div class="npa-meta"><div><span>Документ</span><b>Постановление Правительства РФ от 25.12.2021 № 2479 «Об утверждении Правил выдачи (перевода, отзыва) казначейского обеспечения обязательств…»</b></div><div class="npa-meta-row"><span>Дата: 25 декабря 2021</span><span>действует, ред. от 26.03.2022; редакция подтверждена 16.09.2026</span><a href="https://www.consultant.ru/document/cons_doc_LAW_405179/" target="_blank" rel="noopener nofollow">Первоисточник →</a></div></div>
    <div class="tldr">Казначейское обеспечение обязательств — инструмент, который позволяет рассчитываться по контракту без отвлечения собственных оборотных средств. По сути, это гарантия казначейства оплатить обязательство в пределах доведённой суммы. Порядок его выдачи, перевода и отзыва задаёт Постановление № 2479. По состоянию на 16 сентября 2026 года действует редакция от 26.03.2022 (изменение внесено ПП № 481); других поправок в постановление не вносилось. Важное ограничение: Правила прямо не распространяются на государственные контракты в рамках гособоронзаказа, а также на казначейское обеспечение при банковском сопровождении.</div>

    <h2 id="reg">Что регулирует</h2>
    <div class="answer reveal"><p class="lead-p">ПП № 2479 утверждает Правила выдачи, перевода и отзыва казначейского обеспечения обязательств (КОО) по ст. 242.22 БК и сроки операций Федерального казначейства с КОО.</p><p>КОО применяется, когда условие о нём прямо включено в государственный (муниципальный) контракт, договор (соглашение) или контракт в цепочке кооперации: вместо перечисления аванса «живыми» деньгами казначейство выдаёт обеспечение, которое подтверждает гарантию оплаты. Из-под действия Правил выведены государственные контракты в рамках гособоронзаказа (подпункт 5 статьи 242.27 БК), а пункт 1(1), добавленный ПП № 481 от 26.03.2022, исключает и отношения при банковском сопровождении.</p></div>

    <h2 id="kak">Как это работает на практике</h2><div class="answer reveal"><ol class="ol"><li>Казначейство выдаёт КОО в пределах сумм, доведённых по контракту под сопровождением.</li><li>Головной исполнитель переводит обеспечение соисполнителям по цепочке кооперации — тоже в пределах сумм.</li><li>Фактическая оплата происходит при наступлении оснований; при необходимости обеспечение отзывается.</li><li>Территориальный орган проверяет заявление по данным ГИИС «Электронный бюджет» и при положительном результате формирует КОО не позднее 2-го рабочего дня после дня получения заявления; при несоответствии требованиям в тот же срок возвращает заявление без исполнения.</li><li>По истечении срока действия КОО отзывается территориальным органом автоматически — заявление об отзыве для этого не нужно.</li></ol></div>

    <h2 id="means">Что это значит для исполнителя контракта</h2>
    <div class="answer reveal"><ul class="ul"><li>КОО позволяет подтвердить контрагенту гарантию оплаты, не перечисляя аванс деньгами заранее.</li><li>Обеспечение переводится по цепочке кооперации — соисполнителям.</li><li>Это снижает потребность в оборотных средствах на старте контракта.</li><li>Работа с КОО требует точного документооборота — ошибки приводят к задержкам перевода.</li><li>Условие о применении КОО должно быть прямо прописано в контракте: без него территориальный орган не выдаст и не переведёт обеспечение.</li><li>Сумма перевода соисполнителю ограничена не только суммой контракта, но и остатком по укрупнённому коду направления расходования в Сведениях об операциях с целевыми средствами.</li><li>По гособоронзаказу этот инструмент не применяется — там работает режим отдельного счёта по закону № 275-ФЗ.</li></ul></div>

    <h2 id="norms">Ключевые нормы</h2>
    <div class="answer reveal"><table class="ctab"><thead><tr><th>Норма</th><th>Суть</th></tr></thead><tbody><tr><td class="cd">Выдача КОО</td><td>казначейство выдаёт обеспечение в пределах сумм, доведённых при казначейском сопровождении.</td></tr><tr><td class="cd">Перевод</td><td>обеспечение переводится соисполнителям по цепочке кооперации.</td></tr><tr><td class="cd">Отзыв</td><td>обеспечение отзывается при наличии оснований.</td></tr><tr><td class="cd">Сроки</td><td>не позднее 2-го рабочего дня после дня получения заявления — как на формирование КОО, так и на возврат заявления без исполнения.</td></tr><tr><td class="cd">Область применения</td><td>не распространяется на госконтракты в рамках гособоронзаказа и на КОО при банковском сопровождении (п. 1 и п. 1(1) Правил).</td></tr><tr><td class="cd">Условие в контракте</td><td>выдача и перевод возможны, только если положение о применении КОО есть в самом контракте (договоре, соглашении).</td></tr></tbody></table></div>

    <h2 id="oshibki">На что обратить внимание</h2><div class="answer reveal"><ul class="ul"><li>Попытка перевести обеспечение сверх доведённых сумм.</li><li>Ошибки в документах на перевод КОО соисполнителю — задержка всей цепочки.</li><li>Смешение КОО с обычным авансом: это разные инструменты с разным порядком.</li><li>Расчёт на КОО по контракту гособоронзаказа — Правила туда не распространяются.</li><li>Пропущенный срок действия обеспечения: по его истечении КОО отзывается автоматически, и распоряжения к оплате возвращаются.</li></ul></div>

    <h2 id="praktika">Из практики применения</h2><div class="answer reveal"><table class="ctab"><thead><tr><th>Ситуация</th><th>Как решается</th><th>На что опереться</th></tr></thead><tbody><tr><td>Заказчик предлагает КОО вместо аванса</td><td>Деньги не поступают на счёт до факта исполнения — оценить потребность в оборотных средствах заранее</td><td class="cd">ПП № 2479</td></tr><tr><td>Непонятно, как «раскрывается» казначейский аккредитив</td><td>Средства перечисляются после подтверждения исполнения обязательств по условиям аккредитива</td><td class="cd">ПП № 2479</td></tr><tr><td>КОО и казначейское сопровождение одновременно</td><td>Режимы сочетаются: КОО закрывает авансирование, сопровождение — расчёты</td><td class="cd">ПП № 2479, БК РФ</td></tr><tr><td>Заказчик по контракту гособоронзаказа предлагает КОО</td><td>Проверить основание: Правила ПП № 2479 не распространяются на госконтракты в рамках гособоронзаказа</td><td class="cd">п. 1 «а» Правил, пп. 5 ст. 242.27 БК</td></tr></tbody></table></div>

    <h2 id="sistema">Место в системе регулирования</h2><div class="answer reveal"><p>КОО опирается на ст. 242.22 БК и применяется в связке с Правилами казначейского сопровождения (ПП № 2024): суммы перевода контролируются по укрупнённым кодам направлений расходования из Сведений об операциях с целевыми средствами. Для исполнителя это альтернатива денежному авансу в режиме сопровождения по крупным гражданским контрактам; на гособоронзаказ инструмент не распространяется.</p></div>

    <h2 id="changed">Актуальная редакция и изменения</h2>
    <div class="answer reveal"><p>Сверка 18 августа 2026 года по тексту постановления на портале Правительства: ПП № 2479 от 25.12.2021 применяется в редакции постановления Правительства РФ от 26.03.2022 № 481 — с 2022 года Правила не менялись. Именно ПП № 481 дополнил их пунктом 1(1), выводящим из-под действия Правил отношения при банковском сопровождении.</p><p>Формы КОО, заявлений о выдаче, переводе, отзыве и исполнении, а также порядок их заполнения устанавливает Федеральное казначейство (п. 10 Правил) — эти формы обновляются чаще самого постановления, их и нужно сверять перед подачей.</p></div>

    <div class="note">Смотрите также: <div class="codechips"><a class="codechip" href="/baza-znaniy/normativnaya-baza/bk-242-24-rasshirennoe/">Расширенное казначейское сопровождение (ст. 242.24 БК)</a><a class="codechip" href="/baza-znaniy/kaznacheyskoe-soprovozhdenie-goz-275-fz/">Казначейское сопровождение ГОЗ</a><a class="codechip" href="/baza-znaniy/normativnaya-baza/pp-2024-pravila-ks/">Правила казначейского сопровождения (ПП № 2024)</a></div></div>

    <h2 id="faq">Частые вопросы</h2>
    <div class="faq"><details><summary>Что такое казначейское обеспечение обязательств простыми словами?</summary><p>Это гарантия казначейства оплатить обязательство в пределах доведённой суммы — без предварительного перечисления аванса деньгами.</p></details><details><summary>Можно ли передать КОО соисполнителю?</summary><p>Да, обеспечение переводится по цепочке кооперации в пределах сумм.</p></details><details><summary>Чем регулируется КОО?</summary><p>Статьёй 242.22 БК и Постановлением Правительства № 2479.</p></details><details><summary>Чем КОО лучше денежного аванса?</summary><p>Не отвлекает оборотные средства: гарантия оплаты подтверждается без перечисления денег вперёд.</p></details><details><summary>Применяется ли КОО по гособоронзаказу?</summary><p>Нет. Правила ПП № 2479 прямо исключают государственные контракты в рамках гособоронзаказа, предусмотренные подпунктом 5 статьи 242.27 БК.</p></details><details><summary>За сколько дней казначейство выдаёт КОО?</summary><p>Не позднее 2-го рабочего дня после дня получения заявления. В тот же срок заявление возвращается без исполнения, если не соответствует требованиям пункта 3 Правил.</p></details></div>

    <section class="refs" aria-label="Источники"><h2>Источник</h2><ol>
      <li id="ref-1">Постановление Правительства РФ от 25.12.2021 № 2479 «Об утверждении Правил выдачи (перевода, отзыва) казначейского обеспечения обязательств…» (в ред. ПП РФ от 26.03.2022 № 481). <a href="http://government.ru/docs/all/138536/" target="_blank" rel="noopener">Первоисточник</a></li>
      <li id="ref-2">Постановление Правительства РФ от 25.12.2021 № 2479, карточка документа. <a href="https://www.consultant.ru/document/cons_doc_LAW_405179/" target="_blank" rel="noopener">Первоисточник</a></li>
  ...
  <div class="related-inline"><b>Рядом в нормативной базе:</b> <a href="/baza-znaniy/normativnaya-baza/pp-2024-pravila-ks/">Постановление № 2024</a> · <a href="/baza-znaniy/normativnaya-baza/prikaz-214n/">Приказ Минфина № 214н</a> · <a href="/baza-znaniy/normativnaya-baza/">все разборы НПА</a></div>
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="npa-pp-2479-koo">

...
<title>Новый порядок санкционирования вместо 214н — что меняется с 01.09.2026</title>
<meta name="description" content="Новый порядок санкционирования при казначейском сопровождении: заявлен с 01.09.2026 взамен 214н, на 16.08.2026 не подписан.">
...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Когда перестанет действовать приказ 214н?", "acceptedAnswer": {"@type": "Answer", "text": "С 1 сентября 2026 года: пунктом 2 нового приказа 214н и все изменявшие его приказы (39н, 97н, 197н, 84н) признаются утратившими силу, пунктом 3 установлено вступление нового Порядка в силу с 01.09.2026."}}, {"@type": "Question", "name": "Изменятся ли коды направлений расходования целевых средств?", "acceptedAnswer": {"@type": "Answer", "text": "Система кодов сохраняется — в тексте нового Порядка фигурируют привычные коды (0100, 0810, 0813, 0888 и другие) и правило первого разряда «6/8/9». Но размещаются они теперь в Приложениях № 2 (укрупнённые) и № 3 (детализированные) нового Порядка. Точный состав сверим по официальной публикации."}}, {"@type": "Question", "name": "Распространится ли новый порядок на контракты, заключённые до 1 сентября 2026 года?", "acceptedAnswer": {"@type": "Answer", "text": "Порядок регулирует санкционирование операций, а не заключение контрактов: с даты вступления в силу проверки платежей идут по новым правилам независимо от даты контракта. Особенности для переходящих контрактов уточним после официального опубликования приказа."}}, {"@type": "Question", "name": "Что изменится в Сведениях об операциях с целевыми средствами?", "acceptedAnswer": {"@type": "Answer", "text": "Форма 0501213 сохраняется. Уточнены правила заполнения (пункт 14) и закреплён срок утверждения заказчиком — не позднее 10 рабочих дней; документооборот ведётся в ГИИС «Электронный бюджет»."}}, {"@type": "Question", "name": "Где посмотреть текст нового порядка?", "acceptedAnswer": {"@type": "Answer", "text": "Подготовленный текст доступен в правовых системах (ГАРАНТ, документ от 20.05.2026); материалы проекта — на regulation.gov.ru (ID 01/02/05-26/00168022). После подписания официальная публикация появится на pravo.gov.ru."}}]}
</script>
...
<meta property="og:description" content="Новый порядок санкционирования при казначейском сопровождении: заявлен с 01.09.2026 взамен 214н, на 16.08.2026 не подписан.">
...
<meta name="twitter:description" content="Новый порядок санкционирования при казначейском сопровождении: заявлен с 01.09.2026 взамен 214н, на 16.08.2026 не подписан.">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="hero"><img class="hero__crest hero__crest--light" src="/img/logogold-crest.webp" alt="" aria-hidden="true" width="188" height="137" decoding="async" loading="lazy"><img class="hero__crest hero__crest--dark" src="/img/LogoWhite.png" alt="" aria-hidden="true" width="188" height="137" decoding="async" loading="lazy"><div class="eyebrow">База знаний · Нормативная база <span class="fresh">Актуально на 2026</span></div><h1>Новый порядок санкционирования вместо 214н — что меняется с 01.09.2026</h1><div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>Обновлено 16 августа 2026</span></div></div>
    <div class="npa-meta"><div><span>Документ</span><b>Приказ Минфина России «Об утверждении Порядка осуществления территориальными органами Федерального казначейства санкционирования операций со средствами участников казначейского сопровождения» (подготовленный текст от 20.05.2026; заменит приказ № 214н)</b></div><div class="npa-meta-row"><span>Дата: 20 мая 2026</span><span>подготовлен, вступает в силу с 01.09.2026</span><a href="https://base.garant.ru/57055965/" target="_blank" rel="noopener nofollow">Первоисточник →</a></div></div>
    <div class="tldr">Минфин подготовил новый порядок санкционирования операций со средствами участников казначейского сопровождения: с 1 сентября 2026 года он полностью заменит приказ № 214н со всеми изменениями. Полный текст опубликован в правовых системах 20 мая 2026 года. Разбираем, что сохраняется, что меняется и что сделать исполнителю контракта до осени.</div>

    <h2 id="reg">Что регулирует</h2>
    <div class="answer reveal"><p>Новый документ утверждает Порядок санкционирования — правила, по которым территориальный орган Федерального казначейства проверяет и проводит каждый платёж участника казначейского сопровождения. Он издан на основании пункта 4 статьи 242.23 Бюджетного кодекса и объединяет в одном тексте все поправки, накопившиеся в приказе 214н за 2022–2025 годы (приказы № 39н, 97н, 197н, 84н), с учётом изменений Бюджетного кодекса.</p><p>Пунктом 2 нового приказа признаются утратившими силу приказ № 214н от 17.12.2021 и все изменявшие его приказы; пунктом 3 установлено вступление в силу с 1 сентября 2026 года. Номер и дата новому приказу ещё не присвоены — опубликован подготовленный Минфином текст (в реквизитах пробелы), впереди подписание и регистрация в Минюсте.</p><p>Ключевая преемственность: сохраняются форма Сведений об операциях с целевыми средствами (ОКУД 0501213), система кодов направлений расходования (в тексте фигурируют привычные 0100, 0400, 0630, 0810, 0813, 0888) и правило первого разряда «6/8/9». Направления расходования теперь оформлены двумя приложениями к новому Порядку: укрупнённые — Приложение № 2, детализированные — Приложение № 3.</p></div>

    <h2 id="kak">Как это работает на практике</h2><div class="answer reveal"><ol class="ol"><li>Документооборот закрепляется в ГИИС «Электронный бюджет»: Сведения, распоряжения и уведомления формируются и проверяются в системе (пункт 3 Порядка).</li><li>Сведения (ф. 0501213) заполняются по правилам пункта 14: в графе 1 — укрупнённое направление расходования по Приложению № 2 и детализированное по Приложению № 3.</li><li>Правило первого разряда сохранено: «6» — единовременная оплата после полного исполнения контракта с единственным поставщиком; «8» — оплата за фактически поставленные товары, работы, услуги без привлечения иных участников казначейского сопровождения; «9» — возмещение произведённых расходов со счёта в банке. Для операций казначейского обеспечения обязательств зарезервированы значения первого разряда с «3» по «5».</li><li>Срок утверждения Сведений заказчиком (получателем средств) — не позднее 10 рабочих дней со дня их поступления (пункт 9); при отказе оформляется уведомление с указанием причин, повторное рассмотрение — в тот же срок.</li><li>Контрактом может быть предусмотрено перечисление средств на банковский счёт исполнителя в пределах 50 % цены контракта (без учёта аванса) и перечисление прибыли в пределах 25 % цены контракта (без учёта аванса) — пункт 8 Порядка.</li><li>Накладные расходы оплачиваются по коду 0888 в доле, приходящейся на контракт (пункт 25); отдельный блок пунктов 20–21 регулирует проверки при расширенном казначейском сопровождении — вплоть до факта поставки и экономической обоснованности затрат.</li></ol></div>

    <h2 id="means">Что это значит для исполнителя контракта</h2>
    <div class="answer reveal"><ul class="ul"><li>До 31 августа 2026 года включительно платежи санкционируются по приказу 214н — менять ничего не нужно, но переходящие через 1 сентября контракты попадут под новый Порядок автоматически.</li><li>Шаблоны Сведений, распоряжений и внутренние регламенты, где упоминается «приказ 214н», к осени потребуют актуализации реквизитов — вплоть до ссылок в договорах с соисполнителями.</li><li>Ссылки на приложения изменятся: направления расходования будут в Приложениях № 2 и № 3 нового Порядка, а не в Приложении № 3 к 214н.</li><li>Логика работы исполнителя не ломается: лицевой счёт, Сведения 0501213, коды направлений и санкционирование каждого платежа сохраняются.</li><li>Точный номер приказа и окончательный состав кодов станут известны после подписания и официального опубликования — мы отслеживаем и обновим справочники кодов и нормативной базы.</li></ul></div>

    <h2 id="norms">Ключевые нормы</h2>
    <div class="answer reveal"><table class="ctab"><thead><tr><th>Норма</th><th>Суть</th></tr></thead><tbody><tr><td class="cd">П. 2–3 приказа</td><td>отмена 214н со всеми изменениями (39н, 97н, 197н, 84н) и вступление в силу с 01.09.2026.</td></tr><tr><td class="cd">Прил. № 1 (ф. 0501213)</td><td>форма Сведений об операциях с целевыми средствами сохранена.</td></tr><tr><td class="cd">Прил. № 2 и № 3</td><td>укрупнённые и детализированные направления расходования целевых средств.</td></tr><tr><td class="cd">П. 8</td><td>перечисление на банковский счёт до 50 % цены контракта и прибыли до 25 % (без учёта аванса), если это предусмотрено контрактом.</td></tr><tr><td class="cd">П. 9</td><td>срок утверждения Сведений — 10 рабочих дней; порядок отказа и повторного утверждения.</td></tr><tr><td class="cd">П. 14</td><td>правила заполнения Сведений; первый разряд «6/8/9», значения «3»–«5» для казначейского обеспечения обязательств.</td></tr><tr><td class="cd">П. 20–21</td><td>состав проверок при санкционировании и режим расширенного казначейского сопровождения.</td></tr><tr><td class="cd">П. 25</td><td>оплата накладных расходов по коду 0888 в доле, приходящейся на контракт.</td></tr></tbody></table></div>

    <h2 id="oshibki">На что обратить внимание</h2><div class="answer reveal"><ul class="ul"><li>Ссылаться после 1 сентября 2026 года на «Порядок 214н» в Сведениях, регламентах и договорах с соисполнителями — реквизиты станут недействующими.</li><li>Брать номера приложений по памяти: перечень направлений расходования переезжает из Приложения № 3 к 214н в Приложения № 2 и № 3 нового Порядка.</li><li>Планировать выплату прибыли и возмещение расходов без оглядки на пределы пункта 8 (50 % и 25 % цены контракта без учёта аванса).</li><li>Игнорировать срок утверждения Сведений: 10 рабочих дней — норма, за нарушение которой заказчику уже сейчас грозит ответственность по статье 15.49 КоАП РФ.</li><li>Считать документ «проектом, который ещё сто раз поменяют»: текст подготовлен и опубликован, дата 01.09.2026 закреплена в самом приказе.</li></ul></div>

    <h2 id="praktika">Из практики применения</h2><div class="answer reveal"><table class="ctab"><thead><tr><th>Ситуация</th><th>Как решается</th><th>На что опереться</th></tr></thead><tbody><tr><td>Контракт исполняется и в 2026, и в 2027 году</td><td>До 31.08.2026 платежи идут по 214н, с 01.09.2026 — по новому Порядку; заранее проверить шаблоны Сведений и распоряжений</td><td class="cd">п. 2–3 нового приказа</td></tr><tr><td>В договорах с соисполнителями зашита ссылка на 214н</td><td>Подготовить дополнительные соглашения или формулировку «в соответствии с действующим порядком санкционирования»</td><td class="cd">п. 2 нового приказа</td></tr><tr><td>Планируется выплата прибыли по контракту</td><td>Сверить условия контракта с пределами: прибыль — до 25 % цены, перечисления на банковский счёт — до 50 % (без учёта аванса)</td><td class="cd">п. 8 нового Порядка</td></tr></tbody></table></div>

    <h2 id="sistema">Место в системе регулирования</h2><div class="answer reveal"><p>Новый порядок занимает в системе то же место, что и 214н: операционное ядро санкционирования, реализующее статьи 242.23–242.26 Бюджетного кодекса и Правила казначейского сопровождения (ПП № 2024). Для исполнителя это главный рабочий документ: по нему проверяется каждый платёж, а его приложения станут первоисточником кодов направлений расходования вместо приложений к 214н.</p></div>

    <h2 id="changed">Актуальная редакция и изменения</h2>
    <div class="answer reveal"><p>Подготовленный Минфином текст опубликован в правовых системах 20.05.2026 (проект проходил обсуждение на regulation.gov.ru, ID 01/02/05-26/00168022). Заявленная дата вступления в силу — 01.09.2026; с этого же дня подготовленный текст отменяет приказ 214н со всеми изменениями. Но это дата из проекта, а не из действующего акта: юридической силы она приобретает только вместе с подписанием и официальным опубликованием приказа. Номер приказа и данные о регистрации в Минюсте появятся после подписания — сверяйте реквизиты по первоисточнику; эту страницу мы обновим сразу после официального опубликования.</p><p><b>Проверка статуса на 16.08.2026:</b> приказ не подписан и не зарегистрирован в Минюсте, номер не присвоен; карточка приказа № 214н в правовых системах по-прежнему показывает редакцию от 27.06.2025 без отметки об утрате силы. До 1 сентября остаётся 16 календарных дней. Практический вывод простой: сентябрьские Сведения и распоряжения готовьте по 214н, а переход на новые правила считайте наступившим не раньше публикации приказа на официальном интернет-портале правовой информации. Пока документа нет в опубликовании, ссылаться на него в переписке с территориальным органом казначейства бессмысленно — санкционируют по действующему Порядку.</p><p>Из подготовленного текста, на что стоит смотреть исполнителю в первую очередь: срок утверждения Сведений об операциях с целевыми средствами заказчиком (получателем бюджетных средств) ограничен 10 рабочими днями со дня их представления участником казначейского сопровождения — тот же срок, за нарушение которого с 2026 года наступает ответственность по статье 15.49 КоАП; сохраняется код «0888» «Прочие расходы» для сумм накладных и общехозяйственных расходов, перечисляемых на банковский счёт.</p></div>

    <div class="note">Смотрите также: <div class="codechips"><a class="codechip" href="/baza-znaniy/normativnaya-baza/prikaz-214n/">Приказ 214н — действующий порядок до 31.08.2026</a><a class="codechip" href="/baza-znaniy/kody/">Коды направлений расходования</a><a class="codechip" href="/baza-znaniy/svedeniya-ob-operaciyah-s-celevymi-sredstvami/">Как заполнить Сведения об операциях</a><a class="codechip" href="/baza-znaniy/poryadok-sankcionirovaniya-rashodov/">Порядок санкционирования расходов</a></div></div>

    <h2 id="faq">Частые вопросы</h2>
    <div class="faq"><details><summary>Когда перестанет действовать приказ 214н?</summary><p>С 1 сентября 2026 года: пунктом 2 нового приказа 214н и все изменявшие его приказы (39н, 97н, 197н, 84н) признаются утратившими силу, пунктом 3 установлено вступление нового Порядка в силу с 01.09.2026.</p></details><details><summary>Изменятся ли коды направлений расходования целевых средств?</summary><p>Система кодов сохраняется — в тексте нового Порядка фигурируют привычные коды (0100, 0810, 0813, 0888 и другие) и правило первого разряда «6/8/9». Но размещаются они теперь в Приложениях № 2 (укрупнённые) и № 3 (детализированные) нового Порядка. Точный состав сверим по официальной публикации.</p></details><details><summary>Распространится ли новый порядок на контракты, заключённые до 1 сентября 2026 года?</summary><p>Порядок регулирует санкционирование операций, а не заключение контрактов: с даты вступления в силу проверки платежей идут по новым правилам независимо от даты контракта. Особенности для переходящих контрактов уточним после официального опубликования приказа.</p></details><details><summary>Что изменится в Сведениях об операциях с целевыми средствами?</summary><p>Форма 0501213 сохраняется. Уточнены правила заполнения (пункт 14) и закреплён срок утверждения заказчиком — не позднее 10 рабочих дней; документооборот ведётся в ГИИС «Электронный бюджет».</p></details><details><summary>Где посмотреть текст нового порядка?</summary><p>Подготовленный текст доступен в правовых системах (ГАРАНТ, документ от 20.05.2026); материалы проекта — на regulation.gov.ru (ID 01/02/05-26/00168022). После подписания официальная публикация появится на pravo.gov.ru.</p></details></div>

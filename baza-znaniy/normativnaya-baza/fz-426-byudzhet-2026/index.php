...
<link rel="canonical" href="https://kaznaexpert.ru/baza-znaniy/normativnaya-baza/fz-426-byudzhet-2026/">
...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/baza-znaniy/">База знаний</a> › <a href="/baza-znaniy/normativnaya-baza/">Нормативная база</a> › 426-ФЗ (бюджет на 2026)</nav>
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p class="lead-p">Статья 242.25 БК отсылает к закону о бюджете: именно он на каждый год определяет конкретные случаи и стоимостные пороги обязательного казначейском сопровождении средств федерального бюджета.</p><p>426-ФЗ закрепляет эти параметры на 2026 год — категории средств (целевые субсидии, бюджетные инвестиции, авансы по госконтрактам и др.) и пороги, при превышении которых сопровождение обязательно. Отдельные особенности применения на год детализирует ПП № 2201.</p></div>
    ...
    <h2 id="praktika">Из практики применения</h2><div class="answer reveal"><table class="ctab"><thead><tr><th>Ситуация</th><th>Как решается</th><th>На что опереться</th></tr></thead><tbody><tr><td>Контракт на 4,9 млн — попадает ли под сопровождение</td><td>Сверить сумму и категорию контракта с порогами закона о бюджете на 2026 год</td><td class="cd">426-ФЗ, ст. 242.25 БК РФ</td></tr><tr><td>Сумма ниже порога, но заказчик включил условие о сопровождении</td><td>Условие в контракте правомерно — режим действует в силу контракта</td><td class="cd">условие контракта</td></tr><tr><td>Средства из регионального бюджета</td><td>Пороги 426-ФЗ — про федеральный бюджет; для региональных смотреть акты субъекта</td><td class="cd">ст. 242.26 БК РФ, акты субъекта</td></tr></tbody></table></div>
    ...
    <div class="answer reveal"><p>426-ФЗ принят 28.11.2025 и действует с 01.01.2026, заменив бюджетный закон предыдущего года. Изменения в закон вносились 26.06.2026, при этом статья 5 — та самая, что задаёт случаи и стоимостные пороги казначейского сопровождения на 2026 год, — сохранена в прежней редакции. Точные пороги и формулировки берите из актуального текста закона: мы намеренно не дублируем суммы, чтобы вы не использовали устаревшие.</p><p>По состоянию на 31 августа 2026 года действует редакция закона с изменениями от 26.06.2026, внесёнными Федеральным законом № 195-ФЗ; более поздних поправок не публиковалось — сверено с официальным текстом № 426-ФЗ.</p></div>

    <div class="note">Смотрите также: <div class="codechips"><a class="codechip" href="/baza-znaniy/chto-takoe-kaznacheyskoe-soprovozhdenie/">Кому нужно казначейское сопровождение и от какой суммы</a><a class="codechip" href="/baza-znaniy/normativnaya-baza/bk-242-23/">Основы казначейского сопровождения (ст. 242.23 БК)</a><a class="codechip" href="/baza-znaniy/kody-postupleniy/">Коды источников поступлений</a></div></div>
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="npa-fz-426-byudzhet-2026">

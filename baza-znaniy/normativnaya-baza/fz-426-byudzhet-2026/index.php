...
<title>426-ФЗ о федеральном бюджете на 2026 год: какие контракты попадают | К</title>
...
<meta property="og:title" content="426-ФЗ о федеральном бюджете на 2026 год: какие контракты попадают | К">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Закон о федеральном бюджете на год — это документ, который ежегодно задаёт, какие именно средства и при каких порогах попадают под казначейское сопровождение. На 2026 год это Федеральный закон № 426-ФЗ.</div>

    <h2 id="reg">Что регулирует</h2>
    <div class="answer reveal"><p>Статья 242.25 БК отсылает к закону о бюджете: именно он на каждый год определяет конкретные случаи и стоимостные пороги обязательного КС средств федерального бюджета.</p><p>426-ФЗ закрепляет эти параметры на 2026 год — категории средств (субсидии, бюджетные инвестиции, авансы по госконтрактам и др.) и пороги, при превышении которых сопровождение обязательно. Отдельные особенности на год детализирует ПП № 2201.</p></div>

    <h2 id="means">Что это значит для исполнителя контракта</h2>
    <div class="answer reveal"><ul class="ul"><li>Проверьте, превышает ли ваш контракт (или аванс по нему) установленный на 2026 год порог — от этого зависит, обязательно ли сопровождение.</li><li>Под КС стабильно попадают целевые субсидии и бюджетные инвестиции юрлицам, крупные госконтракты и авансы сверх порога, контракты ГОЗ.</li><li>Пороги и перечень случаев меняются год к году — ориентируйтесь на действующий закон, а не на прошлогодние значения.</li><li>Если ваш контракт под порогом и не входит в обязательные категории — сопровождение может не требоваться; спорные случаи лучше проверить.</li></ul></div>

    <h2 id="norms">Ключевые нормы</h2>
    <div class="answer reveal"><table class="ctab"><thead><tr><th>Норма</th><th>Суть</th></tr></thead><tbody><tr><td class="cd">Случаи КС на год</td><td>перечень категорий средств федерального бюджета, подлежащих сопровождению в 2026 году.</td></tr><tr><td class="cd">Пороги</td><td>стоимостные значения, при превышении которых КС обязательно (точные суммы — в тексте закона).</td></tr><tr><td class="cd">Детализация</td><td>особенности применения на 2026 год — в ПП № 2201.</td></tr></tbody></table></div>

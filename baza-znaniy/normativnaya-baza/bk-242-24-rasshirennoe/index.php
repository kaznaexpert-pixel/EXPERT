...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Расширенное казначейское сопровождение — усиленный режим контроля для крупных и оборонных контрактов. Статья 242.24 БК объясняет, что именно проверяется дополнительно.</div>

    <h2 id="reg">Что регулирует</h2>
    <div class="answer reveal"><p>Статья вводит расширенное КС: помимо обычной проверки связи платежа с контрактом, казначейство контролирует обоснованность фактических затрат, структуру цены и ведение раздельного учёта.</p><p>Перечень случаев расширенного КС и детальный порядок устанавливают Правительство (ПП № 2024, раздел о расширенном КС) и закон о бюджете на год.</p></div>

    <h2 id="means">Что это значит для исполнителя контракта</h2>
    <div class="answer reveal"><ul class="ul"><li>Недостаточно показать, что платёж связан с контрактом, — нужно подтвердить экономическую обоснованность затрат документами.</li><li>Обязателен раздельный учёт по контракту: доходы и расходы обособляются, фактические затраты сверяются с плановыми.</li><li>Под расширенное КС обычно попадают крупные контракты и ГОЗ — требования к документообороту и обоснованию заметно выше.</li><li>Ошибки в обосновании затрат — частая причина возвратов; здесь особенно важна корректная работа с кодами и сведениями.</li></ul></div>

    <h2 id="norms">Ключевые нормы</h2>
    <div class="answer reveal"><table class="ctab"><thead><tr><th>Норма</th><th>Суть</th></tr></thead><tbody><tr><td class="cd">Расширенный контроль</td><td>проверка фактических затрат и структуры цены, а не только целевого назначения платежа.</td></tr><tr><td class="cd">Раздельный учёт</td><td>обязателен; затраты подтверждаются первичными документами.</td></tr><tr><td class="cd">Случаи</td><td>устанавливаются Правилами КС и законом о бюджете для отдельных категорий контрактов.</td></tr></tbody></table></div>

    <h2 id="changed">Актуальная редакция и изменения</h2>
    <div class="answer reveal"><p>Норма действует в составе главы 24.4 БК. Конкретику расширенного КС задают Правила (ПП № 2024) в действующей редакции — её стоит сверять, так как состав требований уточняется.</p></div>

    <div class="note">Смотрите также: <div class="codechips"><a class="codechip" href="/baza-znaniy/razdelnyy-uchet-goz-275-fz/">Раздельный учёт по ГОЗ</a><a class="codechip" href="/baza-znaniy/kody/0888/">Код 0888 — накладные расходы</a></div></div>

    <h2 id="faq">Частые вопросы</h2>
    <div class="faq"><details><summary>Чем расширенное КС отличается от обычного?</summary><p>Обычное проверяет связь платежа с контрактом; расширенное дополнительно — обоснованность затрат, структуру цены и раздельный учёт.</p></details><details><summary>Кто попадает под расширенное КС?</summary><p>Как правило, крупные контракты и ГОЗ; точный перечень — в Правилах КС и законе о бюджете.</p></details><details><summary>Что грозит за слабое обоснование затрат?</summary><p>Возврат документов и приостановка платежей до устранения замечаний.</p></details></div>

...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/baza-znaniy/">База знаний</a> › <a href="/baza-znaniy/normativnaya-baza/">Нормативная база</a> › ПП № 2024 (Правила КС)</nav>
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal"><p>ПП № 2024 утверждает Правила КС, осуществляемого Федеральным казначейством, и отдельные Правила расширенного КС: порядок открытия счетов, проведения и перечисления операций, состав документов, работу со сведениями и направлениями расходования.</p><p>Постановление заменило прежнюю практику, когда правила КС переписывались в законе о бюджете каждый год, и сделало порядок постоянным и единым.</p></div>

    <h2 id="kak">Как это работает на практике</h2><div class="answer reveal"><ol class="ol"><li>Участник открывает лицевой счёт и формирует Сведения об операциях с целевыми средствами — плановый документ по контракту.</li><li>Операции проводятся в пределах утверждённых Сведений; источники поступлений и направления расходования указываются по кодам.</li><li>Каждый платёж санкционируется по приказу 214н — Правила и приказ работают в связке.</li><li>Для расширенного КС применяется отдельный раздел Правил с дополнительным контролем затрат.</li></ol></div>

    <h2 id="means">Что это значит для исполнителя контракта</h2>
    <div class="answer reveal"><ul class="ul"><li>Все процедуры — от подачи Сведений до санкционирования платежа — выполняются по этим Правилам; знание их экономит время и снижает возвраты.</li><li>Правила разделяют обычное и расширенное КС: для расширенного действуют дополнительные требования к обоснованию затрат.</li><li>Через Правила увязаны источники поступлений и направления расходования целевых средств.</li><li>Изменения в Правила выходят регулярно — работать нужно строго по действующей редакции.</li></ul></div>

    <h2 id="norms">Ключевые нормы</h2>
    <div class="answer reveal"><table class="ctab"><thead><tr><th>Норма</th><th>Суть</th></tr></thead><tbody><tr><td class="cd">Правила КС</td><td>порядок проведения операций Федеральным казначейством с целевыми средствами.</td></tr><tr><td class="cd">Правила расширенного КС</td><td>дополнительный контроль затрат и структуры цены для отдельных контрактов.</td></tr><tr><td class="cd">Перечисление и операции</td><td>условия и ограничения операций по лицевому счёту.</td></tr><tr><td class="cd">Связь с приказом 214н</td><td>санкционирование операций детализирует Порядок 214н Минфина.</td></tr></tbody></table></div>

...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Статья 242.23 Бюджетного кодекса — фундамент всего казначейского сопровождения. Именно она вводит сам механизм и определяет, кто и как работает с целевыми средствами через казначейство.</div>

    <h2 id="reg">Что регулирует</h2>
    <div class="answer reveal"><p>Статья открывает главу 24.4 БК РФ (действует с 1 января 2022 года) и закрепляет: что такое казначейское сопровождение, кто является его участником, что средства проходят через лицевой счёт в территориальном органе казначейства (ТОФК), а каждая операция санкционируется.</p><p>Конкретные случаи и пороги, при которых сопровождение обязательно, статья сама не устанавливает — она отсылает к закону о федеральном бюджете на год (ст. 242.25) и Правилам Правительства.</p></div>

    <h2 id="means">Что это значит для исполнителя контракта</h2>
    <div class="answer reveal"><ul class="ul"><li>Если контракт попал под сопровождение, расчёты идут не через ваш расчётный счёт в банке, а через лицевой счёт в ТОФК.</li><li>Каждый платёж проходит проверку (санкционирование) — деньги нельзя вывести без подтверждения целевого характера.</li><li>Под сопровождение попадают не только головной исполнитель, но и соисполнители по цепочке — им тоже открывают лицевые счета.</li><li>Сам факт сопровождения вписывается в условия контракта; отказаться от него в одностороннем порядке нельзя.</li></ul></div>

    <h2 id="norms">Ключевые нормы</h2>
    <div class="answer reveal"><table class="ctab"><thead><tr><th>Норма</th><th>Суть</th></tr></thead><tbody><tr><td class="cd">Понятие КС</td><td>сопровождение целевых средств с проведением операций на лицевых счетах в ТОФК и санкционированием расходов.</td></tr><tr><td class="cd">Участник КС</td><td>юрлицо/ИП, получившее целевые средства и заключившее контракт (договор), расчёты по которому подлежат сопровождению.</td></tr><tr><td class="cd">Отсылочные нормы</td><td>случаи и пороги — в законе о бюджете (ст. 242.25 БК) и Правилах КС (ПП № 2024).</td></tr></tbody></table></div>

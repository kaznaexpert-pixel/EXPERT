...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p>Жалоба «УФК задерживает платёж» — одна из самых частых при казначейском сопровождении. Но за ней почти всегда стоит не бездействие казначейства, а механика санкционирования: прежде чем деньги уйдут с лицевого счёта, территориальный орган Федерального казначейства проверяет распоряжение и документы и либо санкционирует операцию, либо возвращает её без исполнения. То, что исполнитель воспринимает как «задержку», обычно и есть возврат на доработку.</p>
    ...
    <table>
      <thead><tr><th>Действие</th><th>Кто</th><th>Срок (по общему правилу)</th></tr></thead>
      <tbody>
        <tr><td>Санкционирование распоряжения</td><td>казначейство (ТОФК)</td><td>не позднее 2 рабочих дней после представления</td></tr>
        <tr><td>Проверка сведений об операциях</td><td>казначейство (ТОФК)</td><td>не позднее 1 рабочего дня</td></tr>
        <tr><td>Утверждение сведений</td><td>заказчик / получатель средств</td><td>не позднее 10-го рабочего дня после поступления</td></tr>
      </tbody>
    </table>
    ...
    <ul>
      <li>Проверьте статус распоряжения в системе («Электронный бюджет», СУФД) — санкционировано, на проверке или возвращено.</li>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Приказ Минфина России от 17.12.2021 № 214н (ред. от 27.06.2025) «Об утверждении Порядка осуществления территориальными органами Федерального казначейства санкционирования операций со средствами участников казначейского сопровождения».</li>
        <li id="ref-2">Бюджетный кодекс РФ, статья 242.23 (основы казначейского сопровождения; санкционирование операций).</li>
        <li id="ref-3">Постановление Правительства РФ от 24.11.2021 № 2024 (Правила казначейского сопровождения).</li>
        <li id="ref-4">Федеральный закон от 05.04.2013 № 44-ФЗ, часть 13.1 статьи 34 (срок оплаты по контракту — 10 рабочих дней при казначейском сопровождении).</li>

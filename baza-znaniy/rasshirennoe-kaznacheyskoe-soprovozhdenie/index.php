...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "DefinedTermSet", "name": "Глоссарий: расширенное казначейское сопровождение", "inLanguage": "ru-RU", "hasDefinedTerm": [
{"@type": "DefinedTerm", "name": "Расширенное казначейское сопровождение", "description": "Режим контроля по ст. 242.24 БК РФ с проверками фактического исполнения, учёта и обоснованности затрат до проведения операций."},
{"@type": "DefinedTerm", "name": "Расходная декларация", "description": "Документ участника казначейского сопровождения о структуре затрат по контракту; сверяется с раздельным учётом и первичными документами."},
{"@type": "DefinedTerm", "name": "Проверка фактической поставки", "description": "Сверка реально поставленных товаров (работ, услуг) с контрактом, в том числе с фото- и видеофиксацией."},
{"@type": "DefinedTerm", "name": "Экономическая обоснованность затрат", "description": "Соответствие затрат по контракту правилам экономического обоснования, установленным Правительством РФ."}
]}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#proverki">Четыре блока проверок</a></li>

...
{"@type": "Question", "name": "Чем расширенное КС отличается от обычного?", "acceptedAnswer": {"@type": "Answer", "text": "Обычное сопровождение — документарный контроль. Расширенное добавляет проверки по существу: факт поставки (вплоть до фото/видео), сверку с расходной декларацией, оценку обоснованности затрат и ограничение вывода средств до полного исполнения контракта."}},
{"@type": "Question", "name": "Кто определяет случаи расширенного КС?", "acceptedAnswer": {"@type": "Answer", "text": "Правовой акт Правительства РФ (п. 1 ст. 242.24 БК РФ); режим фиксируется в условиях контракта."}},
...
{"@type": "Question", "name": "Когда можно вывести средства на расчётный счёт при расширенном КС?", "acceptedAnswer": {"@type": "Answer", "text": "После направления госзаказчиком в казначейство уведомления о полном исполнении государственного контракта."}},
...
{"@type": "Question", "name": "Действует ли расширенное КС на региональном уровне?", "acceptedAnswer": {"@type": "Answer", "text": "Да, финансовые органы субъектов РФ и муниципалитетов вправе вести расширенное сопровождение в случаях, определённых Правительством (п. 3 ст. 242.24 БК РФ)."}},
...
{"@type": "DefinedTerm", "name": "Расходная декларация", "description": "Документ участника КС о структуре затрат по контракту; сверяется с раздельным учётом и первичными документами."},
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      <li><a href="#chto-takoe">Что такое расширенное КС</a></li>
      <li><a href="#pravovaya">Правовая база</a></li>
      <li><a href="#kogda">Когда применяется</a></li>
      <li><a href="#otlichiya">Отличия от обычного КС</a></li>
  ...
  <article class="content" id="main">
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">регионы</div><div class="kf__t"><b>Финорганы</b> субъектов тоже вправе вести расширенное КС</div></div>
      </div>
    </section>
    ...
    <table>
      ...
      <tr><td>Ст. 242.24 БК РФ (244-ФЗ от 01.07.2021; ред. 177-ФЗ от 13.07.2024, 158-ФЗ от 24.06.2025)</td><td>Состав дополнительных требований и проверок расширенного КС</td></tr>
      <tr><td>ПП РФ от 24.11.2021 № 2024 (ред. от 15.10.2025), приложение «Правила расширенного казначейского сопровождения»</td><td>Порядок осуществления расширенного КС</td></tr>
      <tr><td>Правовые акты Правительства РФ</td><td>Перечень контрактов и средств, подпадающих под расширенное КС</td></tr>
    ...
    <h2 id="kogda">Когда применяется расширенное КС</h2>
    ...
    <p>Узнать, что контракт под расширенным КС, можно из его условий: режим фиксируется в контракте вместе с обязанностью открыть лицевой счёт и соблюдать порядок проверок. Если в контракте есть отсылки к «проверке фактической поставки» и «расходной декларации» — это оно.</p>

    <h2 id="otlichiya">Чем расширенное КС отличается от обычного</h2>
    <table>
    ...
    <h2 id="proverki">Четыре блока проверок расширенного КС</h2>
    ...
    <table>
      ...
      <tr><td>ФЗ от 01.07.2021 № 244-ФЗ</td><td>Ввёл главу 24.4 БК РФ и саму конструкцию расширенного КС: проверка фактической поставки и раздельного учёта, вывод средств после полного исполнения</td></tr>
      <tr><td>ФЗ от 13.07.2024 № 177-ФЗ</td><td>Добавил проверку экономической обоснованности затрат, расходную декларацию в контур сверки и право финорганов регионов вести расширенное КС</td></tr>
    ...
    <h2 id="podgotovka">Как подготовиться к расширенному КС: чек-лист</h2>
    <ul>
    ...
    <table>
      <caption>Что срывает операции при расширенном КС</caption>
      ...
      <tr><td>Кассовый план «как при обычном КС»</td><td>Кассовый разрыв: прибыль недоступна до конца контракта</td><td>Планировать вывод средств после полного исполнения</td></tr>
    </table>

    <h2 id="keys">Пример из практики</h2>
    <div class="answer reveal">
      <p>Типовая ситуация: производитель оборудования заходит в контракт с расширенным сопровождением, рассчитывая работать «как обычно при КС» — собирать документы под каждый платёж. Первая же оплата за поставленную партию задерживается: казначейству нужны не только товарные накладные, но и проверка фактической поставки на площадке заказчика плюс сверка затрат с расходной декларацией, а в учётной системе аналитика по контракту не настроена. Дальше компания перестраивается: вводит аналитику раздельного учёта, приводит декларацию в соответствие с калькуляцией, готовит площадку к осмотрам — и следующие платежи проходят в штатные сроки. Вывод: расширенное КС прощает меньше, чем обычное, но при выстроенном учёте работает предсказуемо. Пример обобщённый; состав проверок зависит от условий контракта и регламентов ФК.</p>
    </div>

    <div class="takeaways">
      <h2>Что важно запомнить</h2>
      <ol>
        <li>Расширенное КС (ст. 242.24 БК) — это обычное сопровождение плюс проверки по существу: факт поставки, раздельный учёт, обоснованность затрат.</li>
    ...
    <dl class="gloss">
      ...
      <div><dt>Расходная декларация</dt><dd>Документ участника КС о структуре затрат по контракту; сверяется с раздельным учётом и первичкой.</dd></div>
    ...
    <div class="faq">
      ...
      <details><summary>Чем расширенное КС отличается от обычного?</summary><p>Обычное сопровождение — контроль по документам. Расширенное добавляет проверки по существу: фактическую поставку (вплоть до фото/видео), сверку затрат с раздельным учётом и расходной декларацией, оценку обоснованности затрат и ограничение на вывод средств до полного исполнения контракта.</p></details>
      <details><summary>Кто решает, что контракт под расширенным КС?</summary><p>Случаи применения определяются правовым актом Правительства РФ (п. 1 ст. 242.24 БК). Режим фиксируется в условиях контракта.</p></details>
      ...
      <details><summary>Что такое расходная декларация и зачем она нужна?</summary><p>Это документ о структуре затрат по контракту. При расширенном КС казначейство сверяет с ней данные раздельного учёта и первичных документов — расхождения ведут к отказу в операции.</p></details>
      ...
      <details><summary>Применяется ли расширенное КС на региональном уровне?</summary><p>Да, финансовые органы субъектов РФ и муниципалитетов вправе осуществлять расширенное сопровождение средств своего уровня в случаях, определённых Правительством (п. 3 ст. 242.24 БК).</p></details>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-4">Федеральный закон от 28.11.2025 № 426-ФЗ «О федеральном бюджете на 2026 год…», ст. 5 (случаи КС в 2026 году) — <a href="https://www.consultant.ru/document/cons_doc_LAW_520057/" target="_blank" rel="noopener">consultant.ru</a></li>
      </ol>
      <p class="refs__note">Материал носит информационный характер, не является юридической консультацией. Перечень случаев расширенного КС и регламенты проверок устанавливаются актами Правительства и Федерального казначейства — сверяйтесь с условиями вашего контракта. Актуально на 11 июня 2026 года.</p>
    </div>
  </article>
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="rasshirennoe-kaznacheyskoe-soprovozhdenie">
      ...
      <h3 class="railform__title">Контракт под расширенным КС?</h3>

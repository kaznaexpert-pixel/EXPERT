...
{"@type": "Question", "name": "Что такое расширенное казначейское сопровождение простыми словами?", "acceptedAnswer": {"@type": "Answer", "text": "Усиленный режим контроля бюджетных средств: казначейство проводит платежи только после проверки фактической поставки, раздельного учёта, подтверждённости и экономической обоснованности затрат."}},
{"@type": "Question", "name": "Чем расширенное казначейское сопровождение отличается от обычного?", "acceptedAnswer": {"@type": "Answer", "text": "Обычное сопровождение — документарный контроль. Расширенное добавляет проверки по существу: факт поставки (вплоть до фото/видео), сверку с расходной декларацией, оценку обоснованности затрат и ограничение вывода средств до полного исполнения контракта."}},
{"@type": "Question", "name": "Кто определяет случаи расширенного казначейского сопровождения?", "acceptedAnswer": {"@type": "Answer", "text": "Правовой акт Правительства РФ (п. 1 ст. 242.24 БК РФ); режим фиксируется в условиях контракта."}},
{"@type": "Question", "name": "Может ли казначейство проверять объект с фото- и видеофиксацией?", "acceptedAnswer": {"@type": "Answer", "text": "Да, ст. 242.24 БК прямо допускает проверку фактической поставки с использованием фото- и видеотехники по регламенту Федерального казначейства."}},
{"@type": "Question", "name": "Что такое расходная декларация?", "acceptedAnswer": {"@type": "Answer", "text": "Документ о структуре затрат по контракту, с которым казначейство сверяет данные раздельного учёта и первичных документов при расширенном сопровождении."}},
{"@type": "Question", "name": "Когда можно вывести средства на расчётный счёт при расширенном казначейском сопровождении?", "acceptedAnswer": {"@type": "Answer", "text": "После направления госзаказчиком в казначейство уведомления о полном исполнении государственного контракта."}},
{"@type": "Question", "name": "Проверяется ли экономическая обоснованность затрат?", "acceptedAnswer": {"@type": "Answer", "text": "Да, с поправок ФЗ № 177-ФЗ (2024): по порядку Федерального казначейства и правилам экономического обоснования затрат, установленным Правительством."}},
{"@type": "Question", "name": "Действует ли расширенное казначейское сопровождение на региональном уровне?", "acceptedAnswer": {"@type": "Answer", "text": "Да, финансовые органы субъектов РФ и муниципалитетов вправе вести расширенное сопровождение в случаях, определённых Правительством (п. 3 ст. 242.24 БК РФ)."}},
{"@type": "Question", "name": "Как подготовиться к расширенному казначейскому сопровождению?", "acceptedAnswer": {"@type": "Answer", "text": "Настроить раздельный учёт с начала контракта, согласовать расходную декларацию с калькуляцией и первичкой, собирать обоснования затрат и планировать кассу с учётом вывода средств после полного исполнения."}}
]}
</script>
<script type="application/ld+json">

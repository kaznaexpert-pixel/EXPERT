...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p>Распространённое убеждение звучит так: «работаем с казначейством — значит, и подпись нужна только казначейская». Это неточно: у коммерческой организации под сопровождением два законных маршрута, и система принимает оба.</p>
    ...
    <table>
      ...
      <tr><td><b>Коммерческая организация — исполнитель госконтракта</b> с лицевым счётом в казначействе</td><td><b>Удостоверяющий центр ФНС России</b> — подпись юридического лица на руководителя, действующего без доверенности; для сотрудников — сертификат физического лица в аккредитованном центре. <b>Либо удостоверяющий центр Федерального казначейства</b> — сертификаты должностных лиц руководителю и работникам: коммерческие организации, получающие сопровождаемые средства, включены в перечень постановления № 1018</td><td>п. 1 ч. 1 ст. 17.2; п. 4 ч. 3 ст. 17.2 и п. 1 перечня № 1018</td></tr>
    ...
    <p>Виды юридических лиц, которым удостоверяющий центр Федерального казначейства создаёт и выдаёт сертификаты, определены постановлением Правительства РФ от 10.07.2020 № 1018, и пункт 1 перечня называет коммерческие организации, которым предоставляются средства из бюджетов, подлежащие казначейскому сопровождению. Исполнитель сопровождаемого контракта с лицевым счётом в территориальном органе под перечень подпадает: Межрегиональное операционное УФК письмом от 25.08.2023 № 95-09-11/15-377 прямо перечисляет сотрудников таких организаций среди заявителей. При этом Казначейство России письмом от 02.11.2023 № 07-04-05/11-32062 разъяснило, что для работы и подписания документов в «Электронном бюджете» применяются и сертификаты ФНС России, и сертификаты иных аккредитованных удостоверяющих центров; организации, у которых оснований для получения сертификата в казначействе нет — например, подрядчик без сопровождаемых средств, — работают именно ими.<a class="fn" href="#ref-6" aria-label="Источник 6">[6]</a></p>

    <h3 id="rekvizity-sertifikata">Какие реквизиты должны быть в сертификате</h3>
    <div class="note"><b>Требование к содержанию сертификата.</b> Для входа в подсистему информационной безопасности годится сертификат, созданный удостоверяющим центром Казначейства, <b>либо</b> сертификат аккредитованного удостоверяющего центра, в котором указаны ИНН физического лица или СНИЛС. Это не формальность: сертификат без этих реквизитов система не сопоставит с учётной записью, и вход не состоится. Как получить сертификат в казначействе — исполнителю по перечню № 1018 или учреждению — разобрано в материале о <a href="/baza-znaniy/sertifikat-ecp-kaznachejstvo/">сертификате и подписи казначейства</a>.</div>
    ...
    <div class="faq">
      ...
      <details><summary>Какая электронная подпись нужна для «Электронного бюджета»?</summary><p>Квалифицированная электронная подпись. Организация бюджетной сферы получает её в удостоверяющем центре Федерального казначейства; коммерческая организация под сопровождением — либо там же (перечень постановления № 1018), либо в удостоверяющем центре ФНС России: письмо Казначейства России от 02.11.2023 № 07-04-05/11-32062 допускает в «Электронном бюджете» сертификаты ФНС и иных аккредитованных центров.</p></details>
...
<div class="refs">
      ...
      <ol>
        ...
        <li id="ref-6">Федеральный закон от 06.04.2011 № 63-ФЗ «Об электронной подписи» (ред. от 31.07.2025), статьи 17.2, 17.4, 17.5 — <a href="https://www.consultant.ru/document/cons_doc_LAW_112701/" target="_blank" rel="noopener">consultant.ru</a>; постановление Правительства РФ от 10.07.2020 № 1018 — виды юридических лиц, которым сертификаты выдаёт удостоверяющий центр Федерального казначейства (пункт 1 перечня — коммерческие организации, получающие сопровождаемые средства) — <a href="http://publication.pravo.gov.ru/Document/View/0001202007130022" target="_blank" rel="noopener">publication.pravo.gov.ru</a>; письмо Казначейства России от 02.11.2023 № 07-04-05/11-32062 «О применении сертификатов» — <a href="https://www.consultant.ru/document/cons_doc_LAW_461566/" target="_blank" rel="noopener">КонсультантПлюс</a>; письмо Межрегионального операционного УФК от 25.08.2023 № 95-09-11/15-377 «О вопросах создания и выдачи сертификатов» — <a href="https://www.consultant.ru/document/cons_doc_LAW_455630/" target="_blank" rel="noopener">КонсультантПлюс</a></li>

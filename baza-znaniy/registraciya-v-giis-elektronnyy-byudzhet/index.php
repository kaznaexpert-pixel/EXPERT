...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        <li><a href="#korotkiy-otvet">Короткий ответ: с чего начинается подключение</a></li><li><a href="#chto-takoe">Что такое ГИИС «Электронный бюджет» и зачем регистрация исполнителю</a></li><li><a href="#komu-nuzhno">Кому нужна регистрация в системе</a></li><li><a href="#shagi">Пошаговый порядок регистрации и подключения</a></li><li><a href="#podpis-skzi">Электронная подпись, СКЗИ и настройка рабочего места</a></li><li><a href="#roli-mchd">Роли пользователей и машиночитаемая доверенность</a></li><li><a href="#sroki-oshibki">Сроки подключения и частые ошибки</a></li><li><a href="#glossary">Глоссарий</a></li><li><a href="#faq">Частые вопросы</a></li>
      </ol>
    </details>
    ...
    <p>Защищённое соединение с системой обеспечивают средства криптографической защиты информации. Если организация подключается впервые, СКЗИ нужно получить и корректно установить вместе с криптопровайдером и корневыми сертификатами — без этого рабочее место не пройдёт проверку и вход в закрытый контур не состоится. О продлении и отзыве подписи — в материале о <a href="/baza-znaniy/kak-prodlit-i-otozvat-ecp-kaznachejstva/">электронной подписи казначейства</a>.</p>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Порядок подключения и комплект документов могут различаться по территориальным органам; актуальные руководства пользователя публикует Федеральное казначейство. Материал носит справочный характер. Проверено экспертом КазнаЭксперт. Дата актуализации — 4 августа 2026.</p>
    </div>
  </article>

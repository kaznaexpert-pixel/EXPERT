...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">('Вебинар Федерального казначейства «Новые функциональные возможности версии 3.2 Единой бюджетной платформы (ГИИС ЭБ)», июль 2026', 'https://roskazna.gov.ru/')</li>
        <li id="ref-2">('ГИС-документы (форматы обмена) — Федеральное казначейство', 'https://roskazna.gov.ru/gis/dokumenty/')</li>
        <li id="ref-3">('ГИИС «Электронный бюджет» — Федеральное казначейство', 'https://roskazna.gov.ru/gis/elektronnyj-byudzhet/')</li>
      </ol>

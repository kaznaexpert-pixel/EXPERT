...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <p>Первый вход после <a href="/baza-znaniy/registraciya-v-giis-elektronnyy-byudzhet/">регистрации в системе</a> занимает больше времени: проверьте, что роль и организация подтверждены, а сертификат привязан к учётной записи. Дальше вход стабильно занимает меньше минуты.</p>
    </div>
...
<p data-ctx="auto-ctx:auts-0903-5">Работа в кабинете платформы — сведения, распоряжения, выписки — входит в <a href="/uslugi/autsorsing-kaznacheyskogo-soprovozhdeniya/">аутсорсинг казначейского сопровождения</a>: исполнителю не нужно осваивать интерфейс и держать сотрудника с сертификатом.</p>

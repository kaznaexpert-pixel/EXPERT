...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 95 «Изменение, расторжение контракта», часть 1 (ред. от 28.12.2025, с изм. с 01.01.2026).</li>
        <li id="ref-2">Федеральный закон от 05.04.2013 № 44-ФЗ, пункты 1.2 и 1.3 части 1 статьи 95 (изменение объёма и цены).</li>
        <li id="ref-3">Федеральный закон от 05.04.2013 № 44-ФЗ, часть 2 статьи 34 (твёрдая цена и запрет изменения существенных условий).</li>
        <li id="ref-4">Федеральный закон от 05.04.2013 № 44-ФЗ, часть 65.1 статьи 112 (антикризисное изменение контрактов до 01.01.2027).</li>
        <li id="ref-5">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 103 (реестр контрактов, сведения об изменении).</li>
      </ol>

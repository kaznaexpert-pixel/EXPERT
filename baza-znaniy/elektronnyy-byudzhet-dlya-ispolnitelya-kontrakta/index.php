...
<meta property="article:modified_time" content="2026-09-14T10:00:00+03:00">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>16 мин чтения</span><span class="dot">·</span><span>Обновлено 14 сентября 2026 · уточнено место постановления № 1752 в нормативной базе (это порядок перечисления на расчётные счета, а не Правила сопровождения)</span></div>
    </div>
    ...
    <p data-ctx="giis-root">Устройство самой системы — операторы, 14 подсистем по постановлению № 658, портал budget.gov.ru и рабочие кабинеты — разобрано в обзорной статье <a href="/baza-znaniy/giis-elektronnyy-byudzhet/">ГИИС «Электронный бюджет»: что это и из чего состоит</a>; здесь дальше — только практика исполнителя.</p>
...
<div class="refs">
      ...
      <p class="refs__note">Материал актуален на 14 сентября 2026 года. Состав заявки на подключение, требования к рабочему месту и перечень полномочий уточняйте в действующих регламентах и памятке вашего ТОФК.</p>
    </div>

...
{"@type": "Question", "name": "Что такое «Электронный бюджет» простыми словами?", "acceptedAnswer": {"@type": "Answer", "text": "Государственная система, через которую планируют и проводят операции с бюджетными и целевыми средствами. Для исполнителя контракта под казначейским сопровождением это рабочее место для открытия лицевого счёта, утверждения сведений об операциях и платежей."}},
{"@type": "Question", "name": "Чем «Электронный бюджет» отличается от СУФД и портала ФЗС?", "acceptedAnswer": {"@type": "Answer", "text": "Портал ФЗС нужен для выпуска электронной подписи, «Электронный бюджет» — основной контур для лицевого счёта и платежей, СУФД — соседний инструмент работы с расчётными документами по правилам ТОФК."}},
{"@type": "Question", "name": "Как исполнителю контракта подключиться к системе?", "acceptedAnswer": {"@type": "Answer", "text": "Через территориальный орган казначейства: выпустить ЭП, настроить рабочее место и подать заявку на подключение с приказом о назначении ответственных, файлами сертификатов и согласиями. Обычно совмещается с открытием лицевого счёта 71."}},
{"@type": "Question", "name": "Как войти в личный кабинет «Электронного бюджета»?", "acceptedAnswer": {"@type": "Answer", "text": "По квалифицированному сертификату электронной подписи: подключить токен, открыть точку входа на едином портале, выбрать сертификат и подтвердить PIN-кодом. Логин и пароль не используются."}},
{"@type": "Question", "name": "Почему не получается войти в систему?", "acceptedAnswer": {"@type": "Answer", "text": "Чаще всего проблема в рабочем месте: не установлены корневые сертификаты казначейства, не запущен защищённый канал, истёк личный сертификат или браузер обновился до несовместимой версии."}},
{"@type": "Question", "name": "Нужна ли отдельная подпись для «Электронного бюджета»?", "acceptedAnswer": {"@type": "Answer", "text": "Используется квалифицированный сертификат казначейства, который выпускается на портале заявителя ФЗС. Отдельную подпись для системы заводить не нужно."}},
{"@type": "Question", "name": "Какие подсистемы нужны исполнителю контракта?", "acceptedAnswer": {"@type": "Answer", "text": "Учёт и отчётность (лицевой счёт, выписки), управление денежными средствами (сведения об операциях, платежи) и ведение НСИ (реквизиты, сводный реестр)."}},
{"@type": "Question", "name": "Можно ли работать в «Электронном бюджете» с обычного компьютера?", "acceptedAnswer": {"@type": "Answer", "text": "Нужно подготовить рабочее место: криптопровайдер, защищённый канал, корневые сертификаты и плагин ЭП. С «чистого» компьютера без настройки вход в закрытую часть не пройдёт."}},
{"@type": "Question", "name": "Сколько занимает подключение?", "acceptedAnswer": {"@type": "Answer", "text": "Зависит от готовности рабочего места и комплекта документов. Если ЭП выпущена, а АРМ настроен заранее, подключение и открытие счёта идут параллельно. Точные сроки уточняйте в своём ТОФК."}},
{"@type": "Question", "name": "Где взять корневые сертификаты для входа?", "acceptedAnswer": {"@type": "Answer", "text": "На сайте Федерального казначейства; порядок установки и список сертификатов удостоверяющего центра разобраны в отдельной статье о корневых сертификатах казначейства."}}
]}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>16 мин чтения</span><span class="dot">·</span><span>Обновлено 13 июня 2026</span></div>
    </div>

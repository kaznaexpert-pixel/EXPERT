...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <p>При затратном методе цена по гособоронзаказу ограничена правилом «1 % + 25 %» (п. 54 Постановления Правительства РФ № 1465): плановая прибыль — не более 1 % привнесённых затрат (покупные комплектующие, работы и услуги сторонних организаций) плюс не более 25 % собственных затрат, но не менее 10 % собственных. При обосновании направления прибыли на развитие производства — до 30 % собственных. Потолок 25 % действует с 23.05.2022 (ранее было 20 %). Калькулятор даёт ориентир; точный расчёт оформляется в РКМ и согласуется с госзаказчиком.</p>
<!-- goz-profit-calc -->

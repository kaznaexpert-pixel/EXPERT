...
<script type="application/ld+json">
{
  ...
  "datePublished":"2026-06-03","dateModified": "2026-08-17",
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>17 мин чтения</span><span class="dot">·</span><span>Обновлено 17 августа 2026</span></div>
    </div>
...
<figcaption style="font-size:13px;color:#6E6B66;font-style:italic;margin-top:8px">Порог 3 млн ₽ распространяется на всю цепочку кооперации: субподрядчик работает через свой лицевой счёт наравне с головным исполнителем.</figcaption>
    ...
    <div class="faq">
      ...
      <details><summary>Сколько стоит казначейское сопровождение ГОЗ?</summary><p>Стоимость зависит от типа контракта, объёма операций и наличия раздельного учёта по ГОЗ. Точную цену мы называем после анализа контракта — оставьте заявку, и эксперт рассчитает её под вашу ситуацию.</p></details><details><summary>О чём Федеральный закон № 275-ФЗ?</summary><p>Федеральный закон от 29.12.2012 № 275-ФЗ регулирует государственный оборонный заказ: правила размещения и исполнения контрактов ГОЗ, режим отдельного счёта в уполномоченном банке, раздельный учёт результатов финансово-хозяйственной деятельности, запреты на расходование средств и ответственность исполнителя. Для исполнителей ГОЗ это базовый закон наряду с 44-ФЗ, а расчёты по таким контрактам попадают под казначейское сопровождение.</p></details>
    </div>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер; точный режим сопровождения определяется условиями конкретного госконтракта. Проверено экспертом КазнаЭксперт. Дата актуализации — 17 августа 2026.</p>
    </div>

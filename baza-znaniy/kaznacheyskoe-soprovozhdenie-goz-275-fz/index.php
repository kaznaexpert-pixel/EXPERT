...
<title>Казначейское сопровождение ГОЗ 2026: 275-ФЗ, штрафы</title>
...
<!-- Schema: FAQPage -->
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "С какой суммы казначейское сопровождение ГОЗ обязательно в 2026 году?", "acceptedAnswer": {"@type": "Answer", "text": "Расчёты по госконтрактам ГОЗ и контрактам в их исполнение подлежат казначейскому сопровождению при сумме свыше 3 млн рублей (п. 8 ч. 2 ст. 5 ФЗ № 426-ФЗ на 2026 год)."}}, {"@type": "Question", "name": "Чем казначейское сопровождение ГОЗ отличается от банковского?", "acceptedAnswer": {"@type": "Answer", "text": "При банковском сопровождении расчёты идут через отдельный счёт в уполномоченном банке, при казначейском — через лицевой счёт в ТОФК. Режим определяется условиями контракта и решением госзаказчика."}}, {"@type": "Question", "name": "Что такое ИГК и где он используется?", "acceptedAnswer": {"@type": "Answer", "text": "ИГК — 25-значный идентификатор государственного контракта, присваивается заказчиком. Под каждый ИГК открывается отдельный счёт, код указывается во всех платёжных и распорядительных документах."}}, {"@type": "Question", "name": "Какой штраф за нарушение раздельного учёта по ГОЗ в 2026 году?", "acceptedAnswer": {"@type": "Answer", "text": "По ст. 15.37.1 КоАП РФ с 01.01.2026: должностным лицам 10 000–50 000 ₽, ИП и юрлицам — 5–10% цены контракта, но не более 250 000 ₽ для ИП и 500 000 ₽ для юрлиц."}}, {"@type": "Question", "name": "Кто обязан вести раздельный учёт по ГОЗ?", "acceptedAnswer": {"@type": "Answer", "text": "Раздельный учёт результатов финансово-хозяйственной деятельности по каждому контракту обязаны вести все исполнители и соисполнители ГОЗ, чьи расчёты подлежат казначейскому сопровождению."}}, {"@type": "Question", "name": "Что такое расширенное казначейское сопровождение?", "acceptedAnswer": {"@type": "Answer", "text": "Это режим (ст. 242.24 БК РФ) для крупных контрактов, при котором казначейство дополнительно проверяет соответствие фактических затрат данным раздельного учёта и контролирует структуру цены контракта."}}, {"@type": "Question", "name": "Нужно ли казначейское сопровождение субподрядчику по ГОЗ?", "acceptedAnswer": {"@type": "Answer", "text": "Да, если договор с соисполнителем в рамках сопровождаемого контракта заключён на сумму свыше 3 млн рублей — такие расчёты подлежат казначейскому сопровождению (п. 9 ч. 2 ст. 5 ФЗ № 426-ФЗ)."}}, {"@type": "Question", "name": "Сколько открывается лицевой счёт в ТОФК?", "acceptedAnswer": {"@type": "Answer", "text": "Раздел на лицевом счёте по контракту территориальный орган казначейства открывает не позднее следующего рабочего дня после получения контракта; основное время занимает подготовка документов и подключение к ГИИС «Электронный бюджет»."}}, {"@type": "Question", "name": "Что такое казначейская оговорка в контракте ГОЗ?", "acceptedAnswer": {"@type": "Answer", "text": "Условие контракта о том, что расчёты по нему проводятся через лицевой счёт в территориальном органе казначейства с применением казначейского сопровождения. Её наличие нужно проверять до подписания контракта."}}, {"@type": "Question", "name": "Можно ли перевести деньги с казначейского счёта на расчётный?", "acceptedAnswer": {"@type": "Answer", "text": "Свободно распоряжаться средствами нельзя. Перечисление с лицевого счёта в ТОФК на расчётные счета в банках возможно только в установленных случаях и порядке (Постановление Правительства РФ № 1752) и после санкционирования операции."}}, {"@type": "Question", "name": "Какие документы нужны для открытия лицевого счёта?", "acceptedAnswer": {"@type": "Answer", "text": "Документ-основание (контракт или выписка из него) либо карточка контракта, сформированная заказчиком в ГИИС «Электронный бюджет» и подписанная исполнителем, плюс документы, которые по закону подтверждают основание сопровождения. Отдельного заявления на открытие Порядок № 44н не предусматривает, карточка образцов подписей не применяется — полномочия подтверждает машиночитаемая доверенность."}}, {"@type": "Question", "name": "Нужна ли отдельная электронная подпись для казначейского сопровождения?", "acceptedAnswer": {"@type": "Answer", "text": "Да, для работы в ГИИС «Электронный бюджет» необходима действующая квалифицированная электронная подпись на уполномоченных сотрудников."}}, {"@type": "Question", "name": "Что делать, если казначейство вернуло платёж по ГОЗ?", "acceptedAnswer": {"@type": "Answer", "text": "Установить причину отказа (чаще всего код направления расходования, отсутствие ИГК или неполный пакет документов), исправить её и повторно направить платёж. При систематических возвратах целесообразен аудит сопровождения и раздельного учёта."}}, {"@type": "Question", "name": "О чём Федеральный закон № 275-ФЗ?", "acceptedAnswer": {"@type": "Answer", "text": "Федеральный закон от 29.12.2012 № 275-ФЗ регулирует государственный оборонный заказ: правила размещения и исполнения контрактов ГОЗ, режим отдельного счёта в уполномоченном банке, раздельный учёт результатов финансово-хозяйственной деятельности, запреты на расходование средств и ответственность исполнителя. Для исполнителей ГОЗ это базовый закон наряду с 44-ФЗ, а расчёты по таким контрактам попадают под казначейское сопровождение."}}]}</script>
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#zaprety">Запрещённые операции</a></li>
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      ...
      <p>Команда КазнаЭксперт опирается на опыт работы в системе Федерального казначейства с 2009 года. По нашей практике большинство сложностей с ГОЗ возникает не из-за самого закона, а из-за ошибок в оформлении операций — неверных кодов, отсутствия документов или формального раздельного учёта. Именно поэтому разобраться в режиме лучше до первого платежа, а не после первого отказа казначейства.</p>
    </div>
    ...
    <p class="note">Гособоронзаказ не прощает ошибок в санкционировании: один неверный документ — и платёж встал; эту работу снимает с вашей бухгалтерии <a href="/uslugi/soprovozhdenie-avans/">сопровождение контракта по гособоронзаказу &rarr;</a></p>
    </div>
    <table>
    ...
    <p>Таблица выше — только ГОЗ-срез статьи 5. Полный перечень случаев и порогов для всех видов целевых средств (субсидии, инвестиции, контракты учреждений) разобран в статье <a href="/baza-znaniy/kto-popadaet-pod-kaznacheyskoe-soprovozhdenie/">кто попадает под казначейское сопровождение в 2026 году</a>.</p>
    ...
    <div class="answer reveal">
      <p>При затратном методе цена по гособоронзаказу ограничена правилом «1 % + 25 %» (п. 54 Постановления Правительства РФ № 1465): плановая прибыль — не более 1 % привнесённых затрат (покупные комплектующие, работы и услуги сторонних организаций) плюс не более 25 % собственных затрат, но не менее 10 % собственных. При обосновании направления прибыли на развитие производства — до 30 % собственных. Потолок 25 % действует с 23.05.2022 (ранее было 20 %). Калькулятор даёт ориентир; точный расчёт оформляется в <a href="/baza-znaniy/rkm-po-gosoboronzakazu/">расчётно-калькуляционных материалах (РКМ)</a> по формам приказа ФАС № 995/22 и согласуется с госзаказчиком.</p>
<!-- goz-profit-calc -->
<div class="gpc" id="gpc">
<style>
.gpc{margin:22px 0;background:#26241d;color:#e8e2d6;border-radius:16px;padding:24px 26px;border:1px solid #3a382f}
.gpc h3{margin:0 0 4px;font-size:1.05rem;color:#fff}
.gpc__sub{margin:0 0 16px;font-size:.86rem;color:#b8b2a4}
.gpc__row{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:14px}
.gpc__label{display:block;font-size:.8rem;color:#cfc9bb;margin-bottom:5px}
.gpc input{width:100%;box-sizing:border-box;background:#1c1a15;color:#fff;border:1px solid #45433a;border-radius:9px;padding:11px 12px;font-size:1rem}
.gpc__out{margin-top:6px;background:#1c1a15;border:1px solid #45433a;border-radius:12px;padding:16px 18px}
.gpc__big{font-size:1.3rem;font-weight:700;color:#d8b878}
.gpc__line{font-size:.9rem;color:#cfc9bb;margin-top:6px}
.gpc__note{font-size:.78rem;color:#8f897b;margin-top:12px}
@media(max-width:600px){.gpc__row{grid-template-columns:1fr}}
</style>
<h3>Допустимая прибыль по контракту ГОЗ</h3>
<p class="gpc__sub">Затратный метод, п. 54 ПП РФ № 1465. Введите плановые затраты в млн ₽.</p>
<div class="gpc__row">
<div><label class="gpc__label" for="gpcP">Привнесённые затраты (ПКИ, сторонние работы), млн ₽</label><input id="gpcP" type="number" min="0" step="0.1" inputmode="decimal" placeholder="например, 30"></div>
<div><label class="gpc__label" for="gpcS">Собственные затраты, млн ₽</label><input id="gpcS" type="number" min="0" step="0.1" inputmode="decimal" placeholder="например, 10"></div>
</div>
<div class="gpc__out" id="gpcOut" aria-live="polite">
<div class="gpc__big">Введите затраты</div>
<div class="gpc__line">Посчитаем допустимую прибыль и предельную цену контракта.</div>
</div>
<div class="gpc__note">Оценка по правилу 1 % + 25 %. Повышенная норма (развитие производства, 25–30 % собственных) и точный расчёт оформляются в РКМ. Не заменяет согласование цены с госзаказчиком.</div>
</div>
<script>(function(){var P=document.getElementById("gpcP"),S=document.getElementById("gpcS"),O=document.getElementById("gpcOut");if(!P||!S||!O)return;function f(x){return (Math.round(x*100)/100).toLocaleString("ru-RU");}function calc(){var p=parseFloat((P.value||"").replace(",","."))||0,s=parseFloat((S.value||"").replace(",","."))||0;if(p<=0&&s<=0){O.innerHTML='<div class="gpc__big">Введите затраты</div><div class="gpc__line">Посчитаем допустимую прибыль и предельную цену контракта.</div>';return;}var pmin=0.10*s,pmax=0.01*p+0.25*s,pdev=0.01*p+0.30*s,cost=p+s,price=cost+pmax;O.innerHTML='<div class="gpc__big">Прибыль: '+f(pmin)+' – '+f(pmax)+' млн ₽</div>'+'<div class="gpc__line">Себестоимость: <b>'+f(cost)+'</b> млн ₽ · предельная цена: <b>'+f(price)+'</b> млн ₽</div>'+'<div class="gpc__line">При обосновании развития производства (25–30 % собственных) — прибыль до <b>'+f(pdev)+'</b> млн ₽.</div>';}P.addEventListener("input",calc);S.addEventListener("input",calc);})();</script>
    ...
    <h2 id="zaprety">Запрещённые операции по счёту ГОЗ</h2>
    <div class="answer reveal">
      <p>Счёт по гособоронзаказу — отдельный счёт в уполномоченном банке при банковском сопровождении или лицевой счёт в ТОФК при казначейском — работает в жёстком режиме. Часть операций по нему прямо запрещена: при банковском сопровождении перечень закреплён статьёй 8.4 Закона № 275-ФЗ<a class="fn" href="#ref-2" aria-label="Источник 2">[2]</a>, при казначейском действуют аналогичные ограничения режима лицевого счёта. Знание этих запретов снимает часть отказов ещё на этапе планирования платежей.</p>
    </div>
    <table>
      <caption>Операции, которые по счёту ГОЗ не допускаются</caption>
      <tr><th>Запрещено</th><th>Пояснение</th></tr>
      <tr><td>Выдача займов, авансов и кредитов</td><td>Целевые средства нельзя передавать в долг третьим лицам</td></tr>
      <tr><td>Возврат займов и кредитов, уплата процентов</td><td>Запрещено, за отдельными исключениями, установленными законом</td></tr>
      <tr><td>Взносы в уставный (складочный) капитал других юрлиц</td><td>Целевые деньги нельзя вкладывать в капитал иных организаций</td></tr>
      <tr><td>Благотворительность и пожертвования</td><td>Безвозмездные перечисления вне контракта не допускаются</td></tr>
      <tr><td>Покупка иностранной валюты</td><td>Запрещено, кроме случаев, прямо предусмотренных законом</td></tr>
      <tr><td>Приобретение ценных бумаг, включая векселя</td><td>Размещать целевые средства в финансовые инструменты нельзя</td></tr>
    </table>
    <div class="note"><b>Вывод.</b> Логика запретов одна: целевые средства ГОЗ должны идти строго на исполнение контракта, а не «работать» на стороне. Любая операция, не связанная напрямую с контрактом, с высокой вероятностью будет отклонена банком или казначейством.</div>
    <p data-ctx="auto-ctx:komandirovki-obs">Отдельный случай — командировки: выплаты работникам с отдельного счёта разрешены по гарантиям Трудового кодекса, но компенсация проезда и найма жилья из них исключена, а билеты и гостиницы через сервисы бронирования оплачиваются юрлицу в пределах лимита «иных расходов» — подробно в разборе <a href="/baza-znaniy/komandirovochnye-i-podotchetnye-pri-ks/#agregator-goz">оплаты агрегаторов при отдельном счёте</a>.</p>
...
<figcaption style="font-size:13px;color:#6E6B66;font-style:italic;margin-top:8px">Порог 3 млн ₽ распространяется на всю цепочку кооперации: субподрядчик работает через свой лицевой счёт наравне с головным исполнителем.</figcaption>
    ...
    <div class="answer reveal">
      ...
      <p>С 1 января 2026 года введена административная ответственность — её установил Федеральный закон от 28.12.2025 № 506-ФЗ, дополнивший КоАП РФ. Статья 15.37.1 КоАП РФ за несоблюдение требования о раздельном учёте предусматривает штраф для должностных лиц 10 000–50 000 ₽, для ИП и юрлиц — от 5 до 10% цены контракта, но не более 250 000 ₽ для ИП и 500 000 ₽ для юрлиц<a class="fn" href="#ref-4" aria-label="Источник 4">[4]</a>. Статья 15.49 КоАП РФ наказывает за нарушение срока утверждения сведений об операциях с целевыми средствами.</p>
    </div>
    <div class="related-inline"><b>По теме</b>
    ...
    <p data-ctx="kontr-0909:rash">Затраты на сопровождение — специалист, консультант, гарантия, подпись — относимы в цене продукции и в раздельном учёте; по каким статьям Порядка № 334 и с какими документами — в статье <a href="/baza-znaniy/uchet-rashodov-na-soprovozhdenie-goz/">расходы на сопровождение контракта ГОЗ</a>.</p>
    ...
    <p class="note">Большинство отказов из этого списка предотвратимы, когда документы готовит человек, который видит их сотнями, — <a href="/uslugi/soprovozhdenie-avans/">передать сопровождение экспертам &rarr;</a></p>
      <ul>
    ...
    <div class="faq">
      ...
      <details><summary>Какие документы нужны для открытия лицевого счёта?</summary><p>По пункту 24 Порядка № 44н представляются документ-основание, выписка из него либо карточка контракта, а также документы, которые по закону подтверждают основание казначейского сопровождения. Отдельного заявления на открытие в Порядке нет; карточка образцов подписей не применяется — полномочия подтверждает машиночитаемая доверенность. Обмен идёт через ГИИС «Электронный бюджет».</p></details>
      ...
      <details><summary>Сколько стоит казначейское сопровождение ГОЗ?</summary><p>Контракты по ГОЗ ведём по тарифу с авансом и ГОЗ — 105 000 ₽ в месяц без лимита на число операций; РКМ — 105 000 ₽ за комплект, восстановление раздельного учёта — 99 000 ₽ за контракт. Цена фиксируется в договоре.</p></details><details><summary>О чём Федеральный закон № 275-ФЗ?</summary><p>Федеральный закон от 29.12.2012 № 275-ФЗ регулирует государственный оборонный заказ: правила размещения и исполнения контрактов ГОЗ, режим отдельного счёта в уполномоченном банке, раздельный учёт результатов финансово-хозяйственной деятельности, запреты на расходование средств и ответственность исполнителя. Для исполнителей ГОЗ это базовый закон наряду с 44-ФЗ, а расчёты по таким контрактам попадают под казначейское сопровождение.</p></details>
    </div>

    <p data-ctx="auto-ctx:npa-275">Постатейный разбор самого закона — какие главы 275-ФЗ за что отвечают и что менялось в последних редакциях — вынесен в нормативную базу: <a href="/baza-znaniy/normativnaya-baza/fz-275-goz/">275-ФЗ о гособоронзаказе: разбор для исполнителя</a>.</p>
...
<div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер; точный режим сопровождения определяется условиями конкретного госконтракта. Проверено экспертом КазнаЭксперт. Дата актуализации — 9 сентября 2026.</p>
    </div>
...
<section class="related" aria-labelledby="relTitle">
  ...
  <div class="related__grid">
    <!-- auto-related:federalnyy-nomenklaturnyy-nomer-fnn --><a class="card reveal" href="/baza-znaniy/federalnyy-nomenklaturnyy-nomer-fnn/"><div class="card__cover"><span>ФНН</span></div><div class="card__body"><span class="card__cat">База знаний</span><h3 class="card__title">Федеральный номенклатурный номер и каталог продукции</h3><div class="card__meta">Гособоронзаказ · 17 мин</div></div></a>
...
-->
<section class="kz-sub" aria-labelledby="kzSubTitle" data-source="goz">
  <style>

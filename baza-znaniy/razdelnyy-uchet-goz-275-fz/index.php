...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <table>
      ...
      <tr><td>Приказ Минпромторга России № 334</td><td>Состав затрат, включаемых в цену продукции по ГОЗ (методика калькулирования)</td></tr>
      <tr><td>Постановление Правительства РФ № 1465</td><td>Государственное регулирование цен на продукцию по ГОЗ</td></tr>
...
<figcaption style="font-size:13px;color:#6E6B66;font-style:italic;margin-top:8px">Принцип обособления: четыре группы показателей на контракт через субконто по ИГК; накладные — только по базе из учётной политики.</figcaption>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-6">Приказ Минпромторга России № 334 (состав затрат, включаемых в цену продукции по ГОЗ); Постановление Правительства РФ № 1465 (государственное регулирование цен на продукцию по ГОЗ). <a href="https://base.garant.ru/71825654/" target="_blank" rel="noopener">Гарант</a></li>
      </ol>
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию; точные требования к раздельному учёту определяются условиями конкретного контракта и применимыми НПА. Проверено экспертом КазнаЭксперт. Дата актуализации — 23 июля 2026.</p>
    </div>

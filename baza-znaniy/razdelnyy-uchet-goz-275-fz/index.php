...
<title>Раздельный учёт по ГОЗ в 2026: методика, проводки, штрафы | КазнаЭксперт</title>
<meta name="description" content="Раздельный учёт по ГОЗ в 2026: кто обязан по 275-ФЗ, методика распределения затрат, счета и проводки, учётная политика, формы, штрафы ст. 15.37.1 КоАП. Со ссылками на НПА.">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#ks-svyaz">Связь с КС</a></li>
  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        ...
        <li><a href="#ks-svyaz">Связь с КС</a></li><li><a href="#cenoobrazovanie">Учёт и цена ГОЗ</a></li>
    ...
    <table>
      ...
      <tr><td>51 / специальный счёт</td><td>Движение целевых средств по контракту</td><td>По счёту контракта (при КС — лицевой счёт в ТОФК)</td></tr>
    </table>
    ...
    <p>При казначейском сопровождении к отчётности добавляются сведения об операциях с целевыми средствами, которые исполнитель формирует и утверждает в ГИИС «Электронный бюджет». Состав и сроки представления отчётности зависят от режима (обычное или расширенное КС) и условий контракта. Несвоевременное утверждение сведений об операциях с 2026 года также стало объектом административной ответственности (ст. 15.49 КоАП РФ).</p>
    ...
    <div class="answer reveal">
      ...
      <p>При обычном КС казначейство проверяет соответствие платежа условиям контракта и целевому назначению. При <b>расширенном</b> казначейском сопровождении (ст. 242.24 Бюджетного кодекса РФ)<a class="fn" href="#ref-3" aria-label="Источник 3">[3]</a> контроль глубже: казначейство сверяет фактические затраты с данными раздельного учёта и проверяет обоснованность структуры цены. Именно поэтому при расширенном КС качество раздельного учёта становится критичным — расхождения между структурой цены и фактическими затратами по данным раздельного учёта вызывают вопросы и риск приостановки операций. Подробно режим разобран в материале <a href="/baza-znaniy/kaznacheyskoe-soprovozhdenie-goz-275-fz/">«Казначейское сопровождение ГОЗ по 275-ФЗ»</a>.</p>
    </div>
    ...
    <table>
      ...
      <tr><td>Федеральное казначейство</td><td>При расширенном КС — соответствие фактических затрат данным учёта</td></tr>
    ...
    <table>
      ...
      <tr><td>Накладные распределяются «на глаз»</td><td>Искажение структуры цены, претензии при расширенном КС</td><td>Закрепить и единообразно применять обоснованную базу распределения</td></tr>
      ...
      <tr><td>Смешение целевых и собственных средств</td><td>Нарушение целевого использования, риск санкций</td><td>Вести операции по контракту обособленно, при КС — через лицевой счёт в ТОФК</td></tr>
    ...
    <div class="takeaways">
      ...
      <ol>
        ...
        <li>С 01.01.2026 за нарушение раздельного учёта при КС — штраф юрлицу 5–10% цены контракта, до 500 000 ₽ (ст. 15.37.1 КоАП РФ).</li>
        <li>При расширенном КС казначейство сверяет факт затрат с данными раздельного учёта — методику нужно выстраивать с первого платежа.</li>
      </ol>
    </div>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-3">Бюджетный кодекс РФ, глава 24.4 «Казначейское сопровождение» (ст. 242.23–242.27, расширенное КС — ст. 242.24) — <a href="https://base.garant.ru/12112604/c4c9af294a556f592c57e5dc5ad9bbed/" target="_blank" rel="noopener">base.garant.ru</a></li>

  ...
  <article class="content" id="main">
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-5">Постановление Правительства РФ от 19.01.1998 № 47 «О Правилах ведения организациями... раздельного учёта результатов финансово-хозяйственной деятельности».</li>
        <li id="ref-6">Приказ Минпромторга России № 334 (состав затрат, включаемых в цену продукции по ГОЗ); Постановление Правительства РФ № 1465 (государственное регулирование цен на продукцию по ГОЗ).</li>
      </ol>

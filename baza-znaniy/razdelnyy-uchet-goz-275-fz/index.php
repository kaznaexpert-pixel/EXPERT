...
{"@type":"Question","name":"Кто обязан вести раздельный учёт по ГОЗ?","acceptedAnswer":{"@type":"Answer","text":"Головной исполнитель и исполнители всех уровней кооперации, заключившие контракты в рамках исполнения ГОЗ. Обязанность установлена п. 18 ч. 1 ст. 8 ФЗ № 275-ФЗ."}},
{"@type":"Question","name":"С какой суммы нужен раздельный учёт по ГОЗ?","acceptedAnswer":{"@type":"Answer","text":"Обязанность раздельного учёта по ГОЗ не привязана к порогу суммы — она возникает из факта исполнения контракта ГОЗ. Порог 3 млн ₽ относится к обязательности казначейского сопровождения расчётов."}},
{"@type":"Question","name":"Какой штраф за отсутствие раздельного учёта в 2026 году?","acceptedAnswer":{"@type":"Answer","text":"По ст. 15.37.1 КоАП РФ с 01.01.2026 за нарушение раздельного учёта по контрактам на казначейском сопровождении: должностным лицам 10 000–50 000 ₽; ИП 5–10% цены контракта, не более 250 000 ₽; юрлицам 5–10% цены контракта, не более 500 000 ₽."}},
{"@type":"Question","name":"Нужен ли раздельный учёт, если контракт не на казначейском сопровождении?","acceptedAnswer":{"@type":"Answer","text":"Да. Обязанность раздельного учёта по ГОЗ установлена 275-ФЗ и не зависит от наличия казначейского сопровождения. Сопровождение лишь усиливает контроль за этими данными."}},
{"@type":"Question","name":"Как распределять накладные расходы по ГОЗ?","acceptedAnswer":{"@type":"Answer","text":"Накладные распределяют пропорционально обоснованной базе — например, прямым затратам на оплату труда или прямым затратам в целом. База закрепляется в учётной политике и применяется единообразно ко всем контрактам."}},
{"@type":"Question","name":"На каких счетах вести раздельный учёт по ГОЗ?","acceptedAnswer":{"@type":"Answer","text":"На обычных счетах учёта (20, 23, 25, 26, 90 и др.) с аналитикой по каждому контракту (ИГК). Отдельный план счетов не требуется."}}
]}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      ...
      <p>Практически это означает аналитический учёт в разрезе <span class="term" tabindex="0" data-tip="Идентификатор государственного контракта — 25-значный код, который заказчик присваивает контракту ГОЗ.">ИГК</span>: к счетам затрат и расчётов открываются субсчета или аналитические признаки по каждому контракту, а первичные документы маркируются идентификатором контракта. Раздельный учёт — это не отдельная «вторая бухгалтерия», а аналитический срез внутри основного учёта, выстроенный так, чтобы по любому контракту можно было собрать полную картину доходов и затрат.</p>
    </div>

...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 104 «Реестр недобросовестных поставщиков (подрядчиков, исполнителей)» (ред. на 26.06.2026).</li>
        <li id="ref-2">Федеральный закон от 05.04.2013 № 44-ФЗ, часть 1.1 статьи 31 (требование об отсутствии участника в реестре недобросовестных поставщиков).</li>
        <li id="ref-3">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 95 (одностороннее расторжение контракта).</li>

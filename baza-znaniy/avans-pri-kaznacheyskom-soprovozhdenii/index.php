...
<meta name="description" content="Аванс при казначейском сопровождении в 2026: когда попадает под КС, размер (30–50%), обеспечение по 44-ФЗ, лицевой счёт в ТОФК и санкционирование.">
...
<meta property="og:description" content="Аванс при казначейском сопровождении в 2026: когда попадает под КС, размер (30–50%), обеспечение по 44-ФЗ, лицевой счёт в ТОФК и санкционирование.">
...
<meta name="twitter:description" content="Аванс при казначейском сопровождении в 2026: когда попадает под КС, размер (30–50%), обеспечение по 44-ФЗ, лицевой счёт в ТОФК и санкционирование.">
...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/baza-znaniy/">База знаний</a> › Аванс при КС</nav>

  <aside class="toc" aria-label="Содержание">
    <div class="toc__label">Содержание</div>
    <ul class="toc__list" id="tocList">
      <li><a href="#chto">Что значит аванс под КС</a></li><li><a href="#kogda">Когда аванс попадает под КС</a></li><li><a href="#razmer">Размер аванса</a></li><li><a href="#obespechenie">Обеспечение исполнения</a></li><li><a href="#kak">Как работает аванс под КС</a></li><li><a href="#koo">Казначейское обеспечение</a></li><li><a href="#shagi">Порядок: пошагово</a></li><li><a href="#koop">Аванс и кооперация</a></li><li><a href="#goz-avans">Аванс по ГОЗ</a></li><li><a href="#vozvrat">Возврат аванса</a></li><li><a href="#bank">Банковское сопровождение</a></li><li><a href="#dokumenty">Документы и сроки</a></li><li><a href="#oshibki">Частые ошибки</a></li><li><a href="#checklist">Чек-лист</a></li><li><a href="#keys">Пример из практики</a></li><li><a href="#faq">Частые вопросы</a></li>
    </ul>
  </aside>
  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol><li><a href="#chto">Что значит аванс под КС</a></li><li><a href="#kogda">Когда аванс попадает под КС</a></li><li><a href="#razmer">Размер аванса</a></li><li><a href="#obespechenie">Обеспечение исполнения</a></li><li><a href="#kak">Как работает аванс под КС</a></li><li><a href="#koo">Казначейское обеспечение</a></li><li><a href="#shagi">Порядок: пошагово</a></li><li><a href="#koop">Аванс и кооперация</a></li><li><a href="#goz-avans">Аванс по ГОЗ</a></li><li><a href="#vozvrat">Возврат аванса</a></li><li><a href="#bank">Банковское сопровождение</a></li><li><a href="#dokumenty">Документы и сроки</a></li><li><a href="#oshibki">Частые ошибки</a></li><li><a href="#checklist">Чек-лист</a></li><li><a href="#keys">Пример из практики</a></li><li><a href="#faq">Частые вопросы</a></li></ol>
    </details>
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">до 50%</div><div class="kf__t"><b>Размер аванса</b> — по общему правилу до 30%, при КС нередко выше</div></div>
    ...
    <h2 id="kak">Как работает аванс под КС: от зачисления до списания</h2>
    <div class="answer reveal">
    ...
    <h2 id="shagi">Порядок получения и отработки аванса под КС</h2>
    <div class="answer reveal">
      <p>Пошаговый маршрут для исполнителя:</p>
      <ol class="howto">
        <li><b>Подтвердите попадание под КС.</b> Сверьте контракт с перечнем статьи 5 Закона № 426-ФЗ по источнику и сумме.</li>
    ...
    <div class="answer reveal">
      <ul>
        ...
        <li><b>Сумму порога считают от платежа, а не от цены контракта</b> — неверный вывод о попадании под КС.</li>
      </ul>
    </div>
    ...
    <h2 id="checklist">Чек-лист по авансу под КС</h2>
    <div class="answer reveal">
      <ul>
    ...
    <div class="faq reveal">
      ...
      <details><summary>Чем аванс под КС отличается от обычной предоплаты?</summary><p>Обычный аванс идёт на банковский счёт и расходуется свободно. Аванс под казначейским сопровождением зачисляется на лицевой счёт в ТОФК и тратится только под санкционирование, по целевому назначению, отражённому в сведениях об операциях.</p></details>
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="avans-pri-kaznacheyskom-soprovozhdenii">
      ...
      <h3 class="railform__title">Проведём аванс под КС</h3>

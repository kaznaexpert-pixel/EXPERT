...
<meta name="description" content="РКМ — расчётно-калькуляционные материалы: что означает аббревиатура, чем отличаются от сметы и калькуляции себестоимости, кто их требует и что будет, если не представить.">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>9 мин чтения</span><span class="dot">·</span><span>Обновлено 16 августа 2026</span></div>
    </div>
...
<details><summary>Что будет, если не представить РКМ?</summary><p>Отдельного штрафа за непредставление нет, но без обосновывающих документов не выдаётся заключение о цене: контракт не заключить, ориентировочную цену не перевести в фиксированную, а неподтверждённые затраты проверяющий не примет — разница ляжет на прибыль предприятия.</p></details></div>
...
<div class="refs">
      ...
      <p class="refs__note">Материал актуален на 16 августа 2026 года. Перед подачей комплекта сверяйте действующие редакции ПП № 1465 и приказа ФАС № 995/22: состав и формы обосновывающих документов меняются вместе с ними.</p>
    </div>

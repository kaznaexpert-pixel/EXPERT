...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#v-dogovore">ИГК в договоре: что это и как выглядит условие</a></li>
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>15 мин чтения</span><span class="dot">·</span><span>Обновлено 19 сентября 2026</span></div>
    </div>
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        ...
        <li><a href="#gde">Где указывать</a></li><li><a href="#v-dogovore">ИГК в договоре</a></li><li><a href="#1c">Как добавить в 1С</a></li>
    ...
    <h2 id="v-dogovore">ИГК в договоре: что это и как выглядит условие</h2>
    <div class="answer"><p>ИГК в договоре — это идентификатор государственного контракта, перенесённый в текст договора между исполнителем и его контрагентом, плюс условие о том, что тот же код указывается во всех платёжных документах по договору. Для контрактов под казначейским сопровождением такое условие обязательно по подпункту 3 пункта 2 статьи 242.23 Бюджетного кодекса, в гособоронзаказе — по статьям 7 и 8 закона № 275-ФЗ.</p></div>
    <p>Когда в договоре субподряда или поставки встречается строка «ИГК 0000000000000000000» рядом с номером и датой, это не реквизит для бухгалтерии контрагента и не внутренний номер заказчика. Это метка, по которой казначейство или уполномоченный банк связывает платёж по вашему договору с государственным контрактом наверху цепочки. Без неё распоряжение с лицевого счёта вернут, а платёж с отдельного счёта по ГОЗ банк не проведёт.</p>

    <h3 id="v-dogovore-normy">Откуда берётся обязанность: две нормы для двух режимов</h3>
    <p>При казначейском сопровождении обязанность закреплена в подпункте 3 пункта 2 статьи 242.23 Бюджетного кодекса: контракт должен содержать положение об указании идентификатора в контрактах (договорах), распоряжениях и документах, установленных порядком санкционирования. Условие спускается по цепочке: исполнитель включает его в договоры с соисполнителями, те — со своими контрагентами (пункт 4.1 той же статьи, см. раздел <a href="#cepochka">о цепочке</a>).</p>
    <p>В гособоронзаказе нормы лежат в законе № 275-ФЗ. Государственный заказчик присваивает каждому контракту идентификатор и указывает его в государственном контракте (пункт 5 статьи 7). Головной исполнитель включает идентификатор в контракты с исполнителями, а исполнитель — в контракты с другими исполнителями (пункт 4 части 1 и пункт 4 части 2 статьи 8). Оба обязаны указывать код в распоряжении о переводе средств (пункт 9), а режим отдельного счёта допускает списание только при указании идентификатора в распоряжении (пункт 1 части 1 статьи 8.3). Сам порядок указания кода в платёжном документе задаёт Банк России по правилам для уникального идентификатора платежа (часть 4 статьи 6.1).</p>
    <table>
      <caption>Условие об ИГК: казначейское сопровождение и гособоронзаказ</caption>
      <thead><tr><th>Вопрос</th><th>Казначейское сопровождение</th><th>Гособоронзаказ (отдельный счёт)</th></tr></thead>
      <tbody>
        <tr><td>Норма об условии в договоре</td><td>пп. 3 п. 2 ст. 242.23 БК РФ</td><td>п. 5 ст. 7, п. 4 ч. 1 и ч. 2 ст. 8 № 275-ФЗ</td></tr>
        <tr><td>Кто первым вписывает код</td><td>государственный заказчик — в госконтракт</td><td>государственный заказчик — в госконтракт</td></tr>
        <tr><td>Кто переносит вниз по цепочке</td><td>исполнитель и каждый соисполнитель — в свои договоры (п. 4.1 ст. 242.23 БК)</td><td>головной исполнитель и исполнители — в контракты с исполнителями</td></tr>
        <tr><td>Что без кода не пройдёт</td><td>санкционирование распоряжения в ТОФК</td><td>списание с отдельного счёта в уполномоченном банке (п. 1 ч. 1 ст. 8.3)</td></tr>
        <tr><td>Длина кода</td><td>20 знаков по приказу Минфина № 205н</td><td>25 знаков по приказу Минобороны № 475 / Казначейства № 13н</td></tr>
      </tbody>
    </table>

    <h3 id="v-dogovore-gde">Где в договоре стоит код и как его оформляют</h3>
    <p>Единой формы нет, закон требует наличия кода, а не его места. На практике идентификатор встречается в четырёх точках договора, и лучше, когда он есть во всех сразу: в шапке рядом с номером и датой («Договор № 12-СП от 05.09.2026, ИГК …»), в предмете — как реквизит государственного контракта, во исполнение которого заключается договор, в разделе о порядке расчётов — как обязательное содержание назначения платежа, и в реквизитах сторон — вместе с номером лицевого или отдельного счёта. Расположение кода в счёте, счёте-фактуре и УПД разобрано отдельно в материале <a href="/baza-znaniy/igk-v-schete-fakture-i-upd/">про ИГК в счёте-фактуре и УПД</a>.</p>

    <h3 id="v-dogovore-formulirovka">Пример формулировки условия об ИГК</h3>
    <p>Ниже — образец, а не обязательная форма; заказчики нередко предлагают свою редакцию, и спорить с ней не нужно, если сохранены три элемента: сам код, обязанность указывать его в платёжных документах и обязанность переносить его в договоры дальше по цепочке.</p>
    <blockquote><p>«Настоящий договор заключён во исполнение государственного контракта от __.__.2026 № ___ (идентификатор государственного контракта — ИГК ____________________). Стороны указывают ИГК в договоре, в дополнительных соглашениях к нему, в счетах, актах, счетах-фактурах (УПД) и в распоряжениях о переводе денежных средств по договору. Исполнитель обязуется включать ИГК в договоры, заключаемые им с соисполнителями во исполнение настоящего договора, и обеспечивать его указание в платёжных документах по таким договорам».</p></blockquote>
    <p>Для гособоронзаказа к формулировке добавляют условие о расчётах через отдельный счёт в уполномоченном банке и об обязанности исполнителя открыть такой счёт — см. <a href="/baza-znaniy/suschestvennye-usloviya-kontrakta-goz/">существенные условия контракта по ГОЗ</a>.</p>

    <h3 id="v-dogovore-proverka">Что проверить, когда ИГК в договоре уже вписан</h3>
    <ul>
      <li><b>Совпадение с государственным контрактом.</b> Код в вашем договоре сверяют посимвольно с кодом в госконтракте и в реестровой записи: расхождение в одном знаке — возврат распоряжения.</li>
      <li><b>Один код на всю цепочку.</b> Если контрагент предлагает «свой» идентификатор или код другого контракта того же заказчика, это ошибка — по цепочке идёт один и тот же ИГК.</li>
      <li><b>Код в назначении платежа.</b> Условие в договоре не работает само по себе: проверьте, что бухгалтерия подставляет код в каждое <a href="/baza-znaniy/naznachenie-platezha-kaznachejstvo/">назначение платежа</a>.</li>
      <li><b>Дополнительное соглашение при пропуске.</b> Если договор уже подписан без кода, его дополняют соглашением; счёт с ИГК без изменения договора закрывает вопрос только на стороне контрагента, но не условие по пп. 3 п. 2 ст. 242.23 БК.</li>
    </ul>
...
<p data-ctx="auto-ctx:igk-ne-ukazan-0902">Что происходит, когда код пропущен в конкретном документе — счёте-фактуре, распоряжении при казначейском сопровождении, платеже с отдельного счёта, договоре кооперации — и каким документом это исправляют, разобрано в разделе <a href="/baza-znaniy/igk-v-schete-fakture-i-upd/#ne-ukazan">«Не указан ИГК: последствия по каждому документу»</a>.</p>
    ...
    <div class="faq">
      ...
      <details><summary>ИГК в договоре — что это?</summary><p>Идентификатор государственного контракта, перенесённый в договор исполнителя с контрагентом, вместе с условием указывать его в платёжных документах и в договорах дальше по цепочке. При казначейском сопровождении такое условие обязательно по пп. 3 п. 2 ст. 242.23 БК, в гособоронзаказе — по ст. 7 и 8 закона № 275-ФЗ. Разбор — в разделе <a href="#v-dogovore">«ИГК в договоре»</a>.</p></details>
      <details><summary>Нужно ли допсоглашение, если ИГК в договоре не указан?</summary><p>Да. Счёт или УПД с кодом закрывает вопрос только по конкретному платежу, а норма требует условия в самом договоре. Дополнительное соглашение о включении идентификатора не меняет существенных условий — это приведение реквизитов в соответствие с государственным контрактом.</p></details>
    </div>
...
<div class="refs">
      ...
      <ol>
        ...
        <li id="ref-4">Федеральный закон от 29.12.2012 № 275-ФЗ «О государственном оборонном заказе» (ред. от 04.07.2026): ст. 6.1, п. 5 ст. 7, п. 4 и 9 ч. 1–2 ст. 8, п. 1 ч. 1 ст. 8.3 — идентификатор в контракте и распоряжении — <a href="https://www.consultant.ru/document/cons_doc_LAW_140175/" target="_blank" rel="noopener">consultant.ru</a></li>
      </ol>
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию; актуальные структура и порядок формирования ИГК устанавливаются НПА и могут уточняться. Названия полей в 1С зависят от версии конфигурации. Проверено экспертом КазнаЭксперт. Дата актуализации — 19 сентября 2026.</p>
    </div>

...
<title>Идентификатор государственного контракта (ИГК): структура, 1С | КазнаЭксперт</title>
<meta name="description" content="Что такое ИГК — идентификатор государственного контракта: зачем нужен, отличие от ИКЗ, структура 20-значного кода при КС (приказ Минфина № 205н), 25 знаков в ГОЗ, где указывать и как добавить в 1С.">
...
{"@context":"https://schema.org","@type":"Article","headline":"Идентификатор государственного контракта (ИГК): что это, структура, как добавить в 1С","description":"Что такое ИГК — идентификатор государственного контракта: зачем нужен, отличие от ИКЗ, структура 20-значного кода при казначейском сопровождении (приказ Минфина № 205н), 25 знаков в ГОЗ, где указывать и как добавить в 1С.","inLanguage":"ru-RU","datePublished":"2026-06-08","dateModified":"2026-06-08","author":{"@type":"Person","name":"Ярослав Михайлов","jobTitle":"Главный эксперт по казначейскому сопровождению","url":"https://kaznaexpert.ru/komanda/mihailov-yaroslav/"},"publisher":{"@type":"Organization","name":"КазнаЭксперт","url":"https://kaznaexpert.ru","logo":{"@type":"ImageObject","url":"https://kaznaexpert.ru/img/logogold.png"}},"image":"https://kaznaexpert.ru/img/og-image.png","mainEntityOfPage":{"@type":"WebPage","@id":"https://kaznaexpert.ru/baza-znaniy/identifikator-gosudarstvennogo-kontrakta-igk/"}}
</script>
<script type="application/ld+json">
...
<meta property="og:description" content="ИГК при казначейском сопровождении: 20 знаков (приказ Минфина № 205н), 25 в ГОЗ, отличие от ИКЗ, где указывать и как добавить в 1С.">
...
<meta name="twitter:description" content="ИГК при казначейском сопровождении: 20 знаков (приказ Минфина № 205н), 25 в ГОЗ, отличие от ИКЗ, где указывать и как добавить в 1С.">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>15 мин чтения</span><span class="dot">·</span><span>Обновлено 8 июня 2026</span></div>
    </div>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию; актуальные структура и порядок формирования ИГК устанавливаются НПА и могут уточняться. Названия полей в 1С зависят от версии конфигурации. Проверено экспертом КазнаЭксперт. Дата актуализации — 8 июня 2026.</p>
    </div>
  </article>

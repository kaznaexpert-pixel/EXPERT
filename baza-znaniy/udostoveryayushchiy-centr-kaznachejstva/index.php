...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>16 мин чтения</span><span class="dot">·</span><span>Обновлено 17 июня 2026</span></div>
    </div>
    ...
    <div class="tldr">Удостоверяющий центр Федерального казначейства (УЦ ФК) — это государственный аккредитованный удостоверяющий центр, который с 1 января 2022 года выдаёт квалифицированные сертификаты электронной подписи отдельным категориям лиц: должностным лицам госорганов, а также руководителям и работникам организаций, получающих бюджетные средства под казначейским сопровождением. Работает он на основании Закона № 63-ФЗ и приказа Казначейства № 21н, а сертификат выдаёт бесплатно.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></div>
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">Бесплатно</div><div class="kf__t"><b>Стоимость</b> — квалифицированный сертификат выдаётся без платы</div></div>
    ...
    <p>Сам квалифицированный сертификат УЦ ФК выдаёт бесплатно — это прямо установлено для государственных удостоверяющих центров. Но «бесплатно» относится только к выпуску сертификата: за сертифицированный ключевой носитель и средство криптографической защиты платить всё равно придётся, и это нормальные сопутствующие расходы. Срок действия сертификата ограничен, поэтому в планировании работы стоит держать в голове дату окончания и не привязывать к подписи критичные операции в последние дни её действия.</p>
    ...
    <div class="takeaways">
      ...
      <ol>
        ...
        <li>Сертификат выдаётся бесплатно; заявка подаётся через Портал заявителя, идентификация — в ТОФК.</li>
    ...
    <div class="faq">
      ...
      <details><summary>Сколько стоит сертификат в УЦ ФК?</summary><p>Квалифицированный сертификат в государственных удостоверяющих центрах, включая УЦ ФК, выдаётся бесплатно. Платить нужно только за носитель и средство криптографической защиты.</p></details>

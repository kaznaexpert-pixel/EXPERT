...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/baza-znaniy/">База знаний</a> › Выписка ЕБ (ПУР КС) в 1С</nav>
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <p>До первой загрузки в 1С <a href="/baza-znaniy/razdelnyy-uchet-goz-v-1s/#schet-v-1s">заводят лицевой счёт как отдельный банковский счёт организации</a> с реквизитами ТОФК, привязывают договор с заказчиком с идентификатором контракта и настраивают статьи движения денежных средств и аналитику раздельного учёта. Без этого 1С либо не найдёт счёт для операций, либо загрузит их «в никуда» — без контракта и кода.</p>
    </div>

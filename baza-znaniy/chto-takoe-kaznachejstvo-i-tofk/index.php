...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <table>
      ...
      <tr><td>МОУ ФК</td><td>Межрегиональное операционное управление, Москва</td><td>Только отдельные категории клиентов</td></tr>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию. Статус, структура и полномочия Федерального казначейства устанавливаются ПП РФ № 703 и БК РФ и могут уточняться. Проверено экспертом КазнаЭксперт. Дата актуализации — 7 августа 2026.</p>
    </div>

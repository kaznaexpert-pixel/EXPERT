...
<meta name="description" content="Что такое Федеральное казначейство и ТОФК: правовой статус (ПП РФ № 703), территориальные органы (УФК), функции, единый казначейский счёт и роль для исполнителя госконтракта.">
...
{"@type":"Question","name":"Что такое ТОФК?","acceptedAnswer":{"@type":"Answer","text":"Территориальный орган Федерального казначейства. На уровне субъекта РФ это управление Федерального казначейства (УФК). Именно ТОФК открывает исполнителю лицевой счёт и санкционирует операции."}},
...
<meta property="og:title" content="Что такое Федеральное казначейство и ТОФК: структура и функции">
<meta property="og:description" content="Казначейство — служба в ведении Минфина: лицевые счета, санкционирование, ЕКС. Что такое ТОФК и чем казначейство важно исполнителю.">
...
<meta name="twitter:title" content="Что такое Федеральное казначейство и ТОФК: структура и функции">
<meta name="twitter:description" content="Казначейство — служба в ведении Минфина: лицевые счета, санкционирование, ЕКС. Что такое ТОФК и чем казначейство важно исполнителю.">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <p>На местах казначейство представлено территориальными органами. ТОФК — территориальный орган Федерального казначейства; на уровне субъектов РФ это управления Федерального казначейства (УФК) по соответствующему региону. Именно ТОФК открывает исполнителю лицевой счёт, ведёт его и санкционирует операции. Поэтому на практике «общается» с казначейством исполнитель именно через свой территориальный орган.</p>

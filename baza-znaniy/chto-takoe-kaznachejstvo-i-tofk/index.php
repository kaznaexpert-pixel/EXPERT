...
<title>Что такое казначейство, ТОФК и УФК: структура и функции</title>
<meta name="description" content="Что такое Федеральное казначейство, ТОФК и УФК: правовой статус (ПП РФ № 703), территориальные органы, функции, единый казначейский счёт и роль для исполнителя.">

...
<meta name="description" content="Все формы РКМ из приложения № 5 к приказу ФАС № 995/22 (ред. от 18.12.2025): номер, официальное название, когда применяется. Разбивка по трём ситуациям, подписи и типовые ошибки.">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p>Пункт 2 приказа № 995/22 отвечает на этот вопрос прямо: документы, указанные в приложении № 5, представляются <b>на бумажном носителе и в электронном виде на оптических носителях (CD-R) в форматах электронных копий и таблиц</b>.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a> Требование опирается на пункт 76 Положения № 1465.<a class="fn" href="#ref-2" aria-label="Источник 2">[2]</a></p>
...
<details><summary>Можно ли сдать комплект только в электронном виде?</summary><p>Пункт 2 приказа № 995/22 требует представлять документы приложения № 5 на бумажном носителе и в электронном виде на оптических носителях (CD-R) — в форматах электронных копий и таблиц. Конкретный порядок передачи уточняйте у заказчика или военного представительства.</p></details>
...
<div class="refs">
      ...
      <p class="refs__note">Материал актуален на 27 августа 2026 года. Названия форм приведены по редакции приказа № 995/22 от 18.12.2025. Состав комплекта по конкретному контракту определяется запросом заказчика (ВП) и действующими редакциями ПП № 1465 и приказов № 995/22 и № 334 — сверяйте редакции на дату подачи.</p>
    </div>

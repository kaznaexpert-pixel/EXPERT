...
{"@context": "https://schema.org", "@type": "Article", "headline": "Формы РКМ по приказу ФАС № 995/22: полный перечень и назначение", "description": "Полный перечень форм обосновывающих документов (РКМ) из приложения № 5 к приказу ФАС России № 995/22: официальные названия, назначение каждой формы, парные формы с индексом «д», подписанты, порядок представления и типовые ошибки заполнения.", "inLanguage": "ru-RU", "datePublished": "2026-08-16", "dateModified": "2026-08-16", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/", "@id": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/#person"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}, "@id": "https://kaznaexpert.ru/#organization"}, "image": "https://kaznaexpert.ru/img/og-image.png", "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/formy-rkm-995-22/"}, "citation": ["https://www.consultant.ru/document/cons_doc_LAW_436477/", "http://publication.pravo.gov.ru/Document/View/0001202212300048", "https://www.consultant.ru/document/cons_doc_LAW_284195/", "https://www.consultant.ru/document/cons_doc_LAW_322968/"]}
</script>
<script type="application/ld+json">
...
<details><summary>Какие формы можно подать один раз, а не по каждому этапу?</summary><p>Сноска к форме № 2 относит к формам, содержащим информацию о финансово-хозяйственной деятельности организации в целом, формы № 8 (8д), № 10 (10д), № 11 (11д), № 12 (12д), № 13 (13д), № 21, № 21д, № 22 (22д), № 23 и № 23д. Если этапы НИР (ОКР) выполняются в одном году, они представляются единожды в составе соответствующего предложения о цене.</p></details></div>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал актуален на 16 августа 2026 года. Названия форм приведены по редакции приказа № 995/22 от 18.12.2025. Состав комплекта по конкретному контракту определяется запросом заказчика (ВП) и действующими редакциями ПП № 1465 и приказов № 995/22 и № 334 — сверяйте редакции на дату подачи.</p>
    </div>

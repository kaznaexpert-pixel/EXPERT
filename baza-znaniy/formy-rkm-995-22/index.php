...
<title>Формы РКМ по приказу № 995/22 — полный перечень и назначение</title>
<meta name="description" content="Все формы РКМ из приложения № 5 к приказу ФАС № 995/22: номер, название, когда применяется. Разбивка по трём ситуациям, подписи, носитель и типовые ошибки.">
<meta name="author" content="Ярослав Михайлов">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
<meta name="theme-color" content="#F4F1EB" media="(prefers-color-scheme: light)">
<meta name="theme-color" content="#141310" media="(prefers-color-scheme: dark)">
<!-- PROD: canonical и og:url ОБЯЗАТЕЛЬНО менять под URL каждой статьи -->
<link rel="canonical" href="https://kaznaexpert.ru/baza-znaniy/formy-rkm-995-22/">
...
{"@context": "https://schema.org", "@type": "Article", "headline": "Формы РКМ по приказу ФАС № 995/22: полный перечень и назначение", "description": "Полный перечень форм обосновывающих документов (РКМ) из приложения № 5 к приказу ФАС России № 995/22: официальные названия, назначение каждой формы, парные формы с индексом «д», подписанты, порядок представления и типовые ошибки заполнения.", "inLanguage": "ru-RU", "datePublished": "2026-08-16", "dateModified": "2026-09-08", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/", "@id": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/#person", "image": "https://kaznaexpert.ru/img/team/mihailov-photo.jpg"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}, "@id": "https://kaznaexpert.ru/#organization"}, "image": ["https://kaznaexpert.ru/img/og/baza-znaniy__formy-rkm-995-22-16x9.jpg", "https://kaznaexpert.ru/img/og/baza-znaniy__formy-rkm-995-22-4x3.webp", "https://kaznaexpert.ru/img/og/baza-znaniy__formy-rkm-995-22-1x1.webp"], "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/formy-rkm-995-22/"}, "citation": ["https://www.consultant.ru/document/cons_doc_LAW_436477/", "http://publication.pravo.gov.ru/Document/View/0001202212300048", "https://www.consultant.ru/document/cons_doc_LAW_284195/", "https://www.consultant.ru/document/cons_doc_LAW_322968/"]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Главная", "item": "https://kaznaexpert.ru/", "url": "https://kaznaexpert.ru/"}, {"@type": "ListItem", "position": 2, "name": "База знаний", "item": "https://kaznaexpert.ru/baza-znaniy/", "url": "https://kaznaexpert.ru/baza-znaniy/"}, {"@type": "ListItem", "position": 3, "name": "Формы РКМ по приказу № 995/22", "item": "https://kaznaexpert.ru/baza-znaniy/formy-rkm-995-22/", "url": "https://kaznaexpert.ru/baza-znaniy/formy-rkm-995-22/"}]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Сколько всего форм в приказе № 995/22?", "acceptedAnswer": {"@type": "Answer", "text": "Приказ утверждает семь приложений. Формы, которые заполняет исполнитель, собраны в приложении № 5 — это около тридцати форм с номерами от № 1 до № 23, причём большинство существует парой: базовая форма и форма с индексом «д». Приложения № 1–4, № 6 и № 7 — запросы и заключения, их готовят заказчик, отраслевой орган и ФАС."}}, {"@type": "Question", "name": "Что означает индекс «д» в номере формы?", "acceptedAnswer": {"@type": "Answer", "text": "Формы с индексом «д» отличаются периодом обоснования: в шапке базовой формы стоит «на ____ г.», в парной — «на ________ гг.», то есть период охватывает несколько лет. Сноска к форме № 2д дополнительно уточняет, что при переводе других видов цен в фиксированную плановая калькуляция представляется по форме № 2."}}, {"@type": "Question", "name": "Какие формы обязательны в любом комплекте?", "acceptedAnswer": {"@type": "Answer", "text": "Универсального обязательного списка приказ не содержит. Состав определяется видом цены и методом её определения по Положению № 1465, а также запросом заказчика или военного представительства. При затратном методе костяк — плановая калькуляция (ф. № 2), расшифровки материальных затрат (ф. № 4–7), трудоёмкость (ф. № 23), зарплатные формы (ф. № 9, 10), накладные (ф. № 11, 12), прибыль (ф. № 20) и сведения о нормативах (ф. № 22)."}}, {"@type": "Question", "name": "Нужно ли подавать отчётную калькуляцию при первой поставке?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. По сноске к форме № 3 отчётная калькуляция представляется по последнему отчётному периоду исполненного контракта, если продукция ранее поставлялась. При отсутствии поставки ранее отчётная калькуляция не представляется."}}, {"@type": "Question", "name": "Можно ли сдать комплект только в электронном виде?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Пункт 2 приказа № 995/22 требует представлять документы приложения № 5 на бумажном носителе и в электронном виде — в форматах электронных копий и таблиц. Требование к носителю задано пунктом 76 Положения № 1465: после изменений от 14.02.2026 это съёмные оптические машинные носители информации с функцией однократной записи. Конкретный порядок передачи уточняйте у заказчика или военного представительства."}}, {"@type": "Question", "name": "Действуют ли ещё формы приказа ФАС № 1138/19?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Приказ ФАС России от 26.08.2019 № 1138/19 признан утратившим силу пунктом 3 приказа № 995/22. Комплекты, собранные по старым бланкам, возвращают: в них нет разделения себестоимости на привнесённые и собственные затраты."}}, {"@type": "Question", "name": "Какие формы можно подать один раз, а не по каждому этапу?", "acceptedAnswer": {"@type": "Answer", "text": "Сноска к форме № 2 относит к формам, содержащим информацию о финансово-хозяйственной деятельности организации в целом, формы № 8 (8д), № 10 (10д), № 11 (11д), № 12 (12д), № 13 (13д), № 21, № 21д, № 22 (22д), № 23 и № 23д. Если этапы НИР (ОКР) выполняются в одном году, они представляются единожды в составе соответствующего предложения о цене."}}, {"@type": "Question", "name": "Что будет, если в комплекте не хватает одной формы?", "acceptedAnswer": {"@type": "Answer", "text": "Предложение о цене будет считаться непредставленным: пункт 109 Положения № 1465 в редакции постановления Правительства РФ от 14.02.2026 № 138 приравнивает неполный объём запрошенной информации к неподаче. Срок представления при этом считается несоблюдённым."}}, {"@type": "Question", "name": "Нужны ли документы сверх форм приложения № 5?", "acceptedAnswer": {"@type": "Answer", "text": "Часто да. Подпункт «м» пункта 37 Положения № 1465 позволяет государственному заказчику запросить иные документы, а ведомства утверждают собственные перечни — например, приказ ФСБ России от 08.04.2026 № 136. Ведомственный перечень применяется вместе с формами приложения № 5."}}]}
</script>
<script type="application/ld+json">
...
<meta property="og:title" content="Формы РКМ по приказу № 995/22: полный перечень">
<meta property="og:description" content="Все формы приложения № 5 к приказу ФАС № 995/22 с официальными названиями и назначением, разбивка по трём ситуациям контракта и типовые ошибки заполнения.">
<meta property="og:url" content="https://kaznaexpert.ru/baza-znaniy/formy-rkm-995-22/">
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__formy-rkm-995-22-16x9.jpg">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="675">
<meta property="og:image:alt" content="Формы РКМ по приказу ФАС № 995/22 — КазнаЭксперт">
...
<meta name="twitter:title" content="Формы РКМ по приказу № 995/22: полный перечень">
<meta name="twitter:description" content="Приложение № 5 к приказу ФАС № 995/22: все формы с назначением, парные формы «д», подписи и типовые ошибки.">
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__formy-rkm-995-22-16x9.jpg">
...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/baza-znaniy/">База знаний</a> › Формы РКМ по приказу № 995/22</nav>

  <aside class="toc" aria-label="Содержание">
    <div class="toc__label">Содержание</div>
    <ul class="toc__list" id="tocList">
      <li><a href="#gde">Где утверждены формы</a></li>
      <li><a href="#perechen">Полный перечень форм</a></li>
      <li><a href="#ne-vashi">Формы не для исполнителя</a></li>
      <li><a href="#indeks-d">Формы с индексом «д»</a></li>
      <li><a href="#vashi">Какие формы нужны вам</a></li>
      <li><a href="#odnazhdy">Формы, подаваемые один раз</a></li>
      <li><a href="#podpisi">Кто подписывает формы</a></li>
      <li><a href="#kak-sdavat">В каком виде сдаётся комплект</a></li>
      <li><a href="#oshibki">Типовые ошибки по формам</a></li>
      <li><a href="#nepolnyy-komplekt">Если не хватает формы</a></li>
        <li><a href="#vedomstvennyy-perechen">Ведомственный перечень</a></li>
  ...
  <article class="content" id="main">
    ...
    <h1>Формы РКМ по приказу ФАС № 995/22: полный перечень и назначение</h1>
    ...
    <div class="share">
      ...
      <a href="https://t.me/share/url?url=https%3A%2F%2Fkaznaexpert.ru%2Fbaza-znaniy%2Fformy-rkm-995-22%2F&amp;text=%D0%A4%D0%BE%D1%80%D0%BC%D1%8B%20%D0%A0%D0%9A%D0%9C%20%D0%BF%D0%BE%20%D0%BF%D1%80%D0%B8%D0%BA%D0%B0%D0%B7%D1%83%20%D0%A4%D0%90%D0%A1%20%E2%84%96%20995%2F22%3A%20%D0%BF%D0%BE%D0%BB%D0%BD%D1%8B%D0%B9%20%D0%BF%D0%B5%D1%80%D0%B5%D1%87%D0%B5%D0%BD%D1%8C%20%D1%84%D0%BE%D1%80%D0%BC%20%D0%BF%D1%80%D0%B8%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D1%8F%20%E2%84%96%205%20%D1%81%20%D0%BD%D0%B0%D0%B7%D0%BD%D0%B0%D1%87%D0%B5%D0%BD%D0%B8%D0%B5%D0%BC%20%D0%BA%D0%B0%D0%B6%D0%B4%D0%BE%D0%B9%2C%20%D1%80%D0%B0%D0%B7%D0%B1%D0%B8%D0%B2%D0%BA%D0%BE%D0%B9%20%D0%BF%D0%BE%20%D1%81%D1%82%D0%B0%D0%B4%D0%B8%D1%8F%D0%BC%20%D0%BA%D0%BE%D0%BD%D1%82%D1%80%D0%B0%D0%BA%D1%82%D0%B0%20%D0%B8%20%D1%82%D0%B8%D0%BF%D0%BE%D0%B2%D1%8B%D0%BC%D0%B8%20%D0%BE%D1%88%D0%B8%D0%B1%D0%BA%D0%B0%D0%BC%D0%B8%20%D0%B7%D0%B0%D0%BF%D0%BE%D0%BB%D0%BD%D0%B5%D0%BD%D0%B8%D1%8F" target="_blank" rel="noopener"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.56 8.25l-1.86 8.76c-.14.62-.5.77-1.02.48l-2.82-2.08-1.36 1.31c-.15.15-.28.28-.57.28l.2-2.89 5.27-4.76c.23-.2-.05-.32-.35-.12l-6.51 4.1-2.8-.88c-.61-.19-.62-.61.13-.9l10.95-4.22c.5-.18.95.12.79.85z"/></svg>Telegram</a>
    ...
    <div class="tldr">Формы РКМ утверждены <b>приложением № 5 к приказу ФАС России от 16.12.2022 № 995/22</b> (ред. от 18.12.2025) и называются в нём «формами обосновывающих документов». В приложении около тридцати форм — от протокола согласования цены (ф. № 1) до расчёта трудоёмкости (ф. № 23); большинство существует парой: базовая форма и форма с индексом «д». Ниже — полный перечень с официальными названиями и назначением каждой формы, а также разбивка по трём ситуациям: заключение контракта, перевод ориентировочной цены в фиксированную и закрытие контракта.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></div>

    <section class="keyfacts grain" aria-label="Ключевые факты">
      <h2>Коротко о главном</h2>
      <div class="keyfacts__grid">
        <div class="kf"><div class="kf__n">Прил. № 5</div><div class="kf__t"><b>Где искать формы</b> — приложение № 5 к приказу ФАС № 995/22, остальные приложения заполняет не исполнитель</div></div>
        <div class="kf"><div class="kf__n">Ф. 1 — Ф. 23</div><div class="kf__t"><b>Диапазон номеров</b> — от протокола согласования цены до расчёта трудоёмкости</div></div>
        <div class="kf"><div class="kf__n">Индекс «д»</div><div class="kf__t"><b>Парные формы</b> — базовая заполняется на год, форма с «д» — на несколько лет</div></div>
        <div class="kf"><div class="kf__n">CD-R</div><div class="kf__t"><b>Носитель</b> — бумага плюс электронный вид на оптическом носителе (п. 2 приказа)</div></div>
        <div class="kf"><div class="kf__n">№ 1138/19</div><div class="kf__t"><b>Старые формы</b> — приказ 2019 года утратил силу, комплекты по нему не принимаются</div></div>
        <div class="kf"><div class="kf__n">от метода</div><div class="kf__t"><b>Состав комплекта</b> определяется видом цены и методом её определения по ПП № 1465</div></div>
      </div>
    </section>
    <!-- svc-cta:top -->
    ...
    <h2 id="gde">Где утверждены формы и какие из них ваши</h2>
    <div class="answer reveal">
      <p class="lead-p">Приказ ФАС России № 995/22 утверждает семь приложений, но <b>формы РКМ, которые заполняет исполнитель, — это приложение № 5</b>. Остальные шесть приложений — служебные формы контура заказчика: запросы о представлении предложений о цене (приложения № 1, 2, 6, 7) и заключения о прогнозной цене, которые готовят отраслевой орган и сама ФАС (приложения № 3 и 4).<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></p>
    </div>
    <p>Практический вывод простой: когда заказчик или военное представительство просит «формы по 995/22», речь почти всегда идёт о приложении № 5. Если вам прислали для заполнения форму из приложения № 3 — это ошибка адресата, такие заключения предприятие не готовит.</p>
    <h3 id="deystvie-prikaza-995">С какой даты действует приказ и что он заменил</h3>
    <p>Приказ действует с 10 января 2023 года и заменил приказ ФАС России от 26 августа 2019 г. № 1138/19, который признан утратившим силу пунктом 3 приказа № 995/22.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a> Это первое, что стоит проверить в скачанном из интернета шаблоне: формы 1138/19 внешне похожи, но не содержат разделения себестоимости на привнесённые и собственные затраты и по действующим правилам не принимаются. Общая логика комплекта, правовая база и порядок защиты цены разобраны в базовой статье о <a href="/baza-znaniy/rkm-po-gosoboronzakazu/">расчётно-калькуляционных материалах по гособоронзаказу</a>.</p>

    <h2 id="perechen">Полный перечень форм приложения № 5</h2>
    <p>Ниже — все формы обосновывающих документов в том виде, в каком они названы в приказе (редакция от 18.12.2025). Формы сгруппированы по смыслу, внутри групп сохранена нумерация приказа. Колонка «Когда применяется» описывает практическое основание для включения формы в комплект — окончательный перечень всегда определяется методом определения цены и текстом запроса заказчика или ВП.</p>

    <h3 id="formy-cena-kalkulyaciya">Формы согласования цены и калькуляции</h3>
    <table>
      <caption>Согласование цены и калькуляции</caption>
      <tr><th>Форма</th><th>Название по приложению № 5</th><th>Когда применяется</th></tr>
      <tr><td>№ 1 (1д)</td><td>Протокол (Согласование) цены (прогнозной цены) единицы продукции и выбора вида цены</td><td>Итоговый документ согласования: фиксирует цену единицы продукции и выбранный вид цены</td></tr>
      <tr><td>№ 2</td><td>Плановая калькуляция затрат</td><td>Базовая форма комплекта при затратном методе: ожидаемая себестоимость и цена на один год</td></tr>
      <tr><td>№ 2А (2Ад)</td><td>Плановая калькуляция затрат на продукцию и отчётная калькуляция затрат на аналог</td><td>При формировании цены с использованием аналогового подхода — вместо обычной формы № 2</td></tr>
      <tr><td>№ 2д</td><td>Плановая калькуляция затрат</td><td>Та же калькуляция, но на период из нескольких лет («на ____ гг.» в шапке формы)</td></tr>
      <tr><td>№ 3 (3д)</td><td>Отчётная калькуляция затрат</td><td>Фактические затраты по ранее исполненному контракту; если продукция ранее не поставлялась — не представляется</td></tr>
    </table>

    <h3 id="formy-materialnye-zatraty">Формы по материальным затратам и работам сторонних организаций</h3>
    <table>
      <caption>Материальные затраты и работы сторонних организаций</caption>
      <tr><th>Форма</th><th>Название по приложению № 5</th><th>Когда применяется</th></tr>
      <tr><td>№ 4 / № 4д</td><td>Расшифровка затрат на приобретение сырья, материалов и вспомогательных материалов</td><td>Всегда, когда в калькуляции заполнена строка 0101</td></tr>
      <tr><td>№ 5 / № 5д</td><td>Расшифровка затрат на приобретение полуфабрикатов</td><td>При наличии покупных полуфабрикатов — строка 0102</td></tr>
      <tr><td>№ 6 / № 6д</td><td>Расшифровка затрат на приобретение комплектующих изделий</td><td>При наличии ПКИ — строка 0104; самая объёмная расшифровка в большинстве комплектов</td></tr>
      <tr><td>№ 7 / № 7д</td><td>Расшифровка затрат на оплату работ и услуг сторонних организаций производственного характера</td><td>Кооперация производственного характера — строка 0105</td></tr>
      <tr><td>№ 7.1 / № 7.1д</td><td>Расшифровка затрат по работам (услугам), выполняемым (оказываемым) сторонними организациями</td><td>Работы и услуги сторонних организаций, отражаемые по строке 1200</td></tr>
      <tr><td>№ 7 (7д) НИР (ОКР)</td><td>Расшифровка затрат по работам (услугам), выполняемым (оказываемым) сторонними организациями</td><td>Отдельная версия формы для научно-исследовательских и опытно-конструкторских работ</td></tr>
      <tr><td>№ 8 (8д)</td><td>Расчёт-обоснование норматива транспортно-заготовительных затрат</td><td>Если ТЗЗ считаются по нормативу — строка 0106</td></tr>
    </table>

    <h3 id="formy-oplata-truda">Формы по оплате труда</h3>
    <table>
      <caption>Оплата труда</caption>
      <tr><th>Форма</th><th>Название по приложению № 5</th><th>Когда применяется</th></tr>
      <tr><td>№ 9 / № 9д</td><td>Расшифровка затрат на основную заработную плату</td><td>Всегда при затратном методе — строка 0201</td></tr>
      <tr><td>№ 9 (9д) НИР (ОКР)</td><td>Расшифровка основной заработной платы</td><td>Версия для НИР и ОКР</td></tr>
      <tr><td>№ 10 (10д)</td><td>Расчёт-обоснование уровня (%) дополнительной заработной платы основных работников по ГОЗ</td><td>Обоснование норматива по строке 0202; форма содержит структуру дополнительной заработной платы</td></tr>
      <tr><td>№ 23 / № 23д</td><td>Расчёт (обоснование) трудоёмкости</td><td>Основа зарплатных форм: нормо-часы по видам работ</td></tr>
    </table>

    <h3 id="formy-nakladnye">Формы накладных, коммерческих и специальных затрат</h3>
    <table>
      <caption>Накладные, коммерческие и специальные затраты</caption>
      <tr><th>Форма</th><th>Название по приложению № 5</th><th>Когда применяется</th></tr>
      <tr><td>№ 11 / № 11д</td><td>Смета и расчёт общепроизводственных затрат</td><td>Обоснование норматива по строке 0800</td></tr>
      <tr><td>№ 12 / № 12д</td><td>Смета и расчёт общехозяйственных затрат / административно-управленческих расходов</td><td>Обоснование строк 0900 и 1600; распределение между ними зависит от учётной политики</td></tr>
      <tr><td>№ 13 / № 13д</td><td>Смета и расчёт коммерческих (внепроизводственных) затрат</td><td>Обоснование строки 1400</td></tr>
      <tr><td>№ 14 / № 14д</td><td>Расшифровка специальных затрат</td><td>При наличии специальных затрат — строка 0700</td></tr>
      <tr><td>№ 14.1 (14.1д)</td><td>Расчёт затрат на испытания</td><td>Когда в составе цены есть затраты на испытания продукции</td></tr>
      <tr><td>№ 15 (15д) НИР (ОКР)</td><td>Расшифровка затрат на специальное оборудование для научных (экспериментальных) работ</td><td>НИР и ОКР — строка 0600</td></tr>
      <tr><td>№ 15.1 (15.1д) НИР (ОКР)</td><td>Расшифровка затрат на изготовление специального оборудования собственными силами</td><td>НИР и ОКР, если спецоборудование изготавливается самим исполнителем</td></tr>
      <tr><td>№ 16 / № 16д</td><td>Расшифровка затрат на специальную технологическую оснастку</td><td>Строка 0500</td></tr>
      <tr><td>№ 17 (17д)</td><td>Расшифровка затрат на подготовку и освоение производства</td><td>Строка 0400: пусковые затраты и освоение новых видов продукции</td></tr>
      <tr><td>№ 18 (18д)</td><td>Расшифровка прочих прямых затрат</td><td>Строка 1100</td></tr>
      <tr><td>№ 19 (19д)</td><td>Расчёт затрат на командировки</td><td>Строка 1000</td></tr>
    </table>

    <h3 id="formy-pribyl">Формы прибыли и сведений об организации</h3>
    <table>
      <caption>Прибыль и сведения об организации</caption>
      <tr><th>Форма</th><th>Название по приложению № 5</th><th>Когда применяется</th></tr>
      <tr><td>№ 20 (20д)</td><td>Расчёт и обоснование прибыли</td><td>Всегда, когда прибыль включается в цену; состоит из двух таблиц</td></tr>
      <tr><td>№ 21</td><td>Сведения об объёмах поставки продукции, в том числе по государственному оборонному заказу, включая экспортные поставки</td><td>Общие сведения о предприятии, а не о конкретном изделии</td></tr>
      <tr><td>№ 21д</td><td>Сведения об объёмах поставки, в том числе по государственному оборонному заказу, включая экспортные поставки</td><td>Многолетняя версия формы № 21</td></tr>
      <tr><td>№ 22 (22д)</td><td>Сведения о нормативах и экономических показателях организации, используемых при определении цены продукции</td><td>Свод применяемых нормативов: связывает калькуляцию с учётной политикой</td></tr>
    </table>

    <h3 id="net-obyazatelnogo-spiska">Обязательного списка форм в приказе нет</h3>
    <div class="note"><b>Точный перечень — всегда за запросом.</b> Приказ не содержит универсального списка «обязательных» форм: состав комплекта определяется видом цены и методом её определения по Положению № 1465, а также тем, какие сведения запросил заказчик или военное представительство. Логику выбора метода и глубины комплекта мы разобрали в статье о <a href="/baza-znaniy/rkm-po-gosoboronzakazu/">составе и заполнении РКМ</a>.</div>

    <h2 id="ne-vashi">Формы, которые заполняет не исполнитель</h2>
    <p>Чтобы не тратить время на чужие бланки, держите в голове, что делают остальные приложения приказа.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></p>
    <h3 id="prilozheniya-zakazchika">Приложения № 1–4, 6 и 7: чьи это бланки</h3>
    <table>
      <caption>Приложения № 1–4, 6, 7: контур заказчика и регулятора</caption>
      <tr><th>Приложение</th><th>Что это</th><th>Кто готовит</th></tr>
      <tr><td>№ 1</td><td>Запрос о представлении предложений о прогнозной цене на продукцию</td><td>Государственный заказчик</td></tr>
      <tr><td>№ 2</td><td>Запрос о представлении предложений о прогнозной цене на продукцию</td><td>Отраслевой орган</td></tr>
      <tr><td>№ 3</td><td>Заключение о прогнозной цене на продукцию</td><td>Отраслевой орган</td></tr>
      <tr><td>№ 4</td><td>Заключение о прогнозной цене единицы продукции</td><td>Федеральная антимонопольная служба</td></tr>
      <tr><td>№ 6</td><td>Запрос о цене на продукцию, удовлетворяющую требованиям государственного заказчика</td><td>Государственный заказчик</td></tr>
      <tr><td>№ 7</td><td>Запрос о цене единицы продукции</td><td>Государственный заказчик</td></tr>
    </table>
    <h3 id="zachem-zaklyuchenie">Зачем нужно заключение о прогнозной цене</h3>
    <p>Заключение о прогнозной цене — это то, ради чего вы и собираете комплект: в нём проверяющая сторона по пунктам отвечает, приняты ли ваши затраты и обоснована ли прибыль. Кто именно выдаёт заключение по вашей продукции и что происходит после него — в разборе роли <a href="/baza-znaniy/voennoe-predstavitelstvo-minoborony/">военного представительства Минобороны</a>.</p>

    <h2 id="indeks-d">Формы без индекса и формы с индексом «д»</h2>
    <p>Почти каждая форма приложения № 5 существует в паре: базовая и с индексом «д» — например, № 4 и № 4д, № 11 и № 11д. Разница видна прямо в шапке бланка: в базовой форме период указывается как «на ____ г.», в форме с индексом «д» — как «на ________ гг.». То есть парная форма рассчитана на период, охватывающий несколько лет.</p>
    <h3 id="godovoy-ili-mnogoletniy">Когда берут годовой бланк, а когда многолетний</h3>
    <p>Есть и правило перехода между парой: сноска к форме № 2д прямо указывает, что при проведении процедуры перевода в фиксированную цену других видов цен плановая калькуляция представляется по форме № 2.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a> Практический смысл: не тащите многолетний бланк в процедуру, где нужен годовой, и наоборот — это одна из самых механических и потому самых обидных причин возврата комплекта.</p>
    <h3 id="formy-nir-okr">Формы для НИР и ОКР</h3>
    <p>Отдельная линейка — формы с пометкой «НИР (ОКР)»: № 7 (7д), № 9 (9д), № 15 (15д), № 15.1 (15.1д). Они применяются при определении цены на научно-техническую продукцию и учитывают этапность работ: информация представляется на каждый этап (подэтап), в отношении которого формируется стоимостный показатель.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></p>

    <h2 id="vashi">Какие формы нужны именно вам: три ситуации</h2>
    <p>Один и тот же контракт требует разных комплектов на разных стадиях. Ниже — рабочая разбивка, от которой удобно отталкиваться до получения формального запроса.</p>

    <h3>Ситуация 1. Заключение контракта, формирование цены</h3>
    <p>Ядро комплекта — плановая калькуляция (форма № 2 или № 2д, а при аналоговом подходе — № 2А), под неё подкладываются расшифровки по всем заполненным строкам: материалы (№ 4), полуфабрикаты (№ 5), ПКИ (№ 6), кооперация (№ 7 и № 7.1), ТЗЗ (№ 8), трудоёмкость (№ 23) и зарплата (№ 9, № 10), накладные (№ 11, № 12), коммерческие (№ 13). Завершают комплект расчёт прибыли (№ 20) и сведения о нормативах организации (№ 22). Отчётная калькуляция на этой стадии представляется, только если такая продукция ранее уже поставлялась.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a> Какой вид цены вы вообще вправе предложить — разобрано в статье о <a href="/baza-znaniy/vidy-cen-goz/">видах цен на продукцию ГОЗ</a>.</p>

    <h3>Ситуация 2. Перевод ориентировочной цены в фиксированную</h3>
    <p>Здесь центр тяжести смещается на факт: нужна отчётная калькуляция (форма № 3) и уточнённая плановая — причём именно по форме № 2, как указано в сноске к форме № 2д. Расшифровки пересобираются по фактическим данным раздельного учёта, а прибыль пересчитывается от новой структуры затрат в форме № 20. Сроки и порядок самой процедуры — в разборе <a href="/baza-znaniy/perevod-orientirovochnoy-ceny-v-fiksirovannuyu-goz/">перевода ориентировочной цены в фиксированную</a>.</p>

    <h3>Ситуация 3. Закрытие контракта и отчётность</h3>
    <p>На закрытии главным документом становится отчётная калькуляция (форма № 3) с колонками «План» и «Факт»: она показывает, во что производство обошлось на самом деле. Расхождения по каждой существенной строке объясняются в пояснительной записке и подтверждаются регистрами раздельного учёта. Чем плановая калькуляция отличается от отчётной по составу колонок и подписантов — в отдельном разборе <a href="/baza-znaniy/planovaya-i-otchetnaya-kalkulyaciya-goz/">плановой и отчётной калькуляции по ГОЗ</a>.</p>

    <div class="rkm-cta">
      <p class="rkm-cta__k">Услуга</p>
      <p class="rkm-cta__t">Соберём комплект форм под ваш контракт</p>
      <p class="rkm-cta__p">Определим перечень форм по методу определения цены и стадии контракта, заполним их, обоснуем затраты и прибыль, ответим на замечания ВП МО. Фиксированные 105 000 ₽ за комплект по одному контракту — цена не меняется после того, как мы увидим документы.</p>
      <div class="rkm-cta__act"><a class="rkm-cta__b rkm-cta__b--p" href="/uslugi/sostavlenie-rkm/">Составление РКМ под ключ</a><a class="rkm-cta__b rkm-cta__b--s" href="/baza-znaniy/obrazec-zapolneniya-rkm/">Посмотреть образец заполнения</a></div>
    </div>

    <h2 id="odnazhdy">Формы, которые представляются один раз</h2>
    <p>Не все формы приложения № 5 относятся к конкретному изделию. Часть из них описывает предприятие целиком — и приказ прямо разрешает не дублировать их по каждому этапу. Сноска к форме № 2 относит к «формам, содержащим информацию о финансово-хозяйственной деятельности организации в целом», формы <b>№ 8 (8д), № 10 (10д), № 11 (11д), № 12 (12д), № 13 (13д), № 21, № 21д, № 22 (22д), № 23, № 23д</b>: если этапы НИР (ОКР) выполняются в одном году, такие формы представляются единожды в составе соответствующего предложения о цене.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></p>
    <h3 id="razovaya-podacha">Что даёт разовая подача общезаводских форм</h3>
    <p>На практике это экономит десятки страниц и снимает частую претензию проверяющих — расхождение нормативов между этапами. Если смета общепроизводственных затрат подаётся один раз, норматив по всем этапам физически не может разъехаться.</p>

    <h2 id="podpisi">Кто подписывает формы</h2>
    <p>Подписные блоки в приказе различаются, и это не формальность: по подписи видно, кто отвечает за цифры.</p>
    <h3 id="podpisi-v-formah">Кто подписывает формы № 2, № 2д и № 3</h3>
    <table>
      <caption>Подписи в ключевых формах приложения № 5</caption>
      <tr><th>Форма</th><th>Кто подписывает по бланку</th></tr>
      <tr><td>№ 2 (плановая калькуляция)</td><td>Руководитель экономической службы государственного заказчика (заказчика) и руководитель экономической службы организации-поставщика (подрядчика, исполнителя)</td></tr>
      <tr><td>№ 2д (плановая калькуляция на несколько лет)</td><td>Тот же состав подписей, что и в форме № 2</td></tr>
      <tr><td>№ 3 (3д) (отчётная калькуляция)</td><td>Военный представитель, главный бухгалтер организации-поставщика (при наличии) и руководитель экономической службы организации-поставщика; М. П. — при наличии печати</td></tr>
    </table>
    <h3 id="pochemu-glavbuh">Почему отчётную калькуляцию подписывает главный бухгалтер</h3>
    <p>Разница показательна: плановую калькуляцию визируют экономисты двух сторон, а отчётную — ещё и военный представитель с главным бухгалтером. Отчётная калькуляция ближе к бухгалтерскому факту, и подпись главбуха означает, что цифры сверены с учётом. Если раздельный учёт по контракту не поставлен, подписывать эту форму просто нечем — начинать придётся с <a href="/baza-znaniy/razdelnyy-uchet-goz-275-fz/">раздельного учёта по ГОЗ</a>.</p>

    <h2 id="kak-sdavat">В каком виде сдаётся комплект</h2>
    <p>Пункт 2 приказа № 995/22 отвечает на этот вопрос прямо: документы, указанные в приложении № 5, представляются <b>на бумажном носителе и в электронном виде — в форматах электронных копий и таблиц</b>.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a> Само требование к носителю задано пунктом 76 Положения № 1465,<a class="fn" href="#ref-2" aria-label="Источник 2">[2]</a> и в феврале 2026 года его переписали: вместо «оптических носителей (CD-R)» в тексте теперь «съёмные оптические машинные носители информации с функцией однократной записи».<a class="fn" href="#ref-4" aria-label="Источник 4">[4]</a></p>
    <h3 id="nositel-2026">Какой диск подойдёт после февраля 2026 года</h3>
    <p>Ключевое условие — однократная запись. Ему отвечает CD-R и другой оптический диск с такой функцией; перезаписываемый диск и флешка — нет. Бумажный экземпляр обязателен по-прежнему, электронная версия его не заменяет.</p>
    <p>Формулировка «в форматах электронных копий и таблиц» означает две сущности на одном диске: скан подписанного комплекта и живые таблицы с формулами. Вторая часть — не прихоть: проверяющий пересчитывает итоги, и таблица со «вбитыми руками» числами вместо формул вызывает вопросы быстрее, чем любая другая ошибка. Планируйте наличие пишущего привода и болванок заранее — на практике это регулярно всплывает в последний день.</p>

    <h2 id="nepolnyy-komplekt">Если в комплекте не хватает одной формы</h2>
    <p>Пункт 109 Положения № 1465 после изменений февраля 2026 года отвечает на это жёстко: предложение о цене с неполным объёмом запрошенной информации считается непредставленным.<a class="fn" href="#ref-4" aria-label="Источник 4">[4]</a> То есть недостающая расшифровка — это не замечание к комплекту, а отсутствие самого предложения.</p>
    <p>Отсюда порядок работы с перечнем форм: сначала фиксируем письменно, какие формы запросил заказчик или военное представительство, потом собираем их все, и только затем спорим о содержании отдельных бланков.</p>
    <table>
      <caption>Как читается неполный комплект</caption>
      <tr><th>Что произошло</th><th>Как это квалифицируется</th><th>Что с этим делать</th></tr>
      <tr><td>Нет одной формы из запрошенного состава</td><td>Предложение о цене считается непредставленным</td><td>Досылать не «дополнение», а комплект целиком, с новой описью</td></tr>
      <tr><td>Форма есть, но заполнена не полностью</td><td>Спор о содержании: замечание, доработка</td><td>Отработать замечание и подтвердить цифру источником</td></tr>
      <tr><td>Взят бланк прошлой редакции</td><td>Форма не соответствует приказу</td><td>Перенести данные в действующий бланк редакции 2026 года</td></tr>
    </table>

    <h2 id="vedomstvennyy-perechen">Ведомственный перечень поверх приложения № 5</h2>
    <p>Формы приложения № 5 — общая рамка. Подпункт «м» пункта 37 Положения № 1465 разрешает государственному заказчику запросить иные документы, и ведомства оформляют это отдельными перечнями с требованиями к содержанию.</p>
    <p>Пример — приказ ФСБ России от 08.04.2026 № 136: перечень документов к предложению о цене дифференцирован по методам определения цены, и для затратного метода состав шире, чем для сравнимой цены или индексных методов.<a class="fn" href="#ref-5" aria-label="Источник 5">[5]</a> Такой перечень применяется вместе с формами приложения № 5, а не вместо них, поэтому вопрос «есть ли по нашему контракту ведомственный перечень» задают до сбора комплекта, а не после возврата.</p>

    <h2 id="oshibki">Типовые ошибки по ключевым формам</h2>
    <p>Ниже — ошибки, которые чаще всего приводят к возврату комплекта. Перечень основан на практике сопровождения контрактов ГОЗ и на требованиях самих бланков.</p>
    <h3 id="oshibki-po-formam">Ошибки в калькуляциях, расшифровках и прибыли</h3>
    <table>
      <caption>Где комплект ломается чаще всего</caption>
      <tr><th>Форма</th><th>Типовая ошибка</th><th>Как правильно</th></tr>
      <tr><td>№ 2</td><td>Себестоимость (строка 1700) не раскрыта на привнесённые и собственные затраты</td><td>Заполнить обе подстроки: от их соотношения считается предельная прибыль в форме № 20</td></tr>
      <tr><td>№ 2 / № 2д</td><td>Взят бланк не того периода: годовой вместо многолетнего или наоборот</td><td>Сверить шапку формы («на ____ г.» или «на ____ гг.») с периодом, который вы обосновываете</td></tr>
      <tr><td>№ 2А (2Ад)</td><td>При аналоговом подходе подаётся обычная форма № 2</td><td>Использовать форму № 2А: она объединяет плановую калькуляцию на продукцию и отчётную на аналог</td></tr>
      <tr><td>№ 3 (3д)</td><td>Отчётная калькуляция подаётся при первой поставке, когда продукция ранее не поставлялась</td><td>По сноске к форме отчётная калькуляция в этом случае не представляется</td></tr>
      <tr><td>№ 4–№ 7</td><td>Итоги расшифровок не сходятся со строками 0101–0105 калькуляции</td><td>Сквозная сверка: каждая строка калькуляции равна итогу своей расшифровки до рубля</td></tr>
      <tr><td>№ 6</td><td>Цены ПКИ соисполнителей не обоснованы их собственными РКМ</td><td>Запросить обосновывающие документы у соисполнителей заранее — по всей <a href="/baza-znaniy/soispolniteli-kooperaciya-goz/">цепочке кооперации</a></td></tr>
      <tr><td>№ 9, № 23</td><td>Трудоёмкость в форме № 23 не бьётся с расчётом основной заработной платы</td><td>Строить зарплату от нормо-часов формы № 23, а не подгонять её под желаемую сумму</td></tr>
      <tr><td>№ 11, № 12</td><td>Нормативы накладных расходов заявлены без сметы и без опоры на учётную политику</td><td>Обосновать нормативы сметами и закрепить методику в <a href="/baza-znaniy/uchetnaya-politika-razdelnyy-uchet-goz/">учётной политике</a></td></tr>
      <tr><td>№ 20</td><td>Прибыль заявлена «общим процентом» от себестоимости</td><td>Считать по базе: не более 1 % привнесённых плюс не более 25 % собственных затрат — см. <a href="/baza-znaniy/normy-pribyli-goz/">нормы прибыли по ГОЗ</a></td></tr>
      <tr><td>№ 22</td><td>Нормативы в форме расходятся с теми, что применены в калькуляции</td><td>Заполнять форму № 22 последней — как свод фактически применённых нормативов</td></tr>
    </table>

    <div class="takeaways">
      <h2>Что важно запомнить</h2>
      <ol>
        <li>Формы РКМ исполнителя — это приложение № 5 к приказу ФАС № 995/22; приложения № 1–4, 6 и 7 заполняет не предприятие.</li>
        <li>Большинство форм парные: базовая — на один год, форма с индексом «д» — на несколько лет.</li>
        <li>Формы № 8, 10, 11, 12, 13, 21, 22, 23 описывают предприятие в целом и при этапах в одном году подаются единожды.</li>
        <li>Отчётная калькуляция не представляется, если такая продукция ранее не поставлялась.</li>
        <li>Комплект сдаётся на бумаге и на оптическом носителе — копиями и живыми таблицами.</li>
        <li>Формы приказа № 1138/19 недействительны: он утратил силу с введением № 995/22.</li>
      </ol>
    </div>

    <h2 id="faq">Частые вопросы</h2>
    <div class="faq"><details open><summary>Сколько всего форм в приказе № 995/22?</summary><p>Приказ утверждает семь приложений. Формы, которые заполняет исполнитель, собраны в приложении № 5 — это около тридцати форм с номерами от № 1 до № 23, причём большинство существует парой: базовая форма и форма с индексом «д». Приложения № 1–4, № 6 и № 7 — запросы и заключения, их готовят заказчик, отраслевой орган и ФАС.</p></details>
<details><summary>Что означает индекс «д» в номере формы?</summary><p>Формы с индексом «д» отличаются периодом обоснования: в шапке базовой формы стоит «на ____ г.», в парной — «на ________ гг.», то есть период охватывает несколько лет. Сноска к форме № 2д дополнительно уточняет, что при переводе других видов цен в фиксированную плановая калькуляция представляется по форме № 2.</p></details>
<details><summary>Какие формы обязательны в любом комплекте?</summary><p>Универсального обязательного списка приказ не содержит. Состав определяется видом цены и методом её определения по Положению № 1465, а также запросом заказчика или военного представительства. При затратном методе костяк — плановая калькуляция (ф. № 2), расшифровки материальных затрат (ф. № 4–7), трудоёмкость (ф. № 23), зарплатные формы (ф. № 9, 10), накладные (ф. № 11, 12), прибыль (ф. № 20) и сведения о нормативах (ф. № 22).</p></details>
<details><summary>Нужно ли подавать отчётную калькуляцию при первой поставке?</summary><p>Нет. По сноске к форме № 3 отчётная калькуляция представляется по последнему отчётному периоду исполненного контракта, если продукция ранее поставлялась. При отсутствии поставки ранее отчётная калькуляция не представляется.</p></details>
<details><summary>Можно ли сдать комплект только в электронном виде?</summary><p>Нет. Пункт 2 приказа № 995/22 требует представлять документы приложения № 5 на бумажном носителе и в электронном виде — в форматах электронных копий и таблиц. Требование к носителю задано пунктом 76 Положения № 1465: после изменений от 14.02.2026 это съёмные оптические машинные носители информации с функцией однократной записи. Конкретный порядок передачи уточняйте у заказчика или военного представительства.</p></details>
<details><summary>Действуют ли ещё формы приказа ФАС № 1138/19?</summary><p>Нет. Приказ ФАС России от 26.08.2019 № 1138/19 признан утратившим силу пунктом 3 приказа № 995/22. Комплекты, собранные по старым бланкам, возвращают: в них нет разделения себестоимости на привнесённые и собственные затраты.</p></details>
<details><summary>Какие формы можно подать один раз, а не по каждому этапу?</summary><p>Сноска к форме № 2 относит к формам, содержащим информацию о финансово-хозяйственной деятельности организации в целом, формы № 8 (8д), № 10 (10д), № 11 (11д), № 12 (12д), № 13 (13д), № 21, № 21д, № 22 (22д), № 23 и № 23д. Если этапы НИР (ОКР) выполняются в одном году, они представляются единожды в составе соответствующего предложения о цене.</p></details>
<details><summary>Что будет, если в комплекте не хватает одной формы?</summary><p>Предложение о цене будет считаться непредставленным: пункт 109 Положения № 1465 в редакции постановления Правительства РФ от 14.02.2026 № 138 приравнивает неполный объём запрошенной информации к неподаче. Срок представления при этом считается несоблюдённым.</p></details>
<details><summary>Нужны ли документы сверх форм приложения № 5?</summary><p>Часто да. Подпункт «м» пункта 37 Положения № 1465 позволяет государственному заказчику запросить иные документы, а ведомства утверждают собственные перечни — например, приказ ФСБ России от 08.04.2026 № 136. Ведомственный перечень применяется вместе с формами приложения № 5.</p></details></div>
...
<div class="refs">
      ...
      <ol>
        ...
        <li id="ref-3">Приказ Минпромторга России от 08.02.2019 № 334 «Об утверждении порядка определения состава затрат, включаемых в цену продукции, поставляемой в рамках государственного оборонного заказа» (ред. от 26.11.2025) — <a href="http://publication.pravo.gov.ru/Document/View/0001201904190019" target="_blank" rel="noopener">pravo.gov.ru</a>, <a href="https://www.consultant.ru/document/cons_doc_LAW_322968/" target="_blank" rel="noopener">consultant.ru</a></li>
        <li id="ref-4">Постановление Правительства РФ от 14.02.2026 № 138 «О внесении изменений в постановление Правительства Российской Федерации от 2 декабря 2017 г. № 1465» — <a href="http://publication.pravo.gov.ru/document/0001202602140002" target="_blank" rel="noopener">publication.pravo.gov.ru</a></li>
        <li id="ref-5">Приказ ФСБ России от 08.04.2026 № 136 «Об утверждении Перечня документов, представляемых в ФСБ России в составе обосновывающих документов при направлении предложений о цене (прогнозной цене) на продукцию, поставляемую по государственному оборонному заказу…» — <a href="http://publication.pravo.gov.ru/document/0001202605180005" target="_blank" rel="noopener">publication.pravo.gov.ru</a></li>
      </ol>
      <p class="refs__note">Материал актуален на 8 сентября 2026 года. Названия форм приведены по редакции приказа № 995/22 от 18.12.2025. Состав комплекта по конкретному контракту определяется запросом заказчика (ВП) и действующими редакциями ПП № 1465 и приказов № 995/22 и № 334 — сверяйте редакции на дату подачи.</p>
    </div>
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="formy-rkm-995-22">
      <div class="railform__badge">Разбор эксперта</div>
      <h3 class="railform__title">Не сходится перечень форм?</h3>
      <p class="railform__sub">Определим состав комплекта под ваш метод определения цены и стадию контракта, заполним формы приложения № 5 и обоснуем каждую строку.</p>
...
<section class="related" aria-labelledby="relTitle">
  ...
  <div class="related__grid">
    ...
    <a class="card reveal" href="/baza-znaniy/obrazec-zapolneniya-rkm/"><div class="card__cover"><span>Образец</span></div><div class="card__body"><span class="card__cat">База знаний</span><h3 class="card__title">Образец заполнения РКМ: разбор комплекта по шагам</h3><div class="card__meta">Гособоронзаказ · 13 мин</div></div></a>
    ...
    <a class="card reveal" href="/baza-znaniy/vidy-cen-goz/"><div class="card__cover"><span>Цены</span></div><div class="card__body"><span class="card__cat">База знаний</span><h3 class="card__title">Виды цен на продукцию ГОЗ: ориентировочная и фиксированная</h3><div class="card__meta">Гособоронзаказ · 15 мин</div></div></a>
  </div>
</section>
...
<section class="kz-sub" aria-labelledby="kzSubTitle" data-source="formy-rkm-995-22">
  <style>

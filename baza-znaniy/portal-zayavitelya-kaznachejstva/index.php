...
<meta name="description" content="fzs.roskazna.ru — портал заявителя УЦ Казначейства: как открыть в ГОСТ-браузере, подать первичный запрос без подписи, войти по сертификату и проверить статус.">
...
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "В портале заявителя нет распоряжений — где их создавать?", "acceptedAnswer": {"@type": "Answer", "text": "Распоряжения о совершении казначейского платежа создают не в портале заявителя (ФЗС), а в личном кабинете ГИИС «Электронный бюджет», в модуле казначейского сопровождения. ФЗС нужен для получения сертификата, а распоряжения формируют в «Электронном бюджете» — см. разбор распоряжения ."}}, {"@type": "Question", "name": "Что такое портал заявителя ФЗС?", "acceptedAnswer": {"@type": "Answer", "text": "Онлайн-сервис удостоверяющего центра Федерального казначейства (fzs.roskazna.ru) для подачи документов на квалифицированный сертификат электронной подписи и отслеживания статуса запроса."}}, {"@type": "Question", "name": "Можно ли получить сертификат полностью дистанционно?", "acceptedAnswer": {"@type": "Answer", "text": "Замену при действующем сертификате — да, полностью онлайн. Первичное получение требует одного визита в ТОФК: оператор обязан удостоверить личность владельца сертификата."}}, {"@type": "Question", "name": "Сколько изготавливается сертификат?", "acceptedAnswer": {"@type": "Answer", "text": "До 5 рабочих дней с момента представления полного и корректного комплекта документов. Возврат на доработку обнуляет ожидание, поэтому комплект стоит проверять по чек-листу до отправки."}}, {"@type": "Question", "name": "Почему ФЗС не открывается в обычном браузере?", "acceptedAnswer": {"@type": "Answer", "text": "Портал работает по защищённому соединению ГОСТ TLS. Нужен браузер с поддержкой ГОСТ (Chromium-Gost), установленный КриптоПро CSP и КриптоПро ЭЦП Browser plug-in."}}, {"@type": "Question", "name": "Нужен ли договор с казначейством перед подачей запроса?", "acceptedAnswer": {"@type": "Answer", "text": "Да. Организация один раз заключает договор присоединения к Регламенту УЦ ФК со своим территориальным органом казначейства; без него запросы не принимаются."}}, {"@type": "Question", "name": "Чем подпись УЦ ФК отличается от подписи ФНС?", "acceptedAnswer": {"@type": "Answer", "text": "Подпись ФНС выдаётся на руководителя для общей хозяйственной деятельности и торговых площадок; «Электронный бюджет» её тоже принимает (письмо Казначейства России от 02.11.2023 № 07-04-05/11-32062). Подпись УЦ ФК выдаётся должностным лицам — каждому подписанту своя — и закрывает все системы казначейства, включая СУФД. Участнику сопровождения удобно иметь обе, но обязательного требования об этом нет."}}, {"@type": "Question", "name": "Какие документы готовить для первичного запроса?", "acceptedAnswer": {"@type": "Answer", "text": "Паспорт, СНИЛС и ИНН владельца сертификата, ИНН/ОГРН организации, документ о полномочиях (приказ или доверенность) и сертифицированный ключевой носитель."}}, {"@type": "Question", "name": "Кто в организации может быть владельцем сертификата?", "acceptedAnswer": {"@type": "Answer", "text": "Руководитель или сотрудник, чьи полномочия на работу в системах казначейства подтверждены приказом либо доверенностью. На каждого владельца оформляется отдельный сертификат."}}, {"@type": "Question", "name": "Что делать, если запрос вернули на доработку?", "acceptedAnswer": {"@type": "Answer", "text": "Открыть комментарий оператора в ФЗС, исправить ровно указанное замечание — чаще всего это расхождение ФИО/СНИЛС с реестрами или дефект доверенности — и отправить запрос повторно."}}, {"@type": "Question", "name": "За сколько дней подавать на замену сертификата?", "acceptedAnswer": {"@type": "Answer", "text": "За 3–4 недели до окончания срока действия. Тогда замена пройдёт дистанционно и без потери доступа к «Электронному бюджету» и СУФД."}}, {"@type": "Question", "name": "Можно ли подать запрос за владельца сертификата?", "acceptedAnswer": {"@type": "Answer", "text": "Заполнить запрос в ФЗС может уполномоченный сотрудник, но удостоверение личности при первичной выдаче проходит лично владелец, а заявление подписывается им или лицом с соответствующей доверенностью."}}, {"@type": "Question", "name": "Сертификат получен — почему «Электронный бюджет» его не видит?", "acceptedAnswer": {"@type": "Answer", "text": "Обычно не установлена цепочка корневых сертификатов УЦ или сертификат не привязан в личном кабинете системы. Начните с проверки корневых сертификатов и настроек АРМ."}}, {"@type": "Question", "name": "Есть ли у портала заявителя личный кабинет?", "acceptedAnswer": {"@type": "Answer", "text": "Да, но без логина и пароля: кабинет открывается по кнопке «Войти по сертификату» при действующей подписи УЦ ФК. В нём — «Мои запросы» со статусами, замена сертификата, согласование запросов сотрудников руководителем и скачивание выпущенного сертификата. Первичный запрос подаётся без входа в кабинет."}}, {"@type": "Question", "name": "Запрос сотрудника висит в статусе «ожидает согласования руководителем» — что делать?", "acceptedAnswer": {"@type": "Answer", "text": "Руководителю войти в ФЗС по своему сертификату, открыть «Запросы на согласование», проверить сведения и подписать согласование. Без этого запрос в УЦ ФК не уйдёт. Если у руководителя нет действующего сертификата УЦ ФК — сначала оформить его."}}]}</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#dostup">Адрес, регистрация и вход в кабинет</a></li>
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>15 мин чтения</span><span class="dot">·</span><span>Обновлено 18 сентября 2026</span></div>
    </div>
    ...
    <p>Для подрядчика по госконтракту ключевой случай — третий. Квалифицированную подпись для обычной хозяйственной деятельности руководитель компании получает в УЦ ФНС России; для работы с лицевым счётом в «Электронном бюджете» подходит и она (письмо Казначейства России от 02.11.2023 № 07-04-05/11-32062), и сертификаты удостоверяющего центра казначейства, которые исполнителям под сопровождением выдают по перечню постановления Правительства РФ № 1018 — подробный разбор различий есть в статье о <a href="/baza-znaniy/sertifikat-ecp-kaznachejstvo/">сертификате и ЭЦП казначейства</a>. Типичная связка исполнителя контракта: подпись ФНС для ЕГРЮЛ-деятельности плюс подписи УЦ ФК на сотрудников, которые ведут казначейские системы; обязательной вторая не является.</p>
    ...
    <h2 id="dostup">Адрес, регистрация и вход в личный кабинет ФЗС</h2>
    <div class="answer"><p>Официальный адрес портала заявителя — fzs.roskazna.ru. Логина и пароля у портала нет: первичный запрос подаётся без электронной подписи через кнопку «Подать документы», а личный кабинет со списком запросов открывается по кнопке «Войти по сертификату» — для замены сертификата, согласования запросов и скачивания выпущенной подписи.<a class="fn" href="#ref-6" aria-label="Источник 6">[6]</a></p></div>

    <h3 id="oficialnyy-adres">Официальный адрес: fzs.roskazna.ru</h3>
    <p>Ссылка на портал публикуется на официальном сайте Казначейства roskazna.gov.ru в разделе удостоверяющего центра — заходить лучше оттуда, чтобы не попасть на сторонние «зеркала». Проверить готовность рабочего места и браузера можно на arm-fzs.roskazna.gov.ru. Региональных адресов у портала нет: заявители всех субъектов работают через единый fzs.roskazna.ru, а управления Федерального казначейства участвуют как региональные центры регистрации, куда представляются документы.</p>

    <h3 id="registraciya">Есть ли регистрация на портале заявителя</h3>
    <p>Отдельной регистрации с учётной записью нет. То, что пользователи называют «регистрацией на портале заявителя», — это подготовка рабочего места (криптопровайдер, ГОСТ-браузер, корневые сертификаты), договор присоединения к Регламенту УЦ ФК и первый запрос на сертификат. Договор при этом можно оформить прямо в ходе подачи: если организация не найдена в системе УЦ, портал предлагает указать реквизиты уже заключённого договора либо скачать шаблон и представить подписанный экземпляр в ТОФК.</p>

    <h3 id="lichnyy-kabinet">Три входа со стартовой страницы: без сертификата и по сертификату</h3>
    <table>
      <caption>Блоки стартовой страницы ФЗС и что за ними стоит</caption>
      <thead><tr><th>Блок на fzs.roskazna.ru</th><th>Кнопка</th><th>Что открывается</th></tr></thead>
      <tbody>
        <tr><td>Отсутствует действующий сертификат</td><td>Подать документы</td><td>первичный запрос без подписи: регион и орган ФК, ОГРН/ИНН, код с картинки, формирование ключа и заявления</td></tr>
        <tr><td>Имеется действующий сертификат</td><td>Войти по сертификату</td><td>личный кабинет: «Мои запросы» со статусами, замена и дополнительный сертификат, «Запросы на согласование» у руководителя, «Скачать сертификат»</td></tr>
        <tr><td>Изменение статуса сертификата</td><td>Войти по сертификату</td><td>запрос на приостановление или прекращение действия своего сертификата (руководитель — и сертификатов сотрудников)</td></tr>
      </tbody>
    </table>
    <p>Запрос «портал заявителя УФК личный кабинет» описывает второй блок: кабинет привязан к сертификату, а не к региону — управления Федерального казначейства собственных кабинетов не ведут. Первичный запрос в кабинет не попадает: его статус приходит письмом на e-mail из заявления.</p>

    <h3 id="soglasovanie-rukovoditelem">Согласование запроса руководителем: почему запрос «зависает»</h3>
    <p>Если запрос на сертификат подаёт не руководитель, после успешной проверки в СМЭВ он получает статус «ожидает согласования руководителем». Руководитель — лицо, действующее без доверенности по ЕГРЮЛ, — входит в ФЗС по своему действующему сертификату, открывает вкладку «Запросы на согласование», проверяет сведения и подписывает согласование электронной подписью; только после этого запрос уходит на обработку в УЦ ФК. Полномочие согласовывать можно делегировать сотруднику — документ о делегировании представляется оператору регионального центра регистрации.</p>
    ...
    <table>
      ...
      <tr><td>Ожидает согласования руководителем</td><td>Запрос сотрудника прошёл СМЭВ, нужна подпись руководителя в ФЗС</td><td>Руководитель входит по сертификату → «Запросы на согласование» → согласовать и подписать</td></tr>
    ...
    <div class="faq">
      ...
      <details><summary>Чем подпись УЦ ФК отличается от подписи ФНС?</summary><p>Подпись ФНС выдаётся на руководителя для общей хозяйственной деятельности и торговых площадок; «Электронный бюджет» её тоже принимает (письмо Казначейства России от 02.11.2023 № 07-04-05/11-32062). Подпись УЦ ФК выдаётся должностным лицам — каждому подписанту своя — и закрывает все системы казначейства, включая СУФД. Участнику сопровождения удобно иметь обе, но обязательного требования об этом нет.</p></details>
      ...
      <details><summary>Есть ли у портала заявителя личный кабинет?</summary><p>Да, но без логина и пароля: кабинет открывается по кнопке «Войти по сертификату» при действующей подписи УЦ ФК. В нём — «Мои запросы» со статусами, замена сертификата, согласование запросов сотрудников руководителем и скачивание выпущенного сертификата. Первичный запрос подаётся без входа в кабинет.</p></details>
      <details><summary>Запрос сотрудника висит в статусе «ожидает согласования руководителем» — что делать?</summary><p>Руководителю войти в ФЗС по своему сертификату, открыть «Запросы на согласование», проверить сведения и подписать согласование. Без этого запрос в УЦ ФК не уйдёт. Если у руководителя нет действующего сертификата УЦ ФК — сначала оформить его.</p></details>
    </div>
...
<div class="refs">
      ...
      <ol>
        ...
        <li id="ref-6">Инструкция по работе на портале ФЗС (первичная подача запроса, вход по сертификату, согласование руководителем, изменение статуса) — УФК по г. Москве, раздел «Удостоверяющий центр». https://moscow.roskazna.gov.ru/gis/udostoveryayushhij-centr/</li>
      </ol>
      <p class="refs__note">Сведения приведены по состоянию на 18 сентября 2026 года. Технические требования к АРМ и формы документов уточняйте в актуальных памятках УЦ ФК и вашем ТОФК: версии ПО периодически обновляются.</p>
    </div>

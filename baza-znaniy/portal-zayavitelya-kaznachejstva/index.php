...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>15 мин чтения</span><span class="dot">·</span><span>Обновлено 10 сентября 2026</span></div>
    </div>
    ...
    <h2 id="registraciya">Регистрация на портале заявителя казначейства</h2>
    <div class="answer reveal"><p>Отдельной регистрации с логином и паролем на портале заявителя нет: доступ к ФЗС открывается по сертификату электронной подписи после заключения договора присоединения к регламенту удостоверяющего центра Федерального казначейства. То, что пользователи называют «регистрацией на портале заявителя», — это подготовка рабочего места, договор присоединения и первый вход по сертификату на fzs.roskazna.ru.</p></div>
    <p>Порядок «регистрации» по шагам: настроить рабочее место (криптопровайдер, ГОСТ-браузер, корневые сертификаты), заключить договор присоединения, открыть fzs.roskazna.ru и войти по действующему сертификату. После этого доступно формирование запросов на сертификат — первичных и на замену. Каждый шаг подробно разобран в разделах выше.</p>

    <h2 id="oficialnyy-adres">Росказна портал заявителя: официальный адрес</h2>
    <div class="answer reveal"><p>Официальный адрес портала заявителя Федерального казначейства — fzs.roskazna.ru. Проверка готовности рабочего места и браузера — arm-fzs.roskazna.gov.ru. Ссылка на портал публикуется на официальном сайте Казначейства roskazna.gov.ru в разделе удостоверяющего центра — заходить лучше оттуда, чтобы не попасть на сторонние «зеркала».</p></div>
    <p>Запросы «росказна портал заявителя», «портал заявителя росказна», «портал заявителя федерального казначейства» ведут на один и тот же сервис ФЗС. Никаких региональных адресов у портала нет: заявители всех субъектов работают через единый fzs.roskazna.ru, а региональные управления участвуют как центры регистрации, куда представляются документы.</p>
...
<div class="refs">
      ...
      <p class="refs__note">Сведения приведены по состоянию на 10 сентября 2026 года. Технические требования к АРМ и формы документов уточняйте в актуальных памятках УЦ ФК и вашем ТОФК: версии ПО периодически обновляются.</p>
    </div>

...
{"@context": "https://schema.org", "@type": "Article", "headline": "Машиночитаемая доверенность (МЧД) для казначейства: когда нужна, как оформить и применять в «Электронном бюджете»", "description": "Машиночитаемая доверенность (МЧД) для казначейства: когда обязательна в «Электронном бюджете», формат 003, как оформить и применять при подписании.", "inLanguage": "ru-RU", "datePublished": "2026-06-29", "dateModified": "2026-07-08", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}}, "image": "https://kaznaexpert.ru/img/og-image.png", "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/mashinochitaemaya-doverennost-kaznachejstvo/"}}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <article class="content" id="main">
    <div class="hero">
      ...
      <div class="eyebrow">База знаний · Сертификаты и ЭП <span class="fresh">Актуально на 2026</span></div>
...
<h2 id="faq">Частые вопросы</h2>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Федеральный закон от 06.04.2011 № 63-ФЗ «Об электронной подписи» (машиночитаемая доверенность, подтверждение полномочий представителя).</li>

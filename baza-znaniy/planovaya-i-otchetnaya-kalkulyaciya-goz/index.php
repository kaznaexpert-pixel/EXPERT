...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>11 мин чтения</span><span class="dot">·</span><span>Обновлено 8 сентября 2026</span></div>
    </div>
...
<div class="refs">
      ...
      <p class="refs__note">Материал актуален на 8 сентября 2026 года. Названия строк и подписные блоки приведены по редакции приказа № 995/22 от 18.12.2025. Состав колонок и обязательность отдельных строк зависят от вида продукции и метода определения цены — сверяйте бланк на дату подачи.</p>
    </div>

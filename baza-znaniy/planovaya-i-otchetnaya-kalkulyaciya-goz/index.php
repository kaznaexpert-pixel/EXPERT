...
<title>Плановая и отчётная калькуляция ГОЗ — разница, сроки, состав</title>
<meta name="description" content="Чем плановая калькуляция (форма № 2) отличается от отчётной (форма № 3) по ГОЗ: колонки, подписи, статьи затрат 0100–1900, сроки и расхождения плана с фактом.">
<meta name="author" content="Ярослав Михайлов">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
<meta name="theme-color" content="#F4F1EB" media="(prefers-color-scheme: light)">
<meta name="theme-color" content="#141310" media="(prefers-color-scheme: dark)">
<!-- PROD: canonical и og:url ОБЯЗАТЕЛЬНО менять под URL каждой статьи -->
<link rel="canonical" href="https://kaznaexpert.ru/baza-znaniy/planovaya-i-otchetnaya-kalkulyaciya-goz/">
...
{"@context": "https://schema.org", "@type": "Article", "headline": "Плановая и отчётная калькуляция по ГОЗ: разница, сроки и состав форм", "description": "Плановая калькуляция затрат (форма № 2) и отчётная калькуляция (форма № 3 (3д)) приложения № 5 к приказу ФАС № 995/22: сравнение колонок и подписантов, единая структура статей затрат 0100–1900, сроки представления и последствия расхождения плана и факта.", "inLanguage": "ru-RU", "datePublished": "2026-08-16", "dateModified": "2026-09-09", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/", "@id": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/#person", "image": "https://kaznaexpert.ru/img/team/mihailov-photo.jpg"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}, "@id": "https://kaznaexpert.ru/#organization"}, "image": ["https://kaznaexpert.ru/img/og/baza-znaniy__planovaya-i-otchetnaya-kalkulyaciya-goz-16x9.jpg", "https://kaznaexpert.ru/img/og/baza-znaniy__planovaya-i-otchetnaya-kalkulyaciya-goz-4x3.webp", "https://kaznaexpert.ru/img/og/baza-znaniy__planovaya-i-otchetnaya-kalkulyaciya-goz-1x1.webp"], "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/planovaya-i-otchetnaya-kalkulyaciya-goz/"}, "citation": ["https://www.consultant.ru/document/cons_doc_LAW_436477/", "https://www.consultant.ru/document/cons_doc_LAW_284195/", "https://www.consultant.ru/document/cons_doc_LAW_322968/"]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Главная", "item": "https://kaznaexpert.ru/", "url": "https://kaznaexpert.ru/"}, {"@type": "ListItem", "position": 2, "name": "База знаний", "item": "https://kaznaexpert.ru/baza-znaniy/", "url": "https://kaznaexpert.ru/baza-znaniy/"}, {"@type": "ListItem", "position": 3, "name": "Плановая и отчётная калькуляция", "item": "https://kaznaexpert.ru/baza-znaniy/planovaya-i-otchetnaya-kalkulyaciya-goz/", "url": "https://kaznaexpert.ru/baza-znaniy/planovaya-i-otchetnaya-kalkulyaciya-goz/"}]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Чем плановая калькуляция отличается от отчётной?", "acceptedAnswer": {"@type": "Answer", "text": "Плановая калькуляция (форма № 2) составляется при формировании цены и показывает ожидаемые затраты на предстоящий период — в шапке стоит «на ____ г.». Отчётная (форма № 3 (3д)) составляется после исполнения контракта или этапа, содержит колонки «План» и «Факт» и опирается на данные раздельного учёта. Структура статей затрат у обеих форм одинаковая."}}, {"@type": "Question", "name": "Кто подписывает отчётную калькуляцию?", "acceptedAnswer": {"@type": "Answer", "text": "По бланку формы № 3 (3д) — военный представитель, главный бухгалтер организации-поставщика (при наличии) и руководитель её экономической службы; печать ставится при наличии. Плановую калькуляцию по форме № 2 подписывают руководители экономических служб заказчика и организации-поставщика."}}, {"@type": "Question", "name": "Нужна ли отчётная калькуляция, если продукция выпускается впервые?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Сноска к форме № 3 указывает, что сведения приводятся за последний отчётный период по исполненному контракту, если продукция ранее поставлялась; при отсутствии поставки ранее отчётная калькуляция не представляется."}}, {"@type": "Question", "name": "Как заполнять калькуляцию, если производство идёт больше года?", "acceptedAnswer": {"@type": "Answer", "text": "При продолжительности технологического цикла более одного года либо когда год начала производства не совпадает с годом окончания производства и поставки (или завершения отдельных этапов, предусмотренных контрактом), сведения представляются по каждому году выполнения работ."}}, {"@type": "Question", "name": "В какой срок нужна отчётная калькуляция для перевода цены?", "acceptedAnswer": {"@type": "Answer", "text": "Отдельного срока «на калькуляцию» нет, ориентир задаёт сама процедура: по Положению № 1465 фиксированная цена устанавливается не позднее чем за два месяца до окончания поставки продукции или завершения отдельного этапа. Отчётные данные и уточнённые расчёты собирают с запасом к этому сроку."}}, {"@type": "Question", "name": "Что делать, если фактические затраты превысили плановые?", "acceptedAnswer": {"@type": "Answer", "text": "Превышение принимается только с документальным обоснованием: рост цен поставщиков, изменение технологии, иные подтверждённые причины. Необъяснённое превышение в цену не включат, и разница ляжет на прибыль предприятия. Причины расхождений раскрываются в пояснительной записке построчно."}}, {"@type": "Question", "name": "В каком порядке собирать отчётную калькуляцию?", "acceptedAnswer": {"@type": "Answer", "text": "Закрыть отчётный период, выгрузить затраты по контракту из регистров раздельного учёта, разнести их по строкам 0100–1900 по той же методике, что применялась в плане, собрать расшифровки, поставить план рядом с фактом построчно, объяснить расхождения в пояснительной записке и собрать подписи, включая военного представителя и главного бухгалтера."}}, {"@type": "Question", "name": "Что проверить в комплекте перед сдачей?", "acceptedAnswer": {"@type": "Answer", "text": "Итоги расшифровок против строк калькуляции, трудоёмкость против основной заработной платы, применённые нормативы против заявленных в сметах, разрез привнесённых и собственных затрат в строке 1700 и расчёт прибыли от него, отсутствие задвоения административно-управленческих и общехозяйственных затрат, прослеживаемость колонки «Факт» до регистров учёта."}}, {"@type": "Question", "name": "Что будет, если часть расшифровок не приложена?", "acceptedAnswer": {"@type": "Answer", "text": "По пункту 109 Положения, утверждённого постановлением Правительства РФ № 1465, в редакции постановления от 14.02.2026 № 138 предложение о цене с неполным объёмом запрошенной информации считается непредставленным. То есть неполный комплект — это не задержка рассмотрения, а отсутствие предложения о цене."}}]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "HowTo", "name": "Как собрать отчётную калькуляцию по гособоронзаказу", "description": "Порядок сборки отчётной калькуляции формы № 3 (3д) из данных раздельного учёта: период, выгрузка затрат, разнесение по статьям, расшифровки, сверка плана и факта, пояснительная записка, подписи.", "inLanguage": "ru-RU", "step": [{"@type": "HowToStep", "position": 1, "name": "Определить отчётный период", "text": "Взять период из шапки формы; при цикле дольше года формировать сведения по каждому году выполнения работ."}, {"@type": "HowToStep", "position": 2, "name": "Выгрузить затраты по контракту", "text": "Собрать затраты из регистров раздельного учёта, сгруппированные по идентификатору государственного контракта."}, {"@type": "HowToStep", "position": 3, "name": "Разнести затраты по статьям", "text": "Распределить затраты по строкам 0100–1900 по той же методике, что применялась при формировании плановой калькуляции."}, {"@type": "HowToStep", "position": 4, "name": "Собрать расшифровки", "text": "Подготовить расшифровки по материалам, оплате труда и косвенным затратам так, чтобы итог каждой совпадал со строкой калькуляции."}, {"@type": "HowToStep", "position": 5, "name": "Сопоставить план и факт", "text": "Заполнить колонки «План» и «Факт» построчно и сравнить по строкам, а не по итогу."}, {"@type": "HowToStep", "position": 6, "name": "Объяснить расхождения", "text": "Описать каждое существенное отклонение в пояснительной записке с причиной и подтверждающим документом."}, {"@type": "HowToStep", "position": 7, "name": "Собрать подписи", "text": "Получить подписи военного представителя, главного бухгалтера при наличии и руководителя экономической службы."}]}
</script>
<script type="application/ld+json">
...
<meta property="og:title" content="Плановая и отчётная калькуляция ГОЗ: в чём разница">
<meta property="og:description" content="Формы № 2 и № 3 приказа ФАС № 995/22: разные колонки, разные подписи, единая структура статей затрат, сроки и разбор расхождений плана с фактом.">
<meta property="og:url" content="https://kaznaexpert.ru/baza-znaniy/planovaya-i-otchetnaya-kalkulyaciya-goz/">
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__planovaya-i-otchetnaya-kalkulyaciya-goz-16x9.jpg">
...
<meta name="twitter:title" content="Плановая и отчётная калькуляция ГОЗ: в чём разница">
<meta name="twitter:description" content="Формы № 2 и № 3: колонки, подписанты, статьи затрат 0100–1900, сроки и расхождения плана с фактом.">
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__planovaya-i-otchetnaya-kalkulyaciya-goz-16x9.jpg">
...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/baza-znaniy/">База знаний</a> › Плановая и отчётная калькуляция</nav>

  <aside class="toc" aria-label="Содержание">
    <div class="toc__label">Содержание</div>
    <ul class="toc__list" id="tocList">
      <li><a href="#raznica">Сравнение форм № 2 и № 3</a></li>
      <li><a href="#statyi">Структура статей затрат</a></li>
      <li><a href="#plan">Плановая калькуляция</a></li>
      <li><a href="#fakt">Отчётная калькуляция</a></li>
      <li><a href="#sroki">Когда что представляется</a></li>
      <li><a href="#rashozhdeniya">Расхождение плана и факта</a></li>
      <li><a href="#sborka">Как собрать отчётную калькуляцию</a></li><li><a href="#checklist">Чек-лист перед сдачей</a></li>
        <li><a href="#checklist">Чек-лист перед сдачей</a></li>
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>11 мин чтения</span><span class="dot">·</span><span>Обновлено 9 сентября 2026 · добавлены порядок сборки отчётной калькуляции, чек-лист самопроверки и последствия неполного комплекта</span></div>
    </div>

    <div class="share">
      <span class="share__label">Поделиться:</span>
      <a href="https://t.me/share/url?url=https%3A%2F%2Fkaznaexpert.ru%2Fbaza-znaniy%2Fplanovaya-i-otchetnaya-kalkulyaciya-goz%2F&amp;text=%D0%9F%D0%BB%D0%B0%D0%BD%D0%BE%D0%B2%D0%B0%D1%8F%20%D0%B8%20%D0%BE%D1%82%D1%87%D1%91%D1%82%D0%BD%D0%B0%D1%8F%20%D0%BA%D0%B0%D0%BB%D1%8C%D0%BA%D1%83%D0%BB%D1%8F%D1%86%D0%B8%D1%8F%20%D0%BF%D0%BE%20%D0%93%D0%9E%D0%97%3A%20%D1%87%D0%B5%D0%BC%20%D0%BE%D1%82%D0%BB%D0%B8%D1%87%D0%B0%D1%8E%D1%82%D1%81%D1%8F%20%D1%84%D0%BE%D1%80%D0%BC%D1%8B%20%E2%84%96%202%20%D0%B8%20%E2%84%96%203%20%D0%BF%D1%80%D0%B8%D0%BA%D0%B0%D0%B7%D0%B0%20%D0%A4%D0%90%D0%A1%20%E2%84%96%20995%2F22%2C%20%D0%BA%D0%B0%D0%BA%D0%B8%D0%B5%20%D1%83%20%D0%BD%D0%B8%D1%85%20%D0%BA%D0%BE%D0%BB%D0%BE%D0%BD%D0%BA%D0%B8%20%D0%B8%20%D0%BF%D0%BE%D0%B4%D0%BF%D0%B8%D1%81%D0%B8%2C%20%D0%B2%20%D0%BA%D0%B0%D0%BA%D0%B8%D0%B5%20%D1%81%D1%80%D0%BE%D0%BA%D0%B8%20%D0%BF%D1%80%D0%B5%D0%B4%D1%81%D1%82%D0%B0%D0%B2%D0%BB%D1%8F%D1%8E%D1%82%D1%81%D1%8F%20%D0%B8%20%D1%87%D1%82%D0%BE%20%D0%B1%D1%8B%D0%B2%D0%B0%D0%B5%D1%82%20%D0%BF%D1%80%D0%B8%20%D1%80%D0%B0%D1%81%D1%85%D0%BE%D0%B6%D0%B4%D0%B5%D0%BD%D0%B8%D0%B8%20%D0%BF%D0%BB%D0%B0%D0%BD%D0%B0%20%D1%81%20%D1%84%D0%B0%D0%BA%D1%82%D0%BE%D0%BC" target="_blank" rel="noopener"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.56 8.25l-1.86 8.76c-.14.62-.5.77-1.02.48l-2.82-2.08-1.36 1.31c-.15.15-.28.28-.57.28l.2-2.89 5.27-4.76c.23-.2-.05-.32-.35-.12l-6.51 4.1-2.8-.88c-.61-.19-.62-.61.13-.9l10.95-4.22c.5-.18.95.12.79.85z"/></svg>Telegram</a>
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        ...
        <li><a href="#sroki">Когда что представляется</a></li>
        <li><a href="#rashozhdeniya">Расхождение плана и факта</a></li>
        <li><a href="#sborka">Как собрать отчётную калькуляцию</a></li>
        <li><a href="#checklist">Чек-лист перед сдачей</a></li>
        <li><a href="#faq">Частые вопросы</a></li>
      </ol>
    </details>
    ...
    <div class="tldr">Плановая калькуляция (<b>форма № 2</b> приложения № 5 к приказу ФАС № 995/22) показывает ожидаемые затраты и составляется при формировании цены; отчётная (<b>форма № 3 (3д)</b>) фиксирует факт по данным раздельного учёта после исполнения. У форм одинаковая структура статей затрат — от строки 0100 до 1900, — но разные колонки, разные подписанты и разное назначение: плановая обосновывает цену вперёд, отчётная подтверждает её назад.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></div>

    <section class="keyfacts grain" aria-label="Ключевые факты">
      <h2>Коротко о главном</h2>
      <div class="keyfacts__grid">
        <div class="kf"><div class="kf__n">Ф. № 2</div><div class="kf__t"><b>Плановая калькуляция</b> — «на ____ г.», ожидаемые затраты</div></div>
        <div class="kf"><div class="kf__n">Ф. № 3 (3д)</div><div class="kf__t"><b>Отчётная калькуляция</b> — «за ____ г.», колонки «План» и «Факт»</div></div>
        <div class="kf"><div class="kf__n">0100–1900</div><div class="kf__t"><b>Статьи затрат</b> — единая структура строк в обеих формах</div></div>
        <div class="kf"><div class="kf__n">Стр. 1700</div><div class="kf__t"><b>Себестоимость</b> раскрывается на привнесённые и собственные затраты</div></div>
        <div class="kf"><div class="kf__n">Военпред</div><div class="kf__t"><b>Подпись</b> — отчётную калькуляцию визирует военный представитель и главбух</div></div>
        <div class="kf"><div class="kf__n">2 месяца</div><div class="kf__t"><b>Перевод цены</b> — фиксированная цена устанавливается не позднее чем за 2 месяца до окончания поставки</div></div>
      </div>
    </section>
    <!-- svc-cta:top -->
    ...
    <h2 id="raznica">Плановая и отчётная калькуляция: сравнение</h2>
    <div class="answer reveal">
      <p class="lead-p">Обе формы описывают одни и те же статьи затрат, но отвечают на разные вопросы. Плановая калькуляция отвечает: «сколько это будет стоить и почему столько». Отчётная: «сколько это стоило на самом деле и совпало ли с планом».</p>
    </div>
    <h3 id="razlichiya-form">Чем различаются формы № 2 и № 3 (3д)</h3>
    <table>
      <caption>Форма № 2 и форма № 3 (3д): что различается</caption>
      <tr><th>Критерий</th><th>Плановая калькуляция (ф. № 2)</th><th>Отчётная калькуляция (ф. № 3 (3д))</th></tr>
      <tr><td>Период в шапке</td><td>«на ____ г.» — период, на который формируется цена</td><td>«за ________ г.» — завершённый отчётный период</td></tr>
      <tr><td>Когда составляется</td><td>При формировании цены: до заключения контракта или при её изменении</td><td>После исполнения контракта или этапа, по данным учёта</td></tr>
      <tr><td>Что обосновывает</td><td>Ожидаемую себестоимость и цену продукции</td><td>Фактические затраты и их соответствие плану</td></tr>
      <tr><td>Колонки</td><td>Плановые затраты, согласованные заказчиком при формировании ориентировочной (уточняемой) или возмещающей издержки цены; предложено организацией-поставщиком; принято заказчиком; примечание</td><td>План; Факт; примечание</td></tr>
      <tr><td>Кому представляется</td><td>Государственному заказчику и военному представительству вместе с предложением о цене</td><td>Заказчику и военному представительству — при переводе цены и закрытии контракта</td></tr>
      <tr><td>Чем подтверждается</td><td>Нормами, ценами поставщиков, договорами кооперации, нормативами по сметам форм № 8, 10–13</td><td>Данными раздельного учёта по контракту и первичными документами</td></tr>
      <tr><td>Кто подписывает</td><td>Руководители экономических служб заказчика и организации-поставщика</td><td>Военный представитель, главный бухгалтер организации-поставщика (при наличии) и руководитель её экономической службы</td></tr>
      <tr><td>Многолетний вариант</td><td>Форма № 2д — на период из нескольких лет</td><td>Многолетний вариант заложен в саму форму: № 3 (3д)</td></tr>
    </table>
    <h3 id="kto-podpisyvaet">Кто подписывает плановую и отчётную калькуляцию</h3>
    <p>Обратите внимание на строку с подписями: это не формальность. Плановую калькуляцию визируют экономисты, отчётную — военный представитель и главный бухгалтер. Подпись главбуха означает, что цифры факта сверены с бухгалтерским учётом, а не собраны в отдельной таблице «для военпреда».</p>

    <h2 id="statyi">Единая структура статей затрат</h2>
    <p>Строки в обеих формах совпадают — это позволяет положить план и факт рядом и увидеть расхождение построчно.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></p>
    <h3 id="statyi-zatrat-tablica">Какие статьи затрат входят в обе формы</h3>
    <table>
      <caption>Статьи калькуляции затрат в формах № 2 и № 3 приложения № 5</caption>
      <tr><th>Строка</th><th>Статья затрат</th><th>Чем обосновывается</th></tr>
      <tr><td>0100</td><td>Материальные затраты — всего (в том числе строки 0101–0110)</td><td>Расшифровки форм № 4–7, норматив ТЗЗ по форме № 8</td></tr>
      <tr><td>0200</td><td>Затраты на оплату труда — основная (0201) и дополнительная (0202) заработная плата</td><td>Трудоёмкость по форме № 23, расшифровка по форме № 9, норматив дополнительной зарплаты по форме № 10</td></tr>
      <tr><td>0300</td><td>Страховые взносы на обязательное социальное страхование</td><td>Тариф взносов к базе оплаты труда</td></tr>
      <tr><td>0400</td><td>Затраты на подготовку и освоение производства</td><td>Форма № 17</td></tr>
      <tr><td>0500</td><td>Затраты на специальную технологическую оснастку</td><td>Форма № 16</td></tr>
      <tr><td>0600</td><td>Затраты на специальное оборудование для научных (экспериментальных) работ</td><td>Формы № 15 и № 15.1 (НИР, ОКР)</td></tr>
      <tr><td>0700</td><td>Специальные затраты</td><td>Форма № 14, затраты на испытания — форма № 14.1</td></tr>
      <tr><td>0800</td><td>Общепроизводственные затраты</td><td>Смета и расчёт по форме № 11</td></tr>
      <tr><td>0900</td><td>Общехозяйственные затраты</td><td>Смета и расчёт по форме № 12</td></tr>
      <tr><td>1000</td><td>Затраты на командировки</td><td>Форма № 19</td></tr>
      <tr><td>1100</td><td>Прочие прямые затраты</td><td>Форма № 18</td></tr>
      <tr><td>1200</td><td>Затраты по работам (услугам), выполняемым сторонними организациями</td><td>Форма № 7.1</td></tr>
      <tr><td>1300</td><td>Производственная себестоимость</td><td>Расчётный итог по строкам выше</td></tr>
      <tr><td>1400</td><td>Коммерческие (внепроизводственные) затраты</td><td>Смета и расчёт по форме № 13</td></tr>
      <tr><td>1500</td><td>Проценты по кредитам</td><td>Кредитные договоры и расчёт-обоснование</td></tr>
      <tr><td>1600</td><td>Административно-управленческие расходы</td><td>Форма № 12; включаются в зависимости от учётной политики организации</td></tr>
      <tr><td>1700</td><td>Себестоимость продукции, в том числе привнесённые и собственные затраты</td><td>Итог; разрез привнесённых и собственных — база для расчёта прибыли</td></tr>
      <tr><td>1800</td><td>Прибыль</td><td>Расчёт и обоснование по форме № 20</td></tr>
      <tr><td>1900</td><td>Цена продукции (без НДС)</td><td>Себестоимость плюс прибыль</td></tr>
    </table>
    <h3 id="ogovorki-blankov">Какие две оговорки есть у самих бланков</h3>
    <p>Отдельно стоит держать в голове две оговорки самих бланков. Первая: административно-управленческие расходы включаются в зависимости от того, как построена учётная политика организации, — и если по учётной политике они относятся на финансовый результат контракта, статья «Общехозяйственные затраты» (строка 0900) не применяется.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a> Вторая: часть строк заполняется только при определении цены на научно-техническую продукцию, а также на работы по ремонту, сервисному обслуживанию и утилизации.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a> Как закрепить методику, чтобы она не разъезжалась от контракта к контракту, — в разборе <a href="/baza-znaniy/uchetnaya-politika-razdelnyy-uchet-goz/">учётной политики под раздельный учёт ГОЗ</a>.</p>

    <h2 id="plan">Плановая калькуляция: что важно в форме № 2</h2>
    <p>Плановая калькуляция — центральный документ комплекта при затратном методе. Три её особенности задают качество всего комплекта.</p>
    <h3 id="tri-kolonki">Какие три графы заполняют в плановой калькуляции</h3>
    <p><b>Три колонки вместо одной.</b> В форме предусмотрены отдельные графы: плановые затраты, ранее согласованные заказчиком при формировании ориентировочной (уточняемой) или возмещающей издержки цены; то, что предлагает организация-поставщик; и то, что принято заказчиком. Заполнение только «своей» колонки — типовая причина возврата: проверяющему нужна сопоставимость.</p>
    <h3 id="stroka-1700">Что требует строка 1700 формы № 2</h3>
    <p><b>Раскрытие себестоимости.</b> Строка 1700 требует разложить себестоимость на привнесённые (покупные) и собственные затраты. От их соотношения считается предельная прибыль по правилу «не более 1 % привнесённых плюс не более 25 % собственных» — детально в разборе <a href="/baza-znaniy/normy-pribyli-goz/">норм прибыли по гособоронзаказу</a>.</p>
    <h3 id="analogovyy-podhod">Какая форма применяется при аналоговом подходе</h3>
    <p><b>Аналоговый подход — другая форма.</b> Если цена формируется с использованием аналогового подхода, плановая калькуляция представляется не по форме № 2, а по форме № 2А (2Ад), которая объединяет плановую калькуляцию на продукцию и отчётную калькуляцию на аналог.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a> Какие вообще бывают виды цен и методы их определения — в статье о <a href="/baza-znaniy/vidy-cen-goz/">видах цен на продукцию ГОЗ</a>.</p>

    <h2 id="fakt">Отчётная калькуляция: что важно в форме № 3</h2>
    <p>Отчётная калькуляция — это план и факт рядом, построчно. Именно она превращает разговор о цене из спора в арифметику.</p>
    ...
    <h3 id="pervaya-postavka">Нужна ли отчётная калькуляция при первой поставке</h3>
    <p><b>Первая поставка — без отчётной калькуляции.</b> Сноска к форме прямо указывает: сведения приводятся за последний отчётный период по исполненному контракту, если продукция ранее поставлялась; при отсутствии поставки ранее отчётная калькуляция не представляется.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a> Это снимает частый вопрос новых исполнителей, которым «требуют факт» по продукции, которую они ещё не выпускали.</p>
    <h3 id="dlinnyy-cikl">Как заполнять форму при цикле производства дольше года</h3>
    <p><b>Длинный цикл — разбивка по годам.</b> Если технологический цикл производства превышает год либо год начала производства не совпадает с годом окончания производства и поставки (или завершения отдельных этапов, если контрактом такие этапы предусмотрены), сведения представляются по каждому году выполнения работ.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a></p>
    <h3 id="otkuda-fakt">Откуда берутся цифры колонки «Факт»</h3>
    <p><b>Факт берётся из учёта, а не из памяти.</b> Каждая цифра колонки «Факт» должна прослеживаться до регистров раздельного учёта и первичных документов. Если учёт по контракту не выделен, отчётную калькуляцию собрать физически нельзя — сначала придётся навести порядок в <a href="/baza-znaniy/razdelnyy-uchet-goz-275-fz/">раздельном учёте по ГОЗ</a>.</p>

    <div class="rkm-cta">
      <p class="rkm-cta__k">Услуга</p>
      <p class="rkm-cta__t">Соберём плановую и отчётную калькуляции</p>
      <p class="rkm-cta__p">Пересоберём расшифровки, сведём план с фактом по данным вашего учёта, пересчитаем прибыль от новой структуры затрат и объясним расхождения в пояснительной записке. 105 000 ₽ фиксированно за комплект по одному контракту.</p>
      <div class="rkm-cta__act"><a class="rkm-cta__b rkm-cta__b--p" href="/uslugi/sostavlenie-rkm/">Составление РКМ под ключ</a><a class="rkm-cta__b rkm-cta__b--s" href="/baza-znaniy/formy-rkm-995-22/">Все формы приказа № 995/22</a></div>
    </div>

    <h2 id="sroki">Когда какая калькуляция представляется</h2>
    <table>
      <caption>Стадии контракта и востребованная форма</caption>
      <tr><th>Стадия</th><th>Плановая (ф. № 2)</th><th>Отчётная (ф. № 3)</th></tr>
      <tr><td>Формирование цены, заключение контракта</td><td>Да — ядро комплекта</td><td>Только если такая продукция ранее поставлялась</td></tr>
      <tr><td>Изменение цены в ходе исполнения</td><td>Да — уточнённая калькуляция</td><td>Да, если есть завершённый отчётный период</td></tr>
      <tr><td>Перевод ориентировочной цены в фиксированную</td><td>Да — по форме № 2</td><td>Да — основная доказательная база</td></tr>
      <tr><td>Закрытие контракта, отчётность</td><td>Как справочная база сравнения</td><td>Да — итоговый документ</td></tr>
    </table>
    <p>Сроковый ориентир для самого «горячего» сценария: по Положению № 1465 фиксированная цена устанавливается не позднее чем за два месяца до окончания поставки продукции или завершения отдельного этапа.<a class="fn" href="#ref-2" aria-label="Источник 2">[2]</a> С учётом времени на согласование с заказчиком и военным представительством отчётную калькуляцию и уточнённые расчёты собирают с запасом — детально сроки и порядок разобраны в статье о <a href="/baza-znaniy/perevod-orientirovochnoy-ceny-v-fiksirovannuyu-goz/">переводе ориентировочной цены в фиксированную</a>.</p>
<p data-ctx="auto-ctx:p76">Расхождения разбирают только по принятому комплекту: если состав документов неполный, предложение о цене считается непредставленным. Как проверить комплектность до отправки — в разборе <a href="/baza-znaniy/obrazec-zapolneniya-rkm/#polnota">полнота комплекта РКМ</a>.</p>

    
    <h2 id="rashozhdeniya">Что бывает при расхождении плана и факта</h2>
    <p>Расхождение само по себе не нарушение — производство не бывает точным до рубля. Проблемой оно становится, когда его нечем объяснить.</p>
    <ul>
      <li><b>Факт ниже плана.</b> Экономия по существенным строкам — повод пересмотреть цену вниз при её переводе в фиксированную. Именно поэтому «запас» в плановой калькуляции редко доживает до закрытия контракта.</li>
      <li><b>Факт выше плана.</b> Превышение принимается только с обоснованием: рост цен поставщиков, изменение технологии, документально подтверждённые причины. Необъяснённое превышение просто не включат в цену — разница останется на предприятии.</li>
      <li><b>Факт не бьётся с учётом.</b> Самый тяжёлый случай: цифры отчётной калькуляции не выводятся из регистров. Это ставит под сомнение весь комплект и легко перерастает в контрольное мероприятие.</li>
      <li><b>Расхождение внутри комплекта.</b> Итог расшифровки не равен строке калькуляции, трудоёмкость не соответствует зарплате, нормативы в форме № 22 отличаются от применённых. Такие ошибки находят первыми — сквозная сверка перед сдачей закрывает их полностью.</li>
    </ul>
    <p>Как выглядит сквозная сверка на конкретных цифрах и откуда берётся каждая строка калькуляции, показано в разборе <a href="/baza-znaniy/obrazec-zapolneniya-rkm/">образца заполнения РКМ</a>.</p>

    <!-- p77-sborka -->
    <p data-ctx="auto-ctx:kontr0911">Цены покупных ресурсов в калькуляции должны опираться на пакет подтверждений — какие документы принимает проверяющий, см. в разборе <a href="/baza-znaniy/obosnovanie-rynochnoy-stoimosti-goz/">обоснования рыночной стоимости аренды, оборудования и услуг</a>.</p>

    <h2 id="sborka">Как собрать отчётную калькуляцию: порядок действий</h2>

    <div class="answer">
      <p>Отчётная калькуляция собирается не из таблицы «для военпреда», а из регистров раздельного учёта по контракту. Порядок один и тот же: закрыть период, выгрузить затраты по идентификатору контракта, разнести их по строкам 0100–1900, сверить с расшифровками, положить рядом план и объяснить каждое расхождение.</p>
    </div>

    <ol>
      <li><b>Определить отчётный период.</b> Он берётся из шапки формы: «за ________ г.». Если технологический цикл дольше года, сведения формируются по каждому году выполнения работ, а не суммарно за весь контракт.</li>
      <li><b>Выгрузить затраты по контракту.</b> Основание — регистры раздельного учёта, сгруппированные по идентификатору государственного контракта. Всё, что нельзя связать с контрактом первичным документом, в калькуляцию не попадает.</li>
      <li><b>Разнести затраты по строкам.</b> Строки в отчётной и плановой форме совпадают, поэтому разнесение делается по той же методике, что применялась при формировании цены. Менять принцип разнесения между планом и фактом нельзя: расхождение тогда объясняется не производством, а методикой.</li>
      <li><b>Собрать расшифровки.</b> Материалы — формы № 4–7, оплата труда — формы № 9 и № 23, косвенные затраты — сметы форм № 11–13. Итог каждой расшифровки должен совпадать со строкой калькуляции до рубля.</li>
      <li><b>Положить план рядом с фактом.</b> Колонки «План» и «Факт» заполняются построчно; сравнение делается по строкам, а не по итогу — итог может сойтись при встречных отклонениях внутри статей.</li>
      <li><b>Объяснить расхождения в пояснительной записке.</b> Каждое существенное отклонение — с причиной и документом: договор с новой ценой поставщика, изменение технологии, протокол об изменении объёма работ.</li>
      <li><b>Проверить подписи.</b> Отчётную калькуляцию визируют военный представитель, главный бухгалтер организации-поставщика (при наличии) и руководитель её экономической службы. Комплект без подписи главного бухгалтера возвращают, не разбирая цифры.</li>
    </ol>

    <h3 id="checklist">Чек-лист самопроверки перед сдачей</h3>

    <div class="answer">
      <p>Больше половины возвратов закрывается сквозной сверкой на своей стороне: итоги расшифровок против строк калькуляции, трудоёмкость против зарплаты, нормативы против применённых процентов, план против факта. Проверка занимает час, повторный круг согласования — недели.</p>
    </div>

    <ul>
      <li>Итог каждой расшифровки равен соответствующей строке калькуляции.</li>
      <li>Трудоёмкость по форме № 23 соответствует основной заработной плате по строке 0201.</li>
      <li>Применённые нормативы косвенных затрат совпадают с нормативами, заявленными в сметах и расчётах.</li>
      <li>Строка 1700 разложена на привнесённые и собственные затраты, и от этого разреза посчитана прибыль по строке 1800.</li>
      <li>Административно-управленческие расходы и общехозяйственные затраты не задвоены: применяется тот вариант, который закреплён учётной политикой.</li>
      <li>Цифры колонки «Факт» выводятся из регистров раздельного учёта, а не из отдельной таблицы.</li>
      <li>Каждое существенное расхождение плана и факта закрыто причиной и документом в пояснительной записке.</li>
      <li>Комплект полный: калькуляция, расшифровки, пояснительная записка, подписи и, где нужно, отметка военного представительства.</li>
    </ul>

    <h3 id="nepolnyy-komplekt">Что будет, если комплект неполный</h3>

    <div class="answer">
      <p>Неполнота комплекта бьёт не по срокам, а по самому факту рассмотрения: по пункту 109 Положения, утверждённого постановлением Правительства РФ № 1465, в редакции постановления от 14 февраля 2026 г. № 138 предложение о цене, поданное с неполным объёмом запрошенной информации, считается непредставленным.</p>
    </div>

    <p>Практический вывод простой: отсутствующая расшифровка равна отсутствующему предложению о цене, и «донести потом» здесь не работает так, как привыкли в закупках. Как проверить комплектность по перечню форм до отправки, показано в разборе <a href="/baza-znaniy/formy-rkm-995-22/">форм РКМ по приказу № 995/22</a>.</p>

    <h3 id="keys-praktika">Из практики: расхождение по материалам, которое сняли из цены</h3>

    <p>Типовая ситуация, обобщённая по нескольким разборам. Предприятие переводит ориентировочную цену в фиксированную. По строке 0100 факт выше плана примерно на десятую часть: поставщик повысил цену на комплектующие в середине года. Документы у предприятия есть — счета и договор с новой ценой, — но в пояснительной записке расхождение описано одной фразой «рост цен поставщиков», без привязки к позициям и датам. Заказчик исключает разницу из расчёта: обоснование не позволяет соотнести подорожание с конкретной поставкой. После пересборки записки с разбивкой по позициям и приложением договоров расхождение принимается. Пример иллюстративный, конкретный исход зависит от условий контракта, позиции заказчика и военного представительства.</p>

    <div class="takeaways">
      <h2>Что важно запомнить</h2>
      <ol>
        <li>Плановая калькуляция — форма № 2 («на ____ г.»), отчётная — форма № 3 (3д) («за ____ г.»); структура статей затрат у них одинаковая.</li>
        <li>Колонки разные: у плановой — согласовано ранее / предложено / принято, у отчётной — «План» и «Факт».</li>
        <li>Отчётную калькуляцию подписывают военный представитель и главный бухгалтер — она обязана выводиться из учёта.</li>
        <li>Если продукция ранее не поставлялась, отчётная калькуляция не представляется.</li>
        <li>При аналоговом подходе вместо формы № 2 применяется форма № 2А (2Ад).</li>
        <li>Фиксированная цена устанавливается не позднее чем за два месяца до окончания поставки — отчётные данные нужны заранее.</li>
      </ol>
    </div>

    <h2 id="faq">Частые вопросы</h2>
    <div class="faq"><details open><summary>Чем плановая калькуляция отличается от отчётной?</summary><p>Плановая калькуляция (форма № 2) составляется при формировании цены и показывает ожидаемые затраты на предстоящий период — в шапке стоит «на ____ г.». Отчётная (форма № 3 (3д)) составляется после исполнения контракта или этапа, содержит колонки «План» и «Факт» и опирается на данные раздельного учёта. Структура статей затрат у обеих форм одинаковая.</p></details>
<details><summary>Кто подписывает отчётную калькуляцию?</summary><p>По бланку формы № 3 (3д) — военный представитель, главный бухгалтер организации-поставщика (при наличии) и руководитель её экономической службы; печать ставится при наличии. Плановую калькуляцию по форме № 2 подписывают руководители экономических служб заказчика и организации-поставщика.</p></details>
<details><summary>Нужна ли отчётная калькуляция, если продукция выпускается впервые?</summary><p>Нет. Сноска к форме № 3 указывает, что сведения приводятся за последний отчётный период по исполненному контракту, если продукция ранее поставлялась; при отсутствии поставки ранее отчётная калькуляция не представляется.</p></details>
<details><summary>Как заполнять калькуляцию, если производство идёт больше года?</summary><p>При продолжительности технологического цикла более одного года либо когда год начала производства не совпадает с годом окончания производства и поставки (или завершения отдельных этапов, предусмотренных контрактом), сведения представляются по каждому году выполнения работ.</p></details>
<details><summary>В какой срок нужна отчётная калькуляция для перевода цены?</summary><p>Отдельного срока «на калькуляцию» нет, ориентир задаёт сама процедура: по Положению № 1465 фиксированная цена устанавливается не позднее чем за два месяца до окончания поставки продукции или завершения отдельного этапа. Отчётные данные и уточнённые расчёты собирают с запасом к этому сроку.</p></details>
<details><summary>Что делать, если фактические затраты превысили плановые?</summary><p>Превышение принимается только с документальным обоснованием: рост цен поставщиков, изменение технологии, иные подтверждённые причины. Необъяснённое превышение в цену не включат, и разница ляжет на прибыль предприятия. Причины расхождений раскрываются в пояснительной записке построчно.</p></details><details><summary>В каком порядке собирать отчётную калькуляцию?</summary><p>Закрыть отчётный период, выгрузить затраты по контракту из регистров раздельного учёта, разнести их по строкам 0100–1900 по той же методике, что применялась в плане, собрать расшифровки, поставить план рядом с фактом построчно, объяснить расхождения в пояснительной записке и собрать подписи, включая военного представителя и главного бухгалтера.</p></details><details><summary>Что проверить в комплекте перед сдачей?</summary><p>Итоги расшифровок против строк калькуляции, трудоёмкость против основной заработной платы, применённые нормативы против заявленных в сметах, разрез привнесённых и собственных затрат в строке 1700 и расчёт прибыли от него, отсутствие задвоения административно-управленческих и общехозяйственных затрат, прослеживаемость колонки «Факт» до регистров учёта.</p></details><details><summary>Что будет, если часть расшифровок не приложена?</summary><p>По пункту 109 Положения, утверждённого постановлением Правительства РФ № 1465, в редакции постановления от 14.02.2026 № 138 предложение о цене с неполным объёмом запрошенной информации считается непредставленным. То есть неполный комплект — это не задержка рассмотрения, а отсутствие предложения о цене.</p></details></div>
...
<div class="refs">
      ...
      <p class="refs__note">Материал актуален на 9 сентября 2026 года. Названия строк и подписные блоки приведены по редакции приказа № 995/22 от 18.12.2025. Состав колонок и обязательность отдельных строк зависят от вида продукции и метода определения цены — сверяйте бланк на дату подачи.</p>
    </div>
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="planovaya-i-otchetnaya-kalkulyaciya-goz">
      <div class="railform__badge">Разбор эксперта</div>
      <h3 class="railform__title">Факт не сходится с планом?</h3>
      <p class="railform__sub">Сведём отчётную калькуляцию с данными раздельного учёта, объясним расхождения в пояснительной записке и пересчитаем прибыль от новой структуры затрат.</p>
...
<section class="related" aria-labelledby="relTitle">
  ...
  <div class="related__grid">
    ...
    <a class="card reveal" href="/baza-znaniy/perevod-orientirovochnoy-ceny-v-fiksirovannuyu-goz/"><div class="card__cover"><span>Перевод</span></div><div class="card__body"><span class="card__cat">База знаний</span><h3 class="card__title">Перевод ориентировочной цены в фиксированную по ГОЗ</h3><div class="card__meta">Гособоронзаказ · 16 мин</div></div></a>
...
<section class="kz-sub" aria-labelledby="kzSubTitle" data-source="planovaya-i-otchetnaya-kalkulyaciya-goz">
  <style>

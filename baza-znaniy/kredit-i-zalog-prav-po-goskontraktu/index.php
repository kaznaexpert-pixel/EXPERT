...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Гражданский кодекс РФ, ст. 334 (понятие залога), ст. 358.1 (залог обязательственных прав, в том числе будущих), ч. 7 ст. 448 (ограничение прав победителя торгов).</li>
        ...
        <li id="ref-3">Федеральный закон от 05.04.2013 № 44-ФЗ, ст. 111.2 — залог права требования к заказчику по контракту на предоставление кредита.</li>
        <li id="ref-4">Федеральный закон от 29.12.2012 № 275-ФЗ, ст. 8.3, 8.4 — режим отдельного счёта по гособоронзаказу и ограничения операций.</li>

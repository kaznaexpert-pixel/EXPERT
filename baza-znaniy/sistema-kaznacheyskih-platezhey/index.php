...
{"@context": "https://schema.org", "@type": "Article", "headline": "Система казначейских платежей (СКП): что это, участники и как проходят платежи", "description": "Что такое система казначейских платежей (СКП): глава 24.2 БК, оператор и участники, единый казначейский счёт и как проходит казначейский платёж.", "inLanguage": "ru-RU", "datePublished": "2026-06-23", "dateModified": "2026-08-10", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/", "@id": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/#person", "image": "https://kaznaexpert.ru/img/team/mihailov-photo.jpg"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}, "@id": "https://kaznaexpert.ru/#organization"}, "image": ["https://kaznaexpert.ru/img/og/baza-znaniy__sistema-kaznacheyskih-platezhey-16x9.jpg", "https://kaznaexpert.ru/img/og/baza-znaniy__sistema-kaznacheyskih-platezhey-4x3.webp", "https://kaznaexpert.ru/img/og/baza-znaniy__sistema-kaznacheyskih-platezhey-1x1.webp"], "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/sistema-kaznacheyskih-platezhey/"}, "citation": ["Бюджетный кодекс РФ от 31.07.1998 № 145-ФЗ, глава 24.2 «Система казначейских платежей» (статьи 242.7–242.13-1); введена Федеральным законом от 27.12.2019 № 479-ФЗ, действует с 1 января 2021 года. consultant.ru, pravo.gov.ru.", "Статья 242.7 БК РФ — основы функционирования системы казначейских платежей: система как совокупность участников и оператора. consultant.ru. КонсультантПлюс — https://www.consultant.ru/document/cons_doc_LAW_19702/", "Статья 242.13 БК РФ — доведение средств на единый казначейский счёт; единый казначейский счёт открыт Федеральному казначейству в Банке России (балансовый счёт № 40102, переход с 01.01.2021). consultant.ru, cbr.ru. КонсультантПлюс — https://www.consultant.ru/document/cons_doc_LAW_19702/", "Статья 242.8 БК РФ (в ред. Федерального закона от 01.07.2021 № 244-ФЗ) — прямые и косвенные участники системы казначейских платежей. consultant.ru.", "Статья 242.13-1 БК РФ — казначейский мониторинг (введена Федеральным законом от 01.07.2021 № 244-ФЗ; наименование изменено Федеральным законом от 21.04.2025 № 84-ФЗ). consultant.ru, roskazna.gov.ru."]}
</script>
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Главная", "item": "https://kaznaexpert.ru/", "url": "https://kaznaexpert.ru/"}, {"@type": "ListItem", "position": 2, "name": "База знаний", "item": "https://kaznaexpert.ru/baza-znaniy/", "url": "https://kaznaexpert.ru/baza-znaniy/"}, {"@type": "ListItem", "position": 3, "name": "Система казначейских платежей", "item": "https://kaznaexpert.ru/baza-znaniy/sistema-kaznacheyskih-platezhey/", "url": "https://kaznaexpert.ru/baza-znaniy/sistema-kaznacheyskih-platezhey/"}]}
</script>
<script type="application/ld+json">
...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__sistema-kaznacheyskih-platezhey-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__sistema-kaznacheyskih-platezhey-16x9.jpg">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p data-ctx="auto-ctx:kaznacheyskiy-schet">Номер каждого такого счёта читается по разрядам: признак счёта, код вида, код валюты, идентификатор территории и код органа казначейства. Разбор структуры номера и таблица кодов вида счёта — в материале о <a href="/baza-znaniy/kaznacheyskiy-schet/">казначейском счёте</a>; именно по второй группе цифр видно, что перед вами счёт участника казначейского сопровождения.</p>
    ...
    <p data-ctx="auto-ctx:obsluzhivanie-scheta">Система платежей — это инфраструктура, а вот что именно в ней открывается: семь видов казначейских счетов по пункту 1 статьи 242.14 Бюджетного кодекса, включая счёт по средствам участников сопровождения, — собрано в разборе <a href="/baza-znaniy/kaznacheyskoe-obsluzhivanie/#scheta">казначейского обслуживания и его отличий от сопровождения</a>.</p>
...
<div class="refs">
      ...
      <ol>
        ...
        <li id="ref-2">Статья 242.7 БК РФ — основы функционирования системы казначейских платежей: система как совокупность участников и оператора. consultant.ru. <a href="https://www.consultant.ru/document/cons_doc_LAW_19702/" target="_blank" rel="noopener">КонсультантПлюс</a></li>
        <li id="ref-3">Статья 242.13 БК РФ — доведение средств на единый казначейский счёт; единый казначейский счёт открыт Федеральному казначейству в Банке России (балансовый счёт № 40102, переход с 01.01.2021). consultant.ru, cbr.ru. <a href="https://www.consultant.ru/document/cons_doc_LAW_19702/" target="_blank" rel="noopener">КонсультантПлюс</a></li>

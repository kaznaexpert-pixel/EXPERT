...
<h2 id="oshibki">Частые причины задержек при открытии</h2>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию; точный состав документов уточняется в вашем ТОФК. Проверено экспертом КазнаЭксперт. Дата актуализации — 11 августа 2026.</p>
    </div>

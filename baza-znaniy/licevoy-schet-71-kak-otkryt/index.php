...
<script type="application/ld+json">{
  ...
  "step": [
    ...
    },
    {
      "@type": "HowToStep",
      "position": 3,
      "name": "Сформировать заявление на открытие",
      "text": "Создать заявление на открытие лицевого счёта (изменение Книги регистрации лицевых счетов, тип «Открытие»)."
    },
    {
      "@type": "HowToStep",
      "position": 4,
      "name": "Указать код счёта и бюджет",
      "text": "Выбрать код счёта «71», указать бюджет финансирования контракта и реквизиты контракта (ИГК)."
    },
    {
      "@type": "HowToStep",
      "position": 5,
      "name": "Приложить документы и направить в ТОФК",
      "text": "Приложить документы, подписать ЭП и направить заявление в ТОФК; после проверки счёт открывается."
    }
  ]
}</script>

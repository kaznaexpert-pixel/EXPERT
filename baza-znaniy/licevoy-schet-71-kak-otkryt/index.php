...
<figcaption style="font-size:13px;color:#6E6B66;font-style:italic;margin-top:8px">Путь к счёту 71: КЭП → «Электронный бюджет» → заявление с ИГК; визит в казначейство не нужен.</figcaption>
    ...
    <p>Отдельной формы заявления на открытие лицевого счёта в Порядке № 44н нет. Форма 0531368 применяется только для резервирования номера счёта и для его закрытия. Основанием открытия служат документ-основание и карточка контракта, поступающие из информационных систем.</p>

...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#sroki">Сроки открытия</a></li>
  ...
  <article class="content" id="main">
    ...
    <h1>Как открыть лицевой счёт 71 в ТОФК: документы, порядок и сроки в 2026</h1>
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        ...
        <li><a href="#sroki">Сроки открытия</a></li><li><a href="#ecp">ЭП и Электронный бюджет</a></li>
    ...
    <div class="tldr">Лицевой счёт с кодом «71» — единый лицевой счёт, который территориальный орган Федерального казначейства (ТОФК) открывает участникам казначейского сопровождения: юрлицам, ИП и иным неучастникам бюджетного процесса. Через него проходят расчёты по контракту с санкционированием каждого платежа. Открывается счёт в электронном виде через ГИИС «Электронный бюджет» по заявлению и пакету документов; раздел по контракту ТОФК открывает, как правило, не позднее следующего рабочего дня после получения контракта.</div>
    ...
    <p data-ctx="auto-ctx:kaznacheyskoe-soprovozhdenie-municipalnyh-kontraktov">Такой счёт открывают не только по федеральным, но и по муниципальным контрактам, попавшим под сопровождение. Когда средства местного бюджета подлежат КС, разбираем в статье о <a href="/baza-znaniy/kaznacheyskoe-soprovozhdenie-municipalnyh-kontraktov/">казначейском сопровождении муниципальных контрактов</a>.</p>
    <p data-ctx="auto-ctx:kaznacheyskiy-schet-subpodryadchika">Если лицевой счёт открывает субподрядчик по контракту с КС, порядок тот же — нюансы разобраны в материале о том, <a href="/baza-znaniy/kaznacheyskiy-schet-subpodryadchika/">нужен ли казначейский счёт субподрядчику</a>.</p>
    <p data-ctx="auto-ctx:operacii-po-licevomu-schetu-pri-ks">После открытия счёта пригодится памятка о том, <a href="/baza-znaniy/operacii-po-licevomu-schetu-pri-ks/">какие операции можно проводить по лицевому счёту при КС</a>.</p>
    <div class="takeaways">
    ...
    <div class="faq">
      <details open><summary>Что означает код 71 в лицевом счёте?</summary><p>Код «71» означает, что лицевой счёт открыт неучастнику бюджетного процесса — коммерческой организации, ИП или иному исполнителю, чьи расчёты по контракту подлежат казначейскому сопровождению.</p></details>

...
<script type="application/ld+json">{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Контракт или выписка из него, заявление на открытие в «Электронном бюджете», машиночитаемая доверенность, документы по электронной подписи и включение в Сводный реестр. Карточка образцов подписей и учредительные документы для открытия счёта больше не требуются — полномочия подтверждают машиночитаемая доверенность и квалифицированная электронная подпись (приказ Казначейства № 44н в редакции приказа № 22н). Точный перечень лучше сверить с памяткой вашего ТОФК."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Нужно ли писать заявление на открытие казначейского счёта?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Да. Лицевой счёт 71 открывается по Заявлению на открытие лицевого счёта установленной формы: его подают электронно через ГИИС «Электронный бюджет» вместе с контрактом (документом-основанием), машиночитаемой доверенностью и документами по электронной подписи. Заявление подписывается усиленной квалифицированной электронной подписью — отдельного обращения в свободной форме не требуется."
      }
    }
  ]
}</script>
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <!-- neuro-open --><p>Чтобы открыть казначейский счёт (лицевой счёт с кодом «71»), исполнитель контракта подаёт электронное заявление на открытие лицевого счёта в территориальный орган Федерального казначейства (ТОФК) через ГИИС «Электронный бюджет». Основание — государственный контракт с условием о казначейском сопровождении и включение в Сводный реестр участников и неучастников бюджетного процесса. Счёт открывают в день представления корректного комплекта документов, раздел по контракту — в день получения документа-основания; номер счёта можно зарезервировать заранее.</p>
...
<desc id="fig71D">Для открытия лицевого счёта 71 нужны квалифицированная электронная подпись, подключение к ГИИС «Электронный бюджет» и электронное заявление с ИГК; счёт ТОФК открывает в день представления документов, прошедших проверку (пункт 35 Порядка № 44н).</desc>
...
<figcaption style="font-size:13px;color:#6E6B66;font-style:italic;margin-top:8px">Путь к счёту 71: КЭП → «Электронный бюджет» → заявление с ИГК; визит в казначейство не нужен.</figcaption>
    ...
    <div class="answer reveal">
      <p>Само открытие у казначейства происходит быстро: лицевой счёт открывают в день представления документов, прошедших проверку (пункт 35 Порядка № 44н), раздел по контракту — в день получения документа-основания (пункт 42), а информацию о реквизитах направляют в течение одного рабочего дня после записи в Книгу регистрации (пункт 37). Основное время на практике уходит не на саму регистрацию, а на подготовительные шаги — получение и привязку электронной подписи, подключение к ГИИС «Электронный бюджет» и сбор документов. Поэтому открытие счёта стоит начинать заранее, как только стало понятно, что контракт подпадает под сопровождение, а не в момент, когда уже нужно проводить первый платёж.</p>
    </div>
    ...
    <div class="faq">
      ...
      <details><summary>Нужно ли писать заявление на открытие казначейского счёта?</summary><p>Да. Лицевой счёт 71 открывается по Заявлению на открытие лицевого счёта установленной формы: его подают электронно через ГИИС «Электронный бюджет» вместе с контрактом (документом-основанием), машиночитаемой доверенностью и документами по электронной подписи. Заявление подписывается усиленной квалифицированной электронной подписью — отдельного обращения в свободной форме не требуется.</p></details>
    </div>

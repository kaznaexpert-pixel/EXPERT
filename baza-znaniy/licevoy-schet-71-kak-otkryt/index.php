...
<figcaption style="font-size:13px;color:#6E6B66;font-style:italic;margin-top:8px">Путь к счёту 71: КЭП → «Электронный бюджет» → заявление с ИГК; визит в казначейство не нужен.</figcaption>
    ...
    <h2 id="dokumenty">Документы для открытия счёта 71</h2>
    <div class="answer reveal">
      <p>Базовый комплект для открытия лицевого счёта обычно включает:</p>
    </div>
    <table>
      ...
      <tr><td>Карточка образцов подписей</td><td>Уполномоченные лица; в электронном виде</td></tr>
    ...
    <div class="faq">
      ...
      <details><summary>Какие документы нужны для открытия счёта 71?</summary><p>Контракт или выписка из него, заявление на открытие, карточка образцов подписей, документы по электронной подписи, согласия и сведения об организации. Точный перечень лучше сверить с памяткой вашего ТОФК.</p></details>

...
<title>Как открыть казначейский счёт (лицевой счёт 71) юрлицу в 2026</title>
...
<link rel="canonical" href="https://kaznaexpert.ru/baza-znaniy/licevoy-schet-71-kak-otkryt/">
...
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Как открыть казначейский счёт?", "acceptedAnswer": {"@type": "Answer", "text": "Получите квалифицированную электронную подпись, подключитесь к ГИИС «Электронный бюджет» и подайте электронное заявление с реквизитами контракта (ИГК). Счёт казначейство открывает в день представления документов, прошедших проверку; раздел по контракту — в день получения документа-основания. Номер счёта можно зарезервировать заранее — он действует до 6 месяцев."}}, {"@type": "Question", "name": "Что означает код 71 в лицевом счёте?", "acceptedAnswer": {"@type": "Answer", "text": "Код «71» означает, что лицевой счёт открыт неучастнику бюджетного процесса — коммерческой организации, ИП или иному исполнителю, чьи расчёты по контракту подлежат казначейскому сопровождению."}}, {"@type": "Question", "name": "Где открыть лицевой счёт 71?", "acceptedAnswer": {"@type": "Answer", "text": "В территориальном органе Федерального казначейства (ТОФК) в электронном виде через ГИИС «Электронный бюджет». Бумажная подача заменена электронной (приказ Казначейства № 22н)."}}, {"@type": "Question", "name": "Какие документы нужны для открытия счёта 71?", "acceptedAnswer": {"@type": "Answer", "text": "Контракт или выписка из него, карточка контракта из «Электронного бюджета», машиночитаемая доверенность, документы по электронной подписи и включение в Сводный реестр. Карточка образцов подписей и учредительные документы для открытия счёта больше не требуются — полномочия подтверждают машиночитаемая доверенность и квалифицированная электронная подпись (приказ Казначейства № 44н в редакции приказа № 22н). Точный перечень лучше сверить с памяткой вашего ТОФК."}}, {"@type": "Question", "name": "Сколько времени открывается счёт 71?", "acceptedAnswer": {"@type": "Answer", "text": "Лицевой счёт ТОФК открывает в день представления документов, прошедших проверку (пункт 35 Порядка № 44н); раздел по контракту — в день получения документа-основания (пункт 42). Дольше всего идут подготовительные шаги — ЭП и подключение к «Электронному бюджету»."}}, {"@type": "Question", "name": "Нужна ли электронная подпись для счёта 71?", "acceptedAnswer": {"@type": "Answer", "text": "Да. Без квалифицированной ЭП и подключения к ГИИС «Электронный бюджет» открыть счёт и работать с ним нельзя — документооборот полностью электронный."}}, {"@type": "Question", "name": "Можно ли открыть счёт 71 на ИП?", "acceptedAnswer": {"@type": "Answer", "text": "Да. Единый лицевой счёт с кодом «71» открывается юрлицам, ИП и иным исполнителям — участникам казначейского сопровождения."}}, {"@type": "Question", "name": "Можно ли свободно снимать деньги со счёта 71?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Это не расчётный счёт: каждая операция проходит санкционирование, а перечисления на расчётные счета возможны только в установленных случаях и порядке."}}, {"@type": "Question", "name": "Нужен ли отдельный счёт под каждый контракт?", "acceptedAnswer": {"@type": "Answer", "text": "Счёт «71» единый, но по каждому контракту на нём ведётся свой раздел со своим ИГК. Операции и учёт обособляются по контрактам."}}, {"@type": "Question", "name": "Когда начинать открытие счёта?", "acceptedAnswer": {"@type": "Answer", "text": "Как только стало понятно, что контракт подпадает под сопровождение. Раннее оформление ЭП и подключение к «Электронному бюджету» экономят время в начале контракта."}}, {"@type": "Question", "name": "Кто может открыть счёт под ключ?", "acceptedAnswer": {"@type": "Answer", "text": "Открытие счёта, подключение к «Электронному бюджету» и подготовку документов можно передать на сопровождение эксперту. Оставьте заявку — поможем открыть счёт и начать работу без задержек."}}, {"@type": "Question", "name": "Что такое счёт 71 при казначейском сопровождении?", "acceptedAnswer": {"@type": "Answer", "text": "Счёт с кодом «71» — это лицевой счёт неучастника бюджетного процесса (исполнителя, ИП), который ТОФК открывает для казначейского сопровождения контракта. Через него проходят все расчёты целевыми средствами, а казначейство санкционирует каждый платёж по приказу Минфина № 214н."}}, {"@type": "Question", "name": "Нужно ли подавать заявление на открытие казначейского счёта?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Отдельной формы заявления на открытие лицевого счёта в Порядке № 44н нет: форма 0531368 применяется только для резервирования номера счёта и для его закрытия. Счёт открывается на основании документа-основания и карточки контракта, которую заказчик формирует в ГИИС «Электронный бюджет» и направляет исполнителю на подписание усиленной квалифицированной электронной подписью — отдельного обращения в свободной форме не требуется."}}, {"@type": "Question", "name": "Чем лицевой счёт отличается от казначейского счёта?", "acceptedAnswer": {"@type": "Answer", "text": "Казначейский счёт — банковский счёт Федерального казначейства в Банке России (начинается с 03). Лицевой счёт — учётный счёт организации внутри казначейского: на нём отражаются именно ваши средства и операции. Исполнителю контракта открывают лицевой счёт, а в платёжных реквизитах указываются оба."}}, {"@type": "Question", "name": "Чем лицевой счёт 41 отличается от счёта 71?", "acceptedAnswer": {"@type": "Answer", "text": "Счёт с кодом 71 открывается участнику казначейского сопровождения по приказу № 44н, когда средства по контракту подлежат сопровождению. Счёт с кодом 41 предназначен для учёта операций получателя средств из бюджета и открывается в порядке приказа № 21н. Это разные основания и разные режимы использования средств, поэтому подменять один счёт другим нельзя."}}, {"@type": "Question", "name": "Можно ли открыть казначейский счёт онлайн?", "acceptedAnswer": {"@type": "Answer", "text": "Да, другого пути нет: по пункту 6 Порядка № 44н документы для резервирования, открытия и закрытия лицевого счёта 71 формируются в ГИИС «Электронный бюджет» через единый портал бюджетной системы, а по контрактам из реестра контрактов — в ЕИС. Визит в территориальный орган не требуется."}}, {"@type": "Question", "name": "Казначейский счёт для ООО и для ИП открывают одинаково?", "acceptedAnswer": {"@type": "Answer", "text": "Да, Порядок № 44н один для всех участников казначейского сопровождения. Разница только в подписантах: за ООО карточку контракта подписывает руководитель или представитель по машиночитаемой доверенности, а ИП подписывает сам своей квалифицированной подписью."}}]}</script>
<script type="application/ld+json">{
  "@context": "https://schema.org",
  "@type": "HowTo",
  ...
  "step": [
    {
      ...
      "text": "Оформить квалифицированную ЭП на уполномоченных сотрудников организации."
    },
    {
      "@type": "HowToStep",
      "position": 2,
      "name": "Подключиться к «Электронному бюджету»",
      "text": "Подать заявку на подключение к ГИИС «Электронный бюджет» и привязать ЭП."
    },
    {
      "@type": "HowToStep",
      "position": 3,
      "name": "Подписать карточку контракта",
      "text": "Дождаться карточки контракта, сформированной заказчиком в ГИИС «Электронный бюджет», и подписать её электронной подписью: по пункту 24 Порядка № 44н счёт открывается после подписания."
    },
    {
      "@type": "HowToStep",
      "position": 4,
      "name": "Проверить основание и реквизиты",
      "text": "Убедиться, что документ-основание размещён в информационных системах, а в карточке контракта указаны реквизиты контракта и идентификатор государственного контракта."
    },
    {
      "@type": "HowToStep",
      "position": 5,
      "name": "Получить реквизиты счёта",
      "text": "После проверки документов территориальный орган открывает лицевой счёт с кодом 71 в день их представления, раздел по контракту — в день получения документа-основания."
    }
  ]
}</script>
...
<meta property="og:title" content="Как открыть казначейский счёт (лицевой счёт 71) юрлицу в 2026">
...
<meta name="twitter:title" content="Как открыть казначейский счёт (лицевой счёт 71) юрлицу в 2026">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      <li><a href="#chto-takoe">Что такое счёт 71</a></li>
      <li><a href="#komu">Кому и когда нужен</a></li>
      <li><a href="#kaznacheyskiy-schet-kak-otkryt">Казначейский счёт и счёт 71</a></li>
      <li><a href="#shagi">Как открыть: пошагово</a></li>
      <li><a href="#dokumenty">Документы</a></li>
      <li><a href="#sroki">Сроки открытия</a></li><li><a href="#rezerv">Резервирование заранее</a></li>
      <li><a href="#ecp">ЭП и Электронный бюджет</a></li>
      <li><a href="#posle">Работа со счётом</a></li>
      <li><a href="#oshibki">Частые задержки</a></li>
  ...
  <article class="content" id="main">
    ...
    <h1>Как открыть казначейский счёт (лицевой счёт 71) юридическому лицу в 2026</h1>
    ...
    <div class="share">
      ...
      <a href="https://t.me/share/url?url=https%3A%2F%2Fkaznaexpert.ru%2Fbaza-znaniy%2Flicevoy-schet-71-kak-otkryt%2F&amp;text=Как%20открыть%20лицевой%20счёт%2071%20в%20ТОФК" target="_blank" rel="noopener"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.56 8.25l-1.86 8.76c-.14.62-.5.77-1.02.48l-2.82-2.08-1.36 1.31c-.15.15-.28.28-.57.28l.2-2.89 5.27-4.76c.23-.2-.05-.32-.35-.12l-6.51 4.1-2.8-.88c-.61-.19-.62-.61.13-.9l10.95-4.22c.5-.18.95.12.79.85z"/></svg>Telegram</a>
    ...
    <details><summary>Чем лицевой счёт отличается от казначейского счёта?</summary><p>Казначейский счёт — банковский счёт Федерального казначейства в Банке России (начинается с 03). Лицевой счёт — учётный счёт организации внутри казначейского: на нём отражаются именно ваши средства и операции. Исполнителю контракта открывают лицевой счёт, а в платёжных реквизитах указываются оба.</p></details>
      ...
      <ol>
        ...
        <li><a href="#sroki">Сроки открытия</a></li><li><a href="#rezerv">Резервирование заранее</a></li><li><a href="#ecp">ЭП и Электронный бюджет</a></li>
        <li><a href="#posle">Работа со счётом</a></li><li><a href="#oshibki">Частые задержки</a></li>
        <li><a href="#keys">Пример из практики</a></li><li><a href="#glossary">Глоссарий</a></li><li><a href="#faq">FAQ</a></li>
      </ol>
    </details>

    <div class="tldr"><b>Казначейский счёт</b> — так в обиходе называют лицевой счёт с кодом «71», который территориальный орган Федерального казначейства (ТОФК) открывает участникам казначейского сопровождения: юрлицам, ИП и иным неучастникам бюджетного процесса. Через него проходят расчёты по контракту с санкционированием каждого платежа. <b>Как открыть казначейский счёт:</b> получить квалифицированную электронную подпись, подключиться к ГИИС «Электронный бюджет» и подать электронное заявление с реквизитами контракта (ИГК). Территориальный орган Федерального казначейства открывает лицевой счёт в день представления документов, прошедших проверку (пункт 35 Порядка № 44н), а очередной раздел по контракту — в день получения документа-основания (пункт 42). Уведомление об открытии раздела приходит не позднее следующего рабочего дня. Если открывать счёт самостоятельно некогда — <a href="/uslugi/otkrytie-scheta/" data-ctx="radar-0918:svc">услуга открытия казначейского счёта под ключ</a>.</div>

    <section class="keyfacts grain" aria-label="Ключевые факты">
      <h2>Коротко о главном</h2>
      <div class="keyfacts__grid">
        <div class="kf"><div class="kf__n">код «71»</div><div class="kf__t"><b>Единый лицевой счёт</b> участника казначейского сопровождения</div></div>
        <div class="kf"><div class="kf__n">ГИИС ЭБ</div><div class="kf__t"><b>Где открывают</b> — электронно в «Электронном бюджете»</div></div>
        <div class="kf"><div class="kf__n">№ 22н</div><div class="kf__t"><b>Приказ Казначейства</b> — электронная подача документов</div></div>
        <div class="kf"><div class="kf__n">в день подачи</div><div class="kf__t"><b>Срок</b> открытия раздела после получения контракта ТОФК</div></div>
        <div class="kf"><div class="kf__n">ЭП</div><div class="kf__t"><b>Нужна</b> квалифицированная электронная подпись</div></div>
        <div class="kf"><div class="kf__n">не банк</div><div class="kf__t"><b>Не расчётный счёт</b> — операции под санкционированием ТОФК</div></div>
      </div>
    </section>
    <!-- svc-cta:top -->
    ...
    <h2 id="chto-takoe">Что такое лицевой счёт 71</h2>
    <div class="answer reveal">
      <p class="lead-p">Лицевой счёт с кодом «71» — это единый лицевой счёт, который ведёт территориальный орган Федерального казначейства (<span class="term" tabindex="0" data-tip="Территориальный орган Федерального казначейства — ведёт лицевой счёт и санкционирует операции.">ТОФК</span>) для участника казначейского сопровождения. Код «71» в номере счёта означает, что счёт открыт неучастнику бюджетного процесса — коммерческой организации, ИП или иному исполнителю, чьи расчёты по контракту подлежат казначейскому сопровождению.</p>
    </div>

    <h3>Чем счёт 71 отличается от расчётного счёта в банке</h3>
    <p>Принципиальное отличие от обычного расчётного счёта в банке: средствами на счёте «71» нельзя распоряжаться свободно. Каждая операция проходит санкционирование — казначейство проверяет её на соответствие контракту, целевому назначению и наличию документов. Поэтому счёт «71» — это не банковский счёт, а инструмент целевого контроля расходования средств по контракту.</p>

    <h2 id="komu">Кому и когда нужен счёт 71</h2>
    <div class="answer reveal">
      <p>Открыть лицевой счёт «71» нужно исполнителю, чей контракт попал под казначейское сопровождение. Перечень случаев и пороги на конкретный год задаёт закон о федеральном бюджете. На 2026 год основные пороги установлены статьёй 5 Федерального закона № 426-ФЗ<a class="fn" href="#ref-2" aria-label="Источник 2">[2]</a>.</p>
    <p class="note" id="sosednie-kody">Код 71 — не единственный: неучастнику казначейского сопровождения может открываться и счёт 41 для учёта средств из бюджета, а порядок открытия у них разный — счёт 71 по приказу № 44н, счёт 41 по приказу № 21н. Полная расшифровка кодов — в отдельном разборе: <a href="/baza-znaniy/vidy-licevyh-schetov-v-kaznachejstve/">виды лицевых счетов и их коды &rarr;</a>; коды направления расходования средств разобраны в <a href="/baza-znaniy/kody/">справочнике кодов &rarr;</a>.</p>
    <p class="note">Счёт нужен к подписанию контракта, а любая ошибка в документах сдвигает срок — <a href="/uslugi/otkrytie-scheta/">откроем лицевой счёт за вас &rarr;</a></p>
    </div>
    <table>
      <caption>Когда нужен лицевой счёт 71 (основные случаи, 2026)</caption>
      <tr><th>Случай</th><th>Порог</th></tr>
      <tr><td>Расчёты по контрактам ГОЗ и контрактам в их исполнение</td><td>свыше 3 млн ₽</td></tr>
      <tr><td>Авансы по государственным контрактам</td><td>от 100 млн ₽</td></tr>
      <tr><td>Авансы по контрактам бюджетных и автономных учреждений</td><td>от 10 млн ₽</td></tr>
      <tr><td>Субсидии и бюджетные инвестиции юрлицам</td><td>по решению о предоставлении</td></tr>
    </table>
    ...
    <h3>«Лицевой счёт» и «казначейский счёт» — про одно и то же</h3>
    ...
    <h2 id="kaznacheyskiy-schet-kak-otkryt">Казначейский счёт и лицевой счёт 71: как открыть и чем они отличаются</h2>
    <div class="answer reveal">
      <p>Запрос «казначейский счёт: как открыть» для исполнителя контракта означает одно — лицевой счёт с кодом 71 в территориальном органе Федерального казначейства. Сам казначейский счёт открыть юридическому лицу нельзя: по пункту 8.1 Порядка № 15н его открывает Казначейство своему территориальному органу, а деньги участников сопровождения учитываются на нём через лицевые счета (пункт 2 статьи 242.14 Бюджетного кодекса)<a class="fn" href="#ref-5" aria-label="Источник 5">[5]</a>.</p>
    </div>

    <h3 id="chem-otlichaetsya-kaznacheyskiy-ot-licevogo">Чем казначейский счёт отличается от лицевого счёта 71</h3>
    <table>
      <caption>Казначейский счёт и лицевой счёт 71: кому открывают и на каком основании</caption>
      <tr><th>Признак</th><th>Казначейский счёт</th><th>Лицевой счёт 71</th></tr>
      <tr><td>Кому открывают</td><td>Территориальному органу Казначейства или финансовому органу региона</td><td>Юридическому лицу, ИП — участнику казначейского сопровождения</td></tr>
      <tr><td>Кто открывает</td><td>Федеральное казначейство (пункт 3 статьи 242.14 БК, Порядок № 15н)</td><td>Территориальный орган Казначейства (Порядок № 44н)</td></tr>
      <tr><td>Что на нём</td><td>Средства всех участников сопровождения по источнику финансирования</td><td>Средства одной организации, разделы по контрактам</td></tr>
          </table>
    <p>Практический вывод: в реквизитах для заказчика указывают оба номера — казначейский счёт территориального органа и ваш лицевой счёт 71.</p>

    <h3 id="kak-otkryt-kaznacheyskiy-schet-ooo">Как открыть казначейский счёт юридическому лицу (ООО): порядок в пяти шагах</h3>
    <p>Открыть казначейский счёт юридического лица — то есть лицевой счёт 71 — можно за пять шагов; каждый подробно разобран выше по ссылкам.</p>
    <ol class="steps">
      <li>Убедиться, что контракт подпадает под сопровождение и содержит казначейскую оговорку — <a href="#komu">кому и когда нужен счёт 71</a>.</li>
      <li>Получить квалифицированную электронную подпись, оформить МЧД, подключиться к ГИИС «Электронный бюджет» — <a href="#ecp">подпись и подключение</a>.</li>
      <li>Проверить запись в Сводном реестре — <a href="#dokumenty">документы и пререквизиты</a>.</li>
      <li>Дождаться карточки контракта от заказчика и подписать её — <a href="#shagi">пошаговый порядок</a>.</li>
      <li>Получить реквизиты: счёт открывают в день представления документов, раздел — в день получения документа-основания — <a href="#sroki">сроки открытия</a>.</li>
    </ol>

    <h3 id="kaznacheyskiy-schet-ooo-s-1-sentyabrya-2026">Казначейский счёт: как открыть для ООО с 1 сентября 2026 и что изменилось</h3>
    <p>Казначейский счёт как открыть для ООО после 1 сентября 2026 — так же, как и раньше: приказ Казначейства от 22.06.2026 № 14н изменил Порядок № 44н, но порядок открытия лицевого счёта не тронул<a class="fn" href="#ref-7" aria-label="Источник 7">[7]</a>. Утратили силу пункты 7, 31–33, 35.1, 36, 40 и приложения 4–8 — всё это касалось казначейского мониторинга, который вынесен в постановление Правительства от 27.07.2026 № 941. Пункт 35 в новой редакции стал короче: территориальный орган открывает счёт в день представления документов, прошедших проверку, — без дополнительных оговорок<a class="fn" href="#ref-6" aria-label="Источник 6">[6]</a>.</p>

    <h2 id="shagi">Как открыть лицевой счёт 71: пошагово</h2>
    <div class="answer reveal">
      <!-- neuro-open --><p>Казначейский счёт (лицевой счёт с кодом «71») открывается через ГИИС «Электронный бюджет» на основании государственного контракта с условием о казначейском сопровождении. Заказчик формирует карточку контракта, исполнитель подписывает её электронной подписью — и территориальный орган Федерального казначейства открывает счёт в день представления документов, прошедших проверку.</p>
      <h3>Что должно быть готово заранее</h3>
    <p>Организация при этом должна быть включена в Сводный реестр участников и неучастников бюджетного процесса, а полномочия подписантов — подтверждены машиночитаемой доверенностью. Номер счёта можно зарезервировать заранее, до подписания контракта.</p>
      <h3>Бумажной подачи больше нет</h3>
    <p>Весь документооборот электронный: с 17 марта 2025 года приказ Федерального казначейства № 22н от 06.12.2024 исключил бумажный путь подачи документов<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a>.</p>
    </div>
<figure class="kx-fig" style="margin:26px 0 6px;overflow-x:auto" data-fig="fig71">
<svg viewBox="0 0 680 392" role="img" aria-labelledby="fig71T fig71D" style="display:block;width:100%;max-width:680px;height:auto;font-family:'Inter',-apple-system,'Segoe UI',sans-serif">
<title id="fig71T">Как открыть лицевой счёт 71: три шага</title>
<desc id="fig71D">Для открытия лицевого счёта 71 нужны квалифицированная электронная подпись, подключение к ГИИС «Электронный бюджет» и подписанная карточка контракта с ИГК; счёт ТОФК открывает в день представления документов, прошедших проверку (пункт 35 Порядка № 44н).</desc>
<circle cx="44" cy="42" r="21" fill="rgba(139,111,71,.12)" stroke="#8B6F47"/><text x="44" y="49" text-anchor="middle" font-size="17" font-weight="600" fill="#8B6F47">1</text><rect x="86" y="12" width="586" height="62" rx="12" fill="#FBF9F4" stroke="rgba(26,26,26,.18)"/><text x="106" y="39" font-size="16" font-weight="600" fill="#1A1A1A">Квалифицированная электронная подпись</text><text x="106" y="60" font-size="13.5" fill="#6E6B66">КЭП на руководителя или уполномоченное лицо</text><line x1="44" y1="63" x2="44" y2="119" stroke="rgba(139,111,71,.5)" stroke-width="1.6"/><circle cx="44" cy="138" r="21" fill="rgba(139,111,71,.12)" stroke="#8B6F47"/><text x="44" y="145" text-anchor="middle" font-size="17" font-weight="600" fill="#8B6F47">2</text><rect x="86" y="108" width="586" height="62" rx="12" fill="#FBF9F4" stroke="rgba(26,26,26,.18)"/><text x="106" y="135" font-size="16" font-weight="600" fill="#1A1A1A">Подключение к ГИИС «Электронный бюджет»</text><text x="106" y="156" font-size="13.5" fill="#6E6B66">рабочее место, сертификаты, доступ в личный кабинет</text><line x1="44" y1="159" x2="44" y2="215" stroke="rgba(139,111,71,.5)" stroke-width="1.6"/><circle cx="44" cy="234" r="21" fill="rgba(139,111,71,.12)" stroke="#8B6F47"/><text x="44" y="241" text-anchor="middle" font-size="17" font-weight="600" fill="#8B6F47">3</text><rect x="86" y="204" width="586" height="62" rx="12" fill="#FBF9F4" stroke="rgba(26,26,26,.18)"/><text x="106" y="231" font-size="16" font-weight="600" fill="#1A1A1A">Электронное заявление с реквизитами контракта</text><text x="106" y="252" font-size="13.5" fill="#6E6B66">ИГК обязателен; подача — без визита в ТОФК</text><line x1="44" y1="255" x2="44" y2="318" stroke="rgba(139,111,71,.5)" stroke-width="1.6"/><rect x="86" y="306" width="586" height="64" rx="12" fill="rgba(139,111,71,.10)" stroke="#8B6F47"/><text x="106" y="334" font-size="16" font-weight="600" fill="#1A1A1A">Лицевой счёт открыт</text><text x="106" y="355" font-size="13.5" fill="#6E6B66">в день представления документов, прошедших проверку</text></svg>
<figcaption style="font-size:13px;color:#6E6B66;font-style:italic;margin-top:8px">Путь к счёту 71: КЭП → «Электронный бюджет» → заявление с ИГК; визит в казначейство не нужен.</figcaption>
</figure>
    <table>
      <caption>Порядок открытия лицевого счёта 71</caption>
      <tr><th>Шаг</th><th>Действие</th></tr>
      <tr><td>1</td><td>Получить квалифицированную электронную подпись на уполномоченных сотрудников</td></tr>
      <tr><td>2</td><td>Подключиться к ГИИС «Электронный бюджет» (подать заявку на подключение, привязать ЭП)</td></tr>
      <tr><td>3</td><td>Дождаться карточки контракта: её формирует заказчик в «Электронном бюджете» и направляет исполнителю</td></tr>
      <tr><td>4</td><td>Проверить в карточке код счёта «71», бюджет финансирования и реквизиты контракта (ИГК)</td></tr>
      <tr><td>5</td><td>Подписать карточку электронной подписью уполномоченного лица по машиночитаемой доверенности</td></tr>
      <tr><td>6</td><td>После проверки ТОФК счёт открывается, реквизиты доступны в «Электронном бюджете»</td></tr>
    </table>

    <h2 id="dokumenty">Документы для открытия казначейского счёта (счёта 71) в 2026 году</h2>
    <div class="answer reveal">
      <p>Для открытия казначейского (лицевого) счёта участника казначейского сопровождения в 2026 году нужны: контракт или выписка из него как документ-основание, карточка контракта, машиночитаемая доверенность на уполномоченных лиц, документы по электронной подписи и включение в Сводный реестр. <b>Карточка образцов подписей и учредительные документы для открытия лицевого счёта больше не требуются</b> — полномочия подтверждаются машиночитаемой доверенностью и усиленной квалифицированной электронной подписью (приказ Казначейства № 44н в редакции приказа № 22н от 06.12.2024).</p>
    </div>
    <table>
      <caption>Документы для открытия лицевого счёта 71</caption>
      <tr><th>Документ</th><th>Назначение</th></tr>
      <tr><td>Контракт или выписка из него</td><td>Основание открытия счёта, источник ИГК и условий сопровождения</td></tr>
      <tr><td>Карточка контракта (договора)</td><td>Формирует заказчик в «Электронном бюджете» и направляет исполнителю на подписание</td></tr>
      <tr><td>Машиночитаемая доверенность (МЧД)</td><td>Подтверждает полномочия подписантов — заменяет карточку образцов подписей</td></tr>
      <tr><td>Включение в Сводный реестр</td><td>Обязательный пререквизит: без записи ТОФК не примет документы на счёт</td></tr>
      <tr><td>Документы по электронной подписи</td><td>Сертификаты ЭП уполномоченных сотрудников</td></tr>
      <tr><td>Согласия и сведения об организации</td><td>Реквизиты, согласия на обработку данных</td></tr>
    </table>
    <h3>Что больше не требуется</h3>
    <p>Карточка образцов подписей, учредительные документы и нотариальные доверенности из процедуры ушли. Пункты 25–28 Порядка № 44н, которые их регулировали, утратили силу с 17 марта 2025 года. Полномочия подтверждает машиночитаемая доверенность, подлинность документа — усиленная квалифицированная электронная подпись.</p>

    <h3>Кто подаёт документы: заказчик или исполнитель</h3>
    <p>Первый шаг делает заказчик, а не исполнитель. Заказчик формирует карточку контракта в «Электронном бюджете» и направляет её исполнителю на подписание. Счёт открывается после того, как исполнитель подписал карточку своей электронной подписью. Отдельного заявления на открытие подавать не нужно.</p>

    <h3>Нужно ли заявление на открытие счёта</h3>
    <p>Отдельной формы заявления на открытие лицевого счёта в Порядке № 44н нет. <a href="/baza-znaniy/rezervirovanie-kaznacheyskogo-scheta/#obrazec-0531368">Форма 0531368</a> применяется только для резервирования номера счёта и для его закрытия. Основанием открытия служат документ-основание и карточка контракта, поступающие из информационных систем.</p>

    <h3>Сводный реестр — скрытый пререквизит</h3>
    <p data-ctx="auto-ctx:svodnyy-reestr">Организация должна быть включена в <a href="/baza-znaniy/svodnyy-reestr/">сводный реестр участников и неучастников бюджетного процесса</a>. Пункт 24 Порядка № 44н прямо связывает открытие счёта с наличием записи в реестре. Нет записи — территориальный орган не примет документы; включение обычно совмещают с подачей на открытие.</p>

    <div class="note"><b>Совет.</b> Точный перечень и формы лучше сверять с памяткой вашего ТОФК на сайте Казначейства региона — состав может уточняться. Большинство задержек возникает именно из-за неполного или неверно оформленного пакета.</div>

    <div class="note" data-ctx="dl-checklist"><b>Чек-лист · PDF.</b> Полный маршрут — от сводного реестра и подписи до первого платежа — в печатном виде: <a href="/files/checklist-pervyy-kontrakt-ks.pdf" download>скачать чек-лист выхода на первый контракт (PDF)</a>.</div>

    <h2 id="sroki">Сроки открытия счёта</h2>
    <div class="answer reveal">
      <p>Лицевой счёт открывают <b>в день представления документов</b>, прошедших проверку — так установлено пунктом 35 Порядка № 44н. Проверку документов территориальный орган проводит в день их поступления (пункт 29). Отдельного срока «три рабочих дня» для открытия счёта в Порядке нет.</p>
    </div>

    <h3>Сколько ждать реквизиты и раздел по контракту</h3>
    <p>Информацию о реквизитах открытого счёта направляют в течение одного рабочего дня после записи в Книгу регистрации (пункт 37). Очередной раздел по новому контракту открывают в день получения документа-основания, а уведомление об этом приходит не позднее следующего рабочего дня (пункт 42).</p>

    <h3>Что будет, если в документах ошибка</h3>
    <p>Документы вернут не позднее рабочего дня, следующего за днём представления (пункт 34), и цикл начнётся заново. Именно возвраты, а не работа казначейства, растягивают срок: каждая итерация стоит несколько дней.</p>

    <h3>Почему на практике счёт открывают дольше</h3>
    <p>Основное время уходит не на регистрацию, а на подготовку: получение и привязку электронной подписи, подключение к ГИИС «Электронный бюджет», включение в сводный реестр и сбор документов. Начинать стоит сразу, как стало понятно, что контракт подпадает под сопровождение, — а не когда пора проводить <a href="/baza-znaniy/operacii-po-licevomu-schetu-pri-ks/#kak-rabotat">первый платёж</a>.</p>

    <h2 id="rezerv">Резервирование казначейского счёта заранее</h2>
    <div class="answer reveal">
      <p>Если счёт нужен к подаче заявки или к подписанию контракта, его номер можно <b>зарезервировать заранее</b> в личном кабинете ГИИС «Электронный бюджет» — без направления документа-основания в ТОФК. Это удобно участникам тендеров: реквизиты будущего счёта можно указать в контракте ещё до его заключения. Зарезервированный номер действует <b>до 6 месяцев</b>; если за этот срок документы на открытие счёта не поданы, резерв аннулируется. Подробнее — в услуге <a href="/uslugi/rezervirovanie-scheta/">«Резервирование счёта по ГОЗ»</a>.</p>
      <p>Ещё один нюанс на перспективу: с 1 сентября 2026 года при открытии лицевых счетов и проведении операций Федеральное казначейство проводит <b>казначейский мониторинг</b> — дополнительную проверку участников. Это лишний довод готовить документы заранее и без ошибок.</p>
    </div>

    <h2 id="ecp">Электронная подпись и подключение к «Электронному бюджету»</h2>
    <div class="answer reveal">
      <p>Без квалифицированной электронной подписи и подключения к ГИИС «Электронный бюджет» открыть счёт «71» и работать с ним нельзя — весь документооборот ведётся электронно. ЭП оформляется на уполномоченных сотрудников (как правило, руководителя и ответственных исполнителей), затем привязывается к профилю организации в системе. Срок действия подписи нужно контролировать: истёкшая ЭП блокирует и открытие счёта, и последующие операции — это одна из частых причин задержек и отказов.</p>
    </div>

    <h2 id="posle">Как работать со счётом после открытия</h2>
    <div class="answer reveal">
      <p>После открытия счёта работа строится вокруг санкционирования: по контракту утверждаются сведения об операциях с целевыми средствами (структура расходов по кодам направления расходования), а каждый платёж сопровождается подтверждающими документами и проходит проверку ТОФК. Свободно вывести средства на расчётный счёт нельзя — перечисления возможны только в установленных случаях и порядке. Чтобы платежи не возвращали, их проверяют до отправки; типичные причины отказов и чек-лист разобраны в материале <a href="/baza-znaniy/prichiny-otkaza-kaznacheystva-v-sankcionirovanii/">«Причины отказа казначейства в санкционировании»</a>.</p>
    </div>

        <h3>Когда счёт придётся закрыть</h3>
    <p>Счёт живёт, пока есть хотя бы один действующий раздел. После исполнения контракта закрывается раздел, а весь лицевой счёт — при ликвидации, реорганизации или после двух лет без операций. Порядок, форма 0531368 и судьба остатка разобраны в материале <a href="/baza-znaniy/zakrytie-licevogo-scheta-v-kaznachejstve/">«Закрытие лицевого счёта в казначействе»</a>.</p>

<h2 id="oshibki">Частые причины задержек при открытии</h2>
    <div class="answer reveal">
      <p>Большинство задержек возникает не у казначейства, а на стороне исполнителя:</p>
    <p class="note">Каждая из этих задержек лечится корректным пакетом с первого раза: документы готовит эксперт, статус контролируем до открытия — <a href="/uslugi/otkrytie-scheta/">открытие счёта под ключ &rarr;</a></p>
    </div>
    <table>
      <caption>Что чаще всего задерживает открытие счёта 71</caption>
      <tr><th>Причина</th><th>Как избежать</th></tr>
      <tr><td>Нет действующей ЭП</td><td>Оформить и привязать ЭП заранее, проверить срок действия</td></tr>
      <tr><td>Не пройдено подключение к «Электронному бюджету»</td><td>Подать заявку на подключение до открытия счёта</td></tr>
      <tr><td>Неполный или неверно оформленный пакет документов</td><td>Сверить состав с памяткой ТОФК, проверить реквизиты и формы</td></tr>
      <tr><td>Нет казначейской оговорки/ИГК в контракте</td><td>Проверить контракт на условия сопровождения до подачи</td></tr>
      <tr><td>Ошибки в выборе бюджета/кода счёта в заявлении</td><td>Указывать бюджет финансирования контракта и код «71» корректно</td></tr>
    </table>

    <h2 id="keys">Пример из практики</h2>
    <div class="answer reveal">
      <p>Типичная ситуация: исполнитель выигрывает контракт под казначейское сопровождение и начинает открывать счёт за пару дней до первого платежа. Оказывается, что электронная подпись оформлена не на всех нужных сотрудников, а подключение к «Электронному бюджету» ещё не завершено — в итоге открытие счёта и первый платёж сдвигаются. Правильный порядок обратный: как только видно, что контракт подпадает под сопровождение, сразу оформляют ЭП, подключаются к ГИИС и готовят пакет документов. Тогда карточка контракта проходит проверку без задержек, а счёт открывается в день представления документов — и исполнитель не теряет время в начале контракта.</p>
    </div>

    <h3>Смежные ситуации: куда смотреть дальше</h3>
    ...
    <p data-ctx="auto-ctx:vidy-licevyh-schetov-v-kaznachejstve">Счёт с кодом «71» — лишь один из видов лицевых счетов в казначействе. Полную расшифровку кодов 01, 03, 05, 41, 71 и других мы собрали в материале о <a href="/baza-znaniy/vidy-licevyh-schetov-v-kaznachejstve/">видах лицевых счетов в казначействе</a>.</p>
    <p data-ctx="auto-ctx:kaznacheyskoe-soprovozhdenie-municipalnyh-kontraktov">Такой счёт открывают не только по федеральным, но и по муниципальным контрактам, попавшим под сопровождение. Когда средства местного бюджета подлежат казначейскому сопровождению, разбираем в статье о <a href="/baza-znaniy/kaznacheyskoe-soprovozhdenie-municipalnyh-kontraktov/">казначейском сопровождении муниципальных контрактов</a>.</p>
    <p data-ctx="auto-ctx:kaznacheyskiy-schet-subpodryadchika">Если лицевой счёт открывает субподрядчик по контракту с казначейским сопровождением, порядок тот же — нюансы разобраны в материале о том, <a href="/baza-znaniy/kaznacheyskiy-schet-subpodryadchika/">нужен ли казначейский счёт субподрядчику</a>.</p>
    ...
    <div class="takeaways">
      ...
      <ol>
        <li>Счёт «71» — единый лицевой счёт участника казначейского сопровождения; ведёт его ТОФК.</li>
        <li>Это не банковский счёт: каждая операция проходит санкционирование.</li>
        <li>Открытие — электронно через ГИИС «Электронный бюджет» (приказ Казначейства № 22н).</li>
        <li>Раздел по контракту открывается обычно на следующий рабочий день; дольше всего идут подготовительные шаги.</li>
        <li>ЭП и подключение к «Электронному бюджету» нужно готовить заранее — это главная причина задержек.</li>
      </ol>
    </div>

    <h2 id="glossary">Глоссарий</h2>
    <dl class="gloss">
      <div><dt>Счёт «71»</dt><dd>Единый лицевой счёт участника казначейского сопровождения в ТОФК.</dd></div>
      <div><dt>ТОФК</dt><dd>Территориальный орган Федерального казначейства.</dd></div>
      <div><dt>ГИИС «ЭБ»</dt><dd>Электронный бюджет — система электронного взаимодействия с казначейством.</dd></div>
      <div><dt>ИГК</dt><dd>Идентификатор государственного контракта, 25 знаков.</dd></div>
      <div><dt>ЭП</dt><dd>Квалифицированная электронная подпись.</dd></div>
      <div><dt>Санкционирование</dt><dd>Проверка ТОФК операции перед списанием средств.</dd></div>
      <div><dt>Казначейская оговорка</dt><dd>Условие контракта о казначейском сопровождении расчётов.</dd></div>
      <div><dt>Неучастник бюджетного процесса</dt><dd>Коммерческая организация, ИП — получатель целевых средств.</dd></div>
    </dl>
<p data-ctx="auto-ctx:auts-0903-3">Открытие счёта — первый шаг; дальше идут Сведения, платежи и отчётность. Весь цикл целиком можно передать на <a href="/uslugi/autsorsing-kaznacheyskogo-soprovozhdeniya/">аутсорсинг казначейского сопровождения</a>, оставив себе только подписание документов.</p>

    <h2 id="faq">Частые вопросы</h2>
    <div class="faq">
      <details><summary>Чем лицевой счёт 41 отличается от счёта 71?</summary><p>Счёт с кодом 71 открывается участнику казначейского сопровождения по приказу № 44н, когда средства по контракту подлежат сопровождению. Счёт с кодом 41 предназначен для учёта операций получателя средств из бюджета и открывается в порядке приказа № 21н. Это разные основания и разные режимы использования средств, поэтому подменять один счёт другим нельзя.</p></details>
      <details open><summary>Как открыть казначейский счёт?</summary><p>Получите квалифицированную электронную подпись, подключитесь к ГИИС «Электронный бюджет» и подайте электронное заявление с реквизитами контракта (ИГК). Счёт казначейство открывает в день представления документов, прошедших проверку; раздел по контракту — в день получения документа-основания. Номер счёта можно зарезервировать заранее — он действует до 6 месяцев.</p></details>
      <details><summary>Что означает код 71 в лицевом счёте?</summary><p>Код «71» означает, что лицевой счёт открыт неучастнику бюджетного процесса — коммерческой организации, ИП или иному исполнителю, чьи расчёты по контракту подлежат казначейскому сопровождению.</p></details>
      <details><summary>Где открыть лицевой счёт 71?</summary><p>В территориальном органе Федерального казначейства (ТОФК) в электронном виде через ГИИС «Электронный бюджет». Бумажная подача заменена электронной (приказ Казначейства № 22н).</p></details>
      <details><summary>Какие документы нужны для открытия счёта 71?</summary><p>Контракт или выписка из него, карточка контракта из «Электронного бюджета», машиночитаемая доверенность, документы по электронной подписи и включение в Сводный реестр. Карточка образцов подписей и учредительные документы для открытия счёта больше не требуются — полномочия подтверждают машиночитаемая доверенность и квалифицированная электронная подпись (приказ Казначейства № 44н в редакции приказа № 22н). Точный перечень лучше сверить с памяткой вашего ТОФК.</p></details>
      <details><summary>Сколько времени открывается счёт 71?</summary><p>Лицевой счёт ТОФК открывает в день представления документов, прошедших проверку (пункт 35 Порядка № 44н); раздел по контракту — в день получения документа-основания (пункт 42). Дольше всего идут подготовительные шаги — ЭП и подключение к «Электронному бюджету».</p></details>
      <details><summary>Нужна ли электронная подпись для счёта 71?</summary><p>Да. Без квалифицированной ЭП и подключения к ГИИС «Электронный бюджет» открыть счёт и работать с ним нельзя — документооборот полностью электронный.</p></details>
      <details><summary>Можно ли открыть счёт 71 на ИП?</summary><p>Да. Единый лицевой счёт с кодом «71» открывается юрлицам, ИП и иным исполнителям — участникам казначейского сопровождения.</p></details>
      <details><summary>Можно ли свободно снимать деньги со счёта 71?</summary><p>Нет. Это не расчётный счёт: каждая операция проходит санкционирование, а перечисления на расчётные счета возможны только в установленных случаях и порядке.</p></details>
      <details><summary>Нужен ли отдельный счёт под каждый контракт?</summary><p>Счёт «71» единый, но по каждому контракту на нём ведётся свой раздел со своим ИГК. Операции и учёт обособляются по контрактам.</p></details>
      <details><summary>Когда начинать открытие счёта?</summary><p>Как только стало понятно, что контракт подпадает под сопровождение. Раннее оформление ЭП и подключение к «Электронному бюджету» экономят время в начале контракта.</p></details>
      <details><summary>Кто может открыть счёт под ключ?</summary><p>Открытие счёта, подключение к «Электронному бюджету» и подготовку документов можно передать на сопровождение эксперту. Оставьте заявку — поможем открыть счёт и начать работу без задержек.</p></details>
      <details><summary>Что такое счёт 71 при казначейском сопровождении?</summary><p>Счёт с кодом «71» — это лицевой счёт неучастника бюджетного процесса (исполнителя, ИП), который ТОФК открывает для казначейского сопровождения контракта. Через него проходят все расчёты целевыми средствами, а казначейство санкционирует каждый платёж по приказу Минфина № 214н.</p></details>
    
      <details><summary>Нужно ли подавать заявление на открытие казначейского счёта?</summary><p>Нет. Отдельной формы заявления на открытие лицевого счёта в Порядке № 44н нет: форма 0531368 применяется только для резервирования номера счёта и для его закрытия. Счёт открывается на основании документа-основания и карточки контракта, которую заказчик формирует в ГИИС «Электронный бюджет» и направляет исполнителю на подписание усиленной квалифицированной электронной подписью — отдельного обращения в свободной форме не требуется.</p></details>
      <details><summary>Можно ли открыть казначейский счёт онлайн?</summary><p>Да, другого пути нет: по пункту 6 Порядка № 44н документы для резервирования, открытия и закрытия лицевого счёта 71 формируются в ГИИС «Электронный бюджет» через единый портал бюджетной системы, а по контрактам из реестра контрактов — в ЕИС. Визит в территориальный орган не требуется.</p></details>
      <details><summary>Казначейский счёт для ООО и для ИП открывают одинаково?</summary><p>Да, Порядок № 44н один для всех участников казначейского сопровождения. Разница только в подписантах: за ООО карточку контракта подписывает руководитель или представитель по машиночитаемой доверенности, а ИП подписывает сам своей квалифицированной подписью.</p></details>
    </div>

    <p data-ctx="auto-ctx:usl-rezerv">Если счёт нужен «к дате» — например, к заключению контракта по итогам тендера, — используйте <a href="/uslugi/rezervirovanie-scheta/">резервирование казначейского счёта</a>: подготовим всё заранее, откроем к нужному дню.</p>
    ...
    <div class="note">Открываете счёт в своём регионе? Код, адрес и официальный сайт вашего ТОФК — в <a href="/baza-znaniy/tofk/">справочнике казначейств по регионам</a>: эти данные нужны при открытии счёта.</div>
...
<div class="refs">
      ...
      <ol>
        <li id="ref-1">Приказ Федерального казначейства от 06.12.2024 № 22н (электронное взаимодействие при открытии и ведении лицевых счетов) — <a href="http://publication.pravo.gov.ru/" target="_blank" rel="noopener">pravo.gov.ru</a></li>
        <li id="ref-2">Федеральный закон от 28.11.2025 № 426-ФЗ «О федеральном бюджете на 2026 год...», ст. 5 — <a href="https://www.consultant.ru/document/cons_doc_LAW_520057/d6ac9d5890b286aa7d2de73aa8fb56eecf6d610b/" target="_blank" rel="noopener">consultant.ru</a></li>
        ...
        <li id="ref-5">Приказ Федерального казначейства от 01.04.2020 № 15н «О Порядке открытия казначейских счетов» (ред. от 28.11.2025), п. 8.1 — казначейский счёт для операций со средствами участников казначейского сопровождения открывается территориальному органу Казначейства или финансовому органу субъекта РФ; Бюджетный кодекс РФ, ст. 242.14 (пп. 6.1 п. 1, п. 2, п. 3) — <a href="https://normativ.kontur.ru/document?documentId=503913&amp;moduleId=1" target="_blank" rel="noopener">normativ.kontur.ru</a>, <a href="https://www.consultant.ru/document/cons_doc_LAW_19702/f6c1ec982a7b32b1ed4bc223a4f254b43321870a/" target="_blank" rel="noopener">consultant.ru</a></li>
        <li id="ref-6">Приказ Федерального казначейства от 22.12.2021 № 44н — Порядок открытия и ведения лицевых счетов участникам казначейского сопровождения (ред. с 01.09.2026, изменения приказами № 22н от 06.12.2024, № 11н от 30.09.2025, № 14н от 22.06.2026): п. 6 (документы формируются в ГИИС «Электронный бюджет» или ЕИС), п. 24 (документы для открытия), п. 29 (проверка в день поступления), п. 35 (открытие в день представления документов), п. 42 (раздел в день получения документа-основания) — <a href="https://normativ.kontur.ru/document?documentId=507790&amp;moduleId=1" target="_blank" rel="noopener">normativ.kontur.ru</a></li>
        <li id="ref-7">Приказ Федерального казначейства от 22.06.2026 № 14н (зарегистрирован Минюстом 23.07.2026 № 87587, действует с 01.09.2026) — изменения в Порядок № 44н: утратили силу п. 7, 31–33, 35.1, 36, 40 и приложения № 4–8; казначейский мониторинг — по постановлению Правительства РФ от 27.07.2026 № 941 — <a href="https://normativ.kontur.ru/document?documentId=507380&amp;moduleId=1" target="_blank" rel="noopener">normativ.kontur.ru</a></li>
      </ol>
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию; точный состав документов уточняется в вашем ТОФК. Проверено экспертом КазнаЭксперт. Дата актуализации — 2 сентября 2026.</p>
    </div>
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="licevoy-schet-71">
      <div class="railform__badge">Открытие счёта под ключ</div>
      <h3 class="railform__title">Откроем счёт 71 за вас</h3>
      <p class="railform__sub">ЭП, подключение к ЭБ, документы. Точная цена — после анализа.</p>
      ...
      <div class="success" id="leadSuccess" role="status" aria-live="polite">
        ...
        <p>Эксперт перезвонит <b>в течение 1 часа</b> (9:00–21:00 МСК) и поможет открыть счёт.</p>
...
<section class="related" aria-labelledby="relTitle">
  ...
  <div class="related__grid"><!-- auto-related:vedenie-kaznacheyskogo-scheta --><a class="card reveal" href="/baza-znaniy/vedenie-kaznacheyskogo-scheta/"><span class="card__cat">Услуги</span><span class="card__t">Ведение казначейского счёта: что входит в услугу</span><span class="card__m">Услуги · 9 мин</span></a><!-- auto-related:rezervirovanie-kaznacheyskogo-scheta --><a class="card reveal" href="/baza-znaniy/rezervirovanie-kaznacheyskogo-scheta/"><span class="card__cat">Открытие счёта</span><span class="card__t">Резервирование казначейского счёта: срок и форма</span><span class="card__m">Открытие счёта · 9 мин</span></a><!-- auto-related:stoimost-kaznacheyskogo-soprovozhdeniya --><a class="card reveal" href="/baza-znaniy/stoimost-kaznacheyskogo-soprovozhdeniya/"><span class="card__cat">Стоимость</span><span class="card__t">Стоимость казначейского сопровождения: цены 2026</span><span class="card__m">Стоимость · 9 мин</span></a>
    ...
    <a class="card reveal" href="/baza-znaniy/prichiny-otkaza-kaznacheystva-v-sankcionirovanii/"><div class="card__cover"><span>10 причин</span></div><div class="card__body"><span class="card__cat">Чек-лист</span><h3 class="card__title">10 причин отказа казначейства в санкционировании</h3><div class="card__meta">Санкционирование · 14 мин</div></div></a>
...
<section class="kz-sub" aria-labelledby="kzSubTitle" data-source="licevoy-schet-71">
  <style>

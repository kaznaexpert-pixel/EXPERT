...
<title>Как открыть лицевой счёт 71 в ТОФК: документы и сроки 2026 | КазнаЭксперт</title>
<meta name="description" content="Лицевой счёт 71: кому нужен, какие документы, как открыть через «Электронный бюджет», сроки и частые задержки. Порядок открытия счёта казначейского сопровождения в 2026.">

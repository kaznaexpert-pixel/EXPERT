...
<figcaption style="font-size:13px;color:#6E6B66;font-style:italic;margin-top:8px">Путь к счёту 71: КЭП → «Электронный бюджет» → заявление с ИГК; визит в казначейство не нужен.</figcaption>
    ...
    <p>Основное время уходит не на регистрацию, а на подготовку: получение и привязку электронной подписи, подключение к ГИИС «Электронный бюджет», включение в сводный реестр и сбор документов. Начинать стоит сразу, как стало понятно, что контракт подпадает под сопровождение, — а не когда пора проводить первый платёж.</p>

...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <ul class="check">
      <li><b>В авансовом счёте-фактуре</b> — при получении предоплаты по сопровождаемому контракту. Это важно, потому что авансы при сопровождении проходят особый контроль; как именно — в материале <a href="/baza-znaniy/kaznacheyskoe-soprovozhdenie-avansovyh-platezhey/">казначейское сопровождение авансовых платежей</a>.</li>

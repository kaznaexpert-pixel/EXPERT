...
<title>ИГК в счёте-фактуре и УПД: где указывать и как добавить в 1С</title>
<meta name="description" content="Где указывать ИГК — идентификатор госконтракта: строка 8 счёта-фактуры и УПД, счёт на оплату, платёжка. Кто обязан проставлять и как настроить в 1С.">
...
<meta property="og:title" content="ИГК в счёте-фактуре, счёте и УПД: где указывать и как настроить в 1С">
...
<meta name="twitter:title" content="ИГК в счёте-фактуре, счёте и УПД: где указывать и как настроить в 1С">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#gde-ukazyvat">Где указывать ИГК: полный список документов</a></li>
      ...
      <li><a href="#oshibki">Частые ошибки с ИГК</a></li>
  ...
  <article class="content" id="main">
    ...
    <h2 id="gde-ukazyvat">Где указывать ИГК: полный список документов</h2>

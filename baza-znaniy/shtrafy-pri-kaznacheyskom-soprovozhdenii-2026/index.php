...
{"@context": "https://schema.org", "@type": "Article", "headline": "Штрафы при казначейском сопровождении с 2026 года: статьи 15.37.1 и 15.49 КоАП РФ", "description": "Штрафы при казначейском сопровождении с 2026 года: статья 15.37.1 КоАП за раздельный учёт и статья 15.49 за просрочку сведений. Размеры и как избежать.", "inLanguage": "ru-RU", "datePublished": "2026-06-29", "dateModified": "2026-06-29", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}}, "image": "https://kaznaexpert.ru/img/og-image.png", "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/shtrafy-pri-kaznacheyskom-soprovozhdenii-2026/"}}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#chek-list">Чек-лист: защита от штрафов по КС</a></li>
  ...
  <article class="content" id="main">
    ...
    <table>
      ...
      <tbody>
        <tr><td>Отсутствие раздельного учёта при КС</td><td>статья 15.37.1 КоАП</td><td>контракты под казначейским сопровождением</td></tr>
        <tr><td>Просрочка утверждения сведений при КС</td><td>статья 15.49 КоАП</td><td>контракты под казначейским сопровождением</td></tr>
    ...
    <h2 id="chek-list">Чек-лист: защита от штрафов по КС</h2>
    ...
    <div class="faq">
      ...
      <details><summary>Какой штраф за отсутствие раздельного учёта при КС?</summary><p>По статье 15.37.1 КоАП для должностных лиц — от 10 до 50 тысяч рублей; для индивидуальных предпринимателей — от 5 до 10% цены сделки, но не более 250 тысяч рублей; для юридических лиц — от 5 до 10% цены сделки, но не более 500 тысяч рублей.</p></details>
      ...
      <details><summary>Кто рассматривает дела о штрафах при КС?</summary><p>Дела рассматривает Федеральное казначейство — орган, осуществляющий казначейское сопровождение. По составу о просрочке утверждения сведений дело могут рассмотреть и финансовые органы субъектов Российской Федерации.</p></details>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Нормы приведены в редакции, действующей на 29 июня 2026 года, по состоянию на дату публикации. Размеры штрафов и составы могут уточняться; сверяйтесь с актуальной редакцией КоАП РФ. Материал носит справочный характер и не заменяет юридическую консультацию.</p>
    </div>
  </article>
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="shtrafy-pri-kaznacheyskom-soprovozhdenii-2026">
      ...
      <h3 class="railform__title">Снизить риск штрафов по КС?</h3>
...
<section class="related" aria-labelledby="relTitle">
  ...
  <div class="related__grid">
    ...
    <a class="card reveal" href="/baza-znaniy/otvetstvennost-za-narusheniya-goz/"><div class="card__cover"><span>ГОЗ</span></div><div class="card__body"><span class="card__cat">База знаний</span><h3 class="card__title">Ответственность за нарушения в сфере ГОЗ и КС</h3><div class="card__meta">Применимость · 15 мин</div></div></a>

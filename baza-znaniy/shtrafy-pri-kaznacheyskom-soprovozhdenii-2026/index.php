...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__shtrafy-pri-kaznacheyskom-soprovozhdenii-2026-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__shtrafy-pri-kaznacheyskom-soprovozhdenii-2026-16x9.jpg">
...
<div class="related-inline"><b>Не путать:</b> здесь — административные штрафы государства по КоАП. Договорная неустойка заказчику — в разборе <a href="/baza-znaniy/peni-i-shtrafy-po-44-fz/">пеней и штрафов по 44-ФЗ</a>, а порядок её удержания при сопровождении — в статье об <a href="/baza-znaniy/uderzhanie-neustoyki-pri-kaznacheyskom-soprovozhdenii/">удержании неустойки</a>.</div>
    ...
    <div class="answer reveal">
      <p class="lead-p">С 1 января 2026 года действуют два новых состава КоАП, введённых Федеральным законом от 28 декабря 2025 года № 506-ФЗ. Статья 15.37.1 наказывает исполнителя за отсутствие раздельного учёта: для юридических лиц 5–10% цены сделки, но не более 500 тысяч рублей. Статья 15.49 — заказчика за просрочку утверждения сведений: 1–5% цены контракта, не более 200 тысяч рублей.</p>
    </div>
    ...
    <h3 id="dva-sostava">Какие два состава ввёл закон № 506-ФЗ</h3>
    ...
    <h3 id="pozitsiya-kaznachejstva">Как казначейство относится к новым штрафам</h3>
    ...
    <h3 id="sverka-redakcii">По какой редакции КоАП сверены размеры штрафов</h3>
    ...
    <h3 id="chto-novogo-uchet">Что нового в требовании о раздельном учёте</h3>
    ...
    <h3 id="pochemu-maksimalnyy">Почему штраф по крупному контракту будет максимальным</h3>
    ...
    <h3 id="subekt-1549">Кого штрафуют за просрочку утверждения сведений</h3>
    ...
    <h3 id="razmer-1549">Каков размер штрафа по статье 15.49</h3>
    ...
    <h3 id="kakoj-tyazhelee">Какой из двух составов тяжелее</h3>
    ...
    <h3 id="otvetstvennost-ispolnitelya">За что отвечает исполнитель</h3>
    ...
    <h3 id="otvetstvennost-zakazchika">За что отвечает заказчик</h3>
    ...
    <h3 id="srok-davnosti">Каков срок давности по статье 15.37.1</h3>
    ...
    <h3 id="kak-vyyavlyayut">Как выявляют нарушения</h3>
    ...
    <h3 id="goz-otdelno">Чем отличается раздельный учёт по гособоронзаказу</h3>
    ...
    <h3 id="proverit-materialy">Что проверить в материалах дела</h3>
    ...
    <h3 id="kogda-specialist">Когда стоит привлекать специалиста</h3>
    ...
    <h3 id="kejs-obshchiy-kotel">Чем заканчивается учёт в общем котле</h3>

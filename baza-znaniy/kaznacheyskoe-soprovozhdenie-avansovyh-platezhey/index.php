...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/baza-znaniy/">База знаний</a> › казначейское сопровождение авансовых платежей</nav>
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#oshibki">Частые ошибки при авансе под казначейское сопровождение</a></li>
  ...
  <article class="content" id="main">
    ...
    <ul class="check">
      ...
      <li><b>Контракт прямо относит аванс к сопровождаемым средствам.</b> Условие о казначейском сопровождении включается в текст госконтракта.</li>
    </ul>
    ...
    <table>
      ...
      <tr><td>Сопровождаются все платежи</td><td>Через лицевой счёт проходят и аванс, и последующие платежи</td><td>Контракт целиком подпадает под казначейское сопровождение по сумме/источнику</td></tr>
    </table>
    <p>На практике встречается запрос «сопровождается аванс или весь контракт» — ответ зависит от условий конкретного госконтракта и оснований применения казначейского сопровождения. Контракт должен прямо указывать, какие платежи попадают на лицевой счёт. Если сопровождается только аванс, то после его полной отработки дальнейшие расчёты идут в обычном порядке.</p>
    ...
    <p>Полный перечень разрешённых и запрещённых операций — в материале <a href="/baza-znaniy/operacii-po-licevomu-schetu-pri-ks/">какие операции можно проводить по лицевому счёту при казначейском сопровождении</a>. Для аванса это особенно важно: казначейство проверяет не только сумму, но и связь каждого расхода с целью контракта.</p>
    ...
    <p>Подробно о размере аванса и обеспечении — в материале <a href="/baza-znaniy/avans-pri-kaznacheyskom-soprovozhdenii/">аванс при казначейском сопровождении</a> и в разборе <a href="/baza-znaniy/obespechenie-ispolneniya-kontrakta-pri-ks/">обеспечения исполнения контракта при казначейском сопровождении</a>.</p>
    ...
    <ol>
      <li><b>Проверьте условие об авансе и казначейского сопровождения в контракте.</b> Найдите размер аванса, указание на сопровождение и порядок его зачёта.</li>
    ...
    <h2 id="oshibki">Частые ошибки при авансе под казначейское сопровождение</h2>
    <ul class="check">
...
<section class="related" aria-labelledby="relTitle">
  ...
  <div class="related__grid">
    <a class="card reveal" href="/baza-znaniy/avans-pri-kaznacheyskom-soprovozhdenii/"><div class="card__cover"><span>Аванс</span></div><div class="card__body"><span class="card__cat">База знаний</span><h3 class="card__title">Аванс при казначейском сопровождении: размер и обеспечение</h3><div class="card__meta">казначейское сопровождение · 16 мин</div></div></a>
    ...
    <a class="card reveal" href="/baza-znaniy/poryadok-sankcionirovaniya-rashodov/"><div class="card__cover"><span>Контроль</span></div><div class="card__body"><span class="card__cat">База знаний</span><h3 class="card__title">Порядок санкционирования расходов при казначейском сопровождении</h3><div class="card__meta">Контроль · 16 мин</div></div></a>

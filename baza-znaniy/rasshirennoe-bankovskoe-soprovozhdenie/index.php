...
<h3 id="otlichie-ot-monitoringa">Чем расширенный режим отличается от мониторинга расчётов</h3>
...
<h3 id="rasshirennyy-soprovozhdaemyy-kontrakt">Что такое расширенный сопровождаемый контракт</h3>
...
<h3 id="sravnenie-dvuh-rezhimov">Что меняется для подрядчика: два режима рядом</h3>
...
<h3 id="osnovaniya-federalnye">Три основания для федеральных нужд</h3>
...
<h3 id="odnoy-ceny-nedostatochno">Почему одной цены в 15 млрд рублей недостаточно</h3>
...
<h3 id="porogi-region-mo">Пороги для региональных и муниципальных контрактов</h3>
...
<h3 id="shkala-platy">Шкала предельной платы по пункту 4 Правил</h3>
...
<h3 id="potolok-ne-tarif">Правила задают потолок, а не тариф банка</h3>
...
<h3 id="kto-platit-za-rezhim">Кто платит за расширенное сопровождение</h3>
...
<h3 id="dva-napravleniya-proverki">Два направления проверки: сроки с объёмами и стройка</h3>
<ol class="ol">
...
<h3 id="pravilo-75-procentov">Правило 75 процентов стоимости строительства</h3>
...
<h3 id="pochemu-vyezdy-i-zaprosy">Почему в расширенном режиме появляются выезды и запросы</h3>
...
<h3 id="vosem-obyazannostey-zakazchika">Восемь обязанностей заказчика по пункту 8</h3>
...
<h3 id="punkt-81-utratil-silu">Пункт 8(1) утратил силу: что проверить в шаблонах</h3>
...
<h3 id="bazovaya-chast-13">Базовая часть договора: пункт 13 Правил</h3>
...
<h3 id="sem-usloviy-14">Семь дополнительных условий из пункта 14</h3>
...
<h3 id="spisanie-avansa-s-scheta">Списание аванса с отдельного счёта по требованию заказчика</h3>
...
<h3 id="normy-prava-na-otkaz">Из каких норм собирается право банка на отказ</h3>
<ol class="steps">
...
<h3 id="zapros-o-nesoglasii">Что делать при отказе: письменный запрос о несогласии</h3>
...
<h3 id="profilaktika-otkaza">Как не доводить дело до отказа</h3>
...
<h3 id="sostav-otcheta-banka">Что дополнительно входит в отчёт банка</h3>
<ul class="ul">
...
<h3 id="sverka-cen-soispolniteley">Сверка цен соисполнителей со среднерыночными</h3>
...
<h3 id="obyazannosti-punkt-6">Обязанности поставщика по пункту 6 Правил</h3>
...
<h3 id="scheta-soispolniteley">Соисполнители открывают счета в том же банке</h3>

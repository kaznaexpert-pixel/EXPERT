...
<!-- p48:prekrashchenie-i-annulirovanie -->
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию. Порядок выпуска, продления и аннулирования сертификатов устанавливается законом № 63-ФЗ и Регламентом УЦ Федерального казначейства и может уточняться; точный срок действия указывается в самом сертификате. Проверено экспертом КазнаЭксперт. Дата актуализации — 17 августа 2026.</p>
    </div>

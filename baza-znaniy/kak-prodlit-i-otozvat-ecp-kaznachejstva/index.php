...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "HowTo", "name": "Как продлить (перевыпустить) сертификат УЦ Федерального казначейства", "inLanguage": "ru-RU", "step": [{"@type": "HowToStep", "position": 1, "name": "Проверить срок", "text": "Уточнить дату окончания текущего сертификата."}, {"@type": "HowToStep", "position": 2, "name": "Подготовить рабочее место", "text": "Проверить СКЗИ, плагин, драйверы носителя и корневые сертификаты."}, {"@type": "HowToStep", "position": 3, "name": "Сформировать запрос", "text": "Создать запрос на новый сертификат через Портал заявителя УЦ ФК."}, {"@type": "HowToStep", "position": 4, "name": "Подтвердить данные", "text": "Проверить сведения о владельце и организации, приложить документы."}, {"@type": "HowToStep", "position": 5, "name": "Дождаться выпуска", "text": "УЦ ФК проверяет запрос и выпускает новый сертификат."}, {"@type": "HowToStep", "position": 6, "name": "Установить и проверить", "text": "Записать сертификат на носитель, проверить подпись и вход в системы."}]}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>13 мин чтения</span><span class="dot">·</span><span>Обновлено 6 августа 2026 · закон № 63-ФЗ сверен в действующей редакции от 31.07.2025 — правила выпуска и аннулирования сертификатов не изменились</span></div>
    </div>

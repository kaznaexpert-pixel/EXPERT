...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      ...
      <p>Сверка на 11 сентября 2026 года: Федеральный закон от 06.04.2011 № 63-ФЗ «Об электронной подписи» действует в редакции от 31.07.2025, порядок выпуска и досрочного прекращения действия квалифицированных сертификатов не менялся (изменения статьи 17.2 по закону от 04.08.2026 № 315-ФЗ вступают в силу с 1 сентября 2027 года). Основание, по которому сертификаты выдаёт удостоверяющий центр Федерального казначейства, — часть 3 статьи 17.2: лица на государственных должностях, должностные лица государственных органов и органов местного самоуправления, подведомственных им организаций, а также работники юридических лиц из перечня, утверждённого постановлением Правительства РФ от 10.07.2020 № 1018. Пункт 1 этого перечня — коммерческие организации, которым предоставляются средства из бюджетов, подлежащие казначейскому сопровождению<a class="fn" href="#ref-4" aria-label="Источник 4">[4]</a>. Поэтому у коммерческого исполнителя сопровождаемого контракта могут быть сертификаты обоих центров: должностных лиц — от казначейства, юридического лица на руководителя — от ФНС России (пункт 1 части 1 статьи 17.2); «Электронный бюджет» принимает оба<a class="fn" href="#ref-5" aria-label="Источник 5">[5]</a>. Перевыпускается сертификат в том центре, который его выдал, — перепутать контуры при продлении нельзя.</p>
    </div>
...
<h2 id="zamena">Замена носителя, смена сотрудника, реорганизация</h2>
    ...
    <div class="answer reveal">
      <p>Здесь возникает частая путаница. Базовую подпись юрлица или ИП (для отчётности, торгов, общего документооборота) руководитель получает и продлевает в удостоверяющем центре ФНС. Сертификаты должностных лиц исполнителя под казначейским сопровождением — руководителю и сотрудникам по приказу о назначении — выпускает и перевыпускает УЦ Федерального казначейства по перечню постановления № 1018<a class="fn" href="#ref-4" aria-label="Источник 4">[4]</a>. Обязательным сертификат казначейства не является: в «Электронном бюджете» принимаются и сертификаты ФНС России и иных аккредитованных центров<a class="fn" href="#ref-5" aria-label="Источник 5">[5]</a>, а сотрудники без казначейского сертификата работают по личным подписям с машиночитаемой доверенностью (МЧД). Подробнее это разграничение разобрано в базовом материале <a href="/baza-znaniy/sertifikat-ecp-kaznachejstvo/">«Сертификат и ЭЦП казначейства»</a>.</p>
      <p>Практический вывод: продлевать нужно тот сертификат, которым вы реально подписываете документы в конкретной системе, и в том центре, который его выдал. Казначейский сертификат сотрудника — через ФЗС и УЦ ФК (при действующем сертификате смена проходит без визита); сертификат ФНС, которым руководитель входит в «Электронный бюджет», — через налоговую или её доверенных лиц. Издатель указан в самом сертификате в поле «Кем выдан» — проверьте его до запуска процедуры.</p>
    </div>
...
<!-- p48:prekrashchenie-i-annulirovanie -->
    ...
    <div class="faq">
      ...
      <details><summary>Где продлевать — в казначействе или в ФНС?</summary><p>В том центре, который выдал истекающий сертификат: казначейские сертификаты должностных лиц — УЦ Федерального казначейства через ФЗС, сертификат юридического лица на руководителя или подпись ИП — УЦ ФНС. Издатель указан в поле «Кем выдан» сертификата; работать в «Электронном бюджете» можно и тем, и другим.</p></details>
...
<div class="refs">
      ...
      <ol>
        ...
        <li id="ref-4">Постановление Правительства РФ от 10.07.2020 № 1018 «О видах юридических лиц и подведомственных им организаций, которым и работникам которых создаются и выдаются квалифицированные сертификаты ключей проверки электронной подписи удостоверяющим центром…» (в силе с 01.01.2022), пункт 1 перечня — коммерческие организации, которым предоставляются средства из бюджетов, подлежащие казначейскому сопровождению; Федеральный закон от 06.04.2011 № 63-ФЗ (ред. от 31.07.2025), пункт 4 части 3 статьи 17.2 — <a href="http://publication.pravo.gov.ru/Document/View/0001202007130022" target="_blank" rel="noopener">publication.pravo.gov.ru</a>, <a href="https://www.consultant.ru/document/cons_doc_LAW_112701/e051fd84282463756121b8992b8fa4df155f2886/" target="_blank" rel="noopener">КонсультантПлюс</a></li>
        <li id="ref-5">Письмо Казначейства России от 02.11.2023 № 07-04-05/11-32062 — в ГИИС «Электронный бюджет» помимо сертификатов удостоверяющего центра Федерального казначейства применяются сертификаты ФНС России и иных аккредитованных удостоверяющих центров; письмо Межрегионального операционного УФК от 25.08.2023 № 95-09-11/15-377 — сотрудники коммерческих организаций под казначейским сопровождением как заявители удостоверяющего центра казначейства, приказ о назначении по пункту 19 Порядка № 21н — <a href="https://www.consultant.ru/document/cons_doc_LAW_461566/" target="_blank" rel="noopener">КонсультантПлюс (письмо 02.11.2023)</a>, <a href="https://www.consultant.ru/document/cons_doc_LAW_455630/" target="_blank" rel="noopener">КонсультантПлюс (письмо 25.08.2023)</a></li>
      </ol>
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию. Порядок выпуска, продления и аннулирования сертификатов устанавливается законом № 63-ФЗ и Регламентом УЦ Федерального казначейства и может уточняться; точный срок действия указывается в самом сертификате. Проверено экспертом КазнаЭксперт. Дата актуализации — 11 сентября 2026.</p>
    </div>

...
{"@type": "Question", "name": "Что значит зарезервировать счёт по ГОЗ?", "acceptedAnswer": {"@type": "Answer", "text": "Заранее забронировать онлайн номер отдельного счёта в уполномоченном банке, чтобы быстро получить реквизиты для контракта. Полное открытие со всеми документами проходит следующим шагом."}},
{"@type": "Question", "name": "Можно ли проводить платежи по зарезервированному счёту?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Резервирование — это только бронь номера. Счёт становится рабочим после полного открытия и заключения договора банковского сопровождения."}},
{"@type": "Question", "name": "В каком банке резервировать счёт?", "acceptedAnswer": {"@type": "Answer", "text": "Только в уполномоченном банке, который закреплён за вашим контрактом. Банк определяет госзаказчик, а кооперация открывает счета в том же банке. Перечень уполномоченных банков ведёт Банк России."}},
{"@type": "Question", "name": "Можно ли выбрать банк самостоятельно?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Уполномоченный банк сделки задаёт заказчик. Резервирование в произвольном банке окажется бесполезным, если расчёты по контракту идут через другой."}},
{"@type": "Question", "name": "Нужен ли ИГК для резервирования?", "acceptedAnswer": {"@type": "Answer", "text": "Желателен, но не всегда обязателен на этапе брони. Если идентификатор ещё не присвоен, счёт резервируют по данным организации, а ИГК привязывают при открытии."}},
{"@type": "Question", "name": "Сколько времени занимает резервирование?", "acceptedAnswer": {"@type": "Answer", "text": "Сама бронь — минуты. Полное открытие счёта обычно занимает от одного-двух рабочих дней при корректном пакете документов."}},
{"@type": "Question", "name": "Чем отдельный счёт в банке отличается от счёта в казначействе?", "acceptedAnswer": {"@type": "Answer", "text": "Отдельный счёт открывается в уполномоченном банке по банковскому сопровождению, лицевой счёт — в казначействе по казначейскому. Резервирование применяется к банковскому отдельному счёту."}},
{"@type": "Question", "name": "Какие документы нужны для открытия после резервирования?", "acceptedAnswer": {"@type": "Answer", "text": "Учредительные документы, карточка с образцами подписей, контракт с условием банковского сопровождения, ИГК и заявление банка."}},
{"@type": "Question", "name": "Что будет, если зарезервировать счёт не в том банке?", "acceptedAnswer": {"@type": "Answer", "text": "Счёт окажется бесполезным: расчёты по контракту должны идти через уполномоченный банк сделки. Резервирование придётся повторить в нужном банке."}},
{"@type": "Question", "name": "Где посмотреть режим отдельного счёта?", "acceptedAnswer": {"@type": "Answer", "text": "Режим списаний, запрещённые операции и порядок вывода прибыли разобраны в материале об отдельном счёте по ГОЗ; они заданы ст. 8.3–8.4 Закона № 275-ФЗ."}}
]}
</script>
<script type="application/ld+json">

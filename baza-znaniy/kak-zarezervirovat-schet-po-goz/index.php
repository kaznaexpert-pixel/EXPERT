...
<title>Как зарезервировать счёт по ГОЗ в банке</title>
<meta name="description" content="Как зарезервировать отдельный счёт по ГОЗ: чем резервирование отличается от открытия, в каком уполномоченном банке резервировать и что нужно из документов.">
...
{"@type": "DefinedTerm", "name": "Опорный банк ГОЗ", "description": "Банк, определённый для сопровождения сделок оборонно-промышленного комплекса."},
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p>Резервировать и открывать отдельный счёт можно только в уполномоченном банке. Статус таких банков задан статьёй 8.1 Закона № 275-ФЗ: это банки, отвечающие установленным требованиям, перечень которых ведёт и публикует Банк России.</p>
    <table>
      <caption>Уполномоченные банки по ГОЗ (по перечню Банка России)</caption>
      <tr><th>Банк</th><th>Примечание</th></tr>
      <tr><td>Промсвязьбанк (ПСБ)</td><td>Опорный банк для оборонно-промышленного комплекса</td></tr>
      <tr><td>ВТБ</td><td>Из числа крупнейших уполномоченных банков</td></tr>
      <tr><td>Сбербанк</td><td>Из числа уполномоченных банков</td></tr>
      <tr><td>Газпромбанк</td><td>Из числа уполномоченных банков</td></tr>
      <tr><td>Россельхозбанк, Новикомбанк и другие</td><td>Полный актуальный перечень — на сайте Банка России</td></tr>
    </table>
    <p>Важный нюанс: выбирать банк произвольно нельзя. Уполномоченный банк сделки определяет государственный заказчик, а вся кооперация открывает счета в том же банке, где счёт у головного исполнителя. Поэтому перед резервированием уточните, какой банк закреплён за вашим контрактом.<a class="fn" href="#ref-2" aria-label="Источник 2">[2]</a></p>

    <h2 id="psb">Резервирование в опорном банке ГОЗ</h2>
    <p>Чаще всего расчёты по гособоронзаказу идут через Промсвязьбанк — он определён опорным банком для сопровождения сделок ОПК. Поэтому большинство запросов на резервирование счёта по ГОЗ касаются именно его, хотя механика похожа у всех уполномоченных банков.</p>
    <p>На сайте опорного банка есть отдельный онлайн-сервис резервирования счёта по ГОЗ: вы указываете данные организации и контракта, а банк бронирует номер отдельного счёта. После этого с вами связывается сопровождающий менеджер, и счёт доводят до полного открытия. Если же ваш контракт закреплён за другим уполномоченным банком, резервирование оформляют по его процедуре — суть та же.</p>
    ...
    <p>Укажите данные организации (ИНН, наименование, контакты) и сведения о контракте, включая <a href="/baza-znaniy/identifikator-gosudarstvennogo-kontrakta-igk/">идентификатор государственного контракта (ИГК)</a>, если он уже присвоен.</p>
    ...
    <table>
      ...
      <tr><td>Резервирование</td><td>ИНН и наименование организации, контактные данные, сведения о контракте и ИГК (при наличии)</td></tr>
...
<!-- p46r:reserv-praktika -->
    ...
    <div class="faq">
      ...
      <details><summary>Нужен ли ИГК для резервирования?</summary><p>Желателен, но не всегда обязателен на этапе брони. Если идентификатор ещё не присвоен, счёт резервируют по данным организации, а ИГК привязывают при открытии.</p></details>

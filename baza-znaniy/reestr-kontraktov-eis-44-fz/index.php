...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 103 «Реестр контрактов, заключённых заказчиками» (ред. на 25.06.2026).</li>
        ...
        <li id="ref-3">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 104 «Реестр недобросовестных поставщиков» (для разграничения).</li>
        <li id="ref-4">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 4 «Единая информационная система в сфере закупок».</li>
        <li id="ref-5">Бюджетный кодекс РФ, статья 219 «Исполнение бюджета по расходам» (санкционирование, сверка со сведениями реестра).</li>

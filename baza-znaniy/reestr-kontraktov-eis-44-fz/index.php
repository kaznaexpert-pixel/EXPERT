...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>13 мин чтения</span><span class="dot">·</span><span>Обновлено 25 июня 2026</span></div>
    </div>
    ...
    <div class="tldr">Реестр контрактов — это официальная база заключённых по 44-ФЗ контрактов в единой информационной системе (ЕИС). Его ведёт <b>Федеральное казначейство</b> по статье 103 Закона № 44-ФЗ и Правилам, утверждённым постановлением Правительства РФ № 1084. Заказчик направляет в реестр сведения о заключении, изменении, исполнении и расторжении контракта — по общему правилу в течение <b>пяти рабочих дней</b>. Для подрядчика реестр важен потому, что именно его данные казначейство сверяет при санкционировании оплаты.</div>
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">№ 1084</div><div class="kf__t"><b>Правила ведения</b> — порядок ведения реестра установлен постановлением Правительства РФ от 28.11.2013 № 1084</div></div>
        ...
        <div class="kf"><div class="kf__n">5 раб. дней</div><div class="kf__t"><b>Срок</b> — по общему правилу заказчик направляет сведения в течение пяти рабочих дней с даты события</div></div>
      </div>
    </section>
    ...
    <p>При этом не все контракты попадают в реестр. Статья 103 прямо исключает ряд закупок — прежде всего «малые» закупки у единственного поставщика по пунктам 4 и 5 части 1 статьи 93 (с отдельными оговорками), а также некоторые другие случаи, например отдельные контракты с физическими лицами. Это сделано, чтобы не перегружать реестр множеством мелких операций.</p>
    ...
    <p>Сведения в реестр направляет заказчик, а не подрядчик. Закон задаёт сжатые сроки, чтобы информация была актуальной. По общему правилу части 3 статьи 103 заказчик направляет информацию и документы в течение пяти рабочих дней с даты соответствующего события — заключения контракта, его изменения, исполнения этапа или расторжения. Для отдельных видов сведений Правила № 1084 устанавливают свои сроки, поэтому конкретный срок всегда стоит сверять с действующей редакцией.</p>
    ...
    <table>
      ...
      <tbody>
        <tr><td>Реестр контрактов</td><td>База всех заключённых контрактов: стороны, цена, исполнение</td><td>ст. 103 № 44-ФЗ; ПП № 1084</td></tr>
    ...
    <div class="faq">
      <details open><summary>Кто ведёт реестр контрактов по 44-ФЗ?</summary><p>Реестр контрактов ведёт Федеральное казначейство в единой информационной системе (ЕИС). Это прямо установлено статьёй 103 Закона № 44-ФЗ, а порядок ведения — постановлением Правительства РФ № 1084.</p></details>
      <details><summary>В какой срок сведения попадают в реестр?</summary><p>По общему правилу части 3 статьи 103 заказчик направляет информацию в течение пяти рабочих дней с даты события — заключения, изменения, исполнения или расторжения контракта. Для отдельных сведений Правила № 1084 устанавливают свои сроки.</p></details>
      <details><summary>Какие контракты не включаются в реестр?</summary><p>В реестр не попадает ряд закупок, прежде всего «малые» закупки у единственного поставщика по пунктам 4 и 5 части 1 статьи 93 (с отдельными оговорками) и некоторые другие случаи, например отдельные контракты с физическими лицами.</p></details>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 103 «Реестр контрактов, заключённых заказчиками» (ред. на 25.06.2026). <a href="https://www.consultant.ru/document/cons_doc_LAW_144624/" target="_blank" rel="noopener">КонсультантПлюс</a></li>
        <li id="ref-2">Постановление Правительства РФ от 28.11.2013 № 1084 «О порядке ведения реестра контрактов, заключённых заказчиками, и реестра контрактов, содержащего сведения, составляющие государственную тайну».</li>

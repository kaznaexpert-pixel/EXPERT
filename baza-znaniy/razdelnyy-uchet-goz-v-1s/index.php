...
{"@type": "Question", "name": "Можно ли вести раздельный учёт ГОЗ в 1С:Бухгалтерии ПРОФ?", "acceptedAnswer": {"@type": "Answer", "text": "Штатной функциональности раздельного учёта в ПРОФ нет. Обособление можно построить вручную через субсчета и субконто, но это трудоёмко и рискованно. Для полноценного учёта используют КОРП, ERP или специализированный модуль."}},
{"@type": "Question", "name": "Как включить раздельный учёт ГОЗ в 1С:Бухгалтерии КОРП?", "acceptedAnswer": {"@type": "Answer", "text": "Администрирование, далее Функциональность, вкладка Расчёты, поставить флаг Контракты государственного заказа. Он включает учёт расчётов и по госзаказу, и по гособоронзаказу."}},
{"@type": "Question", "name": "Что является основным разрезом учёта?", "acceptedAnswer": {"@type": "Answer", "text": "Идентификатор государственного контракта (ИГК). По нему в 1С обособляются деньги, расчёты с контрагентами, материалы, затраты и финансовый результат каждого контракта."}},
{"@type": "Question", "name": "Нужен ли отдельный счёт под каждый контракт?", "acceptedAnswer": {"@type": "Answer", "text": "Да. По каждому контракту ГОЗ открывается свой отдельный счёт в уполномоченном банке или лицевой счёт в казначействе, и в 1С он привязывается к контракту, чтобы движение денег разносилось по ИГК."}},
{"@type": "Question", "name": "Как распределять косвенные расходы между контрактами?", "acceptedAnswer": {"@type": "Answer", "text": "По базе, закреплённой в учётной политике (прямые затраты, ФОТ основных рабочих и др.). В 1С эта база настраивается в методах распределения, и настройка должна совпадать с учётной политикой."}},
{"@type": "Question", "name": "Связаны ли настройка 1С и учётная политика?", "acceptedAnswer": {"@type": "Answer", "text": "Напрямую. Методика раздельного учёта закрепляется в учётной политике, а 1С настраивается под неё. Расхождение между ними — частая причина претензий при проверке."}},
{"@type": "Question", "name": "Откуда берётся отчёт об исполнении контракта?", "acceptedAnswer": {"@type": "Answer", "text": "Он формируется из учётных данных по ИГК. Если документы проведены с правильным идентификатором и аналитикой, отчёт собирается автоматически."}},
{"@type": "Question", "name": "Какой штраф за нарушение раздельного учёта?", "acceptedAnswer": {"@type": "Answer", "text": "По части 2 статьи 15.37 КоАП РФ за грубое нарушение — на должностных лиц от 50 до 100 тыс. рублей или дисквалификация до трёх лет, на юрлиц — от 500 тыс. до 1 млн рублей."}},
{"@type": "Question", "name": "Подходит ли 1С:ERP для раздельного учёта ГОЗ?", "acceptedAnswer": {"@type": "Answer", "text": "Да. В ERP и Комплексной автоматизации есть подсистема гособоронзаказа с позаказным учётом — это удобно для производства со сложной кооперацией и калькуляцией себестоимости."}},
{"@type": "Question", "name": "Что делать, если документ провели без ИГК?", "acceptedAnswer": {"@type": "Answer", "text": "Сумма выпадает из контура контракта. Документ нужно исправить, указав контракт, и пересверить оборотно-сальдовую ведомость в разрезе ИГК до закрытия месяца."}}
]}
</script>
<script type="application/ld+json">
...
<meta property="og:description" content="Раздельный учёт ГОЗ в 1С:Бухгалтерии КОРП: включение функциональности контрактов госзаказа, аналитика по ИГК, отдельные счета, распределение затрат, отчёт исполнения контракта, ст. 15.37 КоАП.">
...
<meta name="twitter:description" content="Раздельный учёт ГОЗ в 1С:Бухгалтерии КОРП: включение функциональности контрактов госзаказа, аналитика по ИГК, отдельные счета, распределение затрат, отчёт исполнения контракта, ст. 15.37 КоАП.">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>18 мин чтения</span><span class="dot">·</span><span>Обновлено 15 июня 2026</span></div>
    </div>
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">ст. 15.37</div><div class="kf__t"><b>Штраф</b> — за грубое нарушение учёта по КоАП до 1 млн ₽</div></div>
    ...
    <table>
      ...
      <tr><td>КоАП РФ, ст. 15.37</td><td>Административная ответственность за нарушение и грубое нарушение правил раздельного учёта</td></tr>
    </table>
    ...
    <p>Раздельный учёт — не формальность: за его отсутствие или искажение предусмотрены штрафы по статье 15.37 КоАП РФ. За грубое нарушение головным исполнителем или исполнителем правил ведения раздельного учёта результатов финансово-хозяйственной деятельности (часть 2 статьи 15.37) штраф на должностных лиц составляет от 50 до 100 тысяч рублей или дисквалификацию на срок до трёх лет, на юридических лиц — от 500 тысяч до 1 миллиона рублей.<a class="fn" href="#ref-4" aria-label="Источник 4">[4]</a></p>
    ...
    <div class="takeaways">
      ...
      <ol>
        ...
        <li>За грубое нарушение раздельного учёта — штраф по статье 15.37 КоАП РФ до 1 млн рублей на юрлицо.</li>
      </ol>
    </div>
    ...
    <div class="faq">
      ...
      <details><summary>Какой штраф за нарушение раздельного учёта?</summary><p>По части 2 статьи 15.37 КоАП РФ за грубое нарушение — на должностных лиц от 50 до 100 тыс. рублей или дисквалификация до трёх лет, на юрлиц — от 500 тыс. до 1 млн рублей.</p></details>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-4">Кодекс РФ об административных правонарушениях, ст. 15.37 — нарушение и грубое нарушение правил раздельного учёта по ГОЗ — <a href="https://www.consultant.ru/document/cons_doc_LAW_34661/" target="_blank" rel="noopener">consultant.ru</a></li>
      </ol>
      <p class="refs__note">Материал актуален на 15 июня 2026 года. Конкретный порядок настройки зависит от версии и редакции конфигурации 1С; методику раздельного учёта закрепляйте в учётной политике и приводите настройку программы в соответствие с ней. Перед внедрением сверяйтесь с действующими редакциями Закона № 275-ФЗ и Правил по постановлению № 47.</p>
    </div>
  </article>

...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>12 мин чтения</span><span class="dot">·</span><span>Обновлено 11 сентября 2026</span></div>
    </div>
    ...
    <p>Удостоверяющих центров в стране много, и все аккредитованные центры работают по одному закону № 63-ФЗ. Но Удостоверяющий центр Казначейства занимает особое место: он выдаёт сертификаты не всем подряд, а строго ограниченному кругу лиц, связанных с бюджетными средствами. Это должностные лица государственных органов и органов местного самоуправления, их подведомственных организаций, а также работники юридических лиц из перечня постановления Правительства РФ от 10.07.2020 № 1018 — пункт 1 перечня называет коммерческие организации, которым предоставляются средства из бюджетов, подлежащие казначейскому сопровождению<a class="fn" href="#ref-7" aria-label="Источник 7">[7]</a>.</p>
    <h3 id="kommercheskiy-ne-podoydet">Подойдёт ли коммерческий сертификат</h3>
    <p>Для бизнеса это означает две вещи. Первая: если контракт попал под казначейское сопровождение, у организации появляется право получить в Удостоверяющем центре Казначейства сертификаты на руководителя и на сотрудников, которые ведут контракт, — по приказу № 21н, с подачей через ФЗС и плановой сменой без визита. Вторая: обязательным такой сертификат не является. Казначейство России письмом от 02.11.2023 № 07-04-05/11-32062 подтвердило, что для работы и подписания документов в «Электронном бюджете» применяются и сертификаты ФНС России, и сертификаты иных аккредитованных удостоверяющих центров<a class="fn" href="#ref-8" aria-label="Источник 8">[8]</a>. Подойдёт ли коммерческий сертификат — да; вопрос лишь в том, чью цепочку доверия под него ставить на рабочее место.</p>
    <h3 id="chi-sertifikaty-v-cepochke">Чьи сертификаты выстраивают цепочку доверия</h3>
    <p>Отсюда же вытекает практическое следствие по сертификатам и спискам отзыва: для подписи, выпущенной казначейством, цепочку доверия выстраивают корневой Головного центра и подчинённый сертификат казначейства. Если на рабочем месте стоят только сертификаты коммерческого центра, подпись казначейства проверяться не будет, какой бы рабочей она ни казалась. Правило симметрично: для сертификата ФНС нужны корневой Головного центра и подчинённый сертификат удостоверяющего центра ФНС России, а списки отзыва казначейства к нему отношения не имеют. Чья подпись у вас — видно в поле «Кем выдан».</p>
    ...
    <div class="faq">
      ...
      <details><summary>Подойдёт ли для казначейства коммерческий сертификат?</summary><p>Да. В «Электронном бюджете» принимаются сертификаты ФНС России и иных аккредитованных удостоверяющих центров — письмо Казначейства России от 02.11.2023 № 07-04-05/11-32062. Сертификат казначейства по приказу № 21н — право исполнителя под сопровождением по перечню постановления № 1018, а не обязанность. Под коммерческий сертификат на рабочее место ставят цепочку его издателя, а не списки отзыва казначейства.</p></details>

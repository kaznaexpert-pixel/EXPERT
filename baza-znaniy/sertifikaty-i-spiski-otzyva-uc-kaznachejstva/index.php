...
<meta property="article:modified_time" content="2026-08-05T09:00:00+03:00">
...
<!-- p47b:v-spiske-otzyva -->
    ...
    <div class="refs">
      ...
      <p class="refs__note">Сведения приведены по состоянию на 5 августа 2026 года. Точные имена файлов, реквизиты текущих сертификатов и периодичность списков отзыва смотрите в актуальном разделе удостоверяющего центра на roskazna.gov.ru.</p>
    </div>

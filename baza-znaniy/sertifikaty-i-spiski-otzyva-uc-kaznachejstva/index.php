...
<title>Сертификаты и списки отзыва УЦ Казначейства: где скачать</title>
<meta name="description" content="Где скачать корневые сертификаты и списки отзыва (СОС/CRL) Удостоверяющего центра Казначейства, как установить их в КриптоПро и проверить статус сертификата.">
...
{"@context": "https://schema.org", "@type": "Article", "headline": "Сертификаты и списки отзыва (СОС) Удостоверяющего центра Казначейства: где скачать и как проверить", "description": "Где скачать корневые сертификаты и списки отзыва (СОС/CRL) Удостоверяющего центра Казначейства, как установить их в КриптоПро и проверить статус сертификата.", "inLanguage": "ru-RU", "datePublished": "2026-06-24", "dateModified": "2026-06-24", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}}, "image": "https://kaznaexpert.ru/img/og-image.png", "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/sertifikaty-i-spiski-otzyva-uc-kaznachejstva/"}}
</script>
<script type="application/ld+json">
...
<meta property="og:title" content="Сертификаты и списки отзыва (СОС) УЦ Федерального казначейства">
<meta property="og:description" content="Где скачать корневые сертификаты и СОС/CRL УЦ Казначейства, установить в КриптоПро и проверить, не отозван ли сертификат.">
...
<meta name="twitter:title" content="Сертификаты и списки отзыва (СОС) УЦ Федерального казначейства">
<meta name="twitter:description" content="Где скачать корневые сертификаты и СОС/CRL УЦ Казначейства, установить в КриптоПро и проверить, не отозван ли сертификат.">
...
<div class="layout">
  ...
  <article class="content" id="main">
    <div class="hero">
      ...
      <div class="eyebrow">База знаний · ЭЦП и сертификаты <span class="fresh">Актуально на 2026</span></div>
    <h1>Сертификаты и списки отзыва (СОС) Удостоверяющего центра Казначейства: где скачать и как проверить</h1>
    ...
    <ul>
      <li><b>Раздел «Удостоверяющий центр» на roskazna.gov.ru</b> — здесь собраны корневые сертификаты, списки аннулированных сертификатов, нормативные документы и портал заявителя. Это основная витрина для пользователей.</li>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Федеральный закон от 06.04.2011 № 63-ФЗ «Об электронной подписи», часть 1 статьи 15, статьи 17.2 и 17.4.</li>
        <li id="ref-2">Приказ Федерального казначейства от 15.06.2021 № 21н о порядке реализации функций аккредитованного удостоверяющего центра (действует с 01.01.2022).</li>
      ...
      <p class="refs__note">Сведения приведены по состоянию на 24 июня 2026 года. Точные имена файлов, реквизиты текущих сертификатов и периодичность списков отзыва смотрите в актуальном разделе удостоверяющего центра на roskazna.gov.ru.</p>
    </div>
  </article>

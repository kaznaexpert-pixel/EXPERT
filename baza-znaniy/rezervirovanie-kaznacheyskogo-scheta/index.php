...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Резервирование казначейского счёта — это получение номера лицевого счёта в территориальном органе казначейства заранее, до заключения контракта. По заявлению организации ТОФК закрепляет за ней реквизиты, и их уже можно указать в заявке на тендер или в проекте контракта. Заявление подаётся по форме по КФД 0531368 через ГИИС «Электронный бюджет», резервирование занимает, как правило, один рабочий день. Зарезервированный номер действует ограниченно: если в течение 6 месяцев участник не представит документы на открытие счёта, резерв аннулируется. Полноценно счёт заработает только после заключения контракта и подачи полного пакета документов.</div>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">('Порядок открытия лицевых счетов участникам казначейского сопровождения (приказ Казначейства № 44н, ред. № 22н от 06.12.2024)', 'https://base.garant.ru/403497186/')</li>
      ...
      <p class="refs__note">Порядок и формы могут уточняться территориальными органами; актуальные памятки публикует Федеральное казначейство. Материал носит справочный характер. Проверено экспертом КазнаЭксперт. Дата актуализации — 10 августа 2026.</p>
    </div>
  </article>

...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <h2 id="posle-01-09-2026">Что будет с отчётностью после 1 сентября 2026 года</h2>
    <div class="answer reveal">
      <p>Вопрос закономерный: правила санкционирования и формы, вокруг которых крутится вся отчётность, задаёт приказ Минфина России от 17.12.2021 № 214н. Он действует в редакции от 27.06.2025 (изменения внесены приказом № 84н). Минфин подготовил новый Порядок санкционирования, который должен заменить 214н целиком вместе с четырьмя изменявшими его приказами; заявленная дата применения — 1 сентября 2026 года.</p>
      <h3 id="status-prikaza">Подписан ли новый приказ взамен 214н</h3>
      <p><b>Статус на 16 августа 2026 года: приказ не подписан и в Минюсте не зарегистрирован, номер ему не присвоен.</b> Карточка приказа № 214н в правовых системах показывает редакцию от 27.06.2025 и отметки об утрате силы не содержит. Пока нового документа нет в официальном опубликовании, отчётность и санкционирование идут по 214н — дата из подготовленного текста сама по себе ничего не меняет.</p>
      <h3 id="forma-za-3-kvartal">Какую форму и коды применять в отчёте за третий квартал</h3>
      <p>Что это значит на практике для того, кто сдаёт отчёт за третий квартал. Форму и коды направления расходования брать из действующего 214н; закладывать в регламент «переход с сентября» рано; следить не за новостями, а за официальным опубликованием приказа — до этого момента ссылаться на новые правила в переписке с территориальным органом казначейства бесполезно. По подготовленному тексту форма Сведений 0501213 и система кодов направлений расходования сохраняются, так что резкой перестройки отчётного блока не ожидается — но это ориентир, а не норма. Разбор подготовленного документа мы ведём отдельно: <a href="/baza-znaniy/normativnaya-baza/novyy-poryadok-sankcionirovaniya-2026/">новый порядок санкционирования взамен 214н</a>.</p>
    </div>

...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      ...
      <p>Главное, что нужно усвоить сразу: отчёт о расходах — это «факт», а не «план». Он отвечает на вопрос «что уже потрачено», тогда как для проведения самих платежей служит другой документ — сведения об операциях с целевыми средствами. Их часто путают, и эта путаница приводит к ошибкам в отчётности. Ниже разбираем разницу подробно.</p>
    </div>

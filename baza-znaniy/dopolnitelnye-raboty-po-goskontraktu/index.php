...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <p class="lead-p">Дополнительные работы по госконтракту — это работы, не учтённые в технической документации и смете, без которых результат контракта недостижим. Подрядчик обязан сообщить о них заказчику, а при молчании 10 дней — приостановить работы. Оплатят их только после допсоглашения по статье 95 закона № 44-ФЗ: за работы вне контракта по факту не платят.</p>
    </div>
    ...
    <h3 id="otlichiya-ot-smezhnyh-situaciy">Чем допработы отличаются от новой потребности и изменения проекта</h3>
    ...
    <h3 id="prakticheskiy-marker-dopravot">Как отличить допработы от пожеланий заказчика</h3>
    ...
    <h3 id="prodolzhat-li-raboty-pri-molchanii">Можно ли продолжать работы, пока заказчик думает</h3>
    ...
    <h3 id="izmenenie-tehdokumentacii-744">Когда заказчик вправе менять техдокументацию</h3>
    ...
    <h3 id="pravilo-10-procentov">Насколько можно увеличить объём работ по правилу 10%</h3>
    ...
    <h3 id="stroitelnye-osnovaniya-95">Какие основания изменения действуют для строительных контрактов</h3>
    ...
    <h3 id="dopraboty-dorozhe-10-procentov">Что делать, если допработы дороже 10% цены контракта</h3>
    ...
    <h3 id="uroven-gk-punkt-4-743">Что говорит Гражданский кодекс о неоформленных допработах</h3>
    ...
    <h3 id="uroven-44fz-oplata-vne-kontrakta">Почему по 44-ФЗ не платят за работы вне контракта</h3>
    ...
    <h3 id="snachala-dopsoglashenie-potom-raboty">Что оформляют раньше: допсоглашение или работы</h3>
    ...
    <h3 id="avariynye-scenarii-isklyucheniya">В каких случаях применяется исключение об аварийности</h3>
    ...
    <h3 id="planirovat-li-isklyuchenie">Можно ли планировать работы в расчёте на это исключение</h3>
    ...
    <h3 id="esli-zakazchik-molchit-ili-otkazal">Что делать, если заказчик молчит или отказал</h3>
    ...
    <h3 id="kogo-zashchishchaet-norma-ob-otkaze">Кого и от чего защищает правило об отказе</h3>
    ...
    <h3 id="dengi-posle-izmeneniya-kontrakta">Когда деньги на допработы доходят до казначейского контура</h3>
    ...
    <h3 id="rashody-tolko-pod-legalnyy-obem">Можно ли оплатить с лицевого счёта неоформленные допработы</h3>
    ...
    <h3 id="igk-pri-dopsoglashenii">Меняется ли идентификатор контракта после допсоглашения</h3>

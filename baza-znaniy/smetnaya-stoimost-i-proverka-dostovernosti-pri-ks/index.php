...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>14 мин чтения</span><span class="dot">·</span><span>Обновлено 16 июля 2026</span></div>
    </div>
    ...
    <div class="tldr">Сметная стоимость — это денежная оценка строительства, реконструкции или капитального ремонта, рассчитанная по установленным нормативам и ценам ресурсов. Для строек, финансируемых из бюджета, сметная стоимость определяется <b>обязательным применением сметных нормативов</b> из федерального реестра и сметных цен строительных ресурсов (ст. 8.3 Градостроительного кодекса), а данные о ценах берут из <b>ФГИС ЦС</b>. Прежде чем такую стройку начнут финансировать, смета проходит <b>проверку достоверности определения сметной стоимости</b> — с 2020 года это часть государственной экспертизы проектной документации (Постановление Правительства РФ от 05.03.2007 № 145). Проверка обязательна для объектов, оплачиваемых полностью или частично из бюджета. При <b>казначейском сопровождении</b> смета работает трижды: задаёт начальную цену контракта, определяет перечень и стоимость материалов для аванса и служит эталоном, с которым казначейство сверяет оплату по актам КС-2 и справкам КС-3. Ниже — как определяют смету, когда нужна проверка достоверности, кто её проводит и почему из-за сметы возвращают платежи.</div>
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-5">Федеральный закон от 05.04.2013 № 44-ФЗ, ст. 22 — обоснование начальной (максимальной) цены контракта, в том числе проектно-сметным методом.</li>

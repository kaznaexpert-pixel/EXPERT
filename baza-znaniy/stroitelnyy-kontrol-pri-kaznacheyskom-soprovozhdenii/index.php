...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Что такое строительный контроль и обязателен ли он?", "acceptedAnswer": {"@type": "Answer", "text": "Строительный контроль — это проверка соответствия работ проектной документации, техническим регламентам и объёмам. По статье 53 Градостроительного кодекса он проводится при строительстве, реконструкции и капитальном ремонте объектов капитального строительства и обязателен для большинства объектов."}}, {"@type": "Question", "name": "Как считается норматив затрат на строительный контроль?", "acceptedAnswer": {"@type": "Answer", "text": "По объектам, финансируемым с привлечением средств федерального бюджета, размер затрат определяется по постановлению Правительства РФ от 21.06.2010 № 468 исходя из общей стоимости строительства (без стоимости земли) в базисном уровне цен на 1 января 2000 года, приводится к текущему уровню и указывается в главе 10 сводного сметного расчёта отдельной строкой."}}, {"@type": "Question", "name": "Попадает ли договор строительного контроля под казначейское сопровождение?", "acceptedAnswer": {"@type": "Answer", "text": "Да, если он финансируется из бюджета и превышает порог, установленный на 2026 год статьёй 5 Федерального закона № 426-ФЗ. Тогда исполнителю открывают лицевой счёт, он ведёт раздельный учёт и проходит санкционирование по каждой оплате."}}, {"@type": "Question", "name": "Чем оплата технадзора отличается от оплаты строительных работ?", "acceptedAnswer": {"@type": "Answer", "text": "Строительный контроль — это услуги, поэтому их закрывают актами оказанных услуг. Формы КС-2 (акт о приёмке выполненных работ) и КС-3 (справка о стоимости) применяют для строительных работ подрядчика, а не для услуг контроля."}}, {"@type": "Question", "name": "Кто проводит строительный контроль?", "acceptedAnswer": {"@type": "Answer", "text": "Контроль ведут две стороны: лицо, осуществляющее строительство (подрядчик), — за своими работами, и застройщик или технический заказчик — за ходом и результатами работ подрядчика. Контроль со стороны заказчика может выполнять привлечённая организация по договору."}}, {"@type": "Question", "name": "Нужен ли раздельный учёт по договору строительного контроля?", "acceptedAnswer": {"@type": "Answer", "text": "Да. По каждому сопровождаемому контракту исполнитель ведёт обособленный учёт доходов и расходов. Без раздельного учёта казначейство не пропустит платёж, а проверка увидит риск нецелевого расходования."}}, {"@type": "Question", "name": "Почему казначейство возвращает оплату строительного контроля?", "acceptedAnswer": {"@type": "Answer", "text": "Чаще всего — из-за оформления услуг актами КС-2 и КС-3 вместо актов оказанных услуг, отсутствия раздельного учёта, неверного кода направления расходования или небрежного назначения платежа. Это возврат на доработку; после исправления распоряжение подают заново."}}, {"@type": "Question", "name": "Что такое акты освидетельствования скрытых работ?", "acceptedAnswer": {"@type": "Answer", "text": "Это документы, которыми в ходе строительного контроля фиксируют работы, закрываемые последующими конструкциями. Их оформляют до того, как работы станут недоступны для проверки; пропущенный акт позже осложняет подтверждение выполненного."}}]}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#normativ">Норматив затрат на строительный контроль</a></li>
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>13 мин чтения</span><span class="dot">·</span><span>Обновлено 15 июля 2026</span></div>
    </div>

...
{"@type":"Question","name":"Что значит отказ казначейства в санкционировании?","acceptedAnswer":{"@type":"Answer","text":"Это возврат платёжного документа без исполнения, когда операция не прошла проверку ТОФК на соответствие контракту, целевому назначению и комплекту документов. Платёж нужно исправить и направить повторно."}},
{"@type":"Question","name":"Какая самая частая причина отказа?","acceptedAnswer":{"@type":"Answer","text":"Отсутствие ИГК в документах и неверный код направления расходования целевых средств — на них приходится наибольшая доля возвратов."}},
{"@type":"Question","name":"Где посмотреть причину отказа?","acceptedAnswer":{"@type":"Answer","text":"Причина указывается в протоколе, который казначейство формирует при возврате операции в «Электронном бюджете»."}},
{"@type":"Question","name":"Что делать, если казначейство вернуло платёж?","acceptedAnswer":{"@type":"Answer","text":"Установить причину по протоколу, исправить ошибку (код, документ, реквизит, сведения), при необходимости обновить сведения об операциях и направить платёж повторно."}},
{"@type":"Question","name":"Можно ли вывести деньги с казначейского счёта на расчётный?","acceptedAnswer":{"@type":"Answer","text":"Свободно — нет. Перечисление возможно только в установленных случаях и порядке, после санкционирования; операции вне режима счёта казначейство не пропустит."}},
{"@type":"Question","name":"Как снизить число отказов?","acceptedAnswer":{"@type":"Answer","text":"Проверять каждый платёж по чек-листу до отправки, держать актуальными сведения об операциях, заранее продлевать ЭП; при системных возвратах — провести аудит сопровождения."}}
]}
</script>
<script type="application/ld+json">

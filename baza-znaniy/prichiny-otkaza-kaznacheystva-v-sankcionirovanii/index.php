...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию; основания отказа определяются уведомлением территориального органа казначейства и применимыми нормативными актами. Проверено экспертом КазнаЭксперт. Дата актуализации — 10 августа 2026.</p>
    </div>

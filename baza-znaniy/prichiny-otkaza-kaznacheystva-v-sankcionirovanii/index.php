  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        ...
        <li><a href="#svedeniya">Сведения об операциях</a></li><li><a href="#chek-list">Чек-лист</a></li>
        <li><a href="#chto-delat">Что делать при отказе</a></li><li><a href="#keys">Пример из практики</a></li>
    ...
    <div class="answer reveal">
      ...
      <p>Порядок и основания такой проверки установлены главой 24.4 Бюджетного кодекса РФ и Порядком осуществления территориальными органами Федерального казначейства санкционирования операций со средствами участников казначейского сопровождения<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a>. Важно понимать: отказ — это не штраф и не блокировка контракта, а возврат конкретного документа на доработку. Но каждый возврат — это потерянное время и риск срыва срока оплаты поставщику, поэтому причины отказов выгоднее снимать заранее.</p>
    <p><strong>Что меняется в 2026 году.</strong> С 1 сентября 2026 года действующий Порядок санкционирования (приказ Минфина России № 214н) планируется заменить новым порядком: Минфин подготовил проект, который консолидирует внесённые изменения, приводит формулировки в соответствие с Бюджетным кодексом и продолжает перенос процедур в «Электронный бюджет». Сама механика проверки сохраняется, поэтому перечень причин отказа ниже остаётся актуальным.</p>
    </div>
    ...
    <div class="note"><b>Важно.</b> С 2026 года Федеральное казначейство усилило контроль за целевым использованием средств, сведениями об операциях и обоснованием платежей<a class="fn" href="#ref-2" aria-label="Источник 2">[2]</a>. Ошибки, которые раньше «проходили», теперь чаще приводят к возвратам. Это значит, что профилактика оформления стала важнее, чем когда-либо.</div>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию; основания отказа определяются протоколом ТОФК и применимыми НПА. Проверено экспертом КазнаЭксперт. Дата актуализации — 4 июня 2026.</p>
    </div>

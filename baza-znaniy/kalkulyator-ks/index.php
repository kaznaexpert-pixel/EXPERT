...
<link rel="canonical" href="https://kaznaexpert.ru/baza-znaniy/kalkulyator-ks/">
...
{"@context": "https://schema.org", "@type": "WebApplication", "name": "Калькулятор казначейского сопровождения 2026", "url": "https://kaznaexpert.ru/baza-znaniy/kalkulyator-ks/", "datePublished": "2026-06-05", "dateModified": "2026-09-16", "applicationCategory": "FinanceApplication", "operatingSystem": "Web", "offers": {"@type": "Offer", "price": "0", "priceCurrency": "RUB"}, "description": "Проверка, попадает ли контракт под казначейское сопровождение по порогам ст. 5 ФЗ № 426-ФЗ", "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "@id": "https://kaznaexpert.ru/#organization"}}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <aside class="toc" aria-label="Содержание">
    ...
    <ul class="toc__list" id="tocList">
      ...
      <li><a href="#porogi">Пороги 2026</a></li>
      <li><a href="#chto-dalshe">Что дальше</a></li>
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Методика: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>по ст. 5 ФЗ № 426-ФЗ</span><span class="dot">·</span><span>Актуально на сентябрь 2026</span><span class="dot">·</span><span>Обновлено 16 сентября 2026 · пороги и логика расчёта сверены со статьёй 5 закона № 426-ФЗ в редакции от 26.06.2026</span></div>
    </div>
...
<h2 id="porogi">Пороги казначейского сопровождения в 2026 году</h2>
    ...
    <table class="tbl">
      <caption>Пороги по ст. 5 ФЗ № 426-ФЗ</caption>
      <tr><th>Тип средств</th><th>Порог</th><th>Норма</th></tr>
      <tr><td>Расчёты по контракту ГОЗ</td><td>свыше 3 млн ₽</td><td>п. 8 ч. 2 ст. 5</td></tr>
      <tr><td>Госконтракт с единственным поставщиком</td><td>свыше 3 млн ₽</td><td>п. 7 ч. 2 ст. 5</td></tr>
      <tr><td>Договор с соисполнителем / субподряд</td><td>свыше 3 млн ₽</td><td>п. 9 ч. 2 ст. 5</td></tr>
      <tr><td>Аванс по обычному госконтракту</td><td>от 100 млн ₽</td><td>п. 5 ч. 2 ст. 5</td></tr>
      <tr><td>Аванс по контракту БУ/АУ за счёт субсидии</td><td>от 10 млн ₽</td><td>п. 6 ч. 2 ст. 5</td></tr>
    ...
    <div class="answer reveal">
      <p>Понадобится <a href="/baza-znaniy/licevoy-schet-71-kak-otkryt/">лицевой счёт в ТОФК</a>, подключение к <a href="/baza-znaniy/elektronnyy-byudzhet-dlya-ispolnitelya-kontrakta/">ГИИС «Электронный бюджет»</a> и прохождение <a href="/baza-znaniy/poryadok-sankcionirovaniya-rashodov/">санкционирования</a> по каждому платежу. Мы делаем это под ключ: счёт за 2 рабочих дня, сопровождение до закрытия контракта — <a href="/uslugi/kaznacheyskoe-soprovozhdenie/">услуги и цены</a>.</p>
    </div>
  ...
  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="kalkulyator">
...
(function(){
  ...
  var used=false;
  function goal(){if(!used){used=true;try{window.ym&&ym(window.YM_ID||0,'reachGoal','calc_used');}catch(e){}}}

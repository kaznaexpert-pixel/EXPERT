...
{"@context": "https://schema.org", "@type": "Article", "headline": "Электронное актирование и приёмка в ЕИС по 44-ФЗ: как оформить документ о приёмке", "description": "Электронное актирование по 44-ФЗ: структурированный документ о приёмке в ЕИС, сроки подписания, мотивированный отказ и связь приёмки с оплатой.", "inLanguage": "ru-RU", "datePublished": "2026-06-27", "dateModified": "2026-06-27", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/"}, "publisher": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "logo": {"@type": "ImageObject", "url": "https://kaznaexpert.ru/img/logogold.png"}}, "image": "https://kaznaexpert.ru/img/og-image.png", "mainEntityOfPage": {"@type": "WebPage", "@id": "https://kaznaexpert.ru/baza-znaniy/elektronnoe-aktirovanie-priyomka-44-fz/"}}
</script>
<script type="application/ld+json">
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p>Мотивированный отказ — это не отказ «по настроению». Заказчик обязан указать конкретные причины: какие именно характеристики не соответствуют контракту, чего не хватает, какие документы не приложены. Немотивированный или формальный отказ поставщик вправе оспорить, и наличие в ЕИС зафиксированной переписки здесь работает на исполнителя.</p>
    ...
    <h2 id="komissiya">Приёмочная комиссия и экспертиза</h2>
    ...
    <p>Кроме того, заказчик обязан провести экспертизу поставленного товара, выполненной работы или оказанной услуги — своими силами или с привлечением экспертов и экспертных организаций. Экспертиза подтверждает, что результат соответствует условиям контракта. По ряду закупок привлечение внешних экспертов обязательно, по остальным заказчик может ограничиться внутренней проверкой.</p>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 94 «Особенности исполнения контракта», части 13 и 14 (ред. от 28.12.2025, с изм. с 01.01.2026).</li>
        <li id="ref-2">Федеральный закон от 05.04.2013 № 44-ФЗ, часть 13.1 статьи 34 (срок оплаты по контракту).</li>
        <li id="ref-3">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 94, часть 7 (документ о приёмке как основание).</li>
        <li id="ref-4">Федеральный закон от 05.04.2013 № 44-ФЗ, статья 103 и постановление Правительства РФ от 28.11.2013 № 1084 (реестр контрактов, сведения об исполнении).</li>
        <li id="ref-5">Федеральный закон от 06.04.2011 № 63-ФЗ «Об электронной подписи» (усиленная квалифицированная подпись).</li>
      </ol>
      <p class="refs__note">Нормы приведены в редакции, действующей на 27 июня 2026 года. Материал носит справочный характер и не заменяет юридическую консультацию по конкретной закупке.</p>
    </div>
  </article>

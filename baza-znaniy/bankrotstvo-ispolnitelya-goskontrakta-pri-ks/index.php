  ...
  <article class="content" id="main">
    ...
    <div class="refs">
      ...
      <ol>
        ...
        <li id="ref-2">Бюджетный кодекс РФ: ст. 242.23 (казначейское сопровождение) и глава 24.1 «Исполнение судебных актов по обращению взыскания на средства бюджетов» (consultant.ru/document/cons_doc_LAW_19702/).</li>
        <li id="ref-3">Федеральный закон от 05.04.2013 № 44-ФЗ «О контрактной системе…», ст. 95 (расторжение контракта).</li>
        <li id="ref-4">Федеральный закон от 29.12.2012 № 275-ФЗ «О государственном оборонном заказе», ст. 8.3, 8.4 (режим отдельного счёта) (consultant.ru/document/cons_doc_LAW_140175/).</li>
        ...
        <li id="ref-6">Приказ Минфина России от 17.12.2021 № 214н (ред. от 27.06.2025) — Порядок санкционирования операций участников казначейского сопровождения.</li>
        <li id="ref-7">Гражданский кодекс РФ, часть первая — общие положения об обязательствах, применяемые при расчётах и уступке требований.</li>
      </ol>

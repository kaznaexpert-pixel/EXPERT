  ...
  <article class="content" id="main">
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        ...
        <div class="kf"><div class="kf__n">Ст. 8.3, 8.4 № 275-ФЗ</div><div class="kf__t"><b>Счёт по ГОЗ</b> — отдельный счёт по гособоронзаказу в уполномоченном банке защищён специальным режимом: списания по нему ограничены даже вне процедуры банкротства</div></div>
      </div>
    </section>

...
{"@type":"Question","name":"Каким актом установлен порядок раздельного учёта при расширенном КС?","acceptedAnswer":{"@type":"Answer","text":"Порядок раздельного учёта и документального обеспечения проверок при расширенном казначейском сопровождении обновлён приказом Федерального казначейства от 30.09.2025 № 12н."}}
]}
</script>
<script type="application/ld+json">
...
<meta property="og:description" content="Когда обязателен раздельный учёт при КС, как его выстроить и штраф по ст. 15.37.1 КоАП РФ (до 500 000 ₽).">
...
<meta name="twitter:description" content="Когда обязателен раздельный учёт при КС, как его выстроить и штраф по ст. 15.37.1 КоАП РФ (до 500 000 ₽).">
  ...
  <article class="content" id="main">
    ...
    <section class="keyfacts grain" aria-label="Ключевые факты">
      ...
      <div class="keyfacts__grid">
        <div class="kf"><div class="kf__n">15.37.1</div><div class="kf__t"><b>Штраф</b> — новая статья КоАП РФ за неведение учёта при КС</div></div>
        ...
        <div class="kf"><div class="kf__n">№ 12н</div><div class="kf__t"><b>Порядок</b> — приказ Казначейства от 30.09.2025 (расширенное КС)</div></div>
    ...
    <div class="answer reveal">
      ...
      <p>Если контракт под казначейское сопровождение не попадает, отдельной обязанности именно «раздельного учёта результатов ФХД» в смысле КС не возникает. Поэтому первый шаг — определить, подпадает ли ваш контракт под сопровождение. Пороги и случаи мы разобрали в материале <a href="/baza-znaniy/kto-popadaet-pod-kaznacheyskoe-soprovozhdenie/">«Кто попадает под казначейское сопровождение»</a>.</p>
    </div>
    <div class="note"><b>Важно.</b> Обязанность привязана не к «любому госконтракту», а к казначейскому сопровождению средств. Нет сопровождения — нет и специального требования о раздельном учёте по правилам КС.</div>

    <h2 id="osnova">На чём основан раздельный учёт при КС</h2>
    <div class="answer reveal">
    ...
    <table>
      ...
      <tr><td>Приказ Казначейства от 30.09.2025 № 12н</td><td>Порядок раздельного учёта и проверок при расширенном КС</td></tr>
    ...
    <div class="answer reveal">
      <p>Это два разных режима, которые часто путают. Раздельный учёт по гособоронзаказу регулируется законодательством о ГОЗ (Закон № 275-ФЗ и профильные постановления) и имеет свои формы, правила распределения затрат и отдельную ответственность. Раздельный учёт по обычному госконтракту под казначейским сопровождением (например, по 44-ФЗ, по субсидиям, бюджетным инвестициям) опирается на бюджетное законодательство о КС и порядок, установленный Правительством.</p>
    ...
    <div class="takeaways">
      ...
      <ol>
        ...
        <li>Порядок учёта и проверок при расширенном КС обновлён приказом Казначейства № 12н.</li>
    ...
    <dl class="gloss">
      ...
      <div><dt>Расширенное КС</dt><dd>Усиленный режим казначейского сопровождения с проверками.</dd></div>
    ...
    <div class="faq">
      ...
      <details><summary>Чем раздельный учёт по госконтракту отличается от учёта по ГОЗ?</summary><p>Принцип общий — обособить доходы и расходы по контракту. Но нормативная база и формы разные: ГОЗ регулируется законодательством о гособоронзаказе, а обычный госконтракт под КС — бюджетным законодательством и порядком Правительства.</p></details>
      ...
      <details><summary>Каким актом установлен порядок раздельного учёта при расширенном КС?</summary><p>Порядок раздельного учёта и документального обеспечения проверок при расширенном казначейском сопровождении обновлён приказом Федерального казначейства от 30.09.2025 № 12н.</p></details>

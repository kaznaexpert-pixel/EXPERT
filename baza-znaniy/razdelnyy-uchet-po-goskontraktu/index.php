...
<p data-ctx="auto-ctx:auts-0903-1">Если вести раздельный учёт по контракту некому, эту работу вместе со счётом, санкционированием и отчётностью закрывает <a href="/uslugi/autsorsing-kaznacheyskogo-soprovozhdeniya/">аутсорсинг казначейского сопровождения</a> — с фиксированной ценой по этапу контракта.</p>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Материал носит справочный характер и не заменяет индивидуальную консультацию; актуальные требования, размеры штрафов и порядок устанавливаются НПА и могут уточняться. Проверено экспертом КазнаЭксперт. Дата актуализации — 14 августа 2026.</p>
    </div>

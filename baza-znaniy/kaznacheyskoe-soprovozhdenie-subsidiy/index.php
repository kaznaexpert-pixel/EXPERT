...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <details class="mtoc"><summary>Содержание статьи</summary>
      <ol>
        <li><a href="#chto-takoe">Что это такое</a></li><li><a href="#kakie">Какие субсидии попадают</a></li><li><a href="#pravovaya">Правовая база</a></li><li><a href="#kak-rabotaet">Как работает</a></li><li><a href="#poryadok">Порядок для получателя</a></li><li><a href="#otlichie">Отличие от обычной субсидии</a></li><li><a href="#oshibki">Частые ошибки</a></li><li><a href="#keys">Пример из практики</a></li><li><a href="#glossary">Глоссарий</a></li><li><a href="#faq">Частые вопросы</a></li>
      </ol>
    </details>
    ...
    <div class="faq">
      ...
      <details><summary>Кто поможет с субсидией под сопровождением?</summary><p>Открытие счёта, подключение к «Электронному бюджету» и проведение расходов можно передать на сопровождение эксперту. Оставьте заявку — поможем получить и провести субсидию без задержек.</p></details>
    </div>

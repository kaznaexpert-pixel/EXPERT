...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p data-ctx="giis-root">АРМ — это рабочее место для входа в закрытую часть системы; что представляет собой сама система и какие её подсистемы понадобятся исполнителю контракта, см. в обзоре <a href="/baza-znaniy/giis-elektronnyy-byudzhet/">ГИИС «Электронный бюджет»: что это и из чего состоит</a>.</p>

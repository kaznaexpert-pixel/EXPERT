...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>16 мин чтения</span><span class="dot">·</span><span>Обновлено 8 августа 2026</span></div>
    </div>
...
<figcaption style="font-size:13px;color:#6E6B66;font-style:italic;margin-top:8px">Пять шагов подготовки: от уточнения параметров проверки до возражений на акт.</figcaption>
    ...
    <div class="refs">
      ...
      <p class="refs__note">Нормы приведены в редакции, действующей на 8 августа 2026 года. Порядок конкретной проверки определяется решением о её проведении и действующими федеральными стандартами. Материал носит справочный характер и не заменяет юридическую консультацию по конкретной проверке.</p>
    </div>

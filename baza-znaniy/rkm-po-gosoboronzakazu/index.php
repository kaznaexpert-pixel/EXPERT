...
{"@type": "Question", "name": "Как нормируется прибыль в цене ГОЗ?", "acceptedAnswer": {"@type": "Answer", "text": "По Положению № 1465 плановая прибыль не превышает 1 % привнесённых затрат плюс 20 % собственных затрат. Расчёт и база раскрываются в форме № 20."}},
...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <p>Плановая рентабельность в ГОЗ нормируется Положением № 1465: общий принцип — прибыль не может превышать 1 % привнесённых затрат плюс 20 % собственных затрат (формула «1+20»), а минимальный уровень при затратном методе привязан к собственным затратам. Форма № 20 как раз и раскрывает базу: сколько в себестоимости привнесённого, сколько собственного и какая прибыль на этом основании заявлена.<a class="fn" href="#ref-2" aria-label="Источник 2">[2]</a></p>
    ...
    <ul>
      ...
      <li>как сформирована прибыль относительно базы «1+20»;</li>
    ...
    <p>Сведите статьи в форму № 2, разделите затраты на привнесённые и собственные, рассчитайте прибыль в форме № 20 по базе «1+20».</p>
    ...
    <div class="takeaways">
      ...
      <ol>
        ...
        <li>Главная новация форм — разделение себестоимости на привнесённые и собственные затраты; от него считается прибыль по формуле «1+20».</li>
    ...
    <dl class="gloss">
      ...
      <div><dt>Формула «1+20»</dt><dd>Предельная плановая прибыль: не более 1 % привнесённых плюс 20 % собственных затрат (Положение № 1465).</dd></div>
    ...
    <div class="faq">
      ...
      <details><summary>Как нормируется прибыль в РКМ?</summary><p>По Положению № 1465: плановая прибыль не более 1 % привнесённых затрат плюс 20 % собственных. База раскрывается в форме № 20 — поэтому структура затрат напрямую влияет на допустимую прибыль.</p></details>

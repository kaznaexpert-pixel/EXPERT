...
{"@type": "Question", "name": "Что такое РКМ по гособоронзаказу?", "acceptedAnswer": {"@type": "Answer", "text": "Расчётно-калькуляционные материалы — комплект документов, обосновывающих цену продукции ГОЗ: калькуляции, расшифровки затрат, расчёты трудоёмкости, оплаты труда и прибыли. В приказе ФАС № 995/22 называются обосновывающими документами."}},
{"@type": "Question", "name": "Каким документом утверждены формы РКМ?", "acceptedAnswer": {"@type": "Answer", "text": "Приказом ФАС России от 16.12.2022 № 995/22, действующим с 10 января 2023 года (актуальная редакция — от 18.12.2025). Он заменил приказ ФАС № 1138/19."}},
{"@type": "Question", "name": "Какие формы РКМ заполнять обязательно?", "acceptedAnswer": {"@type": "Answer", "text": "Состав зависит от вида цены и метода её определения по Положению № 1465. Базовый костяк: плановая калькуляция (форма 2), расшифровки материальных затрат, расчёт трудоёмкости (форма 23), зарплатные формы, расчёт прибыли (форма 20), пояснительная записка."}},
{"@type": "Question", "name": "Что такое привнесённые и собственные затраты?", "acceptedAnswer": {"@type": "Answer", "text": "Привнесённые — покупные ресурсы: материалы, комплектующие, работы соисполнителей. Собственные — создаваемые предприятием: оплата труда, взносы, накладные расходы, амортизация. Формы № 995/22 раскрывают себестоимость в этом разрезе."}},
{"@type": "Question", "name": "Как нормируется прибыль в цене ГОЗ?", "acceptedAnswer": {"@type": "Answer", "text": "По Положению № 1465 плановая прибыль не превышает 1 % привнесённых затрат плюс 25 % собственных затрат. Расчёт и база раскрываются в форме № 20."}},
{"@type": "Question", "name": "Кому направляются РКМ?", "acceptedAnswer": {"@type": "Answer", "text": "Государственному заказчику в составе предложения о цене, а по закреплённой продукции — в военное представительство Минобороны для выдачи заключения о цене. Внутри кооперации комплекты запрашивает головной исполнитель."}},
{"@type": "Question", "name": "Чем отличается плановая калькуляция от отчётной?", "acceptedAnswer": {"@type": "Answer", "text": "Плановая (форма 2) показывает ожидаемые затраты при формировании цены, отчётная (форма 3) — фактические по данным раздельного учёта. Их сопоставление лежит в основе перевода ориентировочной цены в фиксированную."}},
{"@type": "Question", "name": "Какие затраты нельзя включать в цену ГОЗ?", "acceptedAnswer": {"@type": "Answer", "text": "Затраты, не предусмотренные порядком приказа Минпромторга № 334: не связанные с производством продукции или превышающие установленные нормы."}},
{"@type": "Question", "name": "Нужны ли РКМ соисполнителям?", "acceptedAnswer": {"@type": "Answer", "text": "Да, обоснование цены действует по всей цепочке кооперации: головной исполнитель проверяет цены соисполнителей и запрашивает их обосновывающие документы."}},
{"@type": "Question", "name": "Что будет, если подать РКМ на старых формах?", "acceptedAnswer": {"@type": "Answer", "text": "Комплект вернут: с 10 января 2023 года действуют формы приказа № 995/22, и документы по отменённому приказу 1138/19 не принимаются."}}
]}
</script>
<script type="application/ld+json">

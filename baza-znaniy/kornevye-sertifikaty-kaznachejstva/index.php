...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="byline"><span class="av">ЯМ</span><span>Автор: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span><span class="dot">·</span><span>15+ лет в Казначействе</span><span class="dot">·</span><span>13 мин чтения</span><span class="dot">·</span><span>Обновлено 6 августа 2026</span></div>
    </div>
    ...
    <div class="answer reveal">
      <p class="lead-p">Корневые сертификаты УЦ казначейства — это сертификаты вышестоящих удостоверяющих центров, которые подтверждают подлинность вашей электронной подписи казначейства. Чтобы Windows и КриптоПро «доверяли» сертификату пользователя, на компьютер нужно установить два сертификата: корневой сертификат Головного удостоверяющего центра Минцифры России и сертификат Удостоверяющего центра Федерального казначейства. Их публикуют на сайте казначейства и на портале crl.roskazna.ru.<a class="fn" href="#ref-1" aria-label="Источник 1">[1]</a> Подробнее о подаче первичного запроса — в отдельном разборе про <a href="/baza-znaniy/portal-zayavitelya-kaznachejstva/">портал заявителя ФЗС</a>.</p>

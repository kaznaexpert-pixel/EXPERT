...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <p>Сертификаты казначейства выпускаются по российским криптоалгоритмам ГОСТ — формирование и проверка подписи по ГОСТ Р 34.10-2012, хеширование по ГОСТ Р 34.11-2012. Стандартная Windows такие алгоритмы «из коробки» не понимает: нужен сертифицированный криптопровайдер. На практике это КриптоПро CSP (актуальная линейка 5.0).<a class="fn" href="#ref-3" aria-label="Источник 3">[3]</a> Поэтому установка корневых сертификатов без установленного КриптоПро не даст рабочей проверки подписи — провайдер ставят первым.</p>
    </div>

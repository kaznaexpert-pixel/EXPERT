...
{"@context": "https://schema.org", "@type": "DefinedTermSet", "datePublished": "2026-06-25", "dateModified": "2026-07-02", "name": "Глоссарий терминов казначейского сопровождения", "url": "https://kaznaexpert.ru/baza-znaniy/glossary/", "author": {"@type": "Person", "name": "Ярослав Михайлов", "jobTitle": "Главный эксперт по казначейскому сопровождению", "url": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/", "@id": "https://kaznaexpert.ru/komanda/mihailov-yaroslav/#person", "image": "https://kaznaexpert.ru/img/team/mihailov-photo.jpg"}, "publisher": {"@id": "https://kaznaexpert.ru/#organization"}, "hasDefinedTerm": [{"@type": "DefinedTerm", "name": "ТОФК", "description": "Территориальный орган Федерального казначейства, который ведёт счёт и санкционирует операции по контракту."}, {"@type": "DefinedTerm", "name": "УФК", "description": "Управление Федерального казначейства по субъекту РФ — региональное подразделение Федерального казначейства."}, {"@type": "DefinedTerm", "name": "Лицевой счёт 71", "description": "Счёт получателя средств, открытый в ТОФК; через него идут расчёты по контракту под казначейским сопровождением."}, {"@type": "DefinedTerm", "name": "Санкционирование", "description": "Проверка казначейством законности и обоснованности расхода перед проведением платежа."}, {"@type": "DefinedTerm", "name": "Сведения об операциях с целевыми средствами", "description": "Утверждаемый документ с плановыми операциями по целевым средствам; по нему идёт санкционирование."}, {"@type": "DefinedTerm", "name": "ИГК", "description": "Идентификатор государственного контракта — 25-значный код, связывающий операции и счёт с конкретным контрактом."}, {"@type": "DefinedTerm", "name": "КВР", "description": "Код вида расходов — классифицирует направление расходования бюджетных средств."}, {"@type": "DefinedTerm", "name": "КОСГУ", "description": "Классификация операций сектора государственного управления — детализирует экономическое содержание операции."}, {"@type": "DefinedTerm", "name": "Раздельный учёт", "description": "Учёт доходов и расходов в разрезе каждого контракта; обязателен по ГОЗ."}, {"@type": "DefinedTerm", "name": "ГИИС «Электронный бюджет»", "description": "Государственная система, через которую ведутся казначейские операции и документооборот по контракту."}, {"@type": "DefinedTerm", "name": "КЭП", "description": "Квалифицированная электронная подпись; для «Электронного бюджета» выдаётся УЦ казначейства."}, {"@type": "DefinedTerm", "name": "Сводный реестр", "description": "Реестр участников и неучастников бюджетного процесса; без включения в него казначейские операции невозможны."}]}
</script>
<script type="application/ld+json">
...
<meta property="og:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__glossary-16x9.jpg">
...
<meta name="twitter:image" content="https://kaznaexpert.ru/img/og/baza-znaniy__glossary-16x9.jpg">

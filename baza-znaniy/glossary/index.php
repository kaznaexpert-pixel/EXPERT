...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="answer reveal">
      <dl class="gloss">
        <div><dt>УФК</dt><dd>Управление Федерального казначейства по субъекту РФ — региональное подразделение Федерального казначейства.</dd></div>
        <div><dt>ТОФК</dt><dd>Территориальный орган Федерального казначейства, который ведёт счёт и санкционирует операции по контракту.</dd></div>

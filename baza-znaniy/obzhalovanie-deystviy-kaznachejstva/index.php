...
<p class="lead-p">Если же вы уверены, что требования казначейства не основаны на законе, есть два пути: <b>ведомственный</b> — жалоба в вышестоящий орган казначейства в порядке Федерального закона № 59-ФЗ, и <b>судебный</b> — оспаривание действий (бездействия) органа по главе 24 Арбитражного процессуального кодекса, срок три месяца со дня, когда стало известно о нарушении прав.</p>
    ...
    <p>Правовая рамка требования — статьи 242.23 и 269.1 Бюджетного кодекса (санкционирование операций) и порядок санкционирования по приказу Минфина № 214н: именно ими проверяется, было ли требование ТОФК законным. Суд не «разрешает платёж» вместо казначейства, а оценивает законность его действий и возвращает вопрос на исполнение, если отказ был неправомерен.</p>
    ...
    <div class="faq">
      ...
      <details><summary>Чем обжалование отказа отличается от обжалования предписания?</summary><p>Отказ в санкционировании — спор о текущем платеже (гл. 24 АПК, ст. 242.23/269.1 БК). Предписание — акт по итогам проверки финконтроля со своим досудебным порядком (ст. 270.2 БК, ПП № 1237). Это разные институты.</p></details>
    ...
    <div class="refs">
      ...
      <ol>
        <li id="ref-1">Бюджетный кодекс РФ: ст. 242.23 (казначейское сопровождение) и ст. 269.1 (санкционирование операций) (consultant.ru/document/cons_doc_LAW_19702/). <a href="https://www.consultant.ru/document/cons_doc_LAW_19702/" target="_blank" rel="noopener">КонсультантПлюс</a></li>

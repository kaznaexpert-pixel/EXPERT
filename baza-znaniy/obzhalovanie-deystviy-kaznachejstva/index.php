...
<div class="layout">
  ...
  <article class="content" id="main">
    ...
    <div class="tldr">Обжаловать отказ казначейства в санкционировании имеет смысл тогда, когда отказ незаконен, а не когда в распоряжении реальная ошибка. Сначала стоит понять, что произошло: чаще ТОФК не выносит «отказ», а <b>возвращает распоряжение на доработку</b> — тогда быстрее исправить и подать заново. Если же вы уверены, что требования казначейства не основаны на законе, есть два пути: <b>ведомственный</b> — жалоба в вышестоящий орган казначейства в порядке Федерального закона № 59-ФЗ, и <b>судебный</b> — оспаривание действий (бездействия) органа по главе 24 Арбитражного процессуального кодекса, срок три месяца со дня, когда стало известно о нарушении прав. Обжалование отказа в санкционировании не нужно путать с обжалованием предписаний финконтроля — это разные институты.</div>

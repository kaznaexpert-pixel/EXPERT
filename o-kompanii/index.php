...
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Главная","item":"https://kaznaexpert.ru/", "url": "https://kaznaexpert.ru/"},{"@type":"ListItem","position":2,"name":"О компании", "url": "https://kaznaexpert.ru/o-kompanii/"}]}
</script>
...
<section class="ok-sec">
  <div class="ok-wrap">
    ...
    <div class="ok-prose">
      <p>Основатель практики — <b>Ярослав Михайлов</b>. Десять лет, с 2009 по 2019, он провёл внутри системы Федерального казначейства, поэтому КазнаЭксперт строит работу от логики проверяющего: какие формулировки ждёт УФК, на чём чаще всего спотыкается санкционирование и как выглядит правильный пакет документов глазами казначея.</p>
      <p>Из этого опыта выросли внутренние регламенты компании: каждый контракт идёт по одному выверенному маршруту — от резервирования счёта до закрытия и отчётности, а самые сложные ситуации (спасение контрактов, расширенное сопровождение, ГОЗ) основатель контролирует лично. Подробнее о нём — на <a href="/komanda/mihailov-yaroslav/">странице эксперта</a>.</p>
    </div>

...
<title>Контакты КазнаЭксперт: телефон +7 981 833-10-10, реквизиты</title>
<meta name="description" content="Контакты КазнаЭксперт: телефон +7 (981) 833-10-10, почта manager@kaznaexpert.ru, Telegram, реквизиты ИП (ИНН, ОГРНИП). Казначейское сопровождение госконтрактов.">
<meta name="author" content="Ярослав Михайлов">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
<meta name="theme-color" content="#F4F1EB" media="(prefers-color-scheme: light)">
<meta name="theme-color" content="#141310" media="(prefers-color-scheme: dark)">
<!-- PROD: canonical и og:url ОБЯЗАТЕЛЬНО менять под URL каждой статьи -->
<link rel="canonical" href="https://kaznaexpert.ru/kontakty/">
...
<script>window.YM_PARAMS = {page_type:"contacts"};</script>
...
<noscript><link rel="stylesheet" href="/css/v2.css?v=<?= @filemtime($_SERVER['DOCUMENT_ROOT'].'/css/v2.css') ?><link rel="stylesheet" href="/css/landing-shared.css?v=<?= @filemtime($_SERVER['DOCUMENT_ROOT'].'/css/landing-shared.css') ?>">
"></noscript>
...
<section class="kb-faq" aria-labelledby="faq"><style>.kb-faq{max-width:1240px;margin:48px auto;padding:0 24px;font-family:'Inter',system-ui,sans-serif}.kb-faq>h2{font-family:'Playfair Display',Georgia,serif;font-weight:500;font-size:clamp(1.5rem,2vw+1rem,2rem);letter-spacing:-.01em;margin:0 0 18px;color:var(--ink,#1A1A1A)}</style>
  ...
  <div class="faq">
      ...
      <details><summary>Как быстро вы отвечаете на заявку?</summary><p>На заявку с сайта перезваниваем в течение часа в рабочее время. Телефон и Telegram отвечают в будни с 9:00 до 19:00 по московскому времени, письма на manager@kaznaexpert.ru разбираем в течение рабочего дня.</p></details>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    <div class="v2-section-head">
      ...
      <h2 class="v2-section-title">Оставить заявку — <em>перезвоним в рабочее время</em></h2>
    ...
    <div style="max-width:520px;margin:0 auto">
      <form class="railform" id="leadFormBottom" novalidate data-endpoint="/php/lead.php" data-source="kontakty">

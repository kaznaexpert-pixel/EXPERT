 ...
 */
$CAT_MAP = [
    'Основы' => ['Основы', 'Казначейское сопровождение', 'Сопровождение', 'Применимость', 'Госконтракты'],
    'Гособоронзаказ (275-ФЗ)' => ['ГОЗ', 'Гособоронзаказ'],
    ...
    'Операции и отчётность' => ['Операции', 'Операции и отчётность', 'Операции по счёту'],
    'Раздельный учёт' => ['Раздельный учёт', 'Учёт'],
    'Ответственность и штрафы' => ['Ответственность'],
    'ГИИС «Электронный бюджет» и ЭЦП' => ['ГИИС', 'ГИИС «Электронный бюджет»', 'ГИС', 'Сертификаты и ЭП', 'Сертификаты и ЭЦП', 'ЭЦП и ГИИС', 'ЭЦП и сертификаты', 'Электронная подпись', 'Системы и сервисы'],
    'Субсидии и инвестиции' => ['Субсидии', 'Субсидии и инвестиции', 'Сопровождение субсидий'],

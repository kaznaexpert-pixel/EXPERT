          ...
          <div class="v2-container">
            ...
            <div class="v2-hero-grid">
              ...
              <aside class="v2-hero-action v2-reveal">
                ...
                <h2>Перезвоним в течение часа</h2>
...
<style>.v2 .v2-tariff-more{display:inline-block;margin-top:10px;font-size:13px;color:var(--accent,#8B6F47);font-weight:500;letter-spacing:.01em}.v2 .v2-tariff-more:hover{text-decoration:underline}</style>
            ...
            <p class="v2-tariffs-footnote">Также: резерв счёта к тендеру — 25 000 ₽ · открытие счёта — 35 000 ₽ · контракт с постоплатой — 65 000 ₽ · <a href="/uslugi/bankovskoe-soprovozhdenie/">банковское сопровождение контракта</a> — 105 000 ₽/мес. Все цены фиксируются в договоре.</p>
          ...
          <div class="v2-container">
            ...
            <div class="v2-process-grid">
              ...
              <article class="v2-process-step">
                ...
                <h3>Старт работы</h3>
                <p class="v2-process-desc">Связываемся в течение часа в рабочее время после заявки, подписываем договор и начинаем подготовку пакета документов для УФК.</p>
      ...
      <div class="v2">
        <section class="v2-section v2-screen" id="faq">
          ...
          <details itemscope itemtype="https://schema.org/Question">
                ...
                <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                  <p itemprop="text">Чтобы открыть казначейский счёт самостоятельно, нужно: 1) Получить квалифицированную электронную подпись (КЭП). 2) Подключиться к ГИИС «Электронный бюджет». 3) Подготовить пакет документов: устав, ЕГРЮЛ/ЕГРИП, контракт, доверенность. 4) Подать заявление и договор обслуживания в ТОФК. 5) Дождаться открытия. С «КазнаЭксперт» весь процесс — за 2 рабочих дня от готовности документов.</p>
                </div>
              </details>

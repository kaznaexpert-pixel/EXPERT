...
<section class="v2-section v2-screen" id="compare">
  <div class="v2-container">
    ...
    <div class="v2-compare">
      ...
      <div class="v2-compare-row"><div class="v2-compare-cell v2-compare-param" data-label="Параметр">Контроль целевого использования</div><div class="v2-compare-cell" data-label="Самостоятельно">Зависит от опыта</div><div class="v2-compare-cell" data-label="Штатный спец">Не профиль бухгалтерии</div><div class="v2-compare-cell is-us" data-label="С КазнаЭксперт"><strong>Проверяем каждый расход</strong></div></div><div class="v2-compare-row"><div class="v2-compare-cell v2-compare-param" data-label="Параметр">Лимит операций</div><div class="v2-compare-cell" data-label="Самостоятельно">Ограничен ресурсом</div><div class="v2-compare-cell" data-label="Штатный спец">Ограничен</div><div class="v2-compare-cell is-us" data-label="С КазнаЭксперт"><strong>Безлимит</strong></div></div><div class="v2-compare-row"><div class="v2-compare-cell v2-compare-param" data-label="Параметр">Цепочка кооперации</div><div class="v2-compare-cell" data-label="Самостоятельно">Сложно вручную</div><div class="v2-compare-cell" data-label="Штатный спец">Риск ошибок</div><div class="v2-compare-cell is-us" data-label="С КазнаЭксперт"><strong>Ведём все звенья</strong></div></div><div class="v2-compare-row"><div class="v2-compare-cell v2-compare-param" data-label="Параметр">Стоимость</div><div class="v2-compare-cell" data-label="Самостоятельно">Штат от 120–180 тыс ₽/мес</div><div class="v2-compare-cell" data-label="Штатный спец">Перегрузка + ошибки</div><div class="v2-compare-cell is-us" data-label="С КазнаЭксперт"><strong>79 000 ₽/мес</strong></div></div><div class="v2-compare-row"><div class="v2-compare-cell v2-compare-param" data-label="Параметр">Сведения и сроки КоАП</div><div class="v2-compare-cell" data-label="Самостоятельно">Риск просрочки</div><div class="v2-compare-cell" data-label="Штатный спец">Риск штрафа</div><div class="v2-compare-cell is-us" data-label="С КазнаЭксперт"><strong>В срок</strong></div></div><div class="v2-compare-row"><div class="v2-compare-cell v2-compare-param" data-label="Параметр">Реакция на запросы УФК</div><div class="v2-compare-cell" data-label="Самостоятельно">По загрузке</div><div class="v2-compare-cell" data-label="Штатный спец">Медленно</div><div class="v2-compare-cell is-us" data-label="С КазнаЭксперт"><strong>В тот же день</strong></div></div>
    </div>
...
<section class="v2-section v2-screen" id="tarif">
  <div class="v2-container">
    ...
    <div class="v2-tariffs-grid lp-3col"><article class="v2-tariff is-featured">
        ...
        <div class="v2-tariff-price"><div class="v2-tariff-price-num">79 000<span class="v2-tariff-price-unit">&nbsp;₽/мес</span></div><div class="v2-tariff-price-note">Чаще выбирают · безлимит операций</div><a href="#zayavka" class="v2-tariff-link">Обсудить контракт <span aria-hidden="true">→</span></a></div>

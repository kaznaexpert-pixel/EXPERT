...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Что входит в ежемесячное сопровождение?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Контроль целевого использования аванса, подготовка и санкционирование платежей, ведение цепочки кооперации, раздельный учёт, подача сведений об операциях и реакция на запросы казначейства — без лимита по числу операций."
      }
    },
    {
      "@type": "Question",
      "name": "Почему аванс требует особого контроля?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Авансовые средства казначейство проверяет на целевое использование особенно строго. Непрошедший платёж тормозит весь контракт, а нецелевой расход грозит требованием вернуть аванс. Поэтому каждый расход проверяется до подачи."
      }
    },
    {
      "@type": "Question",
      "name": "Что значит «безлимит операций»?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Стоимость не зависит от числа платежей в месяц. Сколько бы операций ни требовал контракт — ведём все в рамках фиксированной цены."
      }
    },
    {
      "@type": "Question",
      "name": "Ведёте цепочку кооперации с соисполнителями?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Да. Проверяем подтверждающие документы по каждому звену расчётов, чтобы платежи соисполнителям проходили санкционирование без возвратов."
      }
    },
    {
      "@type": "Question",
      "name": "Поможете со сведениями об операциях и сроками КоАП?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Да. Формируем и подаём сведения в установленные сроки — это снимает риск административных штрафов по КоАП за нарушение порядка."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Да, дистанционно по всем регионам РФ. Весь документооборот ведётся электронно через «Электронный бюджет»."
      }
    },
    {
      "@type": "Question",
      "name": "С какой суммы аванс попадает под казначейское сопровождение в 2026 году?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "По статье 5 Федерального закона от 28.11.2025 № 426-ФЗ сопровождаются авансы по государственным контрактам на сумму 100 млн ₽ и более, авансы по контрактам федеральных бюджетных и автономных учреждений за счёт субсидий — от 10 млн ₽, авансы исполнителей и соисполнителей в рамках таких контрактов — свыше 3 млн ₽. Авансы за счёт субсидий и бюджетных инвестиций юридическим лицам сопровождаются при любой сумме."
      }
    },
    {
      "@type": "Question",
      "name": "Зависит ли сопровождение от доли аванса в цене контракта?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Нет. В законе о бюджете на 2026 год пороги привязаны к сумме контракта и источнику финансирования, а не к проценту аванса. Контракт на 120 млн ₽ с авансом 10% под сопровождение попадает, а контракт на 20 млн ₽ с авансом 50% — нет, если источником не являются субсидия или бюджетная инвестиция."
      }
    },
    {
      "@type": "Question",
      "name": "Можно ли не предоставлять обеспечение при казначейском сопровождении?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Если расчёты по контракту подлежат казначейскому сопровождению, заказчик вправе не устанавливать требование об обеспечении исполнения контракта. Когда он его всё же устанавливает, размер ограничен десятью процентами цены — часть 6.1 статьи 96 закона № 44-ФЗ."
      }
    },
    {
      "@type": "Question",
      "name": "Как считается обеспечение, если под сопровождение попадает только аванс?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Размер обеспечения устанавливается от начальной (максимальной) цены контракта, уменьшенной на размер аванса, — пункт 3 части 6 статьи 96 закона № 44-ФЗ. Это заметно дешевле обычного правила, по которому обеспечение не может быть меньше аванса."
      }
    },
    {
      "@type": "Question",
      "name": "Какой предельный размер аванса по 44-ФЗ?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Единой цифры нет. Для федерального уровня предельные размеры задаются Положением о мерах по обеспечению исполнения федерального бюджета (постановление Правительства РФ № 1496) и актом Правительства на текущий год, для промышленных товаров — постановлением № 2411, для регионов — их собственными актами. Конкретный размер всегда указан в извещении и проекте контракта."
      }
    }
  ]
}

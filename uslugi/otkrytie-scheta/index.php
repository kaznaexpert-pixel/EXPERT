  ...
  <div class="v2-container">
    ...
    <div class="lp2-block">
      <table class="lp2-table">
        ...
        <tbody>
          <tr><td>Заявление на открытие лицевого счёта</td><td>Правильный код счёта, реквизиты организации и территориальный орган открытия</td></tr>
          <tr><td>Документ-основание: контракт, договор или соглашение</td><td>Наличие условия о казначейском сопровождении и идентификатора документа</td></tr>
          <tr><td>Карточка образцов подписей</td><td>Актуальный состав лиц с правом первой и второй подписи, оттиск печати</td></tr>
          <tr><td>Документы, подтверждающие полномочия подписантов</td><td>Срок действия доверенности и решения о назначении руководителя</td></tr>
      ...
      <p>По регламенту территориальные органы Казначейства открывают лицевой счёт в течение трёх рабочих дней со дня представления документов и направляют информацию о реквизитах открытого счёта. Реальный срок почти всегда больше — за счёт возвратов на доработку и времени на включение организации в сводный реестр. Именно поэтому мы считаем срок не от подачи, а от момента, когда пакет действительно готов: подготовка занимает у нас день, подача и сопровождение до открытия — ещё день.</p>
    ...
    <div class="lp2-block">
      <table class="lp2-table">
        ...
        <tbody>
          ...
          <tr><td>Дефект карточки образцов подписей</td><td>Уволенный сотрудник в составе подписантов, истёкшая доверенность</td><td>Переоформление карточки с действующим составом</td></tr>

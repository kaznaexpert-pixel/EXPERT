...
<script type="application/ld+json">
{
  ...
  "name": "Открытие казначейского счёта под ключ",
  "serviceType": "Открытие лицевого счёта в Федеральном казначействе (УФК)",
  "description": "Открытие казначейского счёта за два рабочих дня: анализ контракта, пакет документов, включение в сводный реестр, открытие счёта в УФК и настройка «Электронного бюджета». Без возвратов, гарантия в договоре.",
  "provider": {
    "@type": "Organization",
    "name": "КазнаЭксперт",
...
<section class="v2-section v2-screen" id="poryadok-2026">
  <div class="v2-container">
    ...
    <div class="lp2-block">
      ...
      <h3>Что меняет приказ 14н с 1 сентября 2026 года</h3>
      <p><b>С 1 сентября 2026 года вступает в силу приказ Федерального казначейства от 22.06.2026 № 14н.</b> Он исключает из Порядка № 44н блок казначейского мониторинга: утрачивают силу пункты 7, 31–33, 35(1), 36, 40 и приложения № 4–8, включая формы 0531361, 0531362, 0531363 и 0531378. Правила мониторинга и мер реагирования при открытии лицевых счетов вынесены в отдельный акт — постановление Правительства РФ от 27.07.2026 № 941. Сам срок открытия «в день представления документов» сохраняется.</p>

...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "За сколько откроете казначейский счёт?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "За два рабочих дня с момента получения документов — при стандартных требованиях. Срок открытия фиксируем в договоре."
      }
    },
    {
      "@type": "Question",
      "name": "Что потребуется от меня?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Госконтракт, ИНН и ОГРН организации, СНИЛС руководителя и контакт для связи. Пересылка занимает 5 минут — всё остальное делаем мы."
      }
    },
    {
      "@type": "Question",
      "name": "Что если казначейство вернёт документы?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Устраняем замечания казначейства без доплат — это входит в услугу. Наша цель — открыть счёт с первой подачи."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Да. Работаем удалённо со всеми регионами РФ — весь документооборот ведётся электронно через «Электронный бюджет»."
      }
    },
    {
      "@type": "Question",
      "name": "Нужна ли электронная подпись?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Да, для работы в «Электронном бюджете» нужна квалифицированная ЭП. Поможем оформить и настроить доступ."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Гарантия результата прописана в договоре. Сопровождаем до открытия счёта и первой операции."
      }
    },
    {
      "@type": "Question",
      "name": "Лицевой счёт с кодом 71 — это казначейский счёт?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "В обиходе их называют одинаково, но формально участнику казначейского сопровождения открывается именно лицевой счёт с кодом 71 в территориальном органе Федерального казначейства. Порядок открытия установлен приказом Казначейства России от 22.12.2021 № 44н."
      }
    },
    {
      "@type": "Question",
      "name": "Сколько по регламенту открывается лицевой счёт в казначействе?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Территориальный орган открывает счёт в течение трёх рабочих дней со дня представления документов. Дольше обычно идёт подготовка комплекта и включение организации в сводный реестр — именно на этом этапе теряют время."
      }
    },
    {
      "@type": "Question",
      "name": "Нужно ли закрывать расчётный счёт в банке?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Нет. Лицевой счёт в казначействе открывается дополнительно и используется только для целевых средств по конкретному контракту. Обычная хозяйственная деятельность компании идёт через расчётный счёт как раньше."
      }
    },
    {
      "@type": "Question",
      "name": "Что такое сводный реестр и зачем он при открытии счёта?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Это справочник участников и неучастников бюджетного процесса, из которого казначейство берёт данные об организации. Пока сведения в нём отсутствуют или расходятся с ЕГРЮЛ, заявление на открытие счёта возвращают."
      }
    },
    {
      "@type": "Question",
      "name": "Можно ли открыть счёт до подписания контракта?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Открыть — нет, нужен документ-основание. Но можно заранее зарезервировать номер лицевого счёта, чтобы указать реквизиты в контракте. Этим занимается отдельная услуга — резервирование счёта."
      }
    }
  ]
}

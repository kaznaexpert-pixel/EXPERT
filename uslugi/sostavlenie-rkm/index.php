...
{"@context": "https://schema.org", "@type": ["Service", "Product"], "brand": {"@type": "Brand", "name": "КазнаЭксперт"}, "image": "https://kaznaexpert.ru/img/og-image.png", "aggregateRating": {"@type": "AggregateRating", "ratingValue": "4.9", "bestRating": "5", "ratingCount": "7", "reviewCount": "7"}, "datePublished": "2026-08-12", "dateModified": "2026-08-16", "name": "Составление расчётно-калькуляционных материалов (РКМ) по гособоронзаказу", "serviceType": "Составление РКМ по ГОЗ (275-ФЗ)", "description": "Составление РКМ по гособоронзаказу под ключ: плановые и отчётные калькуляции по формам приказа ФАС № 995/22, расшифровки статей затрат, обоснование цены для ВП МО и заказчика, ответы на замечания. Фиксированная цена, NDA.", "provider": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "telephone": "+7-981-833-10-10", "logo": "https://kaznaexpert.ru/img/logogold.png", "@id": "https://kaznaexpert.ru/#organization"}, "areaServed": {"@type": "Country", "name": "Россия"}, "url": "https://kaznaexpert.ru/uslugi/sostavlenie-rkm/", "offers": {"@type": "Offer", "name": "Составление РКМ под ключ", "price": "105000", "priceCurrency": "RUB", "availability": "https://schema.org/InStock"}}
</script>
<script type="application/ld+json">
...
<meta property="og:image:alt" content="Составление РКМ по гособоронзаказу — КазнаЭксперт">
...
<meta name="twitter:title" content="Составление РКМ по ГОЗ — комплект форм 995/22">
<meta name="twitter:description" content="Калькуляции, расшифровки, обоснование прибыли и записка. 105 000 ₽ фиксированно; правки после замечаний ВП МО — без доплат.">
...
/* блок «что входит в цену / за что берут отдельно» — локальные стили страницы */
.rkm-scope,.rkm-scope *{box-sizing:border-box}
.rkm-scope{max-width:100%;margin:34px 0 0}
...
@media(max-width:680px){.rkm-tab{font-size:14.5px}.rkm-tab th,.rkm-tab td{padding:10px 8px}.rkm-promise{font-size:15px;padding:14px 14px}}</style>
...
<section class="v2-section v2-screen" id="tarif">
  <div class="v2-container">
    <div class="v2-section-head">
      ...
      <p class="v2-section-lede">Комплект РКМ по одному контракту — 105 000 ₽. Это не «от»: сумма фиксируется в договоре до начала работ и дальше не меняется.</p>
    </div>
    <div class="v2-tariffs-grid lp-3col"><article class="v2-tariff is-featured">
        ...
        <p class="v2-tariff-desc">Смотрим контракт, метод цены и учёт, определяем состав комплекта и подтверждаем фиксированную цену.</p>
        ...
        <div class="v2-tariff-price"><div class="v2-tariff-price-num">105 000<span class="v2-tariff-price-unit">&nbsp;₽</span></div><div class="v2-tariff-price-note">Фиксированная цена · в договоре</div><a href="#zayavka" class="v2-tariff-link">Обсудить <span aria-hidden="true">→</span></a></div>
      </article><article class="v2-tariff">
    ...
    <div class="rkm-scope">
      <div class="rkm-scope__wrap">
        <table class="rkm-tab">
          <caption>Что закрыто фиксированной ценой 105 000 ₽ и что в отраслевой практике обычно тарифицируется отдельно</caption>
          <thead><tr><th scope="col">Входит в наши 105 000 ₽</th><th scope="col">Обычно оплачивается сверх базового тарифа</th></tr></thead>
          <tbody>
            ...
            <tr><td>Плановая калькуляция и расшифровки статей затрат по формам приказа ФАС № 995/22</td><td>Доплата за каждую дополнительную форму расшифровки сверх включённого лимита</td></tr>
            ...
            <tr><td>Ответы на замечания заказчика и ВП МО, доработка форм до принятия комплекта</td><td>Пересчёт после замечаний военпреда по часовой ставке или по новому счёту</td></tr>
            <tr><td>Доработка комплекта при переводе ориентировочной цены в фиксированную по этому же контракту</td><td>Перевод цены в фиксированную как отдельный проект с отдельной сметой</td></tr>
            <tr><td>Повторная защита комплекта, если его вернули</td><td>Повторная защита за отдельную плату</td></tr>
          </tbody>
        </table>
      </div>
      <p class="v2-tariffs-footnote">Правая колонка — обобщённая рыночная практика тарификации, без привязки к конкретным компаниям. Мы сравниваем подход к смете, а не чужие прайсы.</p>
    </div>
  </div>
</section>

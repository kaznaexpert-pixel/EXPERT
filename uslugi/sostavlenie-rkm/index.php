...
{"@context": "https://schema.org", "@type": ["Service", "Product"], "brand": {"@type": "Brand", "name": "КазнаЭксперт"}, "image": "https://kaznaexpert.ru/img/og-image.png", "datePublished": "2026-08-12", "dateModified": "2026-08-16", "name": "Составление расчётно-калькуляционных материалов (РКМ) по гособоронзаказу", "serviceType": "Составление РКМ по ГОЗ (275-ФЗ)", "description": "Составление РКМ по гособоронзаказу под ключ: плановые и отчётные калькуляции по формам приказа ФАС № 995/22, расшифровки статей затрат, обоснование цены для ВП МО и заказчика, ответы на замечания. Фиксированная цена, NDA.", "provider": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "telephone": "+7-981-833-10-10", "logo": "https://kaznaexpert.ru/img/logogold.png", "@id": "https://kaznaexpert.ru/#organization"}, "areaServed": {"@type": "Country", "name": "Россия"}, "url": "https://kaznaexpert.ru/uslugi/sostavlenie-rkm/", "offers": {"@type": "Offer", "name": "Составление РКМ под ключ", "price": "105000", "priceCurrency": "RUB", "availability": "https://schema.org/InStock", "priceValidUntil": "2026-12-31"}}
</script>
<script type="application/ld+json">

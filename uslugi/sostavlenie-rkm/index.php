...
<title>Составление РКМ по гособоронзаказу — под ключ, 105 000 ₽</title>
<meta name="description" content="Составим РКМ по ГОЗ под ключ: плановые и отчётные калькуляции по приказу ФАС № 995/22, расшифровки затрат, обоснование цены для ВП МО. 105 000 ₽ за комплект, NDA.">
...
<section class="v2-section v2-screen" id="tarif">
  <div class="v2-container">
    <div class="v2-section-head">
      ...
      <p class="v2-section-lede">Базовый комплект по одному контракту — 105 000 ₽. Точная цена зависит от состава форм и состояния учёта; фиксируем её в договоре до начала работ.</p>
    </div>

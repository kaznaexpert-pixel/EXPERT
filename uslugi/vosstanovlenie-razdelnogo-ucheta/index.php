...
<link rel="canonical" href="https://kaznaexpert.ru/uslugi/vosstanovlenie-razdelnogo-ucheta/">
...
{"@context": "https://schema.org", "@type": "Service", "datePublished": "2026-06-25", "dateModified": "2026-06-25", "name": "Восстановление раздельного учёта по гособоронзаказу и госконтрактам", "serviceType": "Восстановление раздельного учёта (ГОЗ, целевые средства)", "description": "Восстановление раздельного учёта по гособоронзаказу и контрактам с казначейским сопровождением: первичка, регистры прямых и косвенных затрат, отчётные калькуляции и РКМ, настройка раздельного учёта в 1С, учётная политика. NDA, 15 лет практики.", "provider": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "telephone": "+7-981-833-10-10", "logo": "https://kaznaexpert.ru/img/logogold.png", "@id": "https://kaznaexpert.ru/#organization"}, "areaServed": {"@type": "Country", "name": "Россия"}, "url": "https://kaznaexpert.ru/uslugi/vosstanovlenie-razdelnogo-ucheta/"}
</script>
<script type="application/ld+json">
...
<section class="v2-section v2-screen" id="compare">
  <div class="v2-container">
    ...
    <div class="v2-compare">
      ...
      <div class="v2-compare-row"><div class="v2-compare-cell v2-compare-param" data-label="Параметр">Опыт восстановления</div><div class="v2-compare-cell" data-label="Самостоятельно">Разовый, без практики</div><div class="v2-compare-cell" data-label="Штатный спец">Зависит от человека</div><div class="v2-compare-cell is-us" data-label="С КазнаЭксперт"><strong>Профильный, постоянно</strong></div></div><div class="v2-compare-row"><div class="v2-compare-cell v2-compare-param" data-label="Параметр">Знание требований ГОЗ</div><div class="v2-compare-cell" data-label="Самостоятельно">Поверхностное</div><div class="v2-compare-cell" data-label="Штатный спец">Ограниченное</div><div class="v2-compare-cell is-us" data-label="С КазнаЭксперт"><strong>15 лет практики</strong></div></div><div class="v2-compare-row"><div class="v2-compare-cell v2-compare-param" data-label="Параметр">Калькуляции и РКМ</div><div class="v2-compare-cell" data-label="Самостоятельно">Сложно собрать</div><div class="v2-compare-cell" data-label="Штатный спец">По компетенции</div><div class="v2-compare-cell is-us" data-label="С КазнаЭксперт"><strong>Собираем под обоснование</strong></div></div><div class="v2-compare-row"><div class="v2-compare-cell v2-compare-param" data-label="Параметр">Настройка 1С</div><div class="v2-compare-cell" data-label="Самостоятельно">Сами</div><div class="v2-compare-cell" data-label="Штатный спец">По загрузке</div><div class="v2-compare-cell is-us" data-label="С КазнаЭксперт"><strong>Настраиваем под ГОЗ</strong></div></div><div class="v2-compare-row"><div class="v2-compare-cell v2-compare-param" data-label="Параметр">Срок</div><div class="v2-compare-cell" data-label="Самостоятельно">Затягивается</div><div class="v2-compare-cell" data-label="Штатный спец">По остаточному принципу</div><div class="v2-compare-cell is-us" data-label="С КазнаЭксперт"><strong>По графику</strong></div></div><div class="v2-compare-row"><div class="v2-compare-cell v2-compare-param" data-label="Параметр">Готовность к проверке</div><div class="v2-compare-cell" data-label="Самостоятельно">Под вопросом</div><div class="v2-compare-cell" data-label="Штатный спец">Под вопросом</div><div class="v2-compare-cell is-us" data-label="С КазнаЭксперт"><strong>Документы в порядке</strong></div></div>
    </div>
...
<section class="v2-section v2-screen" id="tarif">
  <div class="v2-container">
    ...
    <div class="v2-tariffs-grid lp-3col"><article class="v2-tariff is-featured">
        ...
        <div class="v2-tariff-price"><div class="v2-tariff-price-num">смета</div><div class="v2-tariff-price-note">По объёму · в договоре</div><a href="#zayavka" class="v2-tariff-link">Обсудить <span aria-hidden="true">→</span></a></div>
      </article><article class="v2-tariff">

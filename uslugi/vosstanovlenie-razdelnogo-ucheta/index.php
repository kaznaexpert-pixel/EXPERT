...
{"@context": "https://schema.org", "@type": "Service", "name": "Восстановление раздельного учёта по гособоронзаказу и госконтрактам", "serviceType": "Восстановление раздельного учёта (ГОЗ, целевые средства)", "description": "Восстановление раздельного учёта по гособоронзаказу и контрактам с казначейским сопровождением: первичка, регистры прямых и косвенных затрат, отчётные калькуляции и РКМ, настройка раздельного учёта в 1С, учётная политика. NDA, 15 лет практики.", "provider": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "telephone": "+7-981-833-10-10", "logo": "https://kaznaexpert.ru/img/logogold.png"}, "areaServed": {"@type": "Country", "name": "Россия"}, "url": "https://kaznaexpert.ru/uslugi/vosstanovlenie-razdelnogo-ucheta/"}
</script>
<script type="application/ld+json">

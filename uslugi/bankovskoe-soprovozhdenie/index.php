...
<section class="v2-section v2-screen" id="tarif">
  <div class="v2-container">
    ...
    <div class="v2-tariffs-grid lp-3col"><article class="v2-tariff is-featured">
        ...
        <p class="v2-tariff-desc">Оба контура одного контракта под ключ: отдельный счёт в банке и лицевой в УФК, согласованные платежи и отчётность. Два профильных специалиста.</p>

...
<link rel="canonical" href="https://kaznaexpert.ru/uslugi/kaznacheyskoe-soprovozhdenie-dlya-ooo/">
  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      ...
      <aside class="v2-hero-action">
        ...
        <p class="v2-hero-action-sub">Оставьте контакты — эксперт перезвонит за 15 минут, проверит, попадает ли ваш контракт под сопровождение, и назовёт точную цену. NDA — до анализа документов.</p>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    <div class="v2-section-head">
      ...
      <p class="v2-section-lede">Оставьте контакты — эксперт перезвонит за 15 минут, проверит, попадает ли ваш контракт под сопровождение, и назовёт точную цену. NDA — до анализа документов.</p>
    </div>

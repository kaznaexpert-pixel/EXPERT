...
{"@context": "https://schema.org", "@type": "Service", "name": "Аудит казначейского сопровождения контракта", "serviceType": "Независимая проверка казначейского сопровождения (второе мнение)", "description": "Независимый аудит казначейского сопровождения контракта: проверка применимости, открытия счёта, санкционирования, раздельного учёта, сведений и отчётности. Отчёт с приоритизацией рисков и планом исправления. NDA, 15 лет практики в Казначействе.", "provider": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "telephone": "+7-981-833-10-10", "logo": "https://kaznaexpert.ru/img/logogold.png"}, "areaServed": {"@type": "Country", "name": "Россия"}, "url": "https://kaznaexpert.ru/uslugi/audit-kaznacheyskogo-soprovozhdeniya/"}
</script>
<script type="application/ld+json">

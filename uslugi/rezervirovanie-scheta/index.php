...
{"@context": "https://schema.org", "@type": "Service", "datePublished": "2026-06-25", "dateModified": "2026-07-14", "name": "Резервирование казначейского счёта", "serviceType": "Резервирование лицевого счёта к дате тендера", "description": "Резервирование казначейского счёта за один рабочий день: анализ тендера, подготовка заявки, подача в УФК и подтверждение готовности для заказчика. Зачёт стоимости в открытие счёта.", "provider": {"@type": "Organization", "name": "КазнаЭксперт", "url": "https://kaznaexpert.ru", "telephone": "+7-981-833-10-10", "logo": "https://kaznaexpert.ru/img/logogold.png", "@id": "https://kaznaexpert.ru/#organization"}, "areaServed": {"@type": "Country", "name": "Россия"}, "offers": {"@type": "Offer", "price": "19000", "priceCurrency": "RUB", "description": "Резервирование казначейского счёта под ключ, разово", "url": "https://kaznaexpert.ru/uslugi/rezervirovanie-scheta/"}, "url": "https://kaznaexpert.ru/uslugi/rezervirovanie-scheta/"}
</script>
<script type="application/ld+json">

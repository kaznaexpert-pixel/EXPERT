...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "По гособоронзаказу при банковском сопровождении резервируется отдельный счёт в уполномоченном банке, а не лицевой счёт в казначействе. Режим определяется условиями контракта: он может быть банковским или казначейским."
      }
    },
    {
      "@type": "Question",
...
<section class="v2-section v2-screen" id="goz-psb">
  <div class="v2-container">
    <div class="v2-section-head">
      <div class="v2-section-eyebrow">Гособоронзаказ</div>
      <h2 class="v2-section-title">Резервирование отдельного счёта <em>по гособоронзаказу</em></h2>
      <p class="v2-section-lede">В контуре гособоронзаказа резервируют не лицевой счёт в казначействе, а отдельный счёт в уполномоченном банке. Механика и документы другие, а спешка — та же.</p>
    </div>
    <div class="lp2-block">
      <p>По контрактам гособоронзаказа расчёты идут либо через банковское сопровождение — отдельный счёт в уполномоченном банке, либо через казначейское — лицевой счёт в территориальном органе. Какой режим применяется, определяют условия контракта. Если режим банковский, номер отдельного счёта резервируют в уполномоченном банке, а перечень таких банков исполнитель получает от государственного заказчика; основная нагрузка по сопровождению гособоронзаказа сосредоточена в опорном банке оборонно-промышленного комплекса.</p>
      <p>С 4 августа 2026 года у этой схемы появилась дополнительная защита. Федеральный закон от 04.07.2026 № 232-ФЗ дополнил закон № 275-ФЗ главой 3.3 (статьи 8.9–8.13): при исключении банка из категории уполномоченных по решению Правительства РФ сопровождаемая сделка переводится в другой уполномоченный банк, причём банковское сопровождение переходит без заявления исполнителя о закрытии отдельного счёта. Резервировать номер заново в этой ситуации не требуется — процедуру перевода запускает не исполнитель.</p>
      <table class="lp2-table">
        <caption>Два контура резервирования по гособоронзаказу</caption>
        <thead><tr><th>Параметр</th><th>Банковское сопровождение</th><th>Казначейское сопровождение</th></tr></thead>
        <tbody>
          <tr><td>Что резервируют</td><td>Отдельный счёт в уполномоченном банке</td><td>Лицевой счёт с кодом 71</td></tr>
          <tr><td>Где</td><td>Уполномоченный банк из перечня заказчика</td><td>Территориальный орган Федерального казначейства</td></tr>
          <tr><td>Кто контролирует платежи</td><td>Уполномоченный банк</td><td>Казначейство при санкционировании</td></tr>
          <tr><td>К чему привязан</td><td>Идентификатор государственного контракта</td><td>Идентификатор документа-основания</td></tr>
        </tbody>
      </table>
      <p class="lp2-note">Пошаговый разбор банковского контура — в материале <a href="/baza-znaniy/kak-zarezervirovat-schet-po-goz/">«Как зарезервировать счёт по гособоронзаказу»</a>; о самих банках — <a href="/baza-znaniy/upolnomochennye-banki-po-goz/">«Уполномоченные банки по гособоронзаказу»</a>.</p>
    </div>
  </div>
</section>
...
<section class="v2-section v2-screen" id="faq">
  <div class="v2-container">
    ...
    <div class="faq">      <details><summary>На каком основании резервируют номер лицевого счёта?</summary><p>Резервирование предусмотрено Порядком открытия лицевых счетов участникам казначейского сопровождения, утверждённым приказом Казначейства России от 22.12.2021 № 44н. Подаётся заявление на резервирование лицевого счёта по форме КФД 0531368, для нескольких участников — перечень по форме КФД 0531369.</p></details>
      ...
      <details><summary>Чем резервирование счёта по гособоронзаказу отличается от казначейского?</summary><p>По гособоронзаказу при банковском сопровождении резервируется отдельный счёт в уполномоченном банке, а не лицевой счёт в казначействе. Режим определяется условиями контракта: он может быть банковским или казначейским.</p></details>

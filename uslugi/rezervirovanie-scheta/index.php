  ...
  <div class="v2-container">
    ...
    <div class="lp2-block">
      <table class="lp2-table">
        ...
        <tbody>
          <tr><td>Что за счёт</td><td>Лицевой счёт с кодом 71</td><td>Отдельный счёт по гособоронзаказу</td></tr>
          <tr><td>Где открывается</td><td>Территориальный орган Федерального казначейства</td><td>Уполномоченный банк из перечня заказчика</td></tr>
          <tr><td>Кто резервирует</td><td>Мы — по доверенности от организации</td><td>Организация самостоятельно в банке</td></tr>

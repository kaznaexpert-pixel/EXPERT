  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      <div class="v2-hero-main">
        ...
        <p class="v2-hero-lede"><strong>Берём казначейское сопровождение госконтракта в Чите на себя:</strong> открытие лицевого счёта в УФК по Забайкальскому краю, ведение платежей и санкционирование, раздельный учёт и спасение проблемных контрактов. Дистанционно по всему региону, без возвратов и срыва сроков.</p>
        ...
        <div class="v2-hero-expert">
          ...
          <p class="v2-expert-quote">«Забайкальский край ведём дистанционно: знаем требования УФК по Забайкальскому краю и доводим платежи до санкционирования с первой подачи».</p>
        </div>
      </div>
...
<section class="v2-section v2-screen" id="region">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Чита</div><h2 class="v2-section-title">Сопровождение в Чите — <em>дистанционно и под ключ</em></h2></div>
    <div class="reg-split">
      <div class="reg-copy">
        ...
        <p>Услуга оказывается по всей России: открываем и ведём лицевые счета в любом территориальном органе казначейства, в том числе в УФК по Забайкальскому краю. Весь документооборот — через «Электронный бюджет», поэтому ваше местонахождение и загруженность регионального УФК не мешают работе. Реквизиты под рукой: УФК по Забайкальскому краю — код КОФК 9100, 672002, г. Чита, ул. Профсоюзная, 17; официальный сайт и коды всех ТОФК — в <a href="/baza-znaniy/tofk/">справочнике казначейств по регионам</a>.</p>
        ...
        <p>Мы закрываем весь этот блок: открываем счёт в УФК по Забайкальскому краю, ведём раздельный учёт, готовим распоряжения и проводим санкционирование, а при возвратах и блокировках — восстанавливаем контракт до исполнения.</p>
      </div>
...
<section class="v2-section v2-screen" id="uslugi">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Услуги</div><h2 class="v2-section-title">Что берём на себя в Чите</h2><p class="v2-section-lede">Полный цикл казначейского сопровождения — от открытия счёта до спасения контракта.</p></div>
    <div class="v2-process-grid lp-3col">
      <article class="v2-process-step reveal"><div class="v2-process-no">01</div><h3>Открытие счёта</h3><p class="v2-process-desc">Пакет документов и открытие лицевого счёта в УФК по Забайкальскому краю с первой подачи за два рабочих дня. <a href="/uslugi/otkrytie-scheta/">Подробнее →</a></p></article>
...
<section class="v2-section v2-screen" id="process">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Процесс</div><h2 class="v2-section-title">Как начинаем работу в Чите</h2><p class="v2-section-lede">Каждый шаг — конкретное действие на нашей стороне. Прозрачно и дистанционно.</p></div>
    <div class="v2-process-grid lp-3col">
      ...
      <article class="v2-process-step reveal"><div class="v2-process-no">02</div><div class="v2-process-day">1–2 дня</div><h3>Документы и счёт</h3><p class="v2-process-desc">Готовим пакет, включаем в сводный реестр, открываем счёт в УФК по Забайкальскому краю.</p><ul class="v2-process-checks"><li>Счёт открыт</li></ul></article>

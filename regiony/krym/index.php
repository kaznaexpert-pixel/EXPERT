...
<section class="v2-section v2-screen" id="region-deep"><div class="v2-container"><div class="v2-section-head"><div class="v2-section-eyebrow">Специфика региона</div><h2 class="v2-section-title">Казначейское сопровождение госзаказа в Республике Крым</h2></div><div class="reg-copy reg-deep" style="max-width:920px"><style>.v2 .reg-deep .reg-scen{margin:14px 0 0;padding:0;list-style:none;display:grid;gap:10px}.v2 .reg-deep .reg-scen li{position:relative;padding-left:26px;font-size:16px;line-height:1.6;color:var(--ink-soft,#3A3A3A)}.v2 .reg-deep .reg-scen li::before{content:"";position:absolute;left:4px;top:9px;width:8px;height:8px;border-radius:50%;background:var(--accent,#8B6F47)}</style><p>Крым — регион масштабного инфраструктурного госзаказа по федеральной программе развития: дорожное строительство (трасса «Таврида» и подъезды), энергетика и водоснабжение, ЖКХ, социальные и санаторно-курортные объекты. Большая доля расчётов идёт через лицевые счета с целевым авансом и санкционированием расходов.</p><p>Лицевой счёт открываем и ведём в УФК по Республике Крым (код КОФК 7500, г. Симферополь, ул. Севастопольская, д. 19) дистанционно через «Электронный бюджет». Доводим санкционирование расходов до первой подачи и держим целевой аванс в правовом режиме.</p><p>Типовые контракты — дорожные, энергетические и социальные объекты по федеральной программе под целевой аванс, а также модернизация ЖКХ и водоснабжения. Берём полный цикл: от открытия счёта до спасения контракта при возвратах.</p><h3>С чем к нам приходят из Крыма</h3><ul class="reg-scen"><li>Дорожный или энергетический объект федеральной программы с целевым авансом — санкционирование расходов.</li><li>Контракт на модернизацию ЖКХ или водоснабжения — ведение целевых платежей.</li><li>Социальный или санаторно-курортный объект — раздельный учёт и санкционирование.</li><li>Возврат распоряжения из-за оснований платежа — срочная диагностика и повторная подача.</li></ul></div></div></section>

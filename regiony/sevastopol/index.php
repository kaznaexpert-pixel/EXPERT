...
<section class="v2-section v2-screen" id="region-deep"><div class="v2-container"><div class="v2-section-head"><div class="v2-section-eyebrow">Специфика региона</div><h2 class="v2-section-title">Казначейское сопровождение госзаказа в городе Севастополе</h2></div><div class="reg-copy reg-deep" style="max-width:920px"><style>.v2 .reg-deep .reg-scen{margin:14px 0 0;padding:0;list-style:none;display:grid;gap:10px}.v2 .reg-deep .reg-scen li{position:relative;padding-left:26px;font-size:16px;line-height:1.6;color:var(--ink-soft,#3A3A3A)}.v2 .reg-deep .reg-scen li::before{content:"";position:absolute;left:4px;top:9px;width:8px;height:8px;border-radius:50%;background:var(--accent,#8B6F47)}</style><p>Севастополь — город с большим объёмом инфраструктурного и оборонного госзаказа: судоремонт, строительство и реконструкция объектов, ЖКХ и социальная инфраструктура. Часть заказов оборонного профиля идёт по 275-ФЗ с обязательным казначейским сопровождением, отдельным счётом и раздельным учётом.</p><p>Лицевой счёт ведём в УФК по г. Севастополю (код КОФК 7400, г. Севастополь, ул. Балаклавская, 9) дистанционно через «Электронный бюджет». Знаем требования севастопольского казначейства к основаниям платежа и доводим санкционирование с первой подачи.</p><p>Типовой поток — судоремонтные и оборонные контракты с раздельным учётом, строительные и социальные объекты под целевой аванс. Ведём весь цикл и подключаемся срочно при возвратах распоряжений.</p><h3>С чем к нам приходят из Севастополя</h3><ul class="reg-scen"><li>Субподряд по гособоронзаказу в судоремонте — отдельный счёт и раздельный учёт по 275-ФЗ.</li><li>Строительный или социальный контракт с целевым авансом — санкционирование расходов.</li><li>Контракт на ЖКХ и городскую инфраструктуру — ведение целевых платежей.</li><li>Возврат распоряжения казначейством — диагностика оснований и повторная подача.</li></ul></div></div></section>

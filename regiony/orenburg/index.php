  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      ...
      <aside class="v2-hero-action">
        ...
        <p class="v2-hero-action-sub">Оставьте контакты — эксперт перезвонит за 15 минут, разберёт ваш контракт в Оренбурге и назовёт точную стоимость. NDA — до анализа документов.</p>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Заявка</div><h2 class="v2-section-title">Казначейское сопровождение в Оренбурге</h2><p class="v2-section-lede">Пришлите контакты — за 15 минут перезвоним, оценим контракт и назовём финальную цену.</p></div>

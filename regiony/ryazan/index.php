...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Вы работаете в Рязани?", "acceptedAnswer": {"@type": "Answer", "text": "Да. Ведём казначейское сопровождение для подрядчиков из Рязань и всего региона дистанционно — открываем и ведём счёт в УФК по Рязанской области через «Электронный бюджет», личное присутствие не требуется."}}, {"@type": "Question", "name": "Какой код у казначейства в Рязани?", "acceptedAnswer": {"@type": "Answer", "text": "УФК по Рязанской области имеет код КОФК 5900 . Адрес: 390000, г. Рязань, ул. Петрова, д. 3. Лицевой счёт в этом ТОФК открываем и ведём дистанционно — полный справочник кодов в базе ТОФК ."}}, {"@type": "Question", "name": "Где находится УФК по Рязанской области?", "acceptedAnswer": {"@type": "Answer", "text": "Адрес: 390000, г. Рязань, ул. Петрова, д. 3. Приезжать туда не нужно — открытие лицевого счёта и весь документооборот в Рязани ведём дистанционно через «Электронный бюджет»."}}, {"@type": "Question", "name": "Что если казначейство вернёт документы?", "acceptedAnswer": {"@type": "Answer", "text": "Устраняем замечания без доплат — это входит в услугу. Цель — пройти санкционирование с первой подачи."}}, {"@type": "Question", "name": "Поможете со спасением проблемного контракта?", "acceptedAnswer": {"@type": "Answer", "text": "Да. Срочно подключаемся: находим причину возвратов и блокировок, восстанавливаем учёт и доводим контракт до исполнения."}}, {"@type": "Question", "name": "Можно ли пройти всё удалённо, без визита в УФК?", "acceptedAnswer": {"@type": "Answer", "text": "Да. Открытие лицевого счёта, подача распоряжений и сведений идут через «Электронный бюджет» — личное присутствие не требуется ни на одном этапе."}}, {"@type": "Question", "name": "За сколько откроете счёт?", "acceptedAnswer": {"@type": "Answer", "text": "За два рабочих дня с момента получения документов при стандартных требованиях. Срок фиксируем в договоре."}}, {"@type": "Question", "name": "Сколько стоит сопровождение?", "acceptedAnswer": {"@type": "Answer", "text": "Цены фиксированные и не зависят от региона: открытие счёта — 29 000 ₽, ведение — от 55 000 ₽, спасение контракта — от 29 000 ₽. Точная стоимость — после анализа."}}]}
</script>
<script type="application/ld+json">
...
<section class="v2-section v2-screen" id="faq">
  <div class="v2-container">
    ...
    <div class="faq">
      ...
      <details><summary>Что если казначейство вернёт документы?</summary><p>Устраняем замечания без доплат — это входит в услугу. Цель — пройти санкционирование с первой подачи.</p></details><details><summary>Поможете со спасением проблемного контракта?</summary><p>Да. Срочно подключаемся: находим причину возвратов и блокировок, восстанавливаем учёт и доводим контракт до исполнения.</p></details><details><summary>Можно ли пройти всё удалённо, без визита в УФК?</summary><p>Да. Открытие лицевого счёта, подача распоряжений и сведений идут через «Электронный бюджет» — личное присутствие не требуется ни на одном этапе.</p></details><details><summary>За сколько откроете счёт?</summary><p>За два рабочих дня с момента получения документов при стандартных требованиях. Срок фиксируем в договоре.</p></details><details><summary>Сколько стоит сопровождение?</summary><p>Цены фиксированные и не зависят от региона: открытие счёта — 29 000 ₽, ведение — от 55 000 ₽, спасение контракта — от 29 000 ₽. Точная стоимость — после анализа.</p></details>
    </div>
  </div>
</section>

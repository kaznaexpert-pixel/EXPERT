...
<section class="v2-section v2-screen" id="region-deep"><div class="v2-container"><div class="v2-section-head"><div class="v2-section-eyebrow">Специфика региона</div><h2 class="v2-section-title">Казначейское сопровождение госзаказа в Ленинградской области</h2></div><div class="reg-copy reg-deep" style="max-width:920px"><style>.v2 .reg-deep .reg-scen{margin:14px 0 0;padding:0;list-style:none;display:grid;gap:10px}.v2 .reg-deep .reg-scen li{position:relative;padding-left:26px;font-size:16px;line-height:1.6;color:var(--ink-soft,#3A3A3A)}.v2 .reg-deep .reg-scen li::before{content:"";position:absolute;left:4px;top:9px;width:8px;height:8px;border-radius:50%;background:var(--accent,#8B6F47)}</style><p>Ленинградская область — крупный логистический и промышленный регион: морские порты Усть-Луга, Приморск и Высоцк, газохимия и нефтепереработка, судостроение и активное дорожно-социальное строительство. Часть контрактов — оборонные и идёт по 275-ФЗ с казначейским сопровождением, отдельным счётом и раздельным учётом.</p><p>Лицевой счёт ведём в УФК по Ленинградской области (код КОФК 4500, г. Санкт-Петербург, ул. Варшавская, д. 63, к. 1) дистанционно через «Электронный бюджет». Знаем требования областного казначейства к основаниям платежа и доводим санкционирование без возвратов.</p><p>Типовой поток — инфраструктурные и портовые контракты под целевой аванс, субподряд по гособоронзаказу в судостроении и поставки для газохимии. Ведём весь цикл и подключаемся срочно при блокировке счёта.</p><h3>С чем к нам приходят из Ленинградской области</h3><ul class="reg-scen"><li>Портовый или дорожный инфраструктурный контракт с целевым авансом — санкционирование расходов.</li><li>Субподряд по гособоронзаказу в судостроении — отдельный счёт и раздельный учёт по 275-ФЗ.</li><li>Поставка оборудования для газохимии и нефтепереработки — ведение целевых платежей.</li><li>Возврат распоряжения казначейством — диагностика оснований и повторная подача.</li></ul></div></div></section>

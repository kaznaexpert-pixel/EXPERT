...
<section class="v2-section v2-screen" id="region-deep"><div class="v2-container"><div class="v2-section-head"><div class="v2-section-eyebrow">Специфика региона</div><h2 class="v2-section-title">Казначейское сопровождение госзаказа в Республике Бурятия</h2></div><div class="reg-copy reg-deep" style="max-width:920px"><style>.v2 .reg-deep .reg-scen{margin:14px 0 0;padding:0;list-style:none;display:grid;gap:10px}.v2 .reg-deep .reg-scen li{position:relative;padding-left:26px;font-size:16px;line-height:1.6;color:var(--ink-soft,#3A3A3A)}.v2 .reg-deep .reg-scen li::before{content:"";position:absolute;left:4px;top:9px;width:8px;height:8px;border-radius:50%;background:var(--accent,#8B6F47)}</style><p>Бурятия — центр авиастроения и машиностроения Забайкалья: авиазавод (вертолёты, ОПК), приборостроение, ремонт железнодорожной техники и добыча угля, золота и цветных металлов. Ядро госзаказа — гособоронзаказ в вертолётостроении: для головного исполнителя и кооперации это 275-ФЗ с обязательным отдельным счётом и раздельным учётом затрат, причём цикл постройки длинный, а кооперация широкая и межрегиональная. Раздельный учёт ведётся по каждому изделию и этапу, а расчёты с соисполнителями должны сходиться без разрывов.</p><p>Регион удалён от центральных заказчиков на несколько часовых поясов, поэтому документооборот выстраиваем полностью дистанционно. Лицевой счёт открываем и ведём в УФК по Республике Бурятия (код КОФК 0200, 670000, г. Улан-Удэ, ул. Ермаковская, д. 12, buryatia.roskazna.gov.ru) через «Электронный бюджет», держа сроки санкционирования под контролем с поправкой на разницу во времени.</p><p>Параллельно идут контракты приборостроения, ремонта ж/д техники и добычи — под целевой аванс с санкционированием расходов. Подключаемся на любом этапе длинного контракта, в том числе срочно при возврате распоряжения или приостановке операций.</p><h3>С чем к нам приходят из Бурятии</h3><ul class="reg-scen"><li>Кооперация по гособоронзаказу в вертолётостроении с длинным циклом — отдельный счёт и раздельный учёт по 275-ФЗ с поэтапной сдачей.</li><li>Межрегиональные расчёты с соисполнителями ГОЗ — синхронизация движения средств по цепочке.</li><li>Контракт приборостроения, ремонта ж/д техники или добычи с авансом — санкционирование целевых расходов.</li><li>Возврат распоряжения на длинном контракте — срочная диагностика и восстановление учёта без срыва этапа.</li></ul></div></div></section>

  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      <div class="v2-hero-main">
        ...
        <p class="v2-hero-lede"><strong>Берём казначейское сопровождение госконтракта в Улан-Удэ на себя:</strong> открытие лицевого счёта в УФК по Республике Бурятия, ведение платежей и санкционирование, раздельный учёт и спасение проблемных контрактов. Дистанционно по всему региону, без возвратов и срыва сроков.</p>
        ...
        <div class="v2-hero-expert">
          ...
          <p class="v2-expert-quote">«Республика Бурятия ведём дистанционно: знаем требования УФК по Республике Бурятия и доводим платежи до санкционирования с первой подачи».</p>
        </div>
      </div>
      <aside class="v2-hero-action">
        <div class="v2-hero-action-eyebrow">Экспертный анализ контракта</div>
        <h2>Разберём ваш контракт</h2>
        <p class="v2-hero-action-sub">Оставьте контакты — эксперт перезвонит за 15 минут, разберёт ваш контракт в Улан-Удэ и назовёт точную стоимость. NDA — до анализа документов.</p>
...
<section class="v2-section v2-screen" id="region">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Улан-Удэ</div><h2 class="v2-section-title">Сопровождение в Улан-Удэ — <em>дистанционно и под ключ</em></h2></div>
    <div class="reg-split">
      <div class="reg-copy">
        ...
        <p>Услуга оказывается по всей России: открываем и ведём лицевые счета в любом территориальном органе казначейства, в том числе в УФК по Республике Бурятия. Весь документооборот — через «Электронный бюджет», поэтому ваше местонахождение и загруженность регионального УФК не мешают работе. Реквизиты под рукой: УФК по Республике Бурятия — код КОФК 0200, 670000, г. Улан-Удэ, ул. Ермаковская, д. 12; официальный сайт и коды всех ТОФК — в <a href="/baza-znaniy/tofk/">справочнике казначейств по регионам</a>.</p>
        ...
        <p>Мы закрываем весь этот блок: открываем счёт в УФК по Республике Бурятия, ведём раздельный учёт, готовим распоряжения и проводим санкционирование, а при возвратах и блокировках — восстанавливаем контракт до исполнения.</p>
      </div>
...
<section class="v2-section v2-screen" id="uslugi">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Услуги</div><h2 class="v2-section-title">Что берём на себя в Улан-Удэ</h2><p class="v2-section-lede">Полный цикл казначейского сопровождения — от открытия счёта до спасения контракта.</p></div>
    <div class="v2-process-grid lp-3col">
      <article class="v2-process-step reveal"><div class="v2-process-no">01</div><h3>Открытие счёта</h3><p class="v2-process-desc">Пакет документов и открытие лицевого счёта в УФК по Республике Бурятия с первой подачи за два рабочих дня. <a href="/uslugi/otkrytie-scheta/">Подробнее →</a></p></article>
...
<section class="v2-section v2-screen" id="process">
  <div class="v2-container">
    ...
    <div class="v2-process-grid lp-3col">
      ...
      <article class="v2-process-step reveal"><div class="v2-process-no">02</div><div class="v2-process-day">1–2 дня</div><h3>Документы и счёт</h3><p class="v2-process-desc">Готовим пакет, включаем в сводный реестр, открываем счёт в УФК по Республике Бурятия.</p><ul class="v2-process-checks"><li>Счёт открыт</li></ul></article>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Заявка</div><h2 class="v2-section-title">Казначейское сопровождение в Улан-Удэ</h2><p class="v2-section-lede">Оставьте контакты — эксперт перезвонит за 15 минут, разберёт ваш контракт и назовёт точную стоимость.</p></div>
...
<section class="reg-cross"><h2>Казначейское сопровождение в других регионах</h2><ul><li><a href="/regiony/ulyanovsk/">Казначейское сопровождение в Ульяновске</a></li><li><a href="/regiony/velikiy-novgorod/">Казначейское сопровождение в Казначейское сопровождение в Великом Новгороде</a></li><li><a href="/regiony/vladikavkaz/">Казначейское сопровождение в Казначейское сопровождение во Владикавказе — под ключ</a></li><li><a href="/regiony/vladimir/">Казначейское сопровождение в Казначейское сопровождение во Владимире — под ключ</a></li><li><a href="/regiony/vladivostok/">Казначейское сопровождение в Казначейское сопровождение во Владивостоке — под ключ</a></li><li><a href="/regiony/volgograd/">Казначейское сопровождение в Волгограде</a></li><li><a href="/regiony/vologda/">Казначейское сопровождение в Вологде</a></li><li><a href="/regiony/voronezh/">Казначейское сопровождение в Воронеже</a></li></ul><p style="margin:12px 0 0;font-size:.9rem"><a href="/regiony/">Все регионы России →</a></p></section>

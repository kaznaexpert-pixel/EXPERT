...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "WebPage", "url": "https://kaznaexpert.ru/regiony/velikiy-novgorod/", "name": "Казначейское сопровождение в Великом Новгороде | КазнаЭксперт", "inLanguage": "ru-RU", "datePublished": "2026-06-05", "dateModified": "2026-07-23"}
</script>
  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      ...
      <aside class="v2-hero-action">
        ...
        <p class="v2-hero-action-sub">Эксперт свяжется в течение 15 минут: разбор вашего контракта в Великом Новгороде, точная стоимость, NDA до передачи документов.</p>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Заявка</div><h2 class="v2-section-title">Казначейское сопровождение в Великом Новгороде</h2><p class="v2-section-lede">Пришлите контакты — за 15 минут перезвоним, оценим контракт и назовём финальную цену.</p></div>

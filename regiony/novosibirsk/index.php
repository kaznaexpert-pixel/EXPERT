...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Вы работаете в Новосибирске?", "acceptedAnswer": {"@type": "Answer", "text": "Да. Ведём казначейское сопровождение для подрядчиков из Новосибирск и всего региона дистанционно — открываем и ведём счёт в УФК по Новосибирской области через «Электронный бюджет»."}}, {"@type": "Question", "name": "Нужно ли приезжать в казначейство?", "acceptedAnswer": {"@type": "Answer", "text": "Нет. Весь документооборот идёт электронно через «Электронный бюджет». Работаем со всеми регионами РФ удалённо."}}]}
</script>
  ...
  <div class="v2-container">
    ...
    <div class="reg-split">
      <div class="reg-copy">
        ...
        <p>Услуга оказывается по всей России: открываем и ведём лицевые счета в любом территориальном органе казначейства, в том числе в УФК по Новосибирской области. Весь документооборот — через «Электронный бюджет», поэтому ваше местонахождение и загруженность регионального УФК не мешают работе. <a href="/baza-znaniy/tofk/">Код, адрес и официальный сайт вашего ТОФК</a> — в справочнике казначейств по регионам.</p>

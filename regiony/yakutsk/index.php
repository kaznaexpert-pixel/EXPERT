    ...
    <div class="v2-hero-grid">
      <div class="v2-hero-main">
        ...
        <div class="v2-hero-expert">
          ...
          <p class="v2-expert-quote">«Республика Саха (Якутия) ведём дистанционно: знаем требования УФК по Республике Саха (Якутия) и доводим платежи до санкционирования с первой подачи».</p>
        </div>
      </div>
...
<!-- geo-fact -->
<h2 id="kto-vedet">Кто осуществляет казначейское сопровождение в Якутске</h2>
<p class="answer"><strong>Казначейское сопровождение в Якутске</strong> по федеральным государственным контрактам осуществляет УФК по Республике Саха (Якутия) — территориальный орган Федерального казначейства (ТОФК). Исполнитель открывает лицевой счёт в этом управлении, проводит платежи через санкционирование и ведёт раздельный учёт целевых средств. Реквизиты и код ТОФК — на официальном сайте sakha.roskazna.gov.ru; справочник — в разделе <a href="/baza-znaniy/tofk/">территориальных органов казначейства</a>.</p>
<p>Адрес управления: 677000, г. Якутск, ул. Орджоникидзе, 19. Порядок открытия лицевого счёта: документ-основание (карточка контракта), машиночитаемая доверенность и включение в Сводный реестр; счёт открываем за 2 рабочих дня дистанционно через ГИИС «Электронный бюджет». Типовые отказы — в разборе <a href="/baza-znaniy/prichiny-otkaza-kaznacheystva-v-sankcionirovanii/">причины отказа казначейства</a>. Возьмём сопровождение под ключ — <a href="/uslugi/kaznacheyskoe-soprovozhdenie/">услуги казначейского сопровождения</a>.</p>
<details><summary>Кто осуществляет казначейское сопровождение в Якутске?</summary><p>По федеральным госконтрактам — УФК по Республике Саха (Якутия) (территориальный орган Федерального казначейства, sakha.roskazna.gov.ru). Исполнитель открывает лицевой счёт, проходит санкционирование и ведёт раздельный учёт целевых средств.</p></details>
<h2>Разберём ваш контракт</h2>
        <p class="v2-hero-action-sub">Оставьте контакты — эксперт перезвонит за 15 минут, разберёт ваш контракт в Якутске и назовёт точную стоимость. NDA — до анализа документов.</p>
...
<section class="v2-section v2-screen" id="region">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Якутск</div><h2 class="v2-section-title">Сопровождение в Якутске — <em>дистанционно и под ключ</em></h2></div>
    <div class="reg-split">
      <div class="reg-copy">
...
<section class="v2-section v2-screen" id="uslugi">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Услуги</div><h2 class="v2-section-title">Что берём на себя в Якутске</h2><p class="v2-section-lede">Полный цикл казначейского сопровождения — от открытия счёта до спасения контракта.</p></div>
...
<section class="v2-section v2-screen" id="process">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Процесс</div><h2 class="v2-section-title">Как начинаем работу в Якутске</h2><p class="v2-section-lede">Каждый шаг — конкретное действие на нашей стороне. Прозрачно и дистанционно.</p></div>
    <div class="v2-process-grid lp-3col">
      ...
      <article class="v2-process-step reveal"><div class="v2-process-no">02</div><div class="v2-process-day">1–2 дня</div><h3>Документы и счёт</h3><p class="v2-process-desc">Готовим пакет, включаем в сводный реестр, открываем счёт в УФК по Республике Саха (Якутия).</p><ul class="v2-process-checks"><li>Счёт открыт</li></ul></article>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Заявка</div><h2 class="v2-section-title">Казначейское сопровождение в Якутске</h2><p class="v2-section-lede">Оставьте контакты — эксперт перезвонит за 15 минут, разберёт ваш контракт и назовёт точную стоимость.</p></div>

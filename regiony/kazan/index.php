...
<section class="v2-section v2-screen" id="region-deep"><div class="v2-container"><div class="v2-section-head"><div class="v2-section-eyebrow">Специфика региона</div><h2 class="v2-section-title">Казначейское сопровождение госзаказа в Республике Татарстан</h2></div><div class="reg-copy reg-deep" style="max-width:920px"><style>.v2 .reg-deep .reg-scen{margin:14px 0 0;padding:0;list-style:none;display:grid;gap:10px}.v2 .reg-deep .reg-scen li{position:relative;padding-left:26px;font-size:16px;line-height:1.6;color:var(--ink-soft,#3A3A3A)}.v2 .reg-deep .reg-scen li::before{content:"";position:absolute;left:4px;top:9px;width:8px;height:8px;border-radius:50%;background:var(--accent,#8B6F47)}</style><p>Госзаказ Татарстана держится на трёх несхожих опорах: крупнотоннажная нефтехимия и нефтепереработка, активное бюджетное строительство и быстрорастущий ИТ-сектор (Иннополис, технопарки). К этому добавляется вертолёто- и авиастроение с оборонной составляющей. Для подрядчика это означает, что один и тот же исполнитель может вести и обычные поставки по 44-ФЗ и 223-ФЗ, и контракты по 275-ФЗ — с разными режимами счёта и учёта, которые нельзя смешивать.</p><p>Лицевой счёт открываем и ведём в УФК по Республике Татарстан (код КОФК 1100, 420043, г. Казань, ул. Вишневского, д. 31, tatarstan.roskazna.gov.ru) дистанционно через «Электронный бюджет» — присутствие в Казани не требуется. Под целевой аванс по нефтехимическому или строительному контракту открывается отдельный счёт, а каждое распоряжение проходит санкционирование казначейства по целевому назначению расходов.</p><p>Отдельная категория — субподряд по гособоронзаказу в вертолёто- и авиастроении, где обязательны отдельный счёт, раздельный учёт и сверка с головным исполнителем. Берём на себя весь цикл: открытие счёта, ведение раздельного учёта, санкционирование расходов и восстановление платежей при возвратах.</p><h3>С чем к нам приходят из Татарстана</h3><ul class="reg-scen"><li>Поставка оборудования и услуг для нефтехимии и нефтепереработки под целевой аванс — санкционирование целевых расходов.</li><li>Субподряд по гособоронзаказу в вертолёто- и авиастроении — отдельный счёт и раздельный учёт по 275-ФЗ.</li><li>Несколько параллельных контрактов у одного юрлица (44-ФЗ, 223-ФЗ, ГОЗ) — разведение оснований платежа и учёта без пересечений.</li><li>Возврат распоряжения по строительному контракту — срочная диагностика и повторная подача без срыва графика.</li></ul></div></div></section>

...
<section class="v2-section v2-screen" id="region-deep"><div class="v2-container"><div class="v2-section-head"><div class="v2-section-eyebrow">Специфика региона</div><h2 class="v2-section-title">Казначейское сопровождение госзаказа в Магаданской области</h2></div><div class="reg-copy reg-deep" style="max-width:920px"><style>.v2 .reg-deep .reg-scen{margin:14px 0 0;padding:0;list-style:none;display:grid;gap:10px}.v2 .reg-deep .reg-scen li{position:relative;padding-left:26px;font-size:16px;line-height:1.6;color:var(--ink-soft,#3A3A3A)}.v2 .reg-deep .reg-scen li::before{content:"";position:absolute;left:4px;top:9px;width:8px;height:8px;border-radius:50%;background:var(--accent,#8B6F47)}</style><p>Магаданская область — золотодобыча и горнодобывающая промышленность Колымы, энергетика, портовое хозяйство и северный завоз определяют поток госконтрактов. Регион удалён и работает в дистанционном формате, часть заказов — по 275-ФЗ.</p><p>Лицевой счёт ведём в УФК по Магаданской области (код КОФК 4700, г. Магадан, ул. Пролетарская, дом 25, корпус 1) дистанционно через «Электронный бюджет» с учётом разницы во времени с центральными заказчиками.</p><p>Типовой поток — инфраструктурные и энергетические контракты под целевой аванс, поставки и услуги для горнодобычи и северного завоза. Ведём весь цикл и подключаемся срочно при возвратах распоряжений.</p><h3>С чем к нам приходят из Магаданской области</h3><ul class="reg-scen"><li>Инфраструктурный или энергетический контракт с целевым авансом — санкционирование расходов.</li><li>Поставка оборудования для горнодобычи или северного завоза — ведение целевых платежей.</li><li>Субподряд по гособоронзаказу — отдельный счёт и раздельный учёт по 275-ФЗ.</li><li>Возврат распоряжения казначейством — диагностика оснований и повторная подача.</li></ul></div></div></section>

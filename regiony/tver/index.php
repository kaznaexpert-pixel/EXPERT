  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      ...
      <aside class="v2-hero-action">
        ...
        <p class="v2-hero-action-sub">Перезвоним за 15 минут, разберём контракт в Твери и назовём финальную цену. Конфиденциальность — NDA до анализа документов.</p>
...
<section class="v2-section v2-screen" id="faq">
  <div class="v2-container">
    ...
    <div class="faq">
      ...
      <details><summary>Сколько стоит сопровождение?</summary><p>Цены фиксированные и не зависят от региона: открытие счёта — 35 000 ₽, ведение — от 65 000 ₽, спасение контракта — от 35 000 ₽. Точная стоимость — после анализа.</p></details><details><summary>Что если казначейство вернёт документы?</summary><p>Устраняем замечания без доплат — это входит в услугу. Цель — пройти санкционирование с первой подачи.</p></details><details><summary>Поможете со спасением проблемного контракта?</summary><p>Да. Срочно подключаемся: находим причину возвратов и блокировок, восстанавливаем учёт и доводим контракт до исполнения.</p></details><details><summary>Нужно ли приезжать в казначейство?</summary><p>Нет. Весь документооборот идёт электронно через «Электронный бюджет». Мы работаем со всеми регионами РФ удалённо.</p></details><details><summary>Какие сроки открытия лицевого счёта?</summary><p>Стандартно — два рабочих дня после получения от вас документов. Срок фиксируем в договоре.</p></details>
    </div>
  </div>
</section>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Заявка</div><h2 class="v2-section-title">Казначейское сопровождение в Твери</h2><p class="v2-section-lede">Оставьте контакты — эксперт перезвонит за 15 минут, разберёт ваш контракт и назовёт точную стоимость.</p></div>

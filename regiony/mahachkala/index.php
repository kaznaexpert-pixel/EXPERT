...
<section class="v2-section v2-screen" id="region-deep"><div class="v2-container"><div class="v2-section-head"><div class="v2-section-eyebrow">Специфика региона</div><h2 class="v2-section-title">Казначейское сопровождение госзаказа в Республике Дагестан</h2></div><div class="reg-copy reg-deep" style="max-width:920px"><style>.v2 .reg-deep .reg-scen{margin:14px 0 0;padding:0;list-style:none;display:grid;gap:10px}.v2 .reg-deep .reg-scen li{position:relative;padding-left:26px;font-size:16px;line-height:1.6;color:var(--ink-soft,#3A3A3A)}.v2 .reg-deep .reg-scen li::before{content:"";position:absolute;left:4px;top:9px;width:8px;height:8px;border-radius:50%;background:var(--accent,#8B6F47)}</style><p>Госзаказ Дагестана опирается на пищевую индустрию и АПК: виноделие и коньячное производство, рыбопереработка, переработка сельхозсырья. Здесь преобладают не оборонные, а гражданские и субсидируемые контракты по 44-ФЗ и 223-ФЗ, где казначейство контролирует прежде всего целевой характер расходования средств — на сырьё, оборудование, тару, логистику. Под целевой аванс открывается отдельный счёт, и каждый расход проходит санкционирование. Мы выстраиваем учёт так, чтобы подтверждение целевого назначения платежа не становилось причиной возврата распоряжения.</p><p>Вторая опора — энергетика, нефтедобыча и машиностроение республики: здесь контракты крупнее и чаще идут с авансами на оборудование и работы. Лицевой счёт открываем и ведём в УФК по Республике Дагестан (код КОФК 0300, 367015, г. Махачкала, ул. М. Ярагского, д. 93, dagestan.roskazna.gov.ru) дистанционно через «Электронный бюджет» — присутствие в Махачкале не требуется, документооборот ведётся удалённо для подрядчиков из всей республики.</p><p>Подключаемся на любом этапе, в том числе срочно — при приостановке операций по счёту или возврате распоряжения из-за расхождения в основаниях платежа. Берём весь цикл: от открытия отдельного счёта до доведения контракта до оплаты.</p><h3>С чем к нам приходят из Дагестана</h3><ul class="reg-scen"><li>Субсидируемая поставка или контракт в пищевой и аграрной отрасли — подтверждение целевого характера расходования средств.</li><li>Целевой аванс по контракту в энергетике или нефтедобыче — отдельный счёт и санкционирование расходов.</li><li>Поставка оборудования для перерабатывающего производства — учёт целевого аванса без расхождений в основаниях.</li><li>Возврат распоряжения по формальному основанию — срочная диагностика и повторная подача.</li></ul></div></div></section>

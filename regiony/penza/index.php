  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      <div class="v2-hero-main">
        ...
        <p class="v2-hero-lede"><strong>Ваша команда занимается контрактом — мы занимаемся казначейством.</strong> Открываем лицевой счёт в УФК по Пензенской области, готовим распоряжения и сведения, проводим санкционирование и вытаскиваем проблемные контракты после возвратов. Формат — дистанционный, для всего региона.</p>

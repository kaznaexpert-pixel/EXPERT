...
<section class="v2-section v2-screen" id="faq">
  <div class="v2-container">
    ...
    <div class="faq">
      ...
      <details><summary>Можно ли пройти всё удалённо, без визита в УФК?</summary><p>Да. Открытие лицевого счёта, подача распоряжений и сведений идут через «Электронный бюджет» — личное присутствие не требуется ни на одном этапе.</p></details><details><summary>За сколько откроете счёт?</summary><p>За два рабочих дня с момента получения документов при стандартных требованиях. Срок фиксируем в договоре.</p></details><details><summary>Сколько стоит сопровождение?</summary><p>Цены фиксированные и не зависят от региона: открытие счёта — 29 000 ₽, ведение — от 55 000 ₽, спасение контракта — от 29 000 ₽. Точная стоимость — после анализа.</p></details><details><summary>Кто отвечает за замечания казначейства?</summary><p>Мы. Замечания устраняем без доплат — это часть услуги. Наша цель — санкционирование с первой подачи.</p></details><details><summary>Поможете со спасением проблемного контракта?</summary><p>Да. Срочно подключаемся: находим причину возвратов и блокировок, восстанавливаем учёт и доводим контракт до исполнения.</p></details>
    </div>
  </div>
</section>

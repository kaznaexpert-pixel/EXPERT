  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      <div class="v2-hero-main">
        ...
        <p class="v2-hero-lede"><strong>Берём казначейское сопровождение госконтракта в Петрозаводске на себя:</strong> открытие лицевого счёта в УФК по Республике Карелия, ведение платежей и санкционирование, раздельный учёт и спасение проблемных контрактов. Дистанционно по всему региону, без возвратов и срыва сроков.</p>
        ...
        <div class="v2-hero-expert">
          ...
          <p class="v2-expert-quote">«Республика Карелия ведём дистанционно: знаем требования УФК по Республике Карелия и доводим платежи до санкционирования с первой подачи».</p>
        </div>
      </div>
      <aside class="v2-hero-action">
        <div class="v2-hero-action-eyebrow">Экспертный анализ контракта</div>
        <h2>Разберём ваш контракт</h2>
        <p class="v2-hero-action-sub">Оставьте контакты — эксперт перезвонит за 15 минут, разберёт ваш контракт в Петрозаводске и назовёт точную стоимость. NDA — до анализа документов.</p>
...
<section class="v2-section v2-screen" id="region">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Петрозаводск</div><h2 class="v2-section-title">Сопровождение в Петрозаводске — <em>дистанционно и под ключ</em></h2></div>
    <div class="reg-split">
      <div class="reg-copy">
...
<section class="v2-section v2-screen" id="uslugi">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Услуги</div><h2 class="v2-section-title">Что берём на себя в Петрозаводске</h2><p class="v2-section-lede">Полный цикл казначейского сопровождения — от открытия счёта до спасения контракта.</p></div>
    <div class="v2-process-grid lp-3col">
      <article class="v2-process-step reveal"><div class="v2-process-no">01</div><h3>Открытие счёта</h3><p class="v2-process-desc">Пакет документов и открытие лицевого счёта в УФК по Республике Карелия с первой подачи за два рабочих дня. <a href="/uslugi/otkrytie-scheta/">Подробнее →</a></p></article>
...
<section class="v2-section v2-screen" id="process">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Процесс</div><h2 class="v2-section-title">Как начинаем работу в Петрозаводске</h2><p class="v2-section-lede">Каждый шаг — конкретное действие на нашей стороне. Прозрачно и дистанционно.</p></div>
    <div class="v2-process-grid lp-3col">
      ...
      <article class="v2-process-step reveal"><div class="v2-process-no">02</div><div class="v2-process-day">1–2 дня</div><h3>Документы и счёт</h3><p class="v2-process-desc">Готовим пакет, включаем в сводный реестр, открываем счёт в УФК по Республике Карелия.</p><ul class="v2-process-checks"><li>Счёт открыт</li></ul></article>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Заявка</div><h2 class="v2-section-title">Казначейское сопровождение в Петрозаводске</h2><p class="v2-section-lede">Оставьте контакты — эксперт перезвонит за 15 минут, разберёт ваш контракт и назовёт точную стоимость.</p></div>
...
<section class="reg-cross"><h2>Казначейское сопровождение в других регионах</h2><ul><li><a href="/regiony/pskov/">Казначейское сопровождение в Пскове</a></li><li><a href="/regiony/rostov-na-donu/">Казначейское сопровождение в Казначейское сопровождение в Ростове-на-Дону — под ключ</a></li><li><a href="/regiony/ryazan/">Казначейское сопровождение в Рязани</a></li><li><a href="/regiony/salehard/">Казначейское сопровождение в Салехарде</a></li><li><a href="/regiony/samara/">Казначейское сопровождение в Самаре</a></li><li><a href="/regiony/sankt-peterburg/">Казначейское сопровождение в Казначейское сопровождение в Санкт-Петербурге</a></li><li><a href="/regiony/saransk/">Казначейское сопровождение в Саранске</a></li><li><a href="/regiony/saratov/">Казначейское сопровождение в Саратове</a></li></ul><p style="margin:12px 0 0;font-size:.9rem"><a href="/regiony/">Все регионы России →</a></p></section>

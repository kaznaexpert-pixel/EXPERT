...
<script type="application/ld+json">
{"@context": "https://schema.org", "@type": "WebPage", "url": "https://kaznaexpert.ru/regiony/syktyvkar/", "name": "Казначейское сопровождение в Сыктывкаре — под ключ | КазнаЭксперт", "inLanguage": "ru-RU", "datePublished": "2026-06-05", "dateModified": "2026-07-23"}
</script>
  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      ...
      <aside class="v2-hero-action">
        ...
        <p class="v2-hero-action-sub">Перезвоним за 15 минут, разберём контракт в Сыктывкаре и назовём финальную цену. Конфиденциальность — NDA до анализа документов.</p>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Заявка</div><h2 class="v2-section-title">Казначейское сопровождение в Сыктывкаре</h2><p class="v2-section-lede">Пришлите контакты — за 15 минут перезвоним, оценим контракт и назовём финальную цену.</p></div>

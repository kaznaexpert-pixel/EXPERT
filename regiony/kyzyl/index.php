...
<section class="v2-section v2-screen" id="region-deep"><div class="v2-container"><div class="v2-section-head"><div class="v2-section-eyebrow">Специфика региона</div><h2 class="v2-section-title">Казначейское сопровождение госзаказа в Республике Тыва</h2></div><div class="reg-copy reg-deep" style="max-width:920px"><style>.v2 .reg-deep .reg-scen{margin:14px 0 0;padding:0;list-style:none;display:grid;gap:10px}.v2 .reg-deep .reg-scen li{position:relative;padding-left:26px;font-size:16px;line-height:1.6;color:var(--ink-soft,#3A3A3A)}.v2 .reg-deep .reg-scen li::before{content:"";position:absolute;left:4px;top:9px;width:8px;height:8px;border-radius:50%;background:var(--accent,#8B6F47)}</style><p>Республика Тыва — горнодобыча (коксующийся уголь, цветные и редкие металлы), агропромышленный комплекс (животноводство) и инфраструктурное строительство по федеральным программам формируют поток госзаказа. Под целевые авансы и субсидии подключается казначейское сопровождение.</p><p>Лицевой счёт открываем и ведём в УФК по Республике Тыва (код КОФК 1200, г. Кызыл, ул. Красноармейская, д. 76а) дистанционно через «Электронный бюджет» — присутствие в Кызыле не требуется.</p><p>Типовые контракты — инфраструктурные и дорожные объекты под целевой аванс, поставки и услуги для угледобычи, социальные объекты и поставки для агропромышленного комплекса. Берём полный цикл: открытие счёта, санкционирование, раздельный учёт, спасение при возвратах.</p><h3>С чем к нам приходят из Республики Тыва</h3><ul class="reg-scen"><li>Инфраструктурный или дорожный контракт с целевым авансом — санкционирование расходов.</li><li>Поставка оборудования для угледобычи — ведение целевых платежей.</li><li>Казначейское сопровождение целевой субсидии в агропромышленном комплексе — режим целевых средств.</li><li>Возврат распоряжения из-за оснований платежа — срочная диагностика и повторная подача.</li></ul></div></div></section>

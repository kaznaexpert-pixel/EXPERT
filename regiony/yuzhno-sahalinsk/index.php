  ...
  <div class="v2-container">
    <div class="v2-hero-grid">
      ...
      <aside class="v2-hero-action">
        ...
        <p class="v2-hero-action-sub">Оставьте контакты — эксперт перезвонит за 15 минут, разберёт ваш контракт в Южно-Сахалинске и назовёт точную стоимость. NDA — до анализа документов.</p>
...
<section class="v2-section v2-screen" id="faq">
  <div class="v2-container">
    ...
    <div class="faq">
      ...
      <details><summary>Что если казначейство вернёт документы?</summary><p>Устраняем замечания без доплат — это входит в услугу. Цель — пройти санкционирование с первой подачи.</p></details><details><summary>Контракт уже заблокирован — возьмётесь?</summary><p>Да, это профильная задача. Диагностируем причину блокировки или возвратов, восстанавливаем раздельный учёт и документы, доводим контракт до исполнения.</p></details><details><summary>Можно ли пройти всё удалённо, без визита в УФК?</summary><p>Да. Открытие лицевого счёта, подача распоряжений и сведений идут через «Электронный бюджет» — личное присутствие не требуется ни на одном этапе.</p></details><details><summary>За сколько откроете счёт?</summary><p>За два рабочих дня с момента получения документов при стандартных требованиях. Срок фиксируем в договоре.</p></details><details><summary>Из чего складывается стоимость?</summary><p>Цены фиксированные по всей России: открытие счёта — 29 000 ₽, ведение контракта — от 55 000 ₽, спасение — от 29 000 ₽. Финальную стоимость называем после анализа контракта — без скрытых доплат.</p></details>
    </div>
  </div>
</section>
...
<section class="v2-section v2-screen" id="zayavka">
  <div class="v2-container">
    <div class="v2-section-head"><div class="v2-section-eyebrow">Заявка</div><h2 class="v2-section-title">Казначейское сопровождение в Южно-Сахалинске</h2><p class="v2-section-lede">Оставьте телефон — эксперт свяжется в течение 15 минут и разберёт вашу ситуацию по контракту.</p></div>

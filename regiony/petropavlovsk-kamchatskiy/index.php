...
<section class="v2-section v2-screen" id="region-deep"><div class="v2-container"><div class="v2-section-head"><div class="v2-section-eyebrow">Специфика региона</div><h2 class="v2-section-title">Казначейское сопровождение госзаказа в Камчатском крае</h2></div><div class="reg-copy reg-deep" style="max-width:920px"><style>.v2 .reg-deep .reg-scen{margin:14px 0 0;padding:0;list-style:none;display:grid;gap:10px}.v2 .reg-deep .reg-scen li{position:relative;padding-left:26px;font-size:16px;line-height:1.6;color:var(--ink-soft,#3A3A3A)}.v2 .reg-deep .reg-scen li::before{content:"";position:absolute;left:4px;top:9px;width:8px;height:8px;border-radius:50%;background:var(--accent,#8B6F47)}</style><p>Камчатский край — рыбопромышленный комплекс, портовая инфраструктура, энергетика (в том числе геотермальная) и северный завоз определяют специфику госзаказа. Удалённость и девять часов разницы с Москвой делают дистанционный формат единственно рациональным; часть контрактов идёт по 275-ФЗ.</p><p>Лицевой счёт ведём в УФК по Камчатскому краю (код КОФК 3800, г. Петропавловск-Камчатский, ул. Ленинградская, д. 89) полностью дистанционно через «Электронный бюджет», а сроки санкционирования держим с поправкой на разницу во времени с центральными заказчиками.</p><p>Типовой поток — инфраструктурные и портовые контракты под целевой аванс, поставки и услуги для рыбопромышленного комплекса и северного завоза, энергетические заказы. Ведём весь цикл и подключаемся срочно при блокировке счёта.</p><h3>С чем к нам приходят из Камчатского края</h3><ul class="reg-scen"><li>Портовый или инфраструктурный контракт с целевым авансом — санкционирование расходов.</li><li>Поставка для рыбопромышленного комплекса или северного завоза — ведение целевых платежей.</li><li>Субподряд по гособоронзаказу — отдельный счёт и раздельный учёт по 275-ФЗ.</li><li>Возврат распоряжения с поправкой на часовые пояса — срочная диагностика и повторная подача.</li></ul></div></div></section>

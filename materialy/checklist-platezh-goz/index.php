...
<title>Чек-лист платежа с отдельного счёта по ГОЗ (PDF)</title>
<meta name="description" content="Бесплатный чек-лист PDF: проверка платежа с отдельного счёта по гособоронзаказу перед отправкой в банк — по ст. 8.3–8.4 закона № 275-ФЗ. Формат для печати бухгалтеру.">
<meta name="author" content="Ярослав Михайлов">
<meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
<meta name="theme-color" content="#F4F1EB" media="(prefers-color-scheme: light)">
<meta name="theme-color" content="#141310" media="(prefers-color-scheme: dark)">
<!-- PROD: canonical и og:url ОБЯЗАТЕЛЬНО менять под URL каждой статьи -->
<link rel="canonical" href="https://kaznaexpert.ru/materialy/checklist-platezh-goz/">
...
<div class="layout">
  <nav class="crumbs" aria-label="Хлебные крошки"><a href="/">Главная</a> › <a href="/materialy/">Материалы</a> › Чек-лист платежа по ГОЗ</nav>

  

  <article class="content" id="main">
    <div class="hero">
      <div class="eyebrow">Материалы · Чек-лист <span class="fresh">PDF для печати</span></div>
    <h1>Чек-лист: платёж с отдельного счёта по гособоронзаказу</h1>
    <div class="byline"><span class="av">ЯМ</span><span>Составил: <a href="/komanda/mihailov-yaroslav/">Ярослав Михайлов</a>, главный эксперт</span></div>
    </div>
    <div class="tldr">Проверка платежа с отдельного счёта по <b>ст. 8.3–8.4 закона № 275-ФЗ</b> перед отправкой в уполномоченный банк — в формате «распечатать и положить на стол бухгалтеру». Меньше возвратов — быстрее расчёты по кооперации.</div>
    <div style="background:var(--card,#fffdf8);border:1px solid var(--line,#e4ddd0);border-radius:16px;padding:24px 26px;margin:18px 0">
      <h2 style="margin-top:0">Что внутри</h2>
      <ul>
        <li>Разрешённые и запрещённые операции по отдельному счёту</li>
        <li>Обязательные реквизиты: ИГК в платёжке и назначение платежа</li>
        <li>Документы-основания, которые запросит банк</li>
        <li>Типовые причины отказа банка и как их избежать</li>
      </ul>
      <p style="margin-bottom:0"><a href="/files/checklist-platezh-obs-goz.pdf" style="display:inline-block;font-family:inherit;font-size:15px;font-weight:500;padding:14px 28px;border-radius:12px;background:var(--ink,#1A1A1A);color:#FBF9F4;text-decoration:none" download>Скачать чек-лист (PDF)</a></p>
    </div>
    <style>.cl-tbl{width:100%;border-collapse:collapse;margin:20px 0;font-size:15px;border-top:2px solid #8B6F47}.cl-tbl th,.cl-tbl td{padding:11px 14px;text-align:left;vertical-align:top;border-bottom:1px solid #E4DDD0;line-height:1.5}.cl-tbl th{font-size:12px;text-transform:uppercase;letter-spacing:.05em;color:#8B6F47}.cl-tbl td:first-child{font-weight:600}.cl-h3{margin:22px 0 6px}</style>
<h2>Как пройти платёж с отдельного счёта по гособоронзаказу: разбор по пунктам</h2>
<p>Отдельный счёт по гособоронзаказу открывается в уполномоченном банке из перечня Банка России и работает в режиме статьи 8.3 Федерального закона № 275-ФЗ. Ниже — что проверить перед каждым платежом, чтобы банк провёл его с первого раза.</p>
<h3 class="cl-h3">1. Разрешённые и запрещённые операции</h3>
<p>Проверьте, что расход прямо связан с исполнением контракта и входит в перечень разрешённых операций по отдельному счёту (ст. 8.3 № 275-ФЗ). Вывод прибыли, займы, размещение на депозитах и перевод на расчётный счёт вне случаев статьи 8.4 запрещены до исполнения обязательств. Ошибка: платёж на нецелевые нужды — банк отказывает в проведении.</p>
<h3 class="cl-h3">2. Обязательные реквизиты: ИГК и назначение платежа</h3>
<p>В платёжном поручении должен стоять 25-значный <a href="/baza-znaniy/identifikator-gosudarstvennogo-kontrakta-igk/">идентификатор государственного контракта (ИГК)</a>, а назначение платежа — раскрывать связь с контрактом (предмет, номер, этап). Проверяется в клиент-банке уполномоченного банка при создании платежа. Ошибка: нет ИГК или он не совпадает с контрактом — платёж возвращается.</p>
<h3 class="cl-h3">3. Документы-основания</h3>
<p>Банк запросит контракт-основание и первичные документы под конкретный платёж: акты, накладные, счета, при строительстве — формы КС-2 и КС-3. Суммы в документах должны совпадать с суммой платежа. Ошибка: комплект неполный или суммы не бьются — платёж не проходит контроль.</p>
<h3 class="cl-h3">4. Расчёты по цепочке кооперации</h3>
<p>Соисполнителям, которым доводится режим, отдельные счета открываются в том же <a href="/baza-znaniy/upolnomochennye-banki-po-goz/">уполномоченном банке</a>; расчёты идут только между отдельными счетами. Ошибка: платёж соисполнителю без открытого отдельного счёта — блокируется.</p>

<h2>Документ → куда прикладывать → типовая ошибка</h2>
<table class="cl-tbl">
<thead><tr><th>Документ</th><th>Куда прикладывать</th><th>Типовая ошибка</th></tr></thead>
<tbody>
<tr><td>Контракт (госконтракт-основание)</td><td>К заявлению на открытие отдельного счёта и к первому платежу</td><td>Указан старый номер или отсутствует ИГК в карточке</td></tr>
<tr><td>Акт, накладная, УПД</td><td>К распоряжению на оплату в клиент-банке</td><td>Сумма документа не совпадает с суммой платежа</td></tr>
<tr><td>Счёт на аванс, обоснование аванса</td><td>К авансовому платежу</td><td>Аванс превышает предусмотренную контрактом долю</td></tr>
<tr><td>Формы КС-2, КС-3 (строительство)</td><td>К оплате выполненных работ</td><td>Объёмы не соответствуют смете контракта</td></tr>
<tr><td>Договор с соисполнителем</td><td>К платежу в цепочке кооперации</td><td>У соисполнителя не открыт отдельный счёт</td></tr>
</tbody>
</table>

<h2>Топ-5 причин отказа в платеже по гособоронзаказу</h2>
<ol>
<li><strong>Нет или неверный ИГК</strong> в назначении платежа — платёж возвращается до исправления реквизита.</li>
<li><strong>Расход вне разрешённых целей</strong> отдельного счёта (ст. 8.3 № 275-ФЗ) — как проходит режим, разобрано в материале <a href="/baza-znaniy/otdelnyy-schet-po-goz/">отдельный счёт по ГОЗ</a>.</li>
<li><strong>Неполный комплект документов</strong> или несовпадение сумм с актами и накладными.</li>
<li><strong>Соисполнитель без отдельного счёта</strong> — режим не доведён по цепочке кооперации.</li>
<li><strong>Попытка вывести средства</strong> (прибыль, займ, депозит) до исполнения — прямой запрет 275-ФЗ; правила сопровождения ГОЗ — в разборе <a href="/baza-znaniy/kaznacheyskoe-soprovozhdenie-goz-275-fz/">казначейское сопровождение ГОЗ по 275-ФЗ</a>.</li>
</ol>

<h2>Разборы по теме</h2>
    <div class="answer reveal"><p>Подробнее о режиме счёта и правилах: <a href="/baza-znaniy/otdelnyy-schet-po-goz/">отдельный счёт по ГОЗ</a>, <a href="/baza-znaniy/identifikator-gosudarstvennogo-kontrakta-igk/">ИГК в платёжных документах</a>, <a href="/baza-znaniy/upolnomochennye-banki-po-goz/">уполномоченные банки</a>, <a href="/baza-znaniy/kaznacheyskoe-soprovozhdenie-goz-275-fz/">казначейское сопровождение ГОЗ</a>.</p></div>
  </article>

  <aside class="rail">
    <form class="railform" id="leadForm" novalidate data-endpoint="/php/lead.php" data-source="materialy">
...
<script type="application/ld+json">{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Что проверить перед платежом с отдельного счёта по гособоронзаказу?", "acceptedAnswer": {"@type": "Answer", "text": "Связь расхода с контрактом и разрешённость операции по ст. 8.3 № 275-ФЗ, наличие 25-значного ИГК в назначении платежа, полный комплект документов-оснований с совпадающими суммами и открытый отдельный счёт у соисполнителя, если платёж идёт по кооперации."}}, {"@type": "Question", "name": "Почему банк отказывает в платеже по гособоронзаказу?", "acceptedAnswer": {"@type": "Answer", "text": "Основные причины: отсутствие или неверный ИГК, расход вне разрешённых целей отдельного счёта, неполный комплект документов или несовпадение сумм, расчёт с соисполнителем без открытого отдельного счёта, попытка вывести средства до исполнения обязательств."}}, {"@type": "Question", "name": "Нужен ли ИГК в платёжке по отдельному счёту ГОЗ?", "acceptedAnswer": {"@type": "Answer", "text": "Да. В платёжном поручении указывается 25-значный идентификатор государственного контракта, а назначение платежа раскрывает связь с контрактом. Без корректного ИГК платёж возвращается."}}]}</script>
</body>
</html>
